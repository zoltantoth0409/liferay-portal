			...
			_createRemoveParameterEvent: function() {
				...
				reportTags.delegate(
					...
					function(event) {
						...
						var parameterValue = currentTarget.getData('parameterValue');
						var parameterType = currentTarget.getData('parameterType');

						instance.deleteParameter(parameterKey, parameterValue, parameterType);
					},
					'.remove-parameter'
				)
			},

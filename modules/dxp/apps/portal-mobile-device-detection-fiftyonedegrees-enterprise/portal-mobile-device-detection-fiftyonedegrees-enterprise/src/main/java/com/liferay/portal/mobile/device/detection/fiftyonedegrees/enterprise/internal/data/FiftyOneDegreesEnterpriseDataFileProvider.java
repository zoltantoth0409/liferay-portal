...
@Component(
	...
	property = {
		...
		"test.file.name=META-INF/51Degrees-TestV3_2.dat.gz"
	},
...
public class FiftyOneDegreesEnterpriseDataFileProvider
	...
	protected void activate(
		...
		_testFileName = GetterUtil.getString(properties.get("test.file.name"));
	}
	...
	private volatile String _testFileName;

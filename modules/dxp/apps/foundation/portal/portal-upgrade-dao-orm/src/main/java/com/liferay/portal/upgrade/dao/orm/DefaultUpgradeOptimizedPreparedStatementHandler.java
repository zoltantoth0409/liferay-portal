 ...
 */
public class DefaultUpgradeOptimizedPreparedStatementHandler
	implements InvocationHandler {

	public DefaultUpgradeOptimizedPreparedStatementHandler(
	...
	protected ResultSet executeQuery() throws SQLException {
		...
		return (ResultSet)ProxyUtil.newProxyInstance(
			...
			new DefaultUpgradeOptimizedResultSetHandler(resultSet));
	}

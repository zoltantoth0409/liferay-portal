...
describe('AddResultModal', () => {
	...
	it('has placeholder text for searching the engine', () => {
	...
	it('calls the handleSearchChange function when text is entered', () => {
	...
	it('calls the handleSearchKeyDown function when enter is pressed', () => {
	...
	it('calls the handleSubmit function when add button is pressed', () => {
	...
	it('disables the add button when the selected results are empty', () => {
		const {getByText} = render(
			<AddResultModal
				DELTAS={DELTAS}
				addResultSearchQuery={''}

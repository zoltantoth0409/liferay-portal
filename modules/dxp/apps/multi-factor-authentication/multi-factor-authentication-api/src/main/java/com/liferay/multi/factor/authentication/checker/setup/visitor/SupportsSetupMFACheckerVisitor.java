 ...
 */
@ProviderType
public class SupportsSetupMFACheckerVisitor extends PredicateMFACheckerVisitor {

	public SupportsSetupMFACheckerVisitor() {
		super(MFACheckerSetup.class::isInstance);
	}

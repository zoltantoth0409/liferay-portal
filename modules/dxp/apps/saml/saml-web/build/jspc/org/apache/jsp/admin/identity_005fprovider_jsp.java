...
public final class identity_005fprovider_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (samlProviderConfigurationHelper != null) {
	samlProviderConfiguration = samlProviderConfigurationHelper.getSamlProviderConfiguration();
      ...
      _jspx_th_portlet_actionURL_0.setName("/admin/updateIdentityProvider");
      _jspx_th_portlet_actionURL_0.setVar("updateIdentityProviderURL");
      ...
      _jspx_tagPool_portlet_actionURL_var_name.reuse(_jspx_th_portlet_actionURL_0);
      java.lang.String updateIdentityProviderURL = null;
      updateIdentityProviderURL = (java.lang.String) _jspx_page_context.findAttribute("updateIdentityProviderURL");
      out.write('\n');
      out.write('\n');
      //  aui:form
      ...
      _jspx_th_aui_form_0.setAction( updateIdentityProviderURL );
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_input_0.setHelpMessage("saml-sign-metadata-description");
          _jspx_th_aui_input_0.setLabel("saml-sign-metadata");
          _jspx_th_aui_input_0.setName( "settings--" + PortletPropsKeys.SAML_SIGN_METADATA + "--" );
          _jspx_th_aui_input_0.setType("checkbox");
          _jspx_th_aui_input_0.setValue( samlProviderConfiguration.signMetadata() );
          ...
          _jspx_th_aui_input_1.setHelpMessage("saml-ssl-required-description");
          _jspx_th_aui_input_1.setLabel("saml-ssl-required");
          _jspx_th_aui_input_1.setName( "settings--" + PortletPropsKeys.SAML_SSL_REQUIRED + "--" );
          _jspx_th_aui_input_1.setType("checkbox");
          _jspx_th_aui_input_1.setValue( samlProviderConfiguration.sslRequired() );
          ...
          _jspx_th_aui_input_2.setHelpMessage("saml-idp-authn-request-signature-required-description");
          _jspx_th_aui_input_2.setLabel("saml-idp-authn-request-signature-required");
          _jspx_th_aui_input_2.setName( "settings--" + PortletPropsKeys.SAML_IDP_AUTHN_REQUEST_SIGNATURE_REQUIRED + "--" );
          _jspx_th_aui_input_2.setType("checkbox");
          _jspx_th_aui_input_2.setValue( samlProviderConfiguration.authnRequestSignatureRequired() );
        ...
        _jspx_th_aui_fieldset_1.setLabel("session");
        ...
        if (_jspx_eval_aui_fieldset_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_aui_input_3.setHelpMessage("saml-idp-session-maximum-age-description");
          _jspx_th_aui_input_3.setLabel("saml-idp-session-maximum-age");
          _jspx_th_aui_input_3.setName( "settings--" + PortletPropsKeys.SAML_IDP_SESSION_MAXIMUM_AGE + "--" );
          _jspx_th_aui_input_3.setValue( String.valueOf(samlProviderConfiguration.sessionMaximumAge()) );
          ...
          _jspx_th_aui_input_4.setHelpMessage("saml-idp-session-timeout-description");
          _jspx_th_aui_input_4.setLabel("saml-idp-session-timeout");
          _jspx_th_aui_input_4.setName( "settings--" + PortletPropsKeys.SAML_IDP_SESSION_TIMEOUT + "--" );
          _jspx_th_aui_input_4.setValue( String.valueOf(samlProviderConfiguration.sessionTimeout()) );
  ...
  private boolean _jspx_meth_portlet_param_0(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_actionURL_0, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_0.setValue("identity-provider");

...
public class SamlSpIdpConnectionLocalServiceUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(SamlSpIdpConnectionLocalService.class);

		ServiceTracker<SamlSpIdpConnectionLocalService, SamlSpIdpConnectionLocalService> serviceTracker =
			new ServiceTracker<SamlSpIdpConnectionLocalService, SamlSpIdpConnectionLocalService>(bundle.getBundleContext(),

...
public class SamlSpIdpConnectionPersistenceImpl
	...
	public List<SamlSpIdpConnection> findByCompanyId(
		...
		List<SamlSpIdpConnection> list =
			(List<SamlSpIdpConnection>)finderCache.getResult(
	 ...
	 *
	 * @deprecated As of Mueller (7.2.x), replaced by {@link #fetchByC_SIEI(long,String)}
	 * @param companyId the company ID
	 * @param samlIdpEntityId the saml idp entity ID
	 * @param useFinderCache whether to use the finder cache
	...
	public SamlSpIdpConnection fetchByC_SIEI(
		...
		return fetchByC_SIEI(companyId, samlIdpEntityId);
	}

 ...
 */
@Generated("")
@GraphQLName("DataRecordIds")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "DataRecordIds")
public class DataRecordIds implements Serializable {

	public static DataRecordIds toDTO(String json) {
		return ObjectMapperUtil.readValue(DataRecordIds.class, json);
	}
	...
	public String toString() {
		...
		if (dataRecordIds != null) {
			...
			for (int i = 0; i < dataRecordIds.length; i++) {
				sb.append(dataRecordIds[i]);

				if ((i + 1) < dataRecordIds.length) {
					sb.append(", ");
				}
			}

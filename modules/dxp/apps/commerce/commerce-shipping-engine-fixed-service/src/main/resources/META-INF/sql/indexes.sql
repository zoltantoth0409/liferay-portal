...
create index IX_D89A7E24 on CommerceShippingFixedOptionRel (commerceShippingFixedOptionId);
create index IX_4AA09D60 on CommerceShippingFixedOptionRel (commerceShippingMethodId);
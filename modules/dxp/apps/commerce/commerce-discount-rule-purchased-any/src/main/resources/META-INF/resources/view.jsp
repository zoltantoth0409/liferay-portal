...
<%
PurchasedAnyCommerceDiscountRuleDisplayContext purchasedAnyCommerceDiscountRuleDisplayContext = (PurchasedAnyCommerceDiscountRuleDisplayContext)request.getAttribute("view.jsp-purchasedAnyCommerceDiscountRuleDisplayContext");

List<CPDefinition> cpDefinitions = purchasedAnyCommerceDiscountRuleDisplayContext.getCPDefinitions();
%>
			...
			var itemSelectorDialog = new A.LiferayItemSelectorDialog(
				{
					...
					url: '<%= purchasedAnyCommerceDiscountRuleDisplayContext.getItemSelectorUrl() %>'
				}
			);

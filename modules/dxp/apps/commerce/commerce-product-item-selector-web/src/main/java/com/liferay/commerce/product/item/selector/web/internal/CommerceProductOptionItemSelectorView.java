...
public class CommerceProductOptionItemSelectorView
	implements ItemSelectorView<CommerceProductOptionItemSelectorCriterion> {

	@Override
	public Class<CommerceProductOptionItemSelectorCriterion>
		getItemSelectorCriterionClass() {

		return CommerceProductOptionItemSelectorCriterion.class;
	}

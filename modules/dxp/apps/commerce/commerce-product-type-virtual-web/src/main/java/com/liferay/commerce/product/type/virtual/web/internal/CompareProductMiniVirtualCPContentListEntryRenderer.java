...
@Component(
	immediate = true,
	property = {
		"commerce.product.content.list.entry.renderer.key=" + CompareProductMiniVirtualCPContentListEntryRenderer.KEY,
		"commerce.product.content.list.entry.renderer.portlet.name=" + CPPortletKeys.CP_COMPARE_CONTENT_MINI_WEB,
		"commerce.product.content.list.entry.renderer.type=" + VirtualCPTypeConstants.NAME
	},
	service = CPContentListEntryRenderer.class
)
public class CompareProductMiniVirtualCPContentListEntryRenderer
	implements CPContentListEntryRenderer {

	public static final String KEY = "compare-product-mini-virtual";

...
@Component(
	immediate = true,
	property = {
		"commerce.product.content.list.entry.renderer.key=" + DefaultVirtualCPContentListEntryRenderer.KEY,
...
public class DefaultVirtualCPContentListEntryRenderer
	implements CPContentListEntryRenderer {

	public static final String KEY = "default-virtual";

...
@Component(
	immediate = true,
	property = {
		"commerce.product.content.list.entry.renderer.key=" + SearchResultVirtualCPContentListEntryRenderer.KEY,
...
public class SearchResultVirtualCPContentListEntryRenderer
	implements CPContentListEntryRenderer {

	public static final String KEY = "search-result-virtual";

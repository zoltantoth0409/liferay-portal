...
@Component(
	immediate = true,
	property = {
		"commerce.product.content.list.entry.renderer.key=" + CompareProductVirtualCPContentListEntryRenderer.KEY,
...
public class CompareProductVirtualCPContentListEntryRenderer
	implements CPContentListEntryRenderer {

	public static final String KEY = "compare-product-virtual";

...
>
	<div class="container-fluid product-detail" id="<portlet:namespace /><%= cpDefinition.getCPDefinitionId() %>ProductContent">
		...
		List<CPOptionCategory> cpOptionCategories = virtualCPTypeDisplayContext.getCPOptionCategories();
			...
			<div class="product-detail-body w-100">
				<div class="nav-tabs-centered">
					<ul class="justify-content-center nav nav-tabs" role="tablist">
						...
						<c:if test="<%= virtualCPTypeDisplayContext.hasCPDefinitionSpecificationOptionValues() %>">
							<li class="nav-item" role="presentation">
						...
						<c:if test="<%= virtualCPTypeDisplayContext.hasCPDefinitionSpecificationOptionValues() %>">
							<div class="tab-pane" id="<portlet:namespace />specification">
								...
								for (CPOptionCategory cpOptionCategory : cpOptionCategories) {
									List<CPDefinitionSpecificationOptionValue> categorizedCPDefinitionSpecificationOptionValues = virtualCPTypeDisplayContext.getCategorizedCPDefinitionSpecificationOptionValues(cpOptionCategory.getCPOptionCategoryId());
								%>

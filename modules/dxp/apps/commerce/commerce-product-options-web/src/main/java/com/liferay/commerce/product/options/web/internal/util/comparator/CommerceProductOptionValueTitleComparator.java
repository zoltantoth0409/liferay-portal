 ...
 */
public class CommerceProductOptionValueTitleComparator
	extends OrderByComparator<CommerceProductOptionValue> {

	public static final String ORDER_BY_ASC =
		"CommerceProductOptionValue.title ASC";

	public static final String ORDER_BY_DESC =
		"CommerceProductOptionValue.title DESC";

	public static final String[] ORDER_BY_FIELDS = {"title"};

	public CommerceProductOptionValueTitleComparator() {
		this(false);
	}

	public CommerceProductOptionValueTitleComparator(boolean ascending) {

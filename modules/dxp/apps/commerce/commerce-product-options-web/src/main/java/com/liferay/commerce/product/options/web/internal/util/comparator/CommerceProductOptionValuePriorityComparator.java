 ...
 */
public class CommerceProductOptionValuePriorityComparator
	extends OrderByComparator<CommerceProductOptionValue> {

	public static final String ORDER_BY_ASC =
		"CommerceProductOptionValue.priority ASC";

	public static final String ORDER_BY_DESC =
		"CommerceProductOptionValue.priority DESC";

	public static final String[] ORDER_BY_FIELDS = {"priority"};

	public CommerceProductOptionValuePriorityComparator() {
		this(false);
	}

	public CommerceProductOptionValuePriorityComparator(boolean ascending) {

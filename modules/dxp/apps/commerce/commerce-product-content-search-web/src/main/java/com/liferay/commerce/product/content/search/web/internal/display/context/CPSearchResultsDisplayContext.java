...
public class CPSearchResultsDisplayContext {
	...
	public String getProductDefaultImage(Document document, ThemeDisplay themeDisplay) throws Exception{


		long fileEntryId = GetterUtil.getLong(document.get(CPDefinitionIndexer.FIELD_DEFAULT_IMAGE_FILE_ENTRY_ID ));

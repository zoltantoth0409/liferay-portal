...
package com.liferay.commerce.payment.engine.purchase.order.internal;
...
@Component(
	immediate = true,
	property = "commerce.payment.engine.key=" + PurchaseOrderCommercePaymentEngine.KEY,
	service = CommercePaymentEngine.class
)
public class PurchaseOrderCommercePaymentEngine
	...
	public String getDescription(Locale locale) {
		...
		return LanguageUtil.get(resourceBundle, "purchase-order-description");
	}
	...
	public void updateConfiguration(
		...
		Settings settings = _settingsFactory.getSettings(
			new GroupServiceSettingsLocator(
				...
				PurchaseOrderCommercePaymentEngineConstants.SERVICE_NAME));

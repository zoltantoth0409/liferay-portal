...
>
	...
	<liferay-frontend:management-bar-buttons>
		...
		<c:if test="<%= hasManageCPTaxCategoriesPermission %>">
			...
			<liferay-frontend:add-menu inline="<%= true %>">
				<liferay-frontend:add-menu-item title='<%= LanguageUtil.get(request, "add-tax-category") %>' url="<%= addCPTaxCategoryURL.toString() %>" />
	...
	<c:if test="<%= hasManageCPTaxCategoriesPermission %>">
		<liferay-frontend:management-bar-action-buttons>
			<liferay-frontend:management-bar-button href='<%= "javascript:" + renderResponse.getNamespace() + "deleteCPTaxCategories();" %>' icon="times" label="delete" />
		</liferay-frontend:management-bar-action-buttons>
	</c:if>
</liferay-frontend:management-bar>

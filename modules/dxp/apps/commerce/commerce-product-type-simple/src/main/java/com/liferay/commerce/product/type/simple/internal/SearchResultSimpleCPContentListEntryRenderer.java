...
@Component(
	immediate = true,
	property = {
		"commerce.product.content.list.entry.renderer.key=" + SearchResultSimpleCPContentListEntryRenderer.KEY,
...
public class SearchResultSimpleCPContentListEntryRenderer
	implements CPContentListEntryRenderer {

	public static final String KEY = "search-result-simple";

...
@Component(
	immediate = true,
	property = {
		"commerce.product.content.list.entry.renderer.key=" + ProductPublisherSimpleCPContentListEntryRenderer.KEY,
...
public class ProductPublisherSimpleCPContentListEntryRenderer
	implements CPContentListEntryRenderer {

	public static final String KEY = "product-publisher-simple";

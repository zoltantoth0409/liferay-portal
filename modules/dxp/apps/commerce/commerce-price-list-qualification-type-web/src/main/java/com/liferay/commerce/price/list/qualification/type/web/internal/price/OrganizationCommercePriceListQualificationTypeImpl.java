...
@Component(
	immediate = true,
	property = {
		"commerce.price.list.qualification.type.key=" + OrganizationCommercePriceListQualificationTypeImpl.KEY,
		"commerce.price.list.qualification.type.priority:Integer=20"
	},
	service = CommercePriceListQualificationType.class
)
public class OrganizationCommercePriceListQualificationTypeImpl

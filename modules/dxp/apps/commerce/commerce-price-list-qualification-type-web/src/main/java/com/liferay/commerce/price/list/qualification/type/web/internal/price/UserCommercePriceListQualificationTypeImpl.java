...
@Component(
	immediate = true,
	property = {
		"commerce.price.list.qualification.type.key=" + UserCommercePriceListQualificationTypeImpl.KEY,
		"commerce.price.list.qualification.type.priority:Integer=10"
	},
	service = CommercePriceListQualificationType.class
)
public class UserCommercePriceListQualificationTypeImpl

...
public class CommerceTaxCategorySelectorCriterionHandler
	extends BaseItemSelectorCriterionHandler
		<CommerceTaxCategoryItemSelectorCriterion> {

	@Override
	public Class<CommerceTaxCategoryItemSelectorCriterion>
		getItemSelectorCriterionClass() {

		return CommerceTaxCategoryItemSelectorCriterion.class;
	}

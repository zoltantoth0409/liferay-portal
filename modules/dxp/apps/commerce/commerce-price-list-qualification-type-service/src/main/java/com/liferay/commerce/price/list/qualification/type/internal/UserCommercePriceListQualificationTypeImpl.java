...
@Component(
	immediate = true,
	property = {
		"commerce.price.list.qualification.type.key=" + CommercePriceListQualificationTypeConstants.QUALIFICATION_TYPE_USER,
...
public class UserCommercePriceListQualificationTypeImpl
	...
	public String getKey() {
		return
			CommercePriceListQualificationTypeConstants.QUALIFICATION_TYPE_USER;
	}

...
public class SpotResourceFactoryImpl implements SpotResource.Factory {
	...
	public SpotResource.Builder create() {
		return new SpotResource.Builder() {
			...
			@Override
			public SpotResource.Builder httpServletRequest(
			...
			@Override
			public SpotResource.Builder preferredLocale(
	...
	private Object _invoke(
		...
		spotResource.setContextAcceptLanguage(
		...
		spotResource.setContextHttpServletRequest(httpServletRequest);

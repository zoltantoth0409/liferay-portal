...
@Component(
	immediate = true,
	property = {
		"commerce.product.content.list.entry.renderer.key=" + SearchResultGroupedCPContentListEntryRenderer.KEY,
...
public class SearchResultGroupedCPContentListEntryRenderer
	implements CPContentListEntryRenderer {

	public static final String KEY = "search-result-grouped";

...
@Component(
	immediate = true,
	property = {
		"commerce.product.content.list.entry.renderer.key=" + CompareProductGroupedCPContentListEntryRenderer.KEY,
...
public class CompareProductGroupedCPContentListEntryRenderer
	implements CPContentListEntryRenderer {

	public static final String KEY = "compare-product-grouped";

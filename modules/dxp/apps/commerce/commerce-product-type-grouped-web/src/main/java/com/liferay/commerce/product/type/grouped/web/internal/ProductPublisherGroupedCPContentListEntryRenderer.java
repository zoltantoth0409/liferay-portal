...
@Component(
	immediate = true,
	property = {
		"commerce.product.content.list.entry.renderer.key=" + ProductPublisherGroupedCPContentListEntryRenderer.KEY,
...
public class ProductPublisherGroupedCPContentListEntryRenderer
	implements CPContentListEntryRenderer {

	public static final String KEY = "product-publisher-grouped";
	...
	public void render(
		...
		_jspRenderer.renderJSP(
			...
			"/render/list_entry/product_publisher.jsp");
	}

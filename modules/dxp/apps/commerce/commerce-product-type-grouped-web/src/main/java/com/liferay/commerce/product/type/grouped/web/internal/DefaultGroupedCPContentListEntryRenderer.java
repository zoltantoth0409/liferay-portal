...
@Component(
	immediate = true,
	property = {
		"commerce.product.content.list.entry.renderer.key=" + DefaultGroupedCPContentListEntryRenderer.KEY,
...
public class DefaultGroupedCPContentListEntryRenderer
	implements CPContentListEntryRenderer {

	public static final String KEY = "default-grouped";

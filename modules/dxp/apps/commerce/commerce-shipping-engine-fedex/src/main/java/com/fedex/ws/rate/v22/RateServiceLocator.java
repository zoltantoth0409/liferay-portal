...
public class RateServiceLocator extends org.apache.axis.client.Service implements com.fedex.ws.rate.v22.RateService {
    ...
    public com.fedex.ws.rate.v22.RatePortType getRateServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.fedex.ws.rate.v22.RatePortType getRateServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.fedex.ws.rate.v22.RateServiceSoapBindingStub _stub = new com.fedex.ws.rate.v22.RateServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.fedex.ws.rate.v22.RatePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.fedex.ws.rate.v22.RateServiceSoapBindingStub _stub = new com.fedex.ws.rate.v22.RateServiceSoapBindingStub(new java.net.URL(RateServicePort_address), this);
                _stub.setPortName(getRateServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://fedex.com/ws/rate/v22", "RateService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v22", "RateServicePort"));
        }

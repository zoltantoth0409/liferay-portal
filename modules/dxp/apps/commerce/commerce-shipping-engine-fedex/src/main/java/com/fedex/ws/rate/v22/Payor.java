...
public class Payor  implements java.io.Serializable {
    private com.fedex.ws.rate.v22.Party responsibleParty;

    public Payor() {
    }

    public Payor(
           com.fedex.ws.rate.v22.Party responsibleParty) {
     ...
     */
    public com.fedex.ws.rate.v22.Party getResponsibleParty() {
        return responsibleParty;
    }
     ...
     */
    public void setResponsibleParty(com.fedex.ws.rate.v22.Party responsibleParty) {
        this.responsibleParty = responsibleParty;
    }

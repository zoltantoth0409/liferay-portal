...
public class CPDefinitionOptionRelDetailsCustomFieldsFormNavigatorEntry
	...
	public boolean isVisible(
		User user, CPDefinitionOptionRel cpDefinitionOptionRel) {
		...
		try {
			...
			if (cpDefinitionOptionRel != null) {
				classPK = cpDefinitionOptionRel.getCPDefinitionOptionRelId();
			}

			hasCustomAttributesAvailable =
				CustomAttributesUtil.hasCustomAttributes(
					user.getCompanyId(), CPDefinitionOptionRel.class.getName(),
					classPK, null);
		}
		catch (Exception e) {
		}

 ...
 */
public class CommerceProductInstanceDisplayDateComparator
	extends OrderByComparator<CommerceProductInstance> {
	...
	public CommerceProductInstanceDisplayDateComparator() {
		this(false);
	}

	public CommerceProductInstanceDisplayDateComparator(boolean ascending) {
		_ascending = ascending;
	}

	@Override
	public int compare(
		CommerceProductInstance productInstance1,
		CommerceProductInstance productInstance2) {

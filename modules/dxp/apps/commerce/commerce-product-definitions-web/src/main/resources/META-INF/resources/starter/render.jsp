...
<div class="commerce-starter-content row">
	<div class="carousel slide w100" data-interval="false" id="carousel-commerce-starter-default">
		<div class="carousel-inner" role="listbox">
			<div class="active carousel-item">
				<img src="<%= servletContext.getContextPath() %>/images/carousel_01.png" />
			</div>

			<div class="carousel-item">
				<img src="<%= servletContext.getContextPath() %>/images/carousel_02.png" />
			</div>
		</div>

		<a class="carousel-control carousel-control-left left" data-slide="prev" href="#carousel-commerce-starter-default" role="button">
			<liferay-ui:icon
		...
		<a class="carousel-control carousel-control-right right" data-slide="next" href="#carousel-commerce-starter-default" role="button">
			<liferay-ui:icon
...
<style>
	#carousel-commerce-starter-default {
		position: relative;
	}

	#carousel-commerce-starter-default .carousel-item > img {
		border-radius: 4px;
		width: 100%;
	}

	#carousel-commerce-starter-default .carousel-control {
	...
	#carousel-commerce-starter-default .carousel-control-left {
		left: 5%;
		top: 50%;
	}

	#carousel-commerce-starter-default .carousel-control-right {
		right: 5%;
		top: 50%;
	}

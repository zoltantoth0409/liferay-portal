...
page import="com.liferay.commerce.product.definitions.web.internal.display.context.CPDefinitionMediaDisplayContext" %><%@
...
page import="com.liferay.commerce.product.model.CPDefinitionMedia" %><%@

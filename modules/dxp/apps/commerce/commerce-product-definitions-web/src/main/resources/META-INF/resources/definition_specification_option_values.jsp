...
String toolbarItem = ParamUtil.getString(request, "toolbarItem", "view-product-definition-specification-options");
...
request.setAttribute("view.jsp-cpType", cpDefinitionSpecificationOptionValueDisplayContext.getCPType());
...
>
	...
	<liferay-frontend:management-bar-action-buttons>
		...
		<liferay-frontend:management-bar-button href='<%= "javascript:" + renderResponse.getNamespace() + "deleteCPDefinitionSpecificationOptionValues();" %>' icon="trash" label="delete" />
	</liferay-frontend:management-bar-action-buttons>
</liferay-frontend:management-bar>
			...
			var itemSelectorDialog = new A.LiferayItemSelectorDialog(
				{
					...
					title: '<liferay-ui:message arguments="<%= cpDefinition.getTitle(languageId) %>" key="add-new-specification-option-value-to-x" />',

...
/**
 * Provides the local service interface for CCart. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Alessio Antonio Rendina
 * @see CCartLocalServiceUtil
...
public interface CCartLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CCartLocalServiceUtil} to access the c cart local service. Add custom service methods to {@link com.liferay.commerce.cart.service.impl.CCartLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CCart fetchCCartByUuidAndGroupId(java.lang.String uuid, long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CCart getCCartByUuidAndGroupId(java.lang.String uuid, long groupId)
		throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CCart> getCCarts(int type, int start, int end,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CCart> getCCartsByUuidAndCompanyId(java.lang.String uuid,
		long companyId);

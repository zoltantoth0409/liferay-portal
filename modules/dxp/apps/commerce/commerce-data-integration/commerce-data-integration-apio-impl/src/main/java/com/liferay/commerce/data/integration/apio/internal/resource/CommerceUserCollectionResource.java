...
import static com.liferay.commerce.data.integration.apio.internal.util.CommerceUserHelper.convertLongArrayToList;
...
public class CommerceUserCollectionResource
	...
	private UserWrapper _updateUser(
		...
		user.setPassword(commerceUserUpdaterForm.getPassword());
		user.setScreenName(commerceUserUpdaterForm.getAlternateName());
		user.setEmailAddress(commerceUserUpdaterForm.getEmail());
		user.setFirstName(commerceUserUpdaterForm.getGivenName());
		user.setLastName(commerceUserUpdaterForm.getFamilyName());
		user.setJobTitle(commerceUserUpdaterForm.getJobTitle());
		...
		if (commerceUserUpdaterForm.getRoleIds() != null) {
			_updateRoles(commerceUserUpdaterForm, user);
		}

...
@Component(
	immediate = true,
	property = "commerce.discount.rule.type.jsp.contributor.key=" + CommerceDiscountRuleConstants.TYPE_HAD_SPENT_AMOUNT
)
public class HadSpentAmountCommerceDiscountRuleTypeJSPContributor

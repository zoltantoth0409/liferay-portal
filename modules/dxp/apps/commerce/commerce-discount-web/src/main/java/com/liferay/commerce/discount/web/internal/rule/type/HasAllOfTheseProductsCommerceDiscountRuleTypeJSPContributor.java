...
@Component(
	immediate = true,
	property = "commerce.discount.rule.type.jsp.contributor.key=" + CommerceDiscountRuleConstants.TYPE_HAS_ALL_OF_THESE_PRODUCTS
)
public class HasAllOfTheseProductsCommerceDiscountRuleTypeJSPContributor

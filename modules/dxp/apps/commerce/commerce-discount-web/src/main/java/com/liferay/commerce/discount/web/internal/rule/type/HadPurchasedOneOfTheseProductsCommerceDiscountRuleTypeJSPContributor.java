...
@Component(
	immediate = true,
	property = "commerce.discount.rule.type.jsp.contributor.key=" + CommerceDiscountRuleConstants.TYPE_HAD_PURCHASED_ONE_OF_THESE_PRODUCTS
)
public class
	HadPurchasedOneOfTheseProductsCommerceDiscountRuleTypeJSPContributor

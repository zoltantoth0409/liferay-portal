...
@Component(
	...
	property = {
		...
		"mvc.command.name=cCartInfoPanel"
	},
	service = MVCResourceCommand.class
)
public class CCartInfoPanelMVCResourceCommand extends BaseMVCResourceCommand {
	...
	protected void doServeResource(
		...
		List<CCart> cCarts = _actionHelper.getCCarts(resourceRequest);

		resourceRequest.setAttribute(CCartWebKeys.C_CARTS, cCarts);

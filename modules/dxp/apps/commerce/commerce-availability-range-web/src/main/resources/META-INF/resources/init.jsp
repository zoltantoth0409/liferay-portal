...
page import="com.liferay.commerce.availability.range.web.internal.admin.CommerceAvailabilityRangeAdminModule" %><%@
...
<%
String commerceAdminModuleKey = CommerceAvailabilityRangeAdminModule.KEY;

...
package com.liferay.commerce.wizard.web.internal.application.list;
...
public class CommerceWizardPanelApp extends BasePanelApp {

	@Override
	public String getPortletId() {
		return CPPortletKeys.COMMERCE_WIZARD;
	}
	...
	@Override
	@Reference(
		target = "(javax.portlet.name=" + CPPortletKeys.COMMERCE_WIZARD + ")",
		unbind = "-"
	)

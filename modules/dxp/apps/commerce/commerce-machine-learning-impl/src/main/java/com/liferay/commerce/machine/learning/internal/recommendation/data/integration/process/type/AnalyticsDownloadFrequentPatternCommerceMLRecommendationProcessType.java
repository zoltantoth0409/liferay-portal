...
@Component(
	...
	property = {
		"commerce.data.integration.process.type.key=" + AnalyticsDownloadFrequentPatternCommerceMLRecommendationProcessType.KEY,
		"commerce.data.integration.process.type.order=100"
	},
	service = ProcessType.class
)
public class AnalyticsDownloadFrequentPatternCommerceMLRecommendationProcessType

...
@Component(
	...
	property = {
		"commerce.data.integration.process.type.key=" + AnalyticsDownloadUserCommerceMLRecommendationProcessType.KEY,
		"commerce.data.integration.process.type.order=100"
	},
	service = ProcessType.class
)
public class AnalyticsDownloadUserCommerceMLRecommendationProcessType

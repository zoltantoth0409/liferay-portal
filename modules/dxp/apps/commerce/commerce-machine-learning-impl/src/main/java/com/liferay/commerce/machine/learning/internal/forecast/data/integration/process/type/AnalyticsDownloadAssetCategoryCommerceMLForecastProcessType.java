...
@Component(
	...
	property = {
		"commerce.data.integration.process.type.key=" + AnalyticsDownloadAssetCategoryCommerceMLForecastProcessType.KEY,
		"commerce.data.integration.process.type.order=100"
	},
	service = ProcessType.class
)
public class AnalyticsDownloadAssetCategoryCommerceMLForecastProcessType

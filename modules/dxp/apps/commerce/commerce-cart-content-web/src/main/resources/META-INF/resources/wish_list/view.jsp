	...
	<div class="commerce-wish-list-items-container" id="<portlet:namespace />entriesContainer">
		...
		>
			...
			>
				...
				Map<CPDefinitionOptionRel, List<CPDefinitionOptionValueRel>> cpDefinitionOptionRelMap = commerceWishListContentDisplayContext.parseJSONString(commerceCartItem.getJson());

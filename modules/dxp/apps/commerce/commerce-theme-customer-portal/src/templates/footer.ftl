<footer class="commerce-footer" id="footer" role="contentinfo">
	<div class="autofit-float autofit-row footer-main-section">
		<div class="autofit-col autofit-col-expand footer-section-column">
			<h3 class="footer-list-title">Category 1</h3>
		...
		<div class="autofit-col autofit-col-expand footer-section-column">
			<h3 class="footer-list-title">Category 2</h3>
			<ul class="list-unstyled">
				<li><a class="footer-link" href="#placeholder">Link One</a></li>
				<li><a class="footer-link" href="#placeholder">Link Two</a></li>
				<li><a class="footer-link" href="#placeholder">Link Three</a></li>
		...
		<div class="autofit-col autofit-col-expand footer-section-column">
			<h3 class="footer-list-title">Category 3</h3>
			<ul class="list-unstyled">
				<li><a class="footer-link" href="#placeholder">Link One</a></li>
				<li><a class="footer-link" href="#placeholder">Link Two</a></li>
				<li><a class="footer-link" href="#placeholder">Link Three</a></li>
		...
		<div class="autofit-col autofit-col-expand footer-section-column">
			<ul class="list-unstyled">
				<li>
					<a class="social-media-link" href="#placeholder">
						<svg aria-hidden="true" class="lexicon-icon lexicon-icon-cog" focusable="false"><use xlink:href="${images_folder}/lexicon/icons.svg#cog" /></svg>
						Facebook
					</a>
				</li>
				<li><a class="social-media-link" href="#placeholder">Twitter</a></li>
				<li>
					<a class="social-media-link" href="#placeholder">
						<svg aria-hidden="true" class="lexicon-icon lexicon-icon-cog" focusable="false"><use xlink:href="${images_folder}/lexicon/icons.svg#cog" /></svg>
						Linkedin
				...
				<li><a class="social-media-link" href="#placeholder">Instagram</a></li>
				<li><a class="social-media-link" href="#placeholder">Youtube</a></li>
			</ul>
		</div>

		<div class="autofit-col autofit-col-expand footer-section-column">
			<h3 class="footer-list-title">Need Help?</h3>
			<div>Please contact us here:</div>
			<div>1-800-RYANCON</div>
			<div>or email us at</div>
			<div><a href="#placeholder">help@ryancon.com</a></div>
		</div>
	</div>

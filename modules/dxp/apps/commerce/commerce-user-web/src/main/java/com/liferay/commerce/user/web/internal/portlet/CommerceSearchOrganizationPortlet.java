...
@Component(
	...
	property = {
		...
		"javax.portlet.name=" + CommerceUserPortletKeys.COMMERCE_SEARCH_ORGANIZATION_ADMIN,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user",
		"javax.portlet.supports.mime-type=text/html"
	},
	service = {CommerceSearchOrganizationPortlet.class, Portlet.class}
)
public class CommerceSearchOrganizationPortlet extends MVCPortlet {

...
<%
PurchasedAllCommerceDiscountRuleDisplayContext purchasedAllCommerceDiscountRuleDisplayContext = (PurchasedAllCommerceDiscountRuleDisplayContext)request.getAttribute("view.jsp-purchasedAllCommerceDiscountRuleDisplayContext");

List<CPDefinition> cpDefinitions = purchasedAllCommerceDiscountRuleDisplayContext.getCPDefinitions();
%>
			...
			var itemSelectorDialog = new A.LiferayItemSelectorDialog(
				{
					...
					url: '<%= purchasedAllCommerceDiscountRuleDisplayContext.getItemSelectorUrl() %>'
				}
			);

...
/**
 * Provides the local service interface for CPAvailabilityRange. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marco Leo
 * @see CPAvailabilityRangeLocalServiceUtil
...
public interface CPAvailabilityRangeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CPAvailabilityRangeLocalServiceUtil} to access the cp availability range local service. Add custom service methods to {@link com.liferay.commerce.product.service.impl.CPAvailabilityRangeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public CPAvailabilityRange createCPAvailabilityRange(
	...
	*/
	...
	public CPAvailabilityRange fetchCPAvailabilityRange(
		long CPAvailabilityRangeId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CPAvailabilityRange fetchCPAvailabilityRangeByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CPAvailabilityRange getCPAvailabilityRangeByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CPAvailabilityRange> getCPAvailabilityRanges(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CPAvailabilityRange> getCPAvailabilityRangesByUuidAndCompanyId(

...
public class CPDefinitionLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.commerce.product.model.CPDefinition addCPDefinition(
		...
		return getService()
			...
			descriptionMap, urlTitleMap, productTypeName, ddmStructureKey,
	...
	*/
	...
	public static com.liferay.commerce.product.model.CPDefinition updateCPDefinition(
		...
		return getService()
			...
			shortDescriptionMap, descriptionMap, urlTitleMap, ddmStructureKey,
			displayDateMonth, displayDateDay, displayDateYear, displayDateHour,
			displayDateMinute, expirationDateMonth, expirationDateDay,
			expirationDateYear, expirationDateHour, expirationDateMinute,
			neverExpire, serviceContext);
	...
	*/
	...
	public static java.lang.String getUniqueUrlTitle(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getUniqueUrlTitle(cpDefinition, languageId);
	}

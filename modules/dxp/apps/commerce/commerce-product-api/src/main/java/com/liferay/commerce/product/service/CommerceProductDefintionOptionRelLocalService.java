...
/**
 * Provides the local service interface for CommerceProductDefintionOptionRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marco Leo
 * @see CommerceProductDefintionOptionRelLocalServiceUtil
...
public interface CommerceProductDefintionOptionRelLocalService
	extends BaseLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommerceProductDefintionOptionRelLocalServiceUtil} to access the commerce product defintion option rel local service. Add custom service methods to {@link com.liferay.commerce.product.service.impl.CommerceProductDefintionOptionRelLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

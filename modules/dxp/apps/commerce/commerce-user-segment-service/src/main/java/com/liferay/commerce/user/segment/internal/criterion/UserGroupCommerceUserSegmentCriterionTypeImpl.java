...
@Component(
	immediate = true,
	property = {
		"commerce.price.list.qualification.type.key=" + CommerceUserSegmentsConstants.CRITERION_TYPE_USER_GROUP,
...
public class UserGroupCommerceUserSegmentCriterionTypeImpl
	...
	public String getKey() {
		return CommerceUserSegmentsConstants.CRITERION_TYPE_USER_GROUP;
	}

...
public class CPDefinitionAvailabilityRangeUtil {
	...
	* @throws NoSuchCPDefinitionAvailabilityRangeException if a matching cp definition availability range could not be found
	*/
	public static CPDefinitionAvailabilityRange findByG_C(long groupId,
		long CPDefinitionId)
		throws com.liferay.commerce.exception.NoSuchCPDefinitionAvailabilityRangeException {
	...
	* @return the matching cp definition availability range, or <code>null</code> if a matching cp definition availability range could not be found
	*/
	public static CPDefinitionAvailabilityRange fetchByG_C(long groupId,
		long CPDefinitionId) {
	...
	* @return the cp definition availability range that was removed
	*/
	public static CPDefinitionAvailabilityRange removeByG_C(long groupId,
		long CPDefinitionId)
		throws com.liferay.commerce.exception.NoSuchCPDefinitionAvailabilityRangeException {
	...
	* @throws NoSuchCPDefinitionAvailabilityRangeException if a matching cp definition availability range could not be found
	*/
	public static CPDefinitionAvailabilityRange findByG_C_C(long groupId,
	...
	* @return the matching cp definition availability range, or <code>null</code> if a matching cp definition availability range could not be found
	*/
	public static CPDefinitionAvailabilityRange fetchByG_C_C(long groupId,
		long CPDefinitionId, long commerceAvailabilityRangeId) {
		return getPersistence()
	...
	* @return the cp definition availability range that was removed
	*/
	public static CPDefinitionAvailabilityRange removeByG_C_C(long groupId,
		long CPDefinitionId, long commerceAvailabilityRangeId)
		throws com.liferay.commerce.exception.NoSuchCPDefinitionAvailabilityRangeException {
		return getPersistence()
	...
	*/
	...
	private static ServiceTracker<CPDefinitionAvailabilityRangePersistence, CPDefinitionAvailabilityRangePersistence> _serviceTracker =
		ServiceTrackerFactory.open(CPDefinitionAvailabilityRangePersistence.class);
}
...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=commerce", "json.web.service.context.path=CommerceTaxCategoryRel"}, service = CommerceTaxCategoryRelService.class)
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface CommerceTaxCategoryRelService extends BaseService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *

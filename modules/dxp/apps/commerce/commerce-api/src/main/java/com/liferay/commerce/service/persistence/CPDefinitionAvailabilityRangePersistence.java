...
public interface CPDefinitionAvailabilityRangePersistence
	...
	*/
	...
	/**
	* Returns the cp definition availability range where groupId = &#63; and CPDefinitionId = &#63; or throws a {@link NoSuchCPDefinitionAvailabilityRangeException} if it could not be found.
	*
	* @param groupId the group ID
	...
	* @throws NoSuchCPDefinitionAvailabilityRangeException if a matching cp definition availability range could not be found
	*/
	public CPDefinitionAvailabilityRange findByG_C(long groupId,
		long CPDefinitionId)
		throws NoSuchCPDefinitionAvailabilityRangeException;

	/**
	* Returns the cp definition availability range where groupId = &#63; and CPDefinitionId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	*
	* @param groupId the group ID
	* @param CPDefinitionId the cp definition ID
	* @return the matching cp definition availability range, or <code>null</code> if a matching cp definition availability range could not be found
	*/
	public CPDefinitionAvailabilityRange fetchByG_C(long groupId,
		long CPDefinitionId);

	/**
	* Returns the cp definition availability range where groupId = &#63; and CPDefinitionId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	*
	* @param groupId the group ID
	* @param CPDefinitionId the cp definition ID
	* @param retrieveFromCache whether to retrieve from the finder cache
	...
	*/
	...
	/**
	* Removes the cp definition availability range where groupId = &#63; and CPDefinitionId = &#63; from the database.
	*
	* @param groupId the group ID
	* @param CPDefinitionId the cp definition ID
	* @return the cp definition availability range that was removed
	*/
	public CPDefinitionAvailabilityRange removeByG_C(long groupId,
		long CPDefinitionId)
		throws NoSuchCPDefinitionAvailabilityRangeException;

	/**
	* Returns the number of cp definition availability ranges where groupId = &#63; and CPDefinitionId = &#63;.
	*
	* @param groupId the group ID
	* @param CPDefinitionId the cp definition ID
	* @return the number of matching cp definition availability ranges
	*/
	...
	/**
	* Returns the cp definition availability range where groupId = &#63; and CPDefinitionId = &#63; and commerceAvailabilityRangeId = &#63; or throws a {@link NoSuchCPDefinitionAvailabilityRangeException} if it could not be found.
	*
	* @param groupId the group ID
	* @param CPDefinitionId the cp definition ID
	...
	* @throws NoSuchCPDefinitionAvailabilityRangeException if a matching cp definition availability range could not be found
	*/
	public CPDefinitionAvailabilityRange findByG_C_C(long groupId,
		long CPDefinitionId, long commerceAvailabilityRangeId)
		throws NoSuchCPDefinitionAvailabilityRangeException;

	/**
	* Returns the cp definition availability range where groupId = &#63; and CPDefinitionId = &#63; and commerceAvailabilityRangeId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	*
	* @param groupId the group ID
	* @param CPDefinitionId the cp definition ID
	* @param commerceAvailabilityRangeId the commerce availability range ID
	* @return the matching cp definition availability range, or <code>null</code> if a matching cp definition availability range could not be found
	*/
	public CPDefinitionAvailabilityRange fetchByG_C_C(long groupId,
		long CPDefinitionId, long commerceAvailabilityRangeId);

	/**
	* Returns the cp definition availability range where groupId = &#63; and CPDefinitionId = &#63; and commerceAvailabilityRangeId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	*
	* @param groupId the group ID
	* @param CPDefinitionId the cp definition ID
	* @param commerceAvailabilityRangeId the commerce availability range ID
	...
	*/
	...
	/**
	* Removes the cp definition availability range where groupId = &#63; and CPDefinitionId = &#63; and commerceAvailabilityRangeId = &#63; from the database.
	*
	* @param groupId the group ID
	* @param CPDefinitionId the cp definition ID
	* @param commerceAvailabilityRangeId the commerce availability range ID
	* @return the cp definition availability range that was removed
	*/
	public CPDefinitionAvailabilityRange removeByG_C_C(long groupId,
		long CPDefinitionId, long commerceAvailabilityRangeId)
		throws NoSuchCPDefinitionAvailabilityRangeException;

	/**
	* Returns the number of cp definition availability ranges where groupId = &#63; and CPDefinitionId = &#63; and commerceAvailabilityRangeId = &#63;.
	*
	* @param groupId the group ID
	* @param CPDefinitionId the cp definition ID
	* @param commerceAvailabilityRangeId the commerce availability range ID

...
/**
 * Provides the local service interface for CommerceTaxCategory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Alessio Antonio Rendina
 * @see CommerceTaxCategoryLocalServiceUtil
...
public interface CommerceTaxCategoryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommerceTaxCategoryLocalServiceUtil} to access the commerce tax category local service. Add custom service methods to {@link com.liferay.commerce.service.impl.CommerceTaxCategoryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public CommerceTaxCategory createCommerceTaxCategory(
	...
	*/
	...
	public CommerceTaxCategory fetchCommerceTaxCategory(
		long commerceTaxCategoryId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CommerceTaxCategory> getCommerceTaxCategories(int start, int end);

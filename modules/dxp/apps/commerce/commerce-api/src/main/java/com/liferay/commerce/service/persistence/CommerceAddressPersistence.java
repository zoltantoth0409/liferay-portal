...
public interface CommerceAddressPersistence extends BasePersistence<CommerceAddress> {
	...
	*/
	public java.util.List<CommerceAddress> findByAddressUserId(
		long addressUserId);
	...
	* @return the matching commerce addresses
	*/
	public java.util.List<CommerceAddress> findByG_A(long groupId,
		long addressUserId);
	...
	* @return the matching commerce addresses
	*/
	public java.util.List<CommerceAddress> findByG_A_DB(long groupId,
	...
	* @return the matching commerce addresses
	*/
	public java.util.List<CommerceAddress> findByG_A_DS(long groupId,

...
public class CommerceWarehouseItemUtil {
	...
	* @return the matching commerce warehouse items
	*/
	public static List<CommerceWarehouseItem> findByC_C(long classNameId,
		long classPK) {
	...
	* @throws NoSuchWarehouseItemException if a matching commerce warehouse item could not be found
	*/
	public static CommerceWarehouseItem findByC_C_First(long classNameId,
	...
	* @return the first matching commerce warehouse item, or <code>null</code> if a matching commerce warehouse item could not be found
	*/
	public static CommerceWarehouseItem fetchByC_C_First(long classNameId,
		long classPK, OrderByComparator<CommerceWarehouseItem> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchWarehouseItemException if a matching commerce warehouse item could not be found
	*/
	public static CommerceWarehouseItem findByC_C_Last(long classNameId,
		long classPK, OrderByComparator<CommerceWarehouseItem> orderByComparator)
		throws com.liferay.commerce.exception.NoSuchWarehouseItemException {
		return getPersistence()
	...
	* @return the last matching commerce warehouse item, or <code>null</code> if a matching commerce warehouse item could not be found
	*/
	public static CommerceWarehouseItem fetchByC_C_Last(long classNameId,
		long classPK, OrderByComparator<CommerceWarehouseItem> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchWarehouseItemException if a commerce warehouse item with the primary key could not be found
	*/
	public static CommerceWarehouseItem[] findByC_C_PrevAndNext(
		long commerceWarehouseItemId, long classNameId, long classPK,
		OrderByComparator<CommerceWarehouseItem> orderByComparator)
		throws com.liferay.commerce.exception.NoSuchWarehouseItemException {
		return getPersistence()
				   .findByC_C_PrevAndNext(commerceWarehouseItemId, classNameId,
	...
	* @throws NoSuchWarehouseItemException if a matching commerce warehouse item could not be found
	*/
	public static CommerceWarehouseItem findByC_C_C(long commerceWarehouseId,
		long classNameId, long classPK)
		throws com.liferay.commerce.exception.NoSuchWarehouseItemException {
		return getPersistence()
				   .findByC_C_C(commerceWarehouseId, classNameId, classPK);
	}
	...
	*/
	public static CommerceWarehouseItem fetchByC_C_C(long commerceWarehouseId,
		long classNameId, long classPK) {
		return getPersistence()
				   .fetchByC_C_C(commerceWarehouseId, classNameId, classPK);
	}
	...
	*/
	public static CommerceWarehouseItem removeByC_C_C(
		long commerceWarehouseId, long classNameId, long classPK)
		throws com.liferay.commerce.exception.NoSuchWarehouseItemException {
		return getPersistence()
				   .removeByC_C_C(commerceWarehouseId, classNameId, classPK);
	}
	...
	* @return the number of matching commerce warehouse items
	*/
	public static int countByC_C_C(long commerceWarehouseId, long classNameId,
		long classPK) {
		return getPersistence()
				   .countByC_C_C(commerceWarehouseId, classNameId, classPK);
	}
	...
	*/
	...
	private static ServiceTracker<CommerceWarehouseItemPersistence, CommerceWarehouseItemPersistence> _serviceTracker =
		ServiceTrackerFactory.open(CommerceWarehouseItemPersistence.class);
}
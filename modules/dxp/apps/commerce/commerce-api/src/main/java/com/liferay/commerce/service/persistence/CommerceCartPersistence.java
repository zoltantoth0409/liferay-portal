...
public interface CommerceCartPersistence extends BasePersistence<CommerceCart> {
	...
	* @return the matching commerce carts
	*/
	public java.util.List<CommerceCart> findByG_U_D_T(long groupId,
		long userId, boolean defaultCart, int type);
	...
	*/
	public java.util.List<CommerceCart> findByG_U_D_T(long groupId,
		long userId, boolean defaultCart, int type, int start, int end);

 ...
 * @see com.liferay.commerce.service.persistence.impl.CommerceCartItemPersistenceImpl
...
public interface CommerceCartItemPersistence extends BasePersistence<CommerceCartItem> {
	...
	* @return the matching commerce cart items
	*/
	public java.util.List<CommerceCartItem> findByC_D_I(long commerceCartId,

...
public class CommerceCartServiceWrapper implements CommerceCartService,
	...
	public com.liferay.commerce.model.CommerceCart addCommerceCart(
		...
		return _commerceCartService.addCommerceCart(name, defaultCart,
			serviceContext);
	}
	...
	public java.util.List<com.liferay.commerce.model.CommerceCart> getCommerceCarts(
		...
		return _commerceCartService.getCommerceCarts(groupId, start, end,
			orderByComparator);
	}

	@Override
	public int getCommerceCartsCount(long groupId) {
		return _commerceCartService.getCommerceCartsCount(groupId);
	}

...
/**
 * Provides the local service interface for CommerceTirePriceEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Alessio Antonio Rendina
 * @see CommerceTirePriceEntryLocalServiceUtil
...
public interface CommerceTirePriceEntryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommerceTirePriceEntryLocalServiceUtil} to access the commerce tire price entry local service. Add custom service methods to {@link com.liferay.commerce.service.impl.CommerceTirePriceEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public CommerceTirePriceEntry createCommerceTirePriceEntry(
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CommerceTirePriceEntry deleteCommerceTirePriceEntry(
		long CommerceTirePriceEntryId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CommerceTirePriceEntry fetchCommerceTirePriceEntryByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CommerceTirePriceEntry> getCommerceTirePriceEntries(int start,
		int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CommerceTirePriceEntry> getCommerceTirePriceEntriesByUuidAndCompanyId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CommerceTirePriceEntry getCommerceTirePriceEntryByUuidAndGroupId(

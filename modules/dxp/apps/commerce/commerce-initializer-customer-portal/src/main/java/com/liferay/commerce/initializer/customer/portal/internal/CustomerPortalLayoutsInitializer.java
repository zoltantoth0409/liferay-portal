 ...
 */
@Component(service = CustomerPortalLayoutsInitializer.class)
public class CustomerPortalLayoutsInitializer {
	...
	private void _createLayouts(ServiceContext serviceContext)
		...
		ClassLoader classLoader =
			CustomerPortalLayoutsInitializer.class.getClassLoader();

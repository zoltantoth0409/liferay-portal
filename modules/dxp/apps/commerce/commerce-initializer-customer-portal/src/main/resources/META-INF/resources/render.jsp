...
<div class="commerce-starter-content row">
	<div class="carousel slide w100" data-interval="false" id="carousel-commerce-starter-customer-portal">
		...
		<a class="carousel-control carousel-control-left left" data-slide="prev" href="#carousel-commerce-starter-customer-portal" role="button">
			<liferay-ui:icon
		...
		<a class="carousel-control carousel-control-right right" data-slide="next" href="#carousel-commerce-starter-customer-portal" role="button">
			<liferay-ui:icon
...
<style>
	#carousel-commerce-starter-customer-portal {
		position: relative;
	}

	#carousel-commerce-starter-customer-portal .carousel-item > img {
		border-radius: 4px;
		width: 100%;
	}

	#carousel-commerce-starter-customer-portal .carousel-control {
	...
	#carousel-commerce-starter-customer-portal .carousel-control-left {
		left: 5%;
		top: 50%;
	}

	#carousel-commerce-starter-customer-portal .carousel-control-right {
		right: 5%;
		top: 50%;
	}

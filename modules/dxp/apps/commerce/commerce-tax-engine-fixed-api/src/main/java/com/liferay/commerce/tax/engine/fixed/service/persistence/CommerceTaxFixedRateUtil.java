...
public class CommerceTaxFixedRateUtil {
	...
	* @throws NoSuchTaxFixedRateException if a matching commerce tax fixed rate could not be found
	*/
	public static CommerceTaxFixedRate findByCommerceTaxCategoryId(
	...
	*/
	public static CommerceTaxFixedRate fetchByCommerceTaxCategoryId(
		long commerceTaxCategoryId) {
		return getPersistence()
				   .fetchByCommerceTaxCategoryId(commerceTaxCategoryId);
	}
	...
	*/
	public static CommerceTaxFixedRate removeByCommerceTaxCategoryId(
		long commerceTaxCategoryId)
		throws com.liferay.commerce.tax.engine.fixed.exception.NoSuchTaxFixedRateException {
		return getPersistence()
				   .removeByCommerceTaxCategoryId(commerceTaxCategoryId);
	}
	...
	*/
	...
	private static ServiceTracker<CommerceTaxFixedRatePersistence, CommerceTaxFixedRatePersistence> _serviceTracker =
		ServiceTrackerFactory.open(CommerceTaxFixedRatePersistence.class);
}
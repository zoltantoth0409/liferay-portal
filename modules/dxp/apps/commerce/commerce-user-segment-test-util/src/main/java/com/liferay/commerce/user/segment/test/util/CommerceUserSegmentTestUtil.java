 ...
 */
public class UserSegmentTestUtil {
	...
	public static void removeCommerceUserSegmentEntry(
			long commerceUserSegmentEntryId)
		throws PortalException {

		CommerceUserSegmentEntryLocalServiceUtil.deleteCommerceUserSegmentEntry(

...
import com.liferay.commerce.exception.NoSuchPriceListUserRelException;
import com.liferay.commerce.model.CommercePriceListUserRel;
import com.liferay.commerce.model.impl.CommercePriceListUserRelImpl;
import com.liferay.commerce.model.impl.CommercePriceListUserRelModelImpl;
 ...
 * @see com.liferay.commerce.service.persistence.CommercePriceListUserRelUtil
 * @generated
 */
@ProviderType
public class CommercePriceListUserRelPersistenceImpl extends BasePersistenceImpl<CommercePriceListUserRel>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMMERCEPRICELISTID =
		new FinderPath(CommercePriceListUserRelModelImpl.ENTITY_CACHE_ENABLED,
			...
			CommercePriceListUserRelModelImpl.COMMERCEPRICELISTID_COLUMN_BITMASK |
			CommercePriceListUserRelModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMMERCEPRICELISTID = new FinderPath(CommercePriceListUserRelModelImpl.ENTITY_CACHE_ENABLED,
			CommercePriceListUserRelModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	 ...
	 */
	@Override
	public List<CommercePriceListUserRel> findByCommercePriceListId(
	...
	public List<CommercePriceListUserRel> findByCommercePriceListId(
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CommercePriceListUserRel commercePriceListUserRel : list) {
					if ((commercePriceListId != commercePriceListUserRel.getCommercePriceListId())) {
						list = null;
	 ...
	 */
	@Override
	public CommercePriceListUserRel findByCommercePriceListId_First(
		long commercePriceListId,
		OrderByComparator<CommercePriceListUserRel> orderByComparator)
		throws NoSuchPriceListUserRelException {
		CommercePriceListUserRel commercePriceListUserRel = fetchByCommercePriceListId_First(commercePriceListId,
				orderByComparator);
	 ...
	 */
	@Override
	public CommercePriceListUserRel fetchByCommercePriceListId_First(
		long commercePriceListId,
		OrderByComparator<CommercePriceListUserRel> orderByComparator) {
		List<CommercePriceListUserRel> list = findByCommercePriceListId(commercePriceListId,
	 ...
	 */
	@Override
	public CommercePriceListUserRel findByCommercePriceListId_Last(
		long commercePriceListId,
		OrderByComparator<CommercePriceListUserRel> orderByComparator)
		throws NoSuchPriceListUserRelException {
		CommercePriceListUserRel commercePriceListUserRel = fetchByCommercePriceListId_Last(commercePriceListId,
				orderByComparator);
	 ...
	 */
	@Override
	public CommercePriceListUserRel fetchByCommercePriceListId_Last(
		long commercePriceListId,
		OrderByComparator<CommercePriceListUserRel> orderByComparator) {
	 ...
	 */
	@Override
	public CommercePriceListUserRel[] findByCommercePriceListId_PrevAndNext(
		...
		try {
			...
			array[0] = getByCommercePriceListId_PrevAndNext(session,
					commercePriceListUserRel, commercePriceListId,
					orderByComparator, true);
	...
	protected CommercePriceListUserRel getByCommercePriceListId_PrevAndNext(
		Session session, CommercePriceListUserRel commercePriceListUserRel,
		long commercePriceListId,
		OrderByComparator<CommercePriceListUserRel> orderByComparator,
		boolean previous) {
	...
	public void removeByCommercePriceListId(long commercePriceListId) {
		for (CommercePriceListUserRel commercePriceListUserRel : findByCommercePriceListId(
	 ...
	 */
	@Override
	public List<CommercePriceListUserRel> findByC_C(long classNameId,
		long classPK) {
	...
	public List<CommercePriceListUserRel> findByC_C(long classNameId,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CommercePriceListUserRel commercePriceListUserRel : list) {
					if ((classNameId != commercePriceListUserRel.getClassNameId()) ||
	 ...
	 */
	@Override
	public CommercePriceListUserRel findByC_C_First(long classNameId,
		long classPK,
		OrderByComparator<CommercePriceListUserRel> orderByComparator)
		throws NoSuchPriceListUserRelException {
		CommercePriceListUserRel commercePriceListUserRel = fetchByC_C_First(classNameId,
	 ...
	 */
	@Override
	public CommercePriceListUserRel fetchByC_C_First(long classNameId,
		long classPK,
		OrderByComparator<CommercePriceListUserRel> orderByComparator) {
		List<CommercePriceListUserRel> list = findByC_C(classNameId, classPK,
				0, 1, orderByComparator);
	 ...
	 */
	@Override
	public CommercePriceListUserRel findByC_C_Last(long classNameId,
		long classPK,
		OrderByComparator<CommercePriceListUserRel> orderByComparator)
		throws NoSuchPriceListUserRelException {
		CommercePriceListUserRel commercePriceListUserRel = fetchByC_C_Last(classNameId,
				classPK, orderByComparator);
	 ...
	 */
	@Override
	public CommercePriceListUserRel fetchByC_C_Last(long classNameId,
		long classPK,
		OrderByComparator<CommercePriceListUserRel> orderByComparator) {
	...
	protected CommercePriceListUserRel getByC_C_PrevAndNext(Session session,
		CommercePriceListUserRel commercePriceListUserRel, long classNameId,
		long classPK,
		OrderByComparator<CommercePriceListUserRel> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	private static final String _FINDER_COLUMN_C_C_CLASSNAMEID_2 = "commercePriceListUserRel.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_C_CLASSPK_2 = "commercePriceListUserRel.classPK = ?";
	...
	public CommercePriceListUserRel updateImpl(
		...
		if (!CommercePriceListUserRelModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] {
					commercePriceListUserRelModelImpl.getCommercePriceListId()
				};
			...
			if ((commercePriceListUserRelModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						commercePriceListUserRelModelImpl.getOriginalCommercePriceListId()
					};
	...
	protected CommercePriceListUserRel toUnwrappedModel(
		...
		commercePriceListUserRelImpl.setCommercePriceListId(commercePriceListUserRel.getCommercePriceListId());

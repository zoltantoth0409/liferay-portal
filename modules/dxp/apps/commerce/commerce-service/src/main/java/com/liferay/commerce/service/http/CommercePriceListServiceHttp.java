...
public class CommercePriceListServiceHttp {
	public static com.liferay.commerce.model.CommercePriceList addCommercePriceList(
		...
		try {
			...
			return (com.liferay.commerce.model.CommercePriceList)returnObj;
		}
	...
	public static void deleteCommercePriceList(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(CommercePriceListServiceUtil.class,
					...
					_deleteCommercePriceListParameterTypes1);
	...
	public static com.liferay.commerce.model.CommercePriceList fetchCommercePriceList(
		...
		try {
			MethodKey methodKey = new MethodKey(CommercePriceListServiceUtil.class,
					...
					_fetchCommercePriceListParameterTypes2);
	...
	public static java.util.List<com.liferay.commerce.model.CommercePriceList> getCommercePriceLists(
		...
		try {
			MethodKey methodKey = new MethodKey(CommercePriceListServiceUtil.class,
					...
					_getCommercePriceListsParameterTypes3);
			...
			return (java.util.List<com.liferay.commerce.model.CommercePriceList>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	public static int getCommercePriceListsCount(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(CommercePriceListServiceUtil.class,
					...
					_getCommercePriceListsCountParameterTypes5);
	...
	public static com.liferay.portal.kernel.search.BaseModelSearchResult<com.liferay.commerce.model.CommercePriceList> searchCommercePriceLists(
		...
		try {
			MethodKey methodKey = new MethodKey(CommercePriceListServiceUtil.class,
					...
					_searchCommercePriceListsParameterTypes7);
			...
			return (com.liferay.portal.kernel.search.BaseModelSearchResult<com.liferay.commerce.model.CommercePriceList>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	private static final Class<?>[] _fetchCommercePriceListParameterTypes2 = new Class[] {
			long.class
		};
	private static final Class<?>[] _getCommercePriceListsParameterTypes3 = new Class[] {
	...
	private static final Class<?>[] _getCommercePriceListsCountParameterTypes5 = new Class[] {

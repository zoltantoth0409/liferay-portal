...
public class CommercePriceListUserSegmentEntryRelServiceHttp {
	public static com.liferay.commerce.model.CommercePriceListUserSegmentEntryRel addCommercePriceListUserSegmentEntryRel(
		...
		try {
			...
			return (com.liferay.commerce.model.CommercePriceListUserSegmentEntryRel)returnObj;
		}
	...
	public static java.util.List<com.liferay.commerce.model.CommercePriceListUserSegmentEntryRel> getCommercePriceListUserSegmentEntryRels(
		...
		try {
			...
			return (java.util.List<com.liferay.commerce.model.CommercePriceListUserSegmentEntryRel>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);

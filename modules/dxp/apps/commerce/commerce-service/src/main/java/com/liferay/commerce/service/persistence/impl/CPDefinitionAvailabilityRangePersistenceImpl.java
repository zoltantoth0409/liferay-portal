...
public class CPDefinitionAvailabilityRangePersistenceImpl
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_G_C = new FinderPath(CPDefinitionAvailabilityRangeModelImpl.ENTITY_CACHE_ENABLED,
			CPDefinitionAvailabilityRangeModelImpl.FINDER_CACHE_ENABLED,
			CPDefinitionAvailabilityRangeImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByG_C",
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_G_C = new FinderPath(CPDefinitionAvailabilityRangeModelImpl.ENTITY_CACHE_ENABLED,
			CPDefinitionAvailabilityRangeModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByG_C",
			new String[] { Long.class.getName(), Long.class.getName() });
	...
	public CPDefinitionAvailabilityRange findByG_C(long groupId,
		long CPDefinitionId)
		throws NoSuchCPDefinitionAvailabilityRangeException {
		CPDefinitionAvailabilityRange cpDefinitionAvailabilityRange = fetchByG_C(groupId,
				CPDefinitionId);
	...
	public CPDefinitionAvailabilityRange fetchByG_C(long groupId,
		...
		if (result instanceof CPDefinitionAvailabilityRange) {
			...
			if ((groupId != cpDefinitionAvailabilityRange.getGroupId()) ||
					(CPDefinitionId != cpDefinitionAvailabilityRange.getCPDefinitionId())) {
				result = null;
			}
		}
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							_log.warn(
								"CPDefinitionAvailabilityRangePersistenceImpl.fetchByG_C(long, long, boolean) with parameters (" +
					...
					if ((cpDefinitionAvailabilityRange.getGroupId() != groupId) ||
							(cpDefinitionAvailabilityRange.getCPDefinitionId() != CPDefinitionId)) {
	...
	public CPDefinitionAvailabilityRange removeByG_C(long groupId,
		long CPDefinitionId)
		throws NoSuchCPDefinitionAvailabilityRangeException {
		CPDefinitionAvailabilityRange cpDefinitionAvailabilityRange = findByG_C(groupId,
				CPDefinitionId);
	...
	private static final String _FINDER_COLUMN_G_C_GROUPID_2 = "cpDefinitionAvailabilityRange.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_CPDEFINITIONID_2 = "cpDefinitionAvailabilityRange.CPDefinitionId = ?";
	public static final FinderPath FINDER_PATH_FETCH_BY_G_C_C = new FinderPath(CPDefinitionAvailabilityRangeModelImpl.ENTITY_CACHE_ENABLED,
			CPDefinitionAvailabilityRangeModelImpl.FINDER_CACHE_ENABLED,
			CPDefinitionAvailabilityRangeImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByG_C_C",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_G_C_C = new FinderPath(CPDefinitionAvailabilityRangeModelImpl.ENTITY_CACHE_ENABLED,
			CPDefinitionAvailabilityRangeModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByG_C_C",
			new String[] {
	...
	public CPDefinitionAvailabilityRange findByG_C_C(long groupId,
		...
		throws NoSuchCPDefinitionAvailabilityRangeException {
		CPDefinitionAvailabilityRange cpDefinitionAvailabilityRange = fetchByG_C_C(groupId,
	...
	public CPDefinitionAvailabilityRange fetchByG_C_C(long groupId,
		...
		if (result instanceof CPDefinitionAvailabilityRange) {
			...
			if ((groupId != cpDefinitionAvailabilityRange.getGroupId()) ||
					(CPDefinitionId != cpDefinitionAvailabilityRange.getCPDefinitionId()) ||
					(commerceAvailabilityRangeId != cpDefinitionAvailabilityRange.getCommerceAvailabilityRangeId())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((cpDefinitionAvailabilityRange.getGroupId() != groupId) ||
							(cpDefinitionAvailabilityRange.getCPDefinitionId() != CPDefinitionId) ||
							(cpDefinitionAvailabilityRange.getCommerceAvailabilityRangeId() != commerceAvailabilityRangeId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_G_C_C,
							finderArgs, cpDefinitionAvailabilityRange);
					}
				}
	...
	public CPDefinitionAvailabilityRange removeByG_C_C(long groupId,
		long CPDefinitionId, long commerceAvailabilityRangeId)
		throws NoSuchCPDefinitionAvailabilityRangeException {
		CPDefinitionAvailabilityRange cpDefinitionAvailabilityRange = findByG_C_C(groupId,
				CPDefinitionId, commerceAvailabilityRangeId);
	...
	private static final String _FINDER_COLUMN_G_C_C_GROUPID_2 = "cpDefinitionAvailabilityRange.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_C_CPDEFINITIONID_2 = "cpDefinitionAvailabilityRange.CPDefinitionId = ? AND ";
	...
	private static final String _SQL_SELECT_CPDEFINITIONAVAILABILITYRANGE_WHERE_PKS_IN =
		"SELECT cpDefinitionAvailabilityRange FROM CPDefinitionAvailabilityRange cpDefinitionAvailabilityRange WHERE CPDefinitionAvailabilityRangeId IN (";

...
public class CPDefinitionAvailabilityRangeServiceHttp {
	...
	public static com.liferay.commerce.model.CPDefinitionAvailabilityRange fetchCPDefinitionAvailabilityRangeByCPDefinitionId(
		...
		try {
			MethodKey methodKey = new MethodKey(CPDefinitionAvailabilityRangeServiceUtil.class,
					...
					_fetchCPDefinitionAvailabilityRangeByCPDefinitionIdParameterTypes1);
	...
	private static final Class<?>[] _fetchCPDefinitionAvailabilityRangeByCPDefinitionIdParameterTypes1 =
		new Class[] { long.class };

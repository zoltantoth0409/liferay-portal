...
public class CommerceTaxCategoryRelPersistenceImpl extends BasePersistenceImpl<CommerceTaxCategoryRel>
	...
	private static final String _FINDER_COLUMN_COMMERCETAXCATEGORYID_COMMERCETAXCATEGORYID_2 =
		"commerceTaxCategoryRel.commerceTaxCategoryId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C = new FinderPath(CommerceTaxCategoryRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceTaxCategoryRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceTaxCategoryRelImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_C = new FinderPath(CommerceTaxCategoryRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceTaxCategoryRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceTaxCategoryRelImpl.class,
	 ...
	 */
	@Override
	public List<CommerceTaxCategoryRel> findByC_C(long classNameId, long classPK) {
	 ...
	 */
	@Override
	public List<CommerceTaxCategoryRel> findByC_C(long classNameId,
	...
	public CommerceTaxCategoryRel findByC_C_First(long classNameId,
		...
		OrderByComparator<CommerceTaxCategoryRel> orderByComparator)
		throws NoSuchTaxCategoryRelException {
		CommerceTaxCategoryRel commerceTaxCategoryRel = fetchByC_C_First(classNameId,
	...
	public CommerceTaxCategoryRel fetchByC_C_First(long classNameId,
		long classPK,
		OrderByComparator<CommerceTaxCategoryRel> orderByComparator) {
		List<CommerceTaxCategoryRel> list = findByC_C(classNameId, classPK, 0,
				1, orderByComparator);
	...
	public CommerceTaxCategoryRel findByC_C_Last(long classNameId,
		...
		OrderByComparator<CommerceTaxCategoryRel> orderByComparator)
		throws NoSuchTaxCategoryRelException {
		CommerceTaxCategoryRel commerceTaxCategoryRel = fetchByC_C_Last(classNameId,
				classPK, orderByComparator);
	...
	public CommerceTaxCategoryRel fetchByC_C_Last(long classNameId,
		...
		List<CommerceTaxCategoryRel> list = findByC_C(classNameId, classPK,
				count - 1, count, orderByComparator);
	...
	public CommerceTaxCategoryRel[] findByC_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByC_C_PrevAndNext(session, commerceTaxCategoryRel,
					classNameId, classPK, orderByComparator, true);

			array[1] = commerceTaxCategoryRel;

			array[2] = getByC_C_PrevAndNext(session, commerceTaxCategoryRel,
	...
	protected CommerceTaxCategoryRel getByC_C_PrevAndNext(Session session,
		CommerceTaxCategoryRel commerceTaxCategoryRel, long classNameId,
		long classPK,
		OrderByComparator<CommerceTaxCategoryRel> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByC_C(long classNameId, long classPK) {
		for (CommerceTaxCategoryRel commerceTaxCategoryRel : findByC_C(
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_C_C_C = new FinderPath(CommerceTaxCategoryRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceTaxCategoryRelModelImpl.FINDER_CACHE_ENABLED,
			...
			CommerceTaxCategoryRelModelImpl.CLASSNAMEID_COLUMN_BITMASK |
			CommerceTaxCategoryRelModelImpl.CLASSPK_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_C_C = new FinderPath(CommerceTaxCategoryRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceTaxCategoryRelModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public CommerceTaxCategoryRel findByC_C_C(long commerceTaxCategoryId,
		...
		CommerceTaxCategoryRel commerceTaxCategoryRel = fetchByC_C_C(commerceTaxCategoryId,
				classNameId, classPK);
	...
	public CommerceTaxCategoryRel fetchByC_C_C(long commerceTaxCategoryId,
		...
		return fetchByC_C_C(commerceTaxCategoryId, classNameId, classPK, true);
	}
	...
	public CommerceTaxCategoryRel fetchByC_C_C(long commerceTaxCategoryId,
		...
		Object[] finderArgs = new Object[] {
				commerceTaxCategoryId, classNameId, classPK
			};
		...
		if (result instanceof CommerceTaxCategoryRel) {
			...
			if ((commerceTaxCategoryId != commerceTaxCategoryRel.getCommerceTaxCategoryId()) ||
					(classNameId != commerceTaxCategoryRel.getClassNameId()) ||
					(classPK != commerceTaxCategoryRel.getClassPK())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_C_C_COMMERCETAXCATEGORYID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((commerceTaxCategoryRel.getCommerceTaxCategoryId() != commerceTaxCategoryId) ||
							(commerceTaxCategoryRel.getClassNameId() != classNameId) ||
	...
	public CommerceTaxCategoryRel removeByC_C_C(long commerceTaxCategoryId,
		long classNameId, long classPK) throws NoSuchTaxCategoryRelException {
		CommerceTaxCategoryRel commerceTaxCategoryRel = findByC_C_C(commerceTaxCategoryId,
				classNameId, classPK);
	...
	private static final String _FINDER_COLUMN_C_C_C_COMMERCETAXCATEGORYID_2 = "commerceTaxCategoryRel.commerceTaxCategoryId = ? AND ";
	private static final String _FINDER_COLUMN_C_C_C_CLASSNAMEID_2 = "commerceTaxCategoryRel.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_C_C_CLASSPK_2 = "commerceTaxCategoryRel.classPK = ?";

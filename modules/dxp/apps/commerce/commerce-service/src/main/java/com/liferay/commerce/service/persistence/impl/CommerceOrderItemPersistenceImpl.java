...
public class CommerceOrderItemPersistenceImpl extends BasePersistenceImpl<CommerceOrderItem>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CPDEFINITIONID =
		new FinderPath(CommerceOrderItemModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName() },
			CommerceOrderItemModelImpl.CPDEFINITIONID_COLUMN_BITMASK |
			CommerceOrderItemModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_CPDEFINITIONID = new FinderPath(CommerceOrderItemModelImpl.ENTITY_CACHE_ENABLED,
			CommerceOrderItemModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<CommerceOrderItem> findByCPDefinitionId(long CPDefinitionId) {
	...
	public List<CommerceOrderItem> findByCPDefinitionId(long CPDefinitionId,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CommerceOrderItem commerceOrderItem : list) {
					if ((CPDefinitionId != commerceOrderItem.getCPDefinitionId())) {
						list = null;
	 ...
	 */
	@Override
	public CommerceOrderItem findByCPDefinitionId_First(long CPDefinitionId,
		OrderByComparator<CommerceOrderItem> orderByComparator)
		throws NoSuchOrderItemException {
		CommerceOrderItem commerceOrderItem = fetchByCPDefinitionId_First(CPDefinitionId,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceOrderItem fetchByCPDefinitionId_First(long CPDefinitionId,
		OrderByComparator<CommerceOrderItem> orderByComparator) {
		List<CommerceOrderItem> list = findByCPDefinitionId(CPDefinitionId, 0,
				1, orderByComparator);
	 ...
	 */
	@Override
	public CommerceOrderItem findByCPDefinitionId_Last(long CPDefinitionId,
		OrderByComparator<CommerceOrderItem> orderByComparator)
		throws NoSuchOrderItemException {
		CommerceOrderItem commerceOrderItem = fetchByCPDefinitionId_Last(CPDefinitionId,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceOrderItem fetchByCPDefinitionId_Last(long CPDefinitionId,
		OrderByComparator<CommerceOrderItem> orderByComparator) {
		...
		List<CommerceOrderItem> list = findByCPDefinitionId(CPDefinitionId,
				count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public CommerceOrderItem[] findByCPDefinitionId_PrevAndNext(
		...
		try {
			...
			array[0] = getByCPDefinitionId_PrevAndNext(session,
					commerceOrderItem, CPDefinitionId, orderByComparator, true);

			array[1] = commerceOrderItem;

			array[2] = getByCPDefinitionId_PrevAndNext(session,
					commerceOrderItem, CPDefinitionId, orderByComparator, false);
	...
	protected CommerceOrderItem getByCPDefinitionId_PrevAndNext(
		Session session, CommerceOrderItem commerceOrderItem,
		long CPDefinitionId,
		OrderByComparator<CommerceOrderItem> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByCPDefinitionId(long CPDefinitionId) {
		for (CommerceOrderItem commerceOrderItem : findByCPDefinitionId(
	...
	private static final String _FINDER_COLUMN_CPDEFINITIONID_CPDEFINITIONID_2 = "commerceOrderItem.CPDefinitionId = ?";
	...
	public CommerceOrderItem updateImpl(CommerceOrderItem commerceOrderItem) {
		...
		if (!CommerceOrderItemModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] { commerceOrderItemModelImpl.getCPDefinitionId() };
			...
			if ((commerceOrderItemModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						commerceOrderItemModelImpl.getOriginalCPDefinitionId()
					};
				...
				args = new Object[] {
						commerceOrderItemModelImpl.getCPDefinitionId()
					};
	...
	protected CommerceOrderItem toUnwrappedModel(
		...
		commerceOrderItemImpl.setCPDefinitionId(commerceOrderItem.getCPDefinitionId());

...
<%
List<CommercePriceList> commercePriceLists = (List<CommercePriceList>)request.getAttribute(CommerceWebKeys.COMMERCE_PRICE_LISTS);
...
<c:choose>
	...
	<c:otherwise>
		...
		<div class="sidebar-body">
			<h5><liferay-ui:message arguments="<%= commercePriceLists.size() %>" key="x-items-are-selected" /></h5>
		</div>
	</c:otherwise>
</c:choose>
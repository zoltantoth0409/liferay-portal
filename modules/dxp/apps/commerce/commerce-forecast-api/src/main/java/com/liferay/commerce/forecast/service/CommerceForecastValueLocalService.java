...
/**
 * Provides the local service interface for CommerceForecastValue. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Andrea Di Giorgi
 * @see CommerceForecastValueLocalServiceUtil
 * @see com.liferay.commerce.forecast.service.base.CommerceForecastValueLocalServiceBaseImpl
...
public interface CommerceForecastValueLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommerceForecastValueLocalServiceUtil} to access the commerce forecast value local service. Add custom service methods to {@link com.liferay.commerce.forecast.service.impl.CommerceForecastValueLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

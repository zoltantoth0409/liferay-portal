...
import com.liferay.commerce.service.persistence.CommercePriceListUserRelUtil;
...
public class CommercePriceListUserRelPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newCommercePriceListUserRel.setCommercePriceListId(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(existingCommercePriceListUserRel.getCommercePriceListId(),
			newCommercePriceListUserRel.getCommercePriceListId());
	...
	protected OrderByComparator<CommercePriceListUserRel> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("CommercePriceListUserRel",
			...
			"classNameId", true, "classPK", true, "lastPublishDate", true);
	}
	...
	protected CommercePriceListUserRel addCommercePriceListUserRel()
		...
		commercePriceListUserRel.setCommercePriceListId(RandomTestUtil.nextLong());

...
@Component(
	immediate = true,
	property = "commerce.user.segment.criterion.type.key=" + CommerceUserSegmentConstants.CRITERION_TYPE_ORGANIZATION,
	service = CommerceUserSegmentCriterionTypeJSPContributor.class
)
public class OrganizationCUSCriterionTypeJSPContributor

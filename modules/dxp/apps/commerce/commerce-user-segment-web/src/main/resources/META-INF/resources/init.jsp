...
page import="com.liferay.commerce.user.segment.web.internal.display.context.CommerceUserSegmentCriterionTypeOrganizationDisplayContext" %><%@
page import="com.liferay.commerce.user.segment.web.internal.display.context.CommerceUserSegmentCriterionTypeRoleDisplayContext" %><%@
page import="com.liferay.commerce.user.segment.web.internal.display.context.CommerceUserSegmentCriterionTypeUserDisplayContext" %><%@
page import="com.liferay.commerce.user.segment.web.internal.display.context.CommerceUserSegmentCriterionTypeUserGroupDisplayContext" %><%@

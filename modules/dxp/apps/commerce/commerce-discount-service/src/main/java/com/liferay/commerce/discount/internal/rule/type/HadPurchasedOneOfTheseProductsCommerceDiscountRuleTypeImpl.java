...
@Component(
	immediate = true,
	property = {
		"commerce.discount.rule.type.key=" + CommerceDiscountRuleConstants.TYPE_HAD_PURCHASED_ONE_OF_THESE_PRODUCTS,
		"commerce.discount.rule.type.order:Integer=30"
	},
	service = CommerceDiscountRuleType.class
)
public class HadPurchasedOneOfTheseProductsCommerceDiscountRuleTypeImpl
	...
	public String getKey() {
		return CommerceDiscountRuleConstants.
			TYPE_HAD_PURCHASED_ONE_OF_THESE_PRODUCTS;
	}

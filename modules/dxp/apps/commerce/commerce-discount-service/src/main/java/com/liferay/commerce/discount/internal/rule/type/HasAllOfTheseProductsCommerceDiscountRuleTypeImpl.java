...
@Component(
	immediate = true,
	property = {
		"commerce.discount.rule.type.key=" + CommerceDiscountRuleConstants.TYPE_HAS_ALL_OF_THESE_PRODUCTS,
		"commerce.discount.rule.type.order:Integer=50"
	},
	service = CommerceDiscountRuleType.class
)
public class HasAllOfTheseProductsCommerceDiscountRuleTypeImpl
	...
	public String getKey() {
		return CommerceDiscountRuleConstants.TYPE_HAS_ALL_OF_THESE_PRODUCTS;
	}
	...
	public String getLabel(Locale locale) {
		return LanguageUtil.get(
			locale,
			CommerceDiscountRuleConstants.TYPE_HAS_ALL_OF_THESE_PRODUCTS);
	}

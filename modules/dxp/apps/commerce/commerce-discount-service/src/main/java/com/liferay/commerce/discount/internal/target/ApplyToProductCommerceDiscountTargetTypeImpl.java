...
@Component(
	immediate = true,
	property = {
		"commerce.discount.target.type.key=" + CommerceDiscountTargetConstants.TYPE_PRODUCT,
...
public class ApplyToProductCommerceDiscountTargetTypeImpl
	...
	public String getKey() {
		return CommerceDiscountTargetConstants.TYPE_PRODUCT;
	}

	@Override
	public String getLabel(Locale locale) {
		return LanguageUtil.get(locale, "apply-to-product");
	}

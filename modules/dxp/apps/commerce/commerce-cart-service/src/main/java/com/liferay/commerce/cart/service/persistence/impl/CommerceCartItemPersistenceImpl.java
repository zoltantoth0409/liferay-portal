...
public class CommerceCartItemPersistenceImpl extends BasePersistenceImpl<CommerceCartItem>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(CommerceCartItemModelImpl.ENTITY_CACHE_ENABLED,
			CommerceCartItemModelImpl.FINDER_CACHE_ENABLED,
			CommerceCartItemImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByUuid",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(CommerceCartItemModelImpl.ENTITY_CACHE_ENABLED,
			CommerceCartItemModelImpl.FINDER_CACHE_ENABLED,
			CommerceCartItemImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			CommerceCartItemModelImpl.UUID_COLUMN_BITMASK |
			CommerceCartItemModelImpl.MODIFIEDDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(CommerceCartItemModelImpl.ENTITY_CACHE_ENABLED,
			CommerceCartItemModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<CommerceCartItem> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<CommerceCartItem> findByUuid(String uuid, int start, int end) {
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CommerceCartItem commerceCartItem : list) {
					if (!Objects.equals(uuid, commerceCartItem.getUuid())) {
						list = null;
	 ...
	 */
	@Override
	public CommerceCartItem findByUuid_First(String uuid,
		OrderByComparator<CommerceCartItem> orderByComparator)
		throws NoSuchCartItemException {
		CommerceCartItem commerceCartItem = fetchByUuid_First(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceCartItem fetchByUuid_First(String uuid,
		OrderByComparator<CommerceCartItem> orderByComparator) {
		List<CommerceCartItem> list = findByUuid(uuid, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public CommerceCartItem findByUuid_Last(String uuid,
		OrderByComparator<CommerceCartItem> orderByComparator)
		throws NoSuchCartItemException {
		CommerceCartItem commerceCartItem = fetchByUuid_Last(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceCartItem fetchByUuid_Last(String uuid,
		OrderByComparator<CommerceCartItem> orderByComparator) {
		...
		List<CommerceCartItem> list = findByUuid(uuid, count - 1, count,
				orderByComparator);
	...
	public CommerceCartItem[] findByUuid_PrevAndNext(long CommerceCartItemId,
		String uuid, OrderByComparator<CommerceCartItem> orderByComparator)
		throws NoSuchCartItemException {
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session, commerceCartItem, uuid,
					orderByComparator, true);

			array[1] = commerceCartItem;

			array[2] = getByUuid_PrevAndNext(session, commerceCartItem, uuid,
	...
	protected CommerceCartItem getByUuid_PrevAndNext(Session session,
		CommerceCartItem commerceCartItem, String uuid,
	...
	public void removeByUuid(String uuid) {
		for (CommerceCartItem commerceCartItem : findByUuid(uuid,
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "commerceCartItem.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "commerceCartItem.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(commerceCartItem.uuid IS NULL OR commerceCartItem.uuid = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(CommerceCartItemModelImpl.ENTITY_CACHE_ENABLED,
			CommerceCartItemModelImpl.FINDER_CACHE_ENABLED,
			CommerceCartItemImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() },
			CommerceCartItemModelImpl.UUID_COLUMN_BITMASK |
			CommerceCartItemModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_G = new FinderPath(CommerceCartItemModelImpl.ENTITY_CACHE_ENABLED,
			CommerceCartItemModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public CommerceCartItem findByUUID_G(String uuid, long groupId)
		throws NoSuchCartItemException {
		CommerceCartItem commerceCartItem = fetchByUUID_G(uuid, groupId);
	 ...
	 */
	@Override
	public CommerceCartItem fetchByUUID_G(String uuid, long groupId) {
	...
	public CommerceCartItem fetchByUUID_G(String uuid, long groupId,
		...
		if (result instanceof CommerceCartItem) {
			CommerceCartItem commerceCartItem = (CommerceCartItem)result;

			if (!Objects.equals(uuid, commerceCartItem.getUuid()) ||
					(groupId != commerceCartItem.getGroupId())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					CommerceCartItem commerceCartItem = list.get(0);

					result = commerceCartItem;

					cacheResult(commerceCartItem);

					if ((commerceCartItem.getUuid() == null) ||
							!commerceCartItem.getUuid().equals(uuid) ||
							(commerceCartItem.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
							finderArgs, commerceCartItem);
					}
				}
			}
			catch (Exception e) {
		...
		if (result instanceof List<?>) {
			...
			return (CommerceCartItem)result;
		}
	}
	 ...
	 */
	@Override
	public CommerceCartItem removeByUUID_G(String uuid, long groupId)
		throws NoSuchCartItemException {
		CommerceCartItem commerceCartItem = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1 = "commerceCartItem.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 = "commerceCartItem.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(commerceCartItem.uuid IS NULL OR commerceCartItem.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 = "commerceCartItem.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(CommerceCartItemModelImpl.ENTITY_CACHE_ENABLED,
			CommerceCartItemModelImpl.FINDER_CACHE_ENABLED,
			CommerceCartItemImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByUuid_C",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(CommerceCartItemModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { String.class.getName(), Long.class.getName() },
			CommerceCartItemModelImpl.UUID_COLUMN_BITMASK |
			CommerceCartItemModelImpl.COMPANYID_COLUMN_BITMASK |
			CommerceCartItemModelImpl.MODIFIEDDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(CommerceCartItemModelImpl.ENTITY_CACHE_ENABLED,
			CommerceCartItemModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<CommerceCartItem> findByUuid_C(String uuid, long companyId) {
	...
	public List<CommerceCartItem> findByUuid_C(String uuid, long companyId,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CommerceCartItem commerceCartItem : list) {
					if (!Objects.equals(uuid, commerceCartItem.getUuid()) ||
							(companyId != commerceCartItem.getCompanyId())) {
						list = null;
	 ...
	 */
	@Override
	public CommerceCartItem findByUuid_C_First(String uuid, long companyId,
		OrderByComparator<CommerceCartItem> orderByComparator)
		throws NoSuchCartItemException {
		CommerceCartItem commerceCartItem = fetchByUuid_C_First(uuid,
	 ...
	 */
	@Override
	public CommerceCartItem fetchByUuid_C_First(String uuid, long companyId,
		OrderByComparator<CommerceCartItem> orderByComparator) {
		List<CommerceCartItem> list = findByUuid_C(uuid, companyId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceCartItem findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<CommerceCartItem> orderByComparator)
		throws NoSuchCartItemException {
		CommerceCartItem commerceCartItem = fetchByUuid_C_Last(uuid, companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceCartItem fetchByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<CommerceCartItem> orderByComparator) {
		...
		List<CommerceCartItem> list = findByUuid_C(uuid, companyId, count - 1,
	...
	public CommerceCartItem[] findByUuid_C_PrevAndNext(
		long CommerceCartItemId, String uuid, long companyId,
		OrderByComparator<CommerceCartItem> orderByComparator)
		throws NoSuchCartItemException {
		CommerceCartItem commerceCartItem = findByPrimaryKey(CommerceCartItemId);
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session, commerceCartItem, uuid,
					companyId, orderByComparator, true);

			array[1] = commerceCartItem;

			array[2] = getByUuid_C_PrevAndNext(session, commerceCartItem, uuid,
	...
	protected CommerceCartItem getByUuid_C_PrevAndNext(Session session,
		CommerceCartItem commerceCartItem, String uuid, long companyId,
		OrderByComparator<CommerceCartItem> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByUuid_C(String uuid, long companyId) {
		for (CommerceCartItem commerceCartItem : findByUuid_C(uuid, companyId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(commerceCartItem);
		}
	}
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "commerceCartItem.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "commerceCartItem.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(commerceCartItem.uuid IS NULL OR commerceCartItem.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "commerceCartItem.companyId = ?";
	...
	public void cacheResult(CommerceCartItem commerceCartItem) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
			new Object[] {
				commerceCartItem.getUuid(), commerceCartItem.getGroupId()
			}, commerceCartItem);
	...
	public void clearCache(CommerceCartItem commerceCartItem) {
		...
		clearUniqueFindersCache((CommerceCartItemModelImpl)commerceCartItem,
			true);
	}
	...
	protected void cacheUniqueFindersCache(
		CommerceCartItemModelImpl commerceCartItemModelImpl) {
		Object[] args = new Object[] {
				commerceCartItemModelImpl.getUuid(),
				commerceCartItemModelImpl.getGroupId()
			};

		finderCache.putResult(FINDER_PATH_COUNT_BY_UUID_G, args,
			Long.valueOf(1), false);
		finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G, args,
			commerceCartItemModelImpl, false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if ((commerceCartItemModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
					commerceCartItemModelImpl.getOriginalUuid(),
					commerceCartItemModelImpl.getOriginalGroupId()
				};
	...
	public CommerceCartItem updateImpl(CommerceCartItem commerceCartItem) {
		...
		if (Validator.isNull(commerceCartItem.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (!CommerceCartItemModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			Object[] args = new Object[] { commerceCartItemModelImpl.getUuid() };
			...
			args = new Object[] {
					commerceCartItemModelImpl.getUuid(),
					commerceCartItemModelImpl.getCompanyId()
				};
			...
			args = new Object[] { commerceCartItemModelImpl.getCommerceCartId() };
			...
			if ((commerceCartItemModelImpl.getColumnBitmask() &
				...
				args = new Object[] { commerceCartItemModelImpl.getUuid() };
			...
			if ((commerceCartItemModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						commerceCartItemModelImpl.getOriginalUuid(),
						commerceCartItemModelImpl.getOriginalCompanyId()
					};
		...
		clearUniqueFindersCache(commerceCartItemModelImpl, false);
		cacheUniqueFindersCache(commerceCartItemModelImpl);
	...
	protected CommerceCartItem toUnwrappedModel(
		...
		commerceCartItemImpl.setUuid(commerceCartItem.getUuid());

...
import com.liferay.commerce.product.service.CPTemplateLayoutEntryService;
...
/**
 * Provides the base implementation for the cp template layout entry remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.commerce.product.service.impl.CPTemplateLayoutEntryServiceImpl}.
 * </p>
 *
 * @author Marco Leo
 ...
 * @generated
 */
public abstract class CPTemplateLayoutEntryServiceBaseImpl
	extends BaseServiceImpl implements CPTemplateLayoutEntryService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.commerce.product.service.CPTemplateLayoutEntryServiceUtil} to access the cp template layout entry remote service.
	 */
	...
	/**
	 * Returns the cp friendly url entry remote service.
	 *
	...
	/**
	 * Sets the cp friendly url entry remote service.
	 *
	 ...
	 */
	public CPTemplateLayoutEntryService getCPTemplateLayoutEntryService() {
	...
	public String getOSGiServiceIdentifier() {
		return CPTemplateLayoutEntryService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cpTemplateLayoutEntryPersistence.getDataSource();
	...
	@BeanReference(type = CPTemplateLayoutEntryService.class)
	protected CPTemplateLayoutEntryService cpTemplateLayoutEntryService;

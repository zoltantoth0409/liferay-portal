...
public class CPDefinitionStagedModelRepository
	...
	public CPDefinition addStagedModel(
		...
		return _cpDefinitionLocalService.addCPDefinition(
			...
			cpDefinition.getProductTypeName(), cpDefinition.getGtin(),
			cpDefinition.getManufacturerPartNumber(),
			...
			cpDefinition.getWeight(), cpDefinition.getCost(),
			cpDefinition.getPrice(), cpDefinition.getDDMStructureKey(),
	...
	public CPDefinition updateStagedModel(
		...
		return _cpDefinitionLocalService.updateCPDefinition(
			...
			cpDefinition.getMetaTitleMap(), cpDefinition.getMetaKeywordsMap(),
			cpDefinition.getMetaDescriptionMap(), cpDefinition.getLayoutUuid(),
			cpDefinition.getGtin(), cpDefinition.getManufacturerPartNumber(),
			cpDefinition.getMinCartQuantity(),
			cpDefinition.getMaxCartQuantity(),
			cpDefinition.getAllowedCartQuantities(),
			cpDefinition.getMultipleCartQuantity(), cpDefinition.getWidth(),

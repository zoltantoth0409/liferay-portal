...
public class CommerceProductDefinitionWorkflowHandler
	extends BaseWorkflowHandler<CommerceProductDefinition> {
	...
	public CommerceProductDefinition updateStatus(
		...
		return _commerceProductDefinitionLocalService.updateStatus(

...
public class CommerceProductOptionPersistenceImpl extends BasePersistenceImpl<CommerceProductOption>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(CommerceProductOptionModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductOptionModelImpl.FINDER_CACHE_ENABLED,
			CommerceProductOptionImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(CommerceProductOptionModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductOptionModelImpl.FINDER_CACHE_ENABLED,
			CommerceProductOptionImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			CommerceProductOptionModelImpl.UUID_COLUMN_BITMASK |
			CommerceProductOptionModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(CommerceProductOptionModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductOptionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<CommerceProductOption> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<CommerceProductOption> findByUuid(String uuid, int start,
		int end) {
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CommerceProductOption commerceProductOption : list) {
					if (!Objects.equals(uuid, commerceProductOption.getUuid())) {
						list = null;
	 ...
	 */
	@Override
	public CommerceProductOption findByUuid_First(String uuid,
		OrderByComparator<CommerceProductOption> orderByComparator)
		throws NoSuchProductOptionException {
		CommerceProductOption commerceProductOption = fetchByUuid_First(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceProductOption fetchByUuid_First(String uuid,
		OrderByComparator<CommerceProductOption> orderByComparator) {
		List<CommerceProductOption> list = findByUuid(uuid, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceProductOption findByUuid_Last(String uuid,
		OrderByComparator<CommerceProductOption> orderByComparator)
		throws NoSuchProductOptionException {
		CommerceProductOption commerceProductOption = fetchByUuid_Last(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceProductOption fetchByUuid_Last(String uuid,
		OrderByComparator<CommerceProductOption> orderByComparator) {
		...
		List<CommerceProductOption> list = findByUuid(uuid, count - 1, count,
				orderByComparator);
	...
	public CommerceProductOption[] findByUuid_PrevAndNext(
		long commerceProductOptionId, String uuid,
		OrderByComparator<CommerceProductOption> orderByComparator)
		throws NoSuchProductOptionException {
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session, commerceProductOption,
					uuid, orderByComparator, true);

			array[1] = commerceProductOption;

			array[2] = getByUuid_PrevAndNext(session, commerceProductOption,
	...
	protected CommerceProductOption getByUuid_PrevAndNext(Session session,
		CommerceProductOption commerceProductOption, String uuid,
		OrderByComparator<CommerceProductOption> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByUuid(String uuid) {
		for (CommerceProductOption commerceProductOption : findByUuid(uuid,
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "commerceProductOption.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "commerceProductOption.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(commerceProductOption.uuid IS NULL OR commerceProductOption.uuid = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(CommerceProductOptionModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductOptionModelImpl.FINDER_CACHE_ENABLED,
			CommerceProductOptionImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() },
			CommerceProductOptionModelImpl.UUID_COLUMN_BITMASK |
			CommerceProductOptionModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_G = new FinderPath(CommerceProductOptionModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductOptionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public CommerceProductOption findByUUID_G(String uuid, long groupId)
		throws NoSuchProductOptionException {
		CommerceProductOption commerceProductOption = fetchByUUID_G(uuid,
				groupId);
	 ...
	 */
	@Override
	public CommerceProductOption fetchByUUID_G(String uuid, long groupId) {
	...
	public CommerceProductOption fetchByUUID_G(String uuid, long groupId,
		...
		if (result instanceof CommerceProductOption) {
			CommerceProductOption commerceProductOption = (CommerceProductOption)result;

			if (!Objects.equals(uuid, commerceProductOption.getUuid()) ||
					(groupId != commerceProductOption.getGroupId())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					CommerceProductOption commerceProductOption = list.get(0);

					result = commerceProductOption;

					cacheResult(commerceProductOption);

					if ((commerceProductOption.getUuid() == null) ||
							!commerceProductOption.getUuid().equals(uuid) ||
							(commerceProductOption.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
							finderArgs, commerceProductOption);
					}
				}
			}
			catch (Exception e) {
		...
		if (result instanceof List<?>) {
			...
			return (CommerceProductOption)result;
		}
	}
	 ...
	 */
	@Override
	public CommerceProductOption removeByUUID_G(String uuid, long groupId)
		throws NoSuchProductOptionException {
		CommerceProductOption commerceProductOption = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1 = "commerceProductOption.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 = "commerceProductOption.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(commerceProductOption.uuid IS NULL OR commerceProductOption.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 = "commerceProductOption.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(CommerceProductOptionModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductOptionModelImpl.FINDER_CACHE_ENABLED,
			CommerceProductOptionImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(CommerceProductOptionModelImpl.ENTITY_CACHE_ENABLED,
			...
			CommerceProductOptionModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(CommerceProductOptionModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductOptionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<CommerceProductOption> findByUuid_C(String uuid, long companyId) {
	 ...
	 */
	@Override
	public List<CommerceProductOption> findByUuid_C(String uuid,
	...
	public List<CommerceProductOption> findByUuid_C(String uuid,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CommerceProductOption commerceProductOption : list) {
					if (!Objects.equals(uuid, commerceProductOption.getUuid()) ||
							(companyId != commerceProductOption.getCompanyId())) {
						list = null;
	 ...
	 */
	@Override
	public CommerceProductOption findByUuid_C_First(String uuid,
		long companyId,
		OrderByComparator<CommerceProductOption> orderByComparator)
		throws NoSuchProductOptionException {
		CommerceProductOption commerceProductOption = fetchByUuid_C_First(uuid,
	 ...
	 */
	@Override
	public CommerceProductOption fetchByUuid_C_First(String uuid,
		long companyId,
		OrderByComparator<CommerceProductOption> orderByComparator) {
		List<CommerceProductOption> list = findByUuid_C(uuid, companyId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceProductOption findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<CommerceProductOption> orderByComparator)
		throws NoSuchProductOptionException {
		CommerceProductOption commerceProductOption = fetchByUuid_C_Last(uuid,
				companyId, orderByComparator);
	 ...
	 */
	@Override
	public CommerceProductOption fetchByUuid_C_Last(String uuid,
		long companyId,
		OrderByComparator<CommerceProductOption> orderByComparator) {
		...
		List<CommerceProductOption> list = findByUuid_C(uuid, companyId,
	...
	public CommerceProductOption[] findByUuid_C_PrevAndNext(
		long commerceProductOptionId, String uuid, long companyId,
		OrderByComparator<CommerceProductOption> orderByComparator)
		throws NoSuchProductOptionException {
		CommerceProductOption commerceProductOption = findByPrimaryKey(commerceProductOptionId);
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session, commerceProductOption,
					uuid, companyId, orderByComparator, true);

			array[1] = commerceProductOption;

			array[2] = getByUuid_C_PrevAndNext(session, commerceProductOption,
	...
	protected CommerceProductOption getByUuid_C_PrevAndNext(Session session,
		CommerceProductOption commerceProductOption, String uuid,
		long companyId,
		OrderByComparator<CommerceProductOption> orderByComparator,
		boolean previous) {
	...
	public void removeByUuid_C(String uuid, long companyId) {
		for (CommerceProductOption commerceProductOption : findByUuid_C(uuid,
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "commerceProductOption.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "commerceProductOption.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(commerceProductOption.uuid IS NULL OR commerceProductOption.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "commerceProductOption.companyId = ?";
	...
	public void clearCache(CommerceProductOption commerceProductOption) {
		...
		clearUniqueFindersCache((CommerceProductOptionModelImpl)commerceProductOption,
			true);
	}
	...
	protected void cacheUniqueFindersCache(
		CommerceProductOptionModelImpl commerceProductOptionModelImpl) {
		Object[] args = new Object[] {
				commerceProductOptionModelImpl.getUuid(),
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G, args,
			commerceProductOptionModelImpl, false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if ((commerceProductOptionModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
					commerceProductOptionModelImpl.getOriginalUuid(),
	...
	public CommerceProductOption create(long commerceProductOptionId) {
		...
		commerceProductOption.setUuid(uuid);
	...
	public CommerceProductOption updateImpl(
		...
		if (Validator.isNull(commerceProductOption.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (!CommerceProductOptionModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			if ((commerceProductOptionModelImpl.getColumnBitmask() &
				...
				args = new Object[] { commerceProductOptionModelImpl.getUuid() };
		...
		clearUniqueFindersCache(commerceProductOptionModelImpl, false);
		cacheUniqueFindersCache(commerceProductOptionModelImpl);
	...
	protected CommerceProductOption toUnwrappedModel(
		...
		commerceProductOptionImpl.setUuid(commerceProductOption.getUuid());

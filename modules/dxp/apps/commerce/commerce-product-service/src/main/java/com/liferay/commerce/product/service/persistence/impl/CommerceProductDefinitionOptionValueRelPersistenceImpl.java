...
public class CommerceProductDefinitionOptionValueRelPersistenceImpl
	...
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(CommerceProductDefinitionOptionValueRelModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[0]);
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(CommerceProductDefinitionOptionValueRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductDefinitionOptionValueRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceProductDefinitionOptionValueRelImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(CommerceProductDefinitionOptionValueRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductDefinitionOptionValueRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceProductDefinitionOptionValueRelImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			CommerceProductDefinitionOptionValueRelModelImpl.UUID_COLUMN_BITMASK |
			CommerceProductDefinitionOptionValueRelModelImpl.PRIORITY_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(CommerceProductDefinitionOptionValueRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductDefinitionOptionValueRelModelImpl.FINDER_CACHE_ENABLED,
	 ...
	 */
	@Override
	public List<CommerceProductDefinitionOptionValueRel> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<CommerceProductDefinitionOptionValueRel> findByUuid(
			...
			if ((list != null) && !list.isEmpty()) {
				for (CommerceProductDefinitionOptionValueRel commerceProductDefinitionOptionValueRel : list) {
					if (!Objects.equals(uuid,
								commerceProductDefinitionOptionValueRel.getUuid())) {
						list = null;
	...
	public CommerceProductDefinitionOptionValueRel fetchByUuid_First(
		String uuid,
		OrderByComparator<CommerceProductDefinitionOptionValueRel> orderByComparator) {
		List<CommerceProductDefinitionOptionValueRel> list = findByUuid(uuid,
	...
	public CommerceProductDefinitionOptionValueRel[] findByUuid_PrevAndNext(
		long commerceProductDefinitionOptionValueRelId, String uuid,
		OrderByComparator<CommerceProductDefinitionOptionValueRel> orderByComparator)
		throws NoSuchProductDefinitionOptionValueRelException {
		CommerceProductDefinitionOptionValueRel commerceProductDefinitionOptionValueRel =
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session,
					commerceProductDefinitionOptionValueRel, uuid,
	...
	protected CommerceProductDefinitionOptionValueRel getByUuid_PrevAndNext(
		Session session,
		CommerceProductDefinitionOptionValueRel commerceProductDefinitionOptionValueRel,
		String uuid,
		OrderByComparator<CommerceProductDefinitionOptionValueRel> orderByComparator,
	...
	public void removeByUuid(String uuid) {
		for (CommerceProductDefinitionOptionValueRel commerceProductDefinitionOptionValueRel : findByUuid(
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "commerceProductDefinitionOptionValueRel.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "commerceProductDefinitionOptionValueRel.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(commerceProductDefinitionOptionValueRel.uuid IS NULL OR commerceProductDefinitionOptionValueRel.uuid = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(CommerceProductDefinitionOptionValueRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductDefinitionOptionValueRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceProductDefinitionOptionValueRelImpl.class,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_G = new FinderPath(CommerceProductDefinitionOptionValueRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductDefinitionOptionValueRelModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() });
	 ...
	 */
	@Override
	public CommerceProductDefinitionOptionValueRel findByUUID_G(String uuid,
		long groupId) throws NoSuchProductDefinitionOptionValueRelException {
		CommerceProductDefinitionOptionValueRel commerceProductDefinitionOptionValueRel =
	 ...
	 */
	@Override
	public CommerceProductDefinitionOptionValueRel fetchByUUID_G(String uuid,
		long groupId) {
	...
	public CommerceProductDefinitionOptionValueRel fetchByUUID_G(String uuid,
		...
		if (result instanceof CommerceProductDefinitionOptionValueRel) {
			CommerceProductDefinitionOptionValueRel commerceProductDefinitionOptionValueRel =
				(CommerceProductDefinitionOptionValueRel)result;

			if (!Objects.equals(uuid,
						commerceProductDefinitionOptionValueRel.getUuid()) ||
					(groupId != commerceProductDefinitionOptionValueRel.getGroupId())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					result = commerceProductDefinitionOptionValueRel;

					cacheResult(commerceProductDefinitionOptionValueRel);

					if ((commerceProductDefinitionOptionValueRel.getUuid() == null) ||
							!commerceProductDefinitionOptionValueRel.getUuid()
																		.equals(uuid) ||
							(commerceProductDefinitionOptionValueRel.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
							finderArgs, commerceProductDefinitionOptionValueRel);
					}
				}
			}
			catch (Exception e) {
		...
		if (result instanceof List<?>) {
			...
			return (CommerceProductDefinitionOptionValueRel)result;
		}
	}
	 ...
	 */
	@Override
	public CommerceProductDefinitionOptionValueRel removeByUUID_G(String uuid,
		long groupId) throws NoSuchProductDefinitionOptionValueRelException {
		CommerceProductDefinitionOptionValueRel commerceProductDefinitionOptionValueRel =
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1 = "commerceProductDefinitionOptionValueRel.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 = "commerceProductDefinitionOptionValueRel.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(commerceProductDefinitionOptionValueRel.uuid IS NULL OR commerceProductDefinitionOptionValueRel.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 = "commerceProductDefinitionOptionValueRel.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(CommerceProductDefinitionOptionValueRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductDefinitionOptionValueRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceProductDefinitionOptionValueRelImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(CommerceProductDefinitionOptionValueRelModelImpl.ENTITY_CACHE_ENABLED,
			...
			CommerceProductDefinitionOptionValueRelModelImpl.PRIORITY_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(CommerceProductDefinitionOptionValueRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductDefinitionOptionValueRelModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByUuid_C",
			new String[] { String.class.getName(), Long.class.getName() });
	 ...
	 */
	@Override
	public List<CommerceProductDefinitionOptionValueRel> findByUuid_C(
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CommerceProductDefinitionOptionValueRel commerceProductDefinitionOptionValueRel : list) {
					if (!Objects.equals(uuid,
								commerceProductDefinitionOptionValueRel.getUuid()) ||
							(companyId != commerceProductDefinitionOptionValueRel.getCompanyId())) {
						list = null;
	...
	public CommerceProductDefinitionOptionValueRel fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<CommerceProductDefinitionOptionValueRel> orderByComparator) {
		List<CommerceProductDefinitionOptionValueRel> list = findByUuid_C(uuid,
	...
	public CommerceProductDefinitionOptionValueRel[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session,
					commerceProductDefinitionOptionValueRel, uuid, companyId,
					orderByComparator, true);
	...
	protected CommerceProductDefinitionOptionValueRel getByUuid_C_PrevAndNext(
		Session session,
		CommerceProductDefinitionOptionValueRel commerceProductDefinitionOptionValueRel,
		String uuid, long companyId,
		OrderByComparator<CommerceProductDefinitionOptionValueRel> orderByComparator,
	...
	public void removeByUuid_C(String uuid, long companyId) {
		for (CommerceProductDefinitionOptionValueRel commerceProductDefinitionOptionValueRel : findByUuid_C(
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "commerceProductDefinitionOptionValueRel.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "commerceProductDefinitionOptionValueRel.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(commerceProductDefinitionOptionValueRel.uuid IS NULL OR commerceProductDefinitionOptionValueRel.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "commerceProductDefinitionOptionValueRel.companyId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COMMERCEPRODUCTDEFINITIONOPTIONRELID =
		new FinderPath(CommerceProductDefinitionOptionValueRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductDefinitionOptionValueRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceProductDefinitionOptionValueRelImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMMERCEPRODUCTDEFINITIONOPTIONRELID =
		new FinderPath(CommerceProductDefinitionOptionValueRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductDefinitionOptionValueRelModelImpl.FINDER_CACHE_ENABLED,
			CommerceProductDefinitionOptionValueRelImpl.class,
			...
			CommerceProductDefinitionOptionValueRelModelImpl.COMMERCEPRODUCTDEFINITIONOPTIONRELID_COLUMN_BITMASK |
			CommerceProductDefinitionOptionValueRelModelImpl.PRIORITY_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMMERCEPRODUCTDEFINITIONOPTIONRELID =
		new FinderPath(CommerceProductDefinitionOptionValueRelModelImpl.ENTITY_CACHE_ENABLED,
			CommerceProductDefinitionOptionValueRelModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	 ...
	 */
	@Override
	public List<CommerceProductDefinitionOptionValueRel> findByCommerceProductDefinitionOptionRelId(
		long commerceProductDefinitionOptionRelId) {
		return findByCommerceProductDefinitionOptionRelId(commerceProductDefinitionOptionRelId,
	...
	public List<CommerceProductDefinitionOptionValueRel> findByCommerceProductDefinitionOptionRelId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMMERCEPRODUCTDEFINITIONOPTIONRELID;
			finderArgs = new Object[] { commerceProductDefinitionOptionRelId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_COMMERCEPRODUCTDEFINITIONOPTIONRELID;
			finderArgs = new Object[] {
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CommerceProductDefinitionOptionValueRel commerceProductDefinitionOptionValueRel : list) {
					if ((commerceProductDefinitionOptionRelId != commerceProductDefinitionOptionValueRel.getCommerceProductDefinitionOptionRelId())) {
						list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_COMMERCEPRODUCTDEFINITIONOPTIONRELID_COMMERCEPRODUCTDEFINITIONOPTIONRELID_2);
			...
			try {
				...
				qPos.add(commerceProductDefinitionOptionRelId);
	...
	public CommerceProductDefinitionOptionValueRel findByCommerceProductDefinitionOptionRelId_First(
		...
		msg.append("commerceProductDefinitionOptionRelId=");
		msg.append(commerceProductDefinitionOptionRelId);
	...
	public CommerceProductDefinitionOptionValueRel fetchByCommerceProductDefinitionOptionRelId_First(
		long commerceProductDefinitionOptionRelId,
		OrderByComparator<CommerceProductDefinitionOptionValueRel> orderByComparator) {
		List<CommerceProductDefinitionOptionValueRel> list = findByCommerceProductDefinitionOptionRelId(commerceProductDefinitionOptionRelId,
				0, 1, orderByComparator);
	...
	public CommerceProductDefinitionOptionValueRel fetchByCommerceProductDefinitionOptionRelId_Last(
		long commerceProductDefinitionOptionRelId,
		OrderByComparator<CommerceProductDefinitionOptionValueRel> orderByComparator) {
		int count = countByCommerceProductDefinitionOptionRelId(commerceProductDefinitionOptionRelId);
	...
	public CommerceProductDefinitionOptionValueRel[] findByCommerceProductDefinitionOptionRelId_PrevAndNext(
		...
		try {
			...
			array[0] = getByCommerceProductDefinitionOptionRelId_PrevAndNext(session,
			...
			array[2] = getByCommerceProductDefinitionOptionRelId_PrevAndNext(session,
					commerceProductDefinitionOptionValueRel,
					commerceProductDefinitionOptionRelId, orderByComparator,
					false);
	...
	protected CommerceProductDefinitionOptionValueRel getByCommerceProductDefinitionOptionRelId_PrevAndNext(
		Session session,
		CommerceProductDefinitionOptionValueRel commerceProductDefinitionOptionValueRel,
		long commerceProductDefinitionOptionRelId,
		OrderByComparator<CommerceProductDefinitionOptionValueRel> orderByComparator,
	...
	public void removeByCommerceProductDefinitionOptionRelId(
		long commerceProductDefinitionOptionRelId) {
		for (CommerceProductDefinitionOptionValueRel commerceProductDefinitionOptionValueRel : findByCommerceProductDefinitionOptionRelId(
	...
	public int countByCommerceProductDefinitionOptionRelId(
		long commerceProductDefinitionOptionRelId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_COMMERCEPRODUCTDEFINITIONOPTIONRELID;

		Object[] finderArgs = new Object[] { commerceProductDefinitionOptionRelId };
	...
	private static final String _FINDER_COLUMN_COMMERCEPRODUCTDEFINITIONOPTIONRELID_COMMERCEPRODUCTDEFINITIONOPTIONRELID_2 =
		"commerceProductDefinitionOptionValueRel.commerceProductDefinitionOptionRelId = ?";
	...
	public CommerceProductDefinitionOptionValueRelPersistenceImpl() {
		...
		try {
			...
			dbColumnNames.put("commerceProductDefinitionOptionValueRelId",
				"definitionOptionValueRelId");
	...
	public void cacheResult(
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
			new Object[] {
				commerceProductDefinitionOptionValueRel.getUuid(),
				commerceProductDefinitionOptionValueRel.getGroupId()
			}, commerceProductDefinitionOptionValueRel);
	...
	public void clearCache(
		...
		clearUniqueFindersCache((CommerceProductDefinitionOptionValueRelModelImpl)commerceProductDefinitionOptionValueRel,
			true);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
				commerceProductDefinitionOptionValueRelModelImpl.getUuid(),
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G, args,
			commerceProductDefinitionOptionValueRelModelImpl, false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if ((commerceProductDefinitionOptionValueRelModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
					commerceProductDefinitionOptionValueRelModelImpl.getOriginalUuid(),
	...
	public CommerceProductDefinitionOptionValueRel create(
		...
		commerceProductDefinitionOptionValueRel.setUuid(uuid);
	...
	public CommerceProductDefinitionOptionValueRel updateImpl(
		...
		if (Validator.isNull(commerceProductDefinitionOptionValueRel.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (!CommerceProductDefinitionOptionValueRelModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] {
					commerceProductDefinitionOptionValueRelModelImpl.getCommerceProductDefinitionOptionRelId()
				};

			finderCache.removeResult(FINDER_PATH_COUNT_BY_COMMERCEPRODUCTDEFINITIONOPTIONRELID,
				args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMMERCEPRODUCTDEFINITIONOPTIONRELID,
				args);
			...
			if ((commerceProductDefinitionOptionValueRelModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMMERCEPRODUCTDEFINITIONOPTIONRELID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						commerceProductDefinitionOptionValueRelModelImpl.getOriginalCommerceProductDefinitionOptionRelId()
					};
		...
		clearUniqueFindersCache(commerceProductDefinitionOptionValueRelModelImpl,
			false);
		cacheUniqueFindersCache(commerceProductDefinitionOptionValueRelModelImpl);
	...
	protected CommerceProductDefinitionOptionValueRel toUnwrappedModel(
		...
		commerceProductDefinitionOptionValueRelImpl.setUuid(commerceProductDefinitionOptionValueRel.getUuid());
	...
	private static final Set<String> _badColumnNames = SetUtil.fromArray(new String[] {
				"uuid", "commerceProductDefinitionOptionValueRelId",
				"commerceProductDefinitionOptionRelId"
			});
}
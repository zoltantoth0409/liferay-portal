...
/**
 * Provides the base implementation for the cp availability range remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.commerce.product.service.impl.CPAvailabilityRangeServiceImpl}.
 * </p>
 *
 * @author Marco Leo
 * @see com.liferay.commerce.product.service.impl.CPAvailabilityRangeServiceImpl
 * @see com.liferay.commerce.product.service.CPAvailabilityRangeServiceUtil
 * @generated
 */
public abstract class CPAvailabilityRangeServiceBaseImpl extends BaseServiceImpl
	implements CPAvailabilityRangeService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.commerce.product.service.CPAvailabilityRangeServiceUtil} to access the cp availability range remote service.
	 */
	 ...
	 */
	public CPAvailabilityRangeService getCPAvailabilityRangeService() {
	...
	public String getOSGiServiceIdentifier() {
		return CPAvailabilityRangeService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cpAvailabilityRangePersistence.getDataSource();
	...
	@BeanReference(type = CPAvailabilityRangeService.class)
	protected CPAvailabilityRangeService cpAvailabilityRangeService;

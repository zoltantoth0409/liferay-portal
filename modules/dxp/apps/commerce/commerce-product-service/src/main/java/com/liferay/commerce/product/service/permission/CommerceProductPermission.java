 ...
 */
@Component(
	property = {"resource.name=" + CommerceProductPermission.RESOURCE_NAME},
	service = ResourcePermissionChecker.class
)
public class CommerceProductPermission extends BaseResourcePermissionChecker {
	...
	public static boolean contains(
		...
		return contains(
			...
			CommerceProductPortletKeys.COMMERCE_PRODUCT_DEFINITIONS, classPK,
			actionId);
	}

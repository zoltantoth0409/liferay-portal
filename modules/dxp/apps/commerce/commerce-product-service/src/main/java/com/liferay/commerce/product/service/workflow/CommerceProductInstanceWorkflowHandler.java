 ...
 */
@Component(
	property = {"model.class.name=com.liferay.commerce.product.model.CommerceProductInstance"},
	service = WorkflowHandler.class
)
public class CommerceProductInstanceWorkflowHandler
	extends BaseWorkflowHandler<CommerceProductInstance> {
	...
	public CommerceProductInstance updateStatus(
		...
		return _commerceProductInstanceLocalService.updateStatus(
			userId, classPK, status, serviceContext, workflowContext);
	}

	@Reference
	private CommerceProductInstanceLocalService

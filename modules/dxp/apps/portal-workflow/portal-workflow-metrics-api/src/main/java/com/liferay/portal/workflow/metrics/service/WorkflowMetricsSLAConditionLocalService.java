...
/**
 * Provides the local service interface for WorkflowMetricsSLACondition. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see WorkflowMetricsSLAConditionLocalServiceUtil
 * @see com.liferay.portal.workflow.metrics.service.base.WorkflowMetricsSLAConditionLocalServiceBaseImpl
...
public interface WorkflowMetricsSLAConditionLocalService
	extends BaseLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WorkflowMetricsSLAConditionLocalServiceUtil} to access the workflow metrics sla condition local service. Add custom service methods to {@link com.liferay.portal.workflow.metrics.service.impl.WorkflowMetricsSLAConditionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

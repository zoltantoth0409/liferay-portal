 ...
 * @see com.liferay.portal.workflow.metrics.service.persistence.impl.WorkflowMetricsSLAConditionPersistenceImpl
 * @see WorkflowMetricsSLAConditionUtil
 * @generated
 */
@ProviderType
public interface WorkflowMetricsSLAConditionPersistence extends BasePersistence<WorkflowMetricsSLACondition> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	@Override
	public Map<Serializable, WorkflowMetricsSLACondition> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<WorkflowMetricsSLACondition> findByUuid(String uuid,
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<WorkflowMetricsSLACondition> orderByComparator);
	...
	*/
	...
	/**
	* Returns the workflow metrics sla condition where uuid = &#63; and groupId = &#63; or throws a {@link NoSuchSLAConditionException} if it could not be found.
	*
	* @param uuid the uuid
	...
	*/
	public void cacheResult(
		java.util.List<WorkflowMetricsSLACondition> workflowMetricsSLAConditions);
	...
	*/
	...
	/**
	* Returns the workflow metrics sla condition with the primary key or throws a {@link NoSuchSLAConditionException} if it could not be found.
	*
	* @param workflowMetricsSLAConditionId the primary key of the workflow metrics sla condition
	...
	*/
	public java.util.List<WorkflowMetricsSLACondition> findAll(int start,
		int end);

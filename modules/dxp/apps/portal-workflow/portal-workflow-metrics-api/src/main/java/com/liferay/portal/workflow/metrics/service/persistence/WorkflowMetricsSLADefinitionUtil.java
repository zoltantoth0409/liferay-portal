 ...
 * @see com.liferay.portal.workflow.metrics.service.persistence.impl.WorkflowMetricsSLADefinitionPersistenceImpl
 * @generated
 */
@ProviderType
public class WorkflowMetricsSLADefinitionUtil {
	 ...
	 */
	public static Map<Serializable, WorkflowMetricsSLADefinition> fetchByPrimaryKeys(
	...
	public static WorkflowMetricsSLADefinition update(
		...
		return getPersistence()
				   .update(workflowMetricsSLADefinition, serviceContext);
	}
	...
	*/
	public static WorkflowMetricsSLADefinition findByUuid_First(String uuid,
		OrderByComparator<WorkflowMetricsSLADefinition> orderByComparator)
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLADefinitionException {
	...
	*/
	public static WorkflowMetricsSLADefinition fetchByUuid_First(String uuid,
		OrderByComparator<WorkflowMetricsSLADefinition> orderByComparator) {
	...
	* @throws NoSuchSLADefinitionException if a matching workflow metrics sla definition could not be found
	*/
	public static WorkflowMetricsSLADefinition findByUuid_Last(String uuid,
		OrderByComparator<WorkflowMetricsSLADefinition> orderByComparator)
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLADefinitionException {
	...
	*/
	public static WorkflowMetricsSLADefinition fetchByUuid_Last(String uuid,
		OrderByComparator<WorkflowMetricsSLADefinition> orderByComparator) {
	...
	*/
	public static WorkflowMetricsSLADefinition[] findByUuid_PrevAndNext(
		...
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLADefinitionException {
		return getPersistence()
				   .findByUuid_PrevAndNext(workflowMetricsSLADefinitionId,
	...
	*/
	...
	/**
	* Returns the workflow metrics sla definition where uuid = &#63; and groupId = &#63; or throws a {@link NoSuchSLADefinitionException} if it could not be found.
	*
	* @param uuid the uuid
	...
	* @throws NoSuchSLADefinitionException if a matching workflow metrics sla definition could not be found
	*/
	public static WorkflowMetricsSLADefinition findByUUID_G(String uuid,
		long groupId)
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLADefinitionException {
	...
	*/
	public static WorkflowMetricsSLADefinition fetchByUUID_G(String uuid,
		long groupId) {
	...
	*/
	public static WorkflowMetricsSLADefinition removeByUUID_G(String uuid,
		long groupId)
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLADefinitionException {
	...
	* @return the matching workflow metrics sla definitions
	*/
	public static List<WorkflowMetricsSLADefinition> findByUuid_C(String uuid,
		long companyId) {
	...
	* @throws NoSuchSLADefinitionException if a matching workflow metrics sla definition could not be found
	*/
	public static WorkflowMetricsSLADefinition findByUuid_C_First(String uuid,
		long companyId,
		OrderByComparator<WorkflowMetricsSLADefinition> orderByComparator)
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLADefinitionException {
		return getPersistence()
	...
	* @throws NoSuchSLADefinitionException if a matching workflow metrics sla definition could not be found
	*/
	public static WorkflowMetricsSLADefinition findByUuid_C_Last(String uuid,
		long companyId,
		OrderByComparator<WorkflowMetricsSLADefinition> orderByComparator)
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLADefinitionException {
		return getPersistence()
	...
	* @return the last matching workflow metrics sla definition, or <code>null</code> if a matching workflow metrics sla definition could not be found
	*/
	public static WorkflowMetricsSLADefinition fetchByUuid_C_Last(String uuid,
		long companyId,
		OrderByComparator<WorkflowMetricsSLADefinition> orderByComparator) {
		return getPersistence()
	...
	*/
	public static WorkflowMetricsSLADefinition[] findByUuid_C_PrevAndNext(
		...
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLADefinitionException {
		return getPersistence()
				   .findByUuid_C_PrevAndNext(workflowMetricsSLADefinitionId,
	...
	* @return the matching workflow metrics sla definitions
	*/
	public static List<WorkflowMetricsSLADefinition> findByC_P(long companyId,
		long processId) {
	...
	*/
	public static List<WorkflowMetricsSLADefinition> findByC_P(long companyId,
		...
		OrderByComparator<WorkflowMetricsSLADefinition> orderByComparator) {
		return getPersistence()
				   .findByC_P(companyId, processId, start, end,
			orderByComparator);
	}
	...
	* @throws NoSuchSLADefinitionException if a matching workflow metrics sla definition could not be found
	*/
	public static WorkflowMetricsSLADefinition findByC_P_First(long companyId,
		long processId,
		OrderByComparator<WorkflowMetricsSLADefinition> orderByComparator)
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLADefinitionException {
		return getPersistence()
				   .findByC_P_First(companyId, processId, orderByComparator);
	}
	...
	* @throws NoSuchSLADefinitionException if a matching workflow metrics sla definition could not be found
	*/
	public static WorkflowMetricsSLADefinition findByC_P_Last(long companyId,
		long processId,
		OrderByComparator<WorkflowMetricsSLADefinition> orderByComparator)
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLADefinitionException {
		return getPersistence()
				   .findByC_P_Last(companyId, processId, orderByComparator);
	}
	...
	* @return the last matching workflow metrics sla definition, or <code>null</code> if a matching workflow metrics sla definition could not be found
	*/
	public static WorkflowMetricsSLADefinition fetchByC_P_Last(long companyId,
		long processId,
		OrderByComparator<WorkflowMetricsSLADefinition> orderByComparator) {
		return getPersistence()
	...
	*/
	public static WorkflowMetricsSLADefinition[] findByC_P_PrevAndNext(
		...
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLADefinitionException {
		return getPersistence()
				   .findByC_P_PrevAndNext(workflowMetricsSLADefinitionId,
	...
	*/
	...
	/**
	* Returns the workflow metrics sla definition where companyId = &#63; and name = &#63; and processId = &#63; or throws a {@link NoSuchSLADefinitionException} if it could not be found.
	*
	* @param companyId the company ID
	* @param name the name
	* @param processId the process ID
	...
	* @throws NoSuchSLADefinitionException if a matching workflow metrics sla definition could not be found
	*/
	public static WorkflowMetricsSLADefinition findByC_N_P(long companyId,
	...
	* @return the matching workflow metrics sla definition, or <code>null</code> if a matching workflow metrics sla definition could not be found
	*/
	public static WorkflowMetricsSLADefinition fetchByC_N_P(long companyId,
		String name, long processId) {
	...
	*/
	public static WorkflowMetricsSLADefinition fetchByC_N_P(long companyId,
		String name, long processId, boolean retrieveFromCache) {
		return getPersistence()
				   .fetchByC_N_P(companyId, name, processId, retrieveFromCache);
	}
	...
	* @return the workflow metrics sla definition that was removed
	*/
	public static WorkflowMetricsSLADefinition removeByC_N_P(long companyId,
		String name, long processId)
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLADefinitionException {
	...
	* @return the number of matching workflow metrics sla definitions
	*/
	public static int countByC_N_P(long companyId, String name, long processId) {
	...
	*/
	...
	/**
	* Returns the workflow metrics sla definition with the primary key or throws a {@link NoSuchSLADefinitionException} if it could not be found.
	*
	* @param workflowMetricsSLADefinitionId the primary key of the workflow metrics sla definition
	...
	*/
	public static WorkflowMetricsSLADefinition findByPrimaryKey(
		long workflowMetricsSLADefinitionId)
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLADefinitionException {
		return getPersistence().findByPrimaryKey(workflowMetricsSLADefinitionId);
	}
	...
	*/
	public static WorkflowMetricsSLADefinition fetchByPrimaryKey(
		long workflowMetricsSLADefinitionId) {
		return getPersistence().fetchByPrimaryKey(workflowMetricsSLADefinitionId);
	}
	...
	*/
	public static List<WorkflowMetricsSLADefinition> findAll(int start,
		int end,
		OrderByComparator<WorkflowMetricsSLADefinition> orderByComparator) {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(WorkflowMetricsSLADefinitionPersistence.class);

		ServiceTracker<WorkflowMetricsSLADefinitionPersistence, WorkflowMetricsSLADefinitionPersistence> serviceTracker =
			new ServiceTracker<WorkflowMetricsSLADefinitionPersistence, WorkflowMetricsSLADefinitionPersistence>(bundle.getBundleContext(),

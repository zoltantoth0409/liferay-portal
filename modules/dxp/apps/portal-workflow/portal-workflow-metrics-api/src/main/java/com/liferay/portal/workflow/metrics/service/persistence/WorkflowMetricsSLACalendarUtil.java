 ...
 * @see com.liferay.portal.workflow.metrics.service.persistence.impl.WorkflowMetricsSLACalendarPersistenceImpl
 * @generated
 */
@ProviderType
public class WorkflowMetricsSLACalendarUtil {
	 ...
	 */
	public static Map<Serializable, WorkflowMetricsSLACalendar> fetchByPrimaryKeys(
	...
	public static WorkflowMetricsSLACalendar update(
		...
		return getPersistence()
				   .update(workflowMetricsSLACalendar, serviceContext);
	}
	...
	*/
	public static WorkflowMetricsSLACalendar findByUuid_First(String uuid,
		OrderByComparator<WorkflowMetricsSLACalendar> orderByComparator)
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLACalendarException {
	...
	*/
	public static WorkflowMetricsSLACalendar fetchByUuid_First(String uuid,
		OrderByComparator<WorkflowMetricsSLACalendar> orderByComparator) {
	...
	* @throws NoSuchSLACalendarException if a matching workflow metrics sla calendar could not be found
	*/
	public static WorkflowMetricsSLACalendar findByUuid_Last(String uuid,
		OrderByComparator<WorkflowMetricsSLACalendar> orderByComparator)
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLACalendarException {
	...
	*/
	public static WorkflowMetricsSLACalendar fetchByUuid_Last(String uuid,
		OrderByComparator<WorkflowMetricsSLACalendar> orderByComparator) {
	...
	*/
	public static WorkflowMetricsSLACalendar[] findByUuid_PrevAndNext(
		...
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLACalendarException {
		return getPersistence()
				   .findByUuid_PrevAndNext(workflowMetricsSLACalendarId, uuid,
			orderByComparator);
	}
	...
	*/
	...
	/**
	* Returns the workflow metrics sla calendar where uuid = &#63; and groupId = &#63; or throws a {@link NoSuchSLACalendarException} if it could not be found.
	*
	* @param uuid the uuid
	...
	* @throws NoSuchSLACalendarException if a matching workflow metrics sla calendar could not be found
	*/
	public static WorkflowMetricsSLACalendar findByUUID_G(String uuid,
		long groupId)
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLACalendarException {
	...
	*/
	public static WorkflowMetricsSLACalendar fetchByUUID_G(String uuid,
		long groupId) {
	...
	*/
	public static WorkflowMetricsSLACalendar removeByUUID_G(String uuid,
		long groupId)
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLACalendarException {
	...
	* @return the matching workflow metrics sla calendars
	*/
	public static List<WorkflowMetricsSLACalendar> findByUuid_C(String uuid,
		long companyId) {
	...
	* @throws NoSuchSLACalendarException if a matching workflow metrics sla calendar could not be found
	*/
	public static WorkflowMetricsSLACalendar findByUuid_C_First(String uuid,
		long companyId,
		OrderByComparator<WorkflowMetricsSLACalendar> orderByComparator)
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLACalendarException {
		return getPersistence()
	...
	* @return the first matching workflow metrics sla calendar, or <code>null</code> if a matching workflow metrics sla calendar could not be found
	*/
	public static WorkflowMetricsSLACalendar fetchByUuid_C_First(String uuid,
		long companyId,
		OrderByComparator<WorkflowMetricsSLACalendar> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchSLACalendarException if a matching workflow metrics sla calendar could not be found
	*/
	public static WorkflowMetricsSLACalendar findByUuid_C_Last(String uuid,
		long companyId,
		OrderByComparator<WorkflowMetricsSLACalendar> orderByComparator)
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLACalendarException {
		return getPersistence()
	...
	* @return the last matching workflow metrics sla calendar, or <code>null</code> if a matching workflow metrics sla calendar could not be found
	*/
	public static WorkflowMetricsSLACalendar fetchByUuid_C_Last(String uuid,
		long companyId,
		OrderByComparator<WorkflowMetricsSLACalendar> orderByComparator) {
		return getPersistence()
	...
	*/
	public static WorkflowMetricsSLACalendar[] findByUuid_C_PrevAndNext(
		...
		throws com.liferay.portal.workflow.metrics.exception.NoSuchSLACalendarException {
		return getPersistence()
				   .findByUuid_C_PrevAndNext(workflowMetricsSLACalendarId,
	...
	*/
	...
	/**
	* Returns the workflow metrics sla calendar with the primary key or throws a {@link NoSuchSLACalendarException} if it could not be found.
	*
	* @param workflowMetricsSLACalendarId the primary key of the workflow metrics sla calendar
	...
	*/
	...
	private static ServiceTracker<WorkflowMetricsSLACalendarPersistence, WorkflowMetricsSLACalendarPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(WorkflowMetricsSLACalendarPersistence.class);

		ServiceTracker<WorkflowMetricsSLACalendarPersistence, WorkflowMetricsSLACalendarPersistence> serviceTracker =
			new ServiceTracker<WorkflowMetricsSLACalendarPersistence, WorkflowMetricsSLACalendarPersistence>(bundle.getBundleContext(),

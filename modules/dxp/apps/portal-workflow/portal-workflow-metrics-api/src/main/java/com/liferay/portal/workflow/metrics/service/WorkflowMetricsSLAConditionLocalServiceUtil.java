...
/**
 * Provides the local service utility for WorkflowMetricsSLACondition. This utility wraps
 * <code>com.liferay.portal.workflow.metrics.service.impl.WorkflowMetricsSLAConditionLocalServiceImpl</code> and
 ...
 */
@ProviderType
public class WorkflowMetricsSLAConditionLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.portal.workflow.metrics.service.impl.WorkflowMetricsSLAConditionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.portal.workflow.metrics.model.WorkflowMetricsSLACondition addWorkflowMetricsSLACondition(
	...
	*/
	public static com.liferay.portal.workflow.metrics.model.WorkflowMetricsSLACondition createWorkflowMetricsSLACondition(
	...
	*/
	public static com.liferay.portal.workflow.metrics.model.WorkflowMetricsSLACondition deleteWorkflowMetricsSLACondition(
		long workflowMetricsSLAConditionId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
	...
	*/
	...
	public static com.liferay.portal.workflow.metrics.model.WorkflowMetricsSLACondition fetchWorkflowMetricsSLACondition(
		long workflowMetricsSLAConditionId) {
		return getService()
	...
	*/
	public static com.liferay.portal.workflow.metrics.model.WorkflowMetricsSLACondition fetchWorkflowMetricsSLAConditionByUuidAndGroupId(
		String uuid, long groupId) {
		return getService()
				   .fetchWorkflowMetricsSLAConditionByUuidAndGroupId(uuid,
			groupId);
	}
	...
	* @throws PortalException if a workflow metrics sla condition with the primary key could not be found
	*/
	public static com.liferay.portal.workflow.metrics.model.WorkflowMetricsSLACondition getWorkflowMetricsSLACondition(
		long workflowMetricsSLAConditionId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
	...
	*/
	public static com.liferay.portal.workflow.metrics.model.WorkflowMetricsSLACondition getWorkflowMetricsSLAConditionByUuidAndGroupId(
		String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
	...
	*/
	public static java.util.List<com.liferay.portal.workflow.metrics.model.WorkflowMetricsSLACondition> getWorkflowMetricsSLAConditions(
		int start, int end) {
		return getService().getWorkflowMetricsSLAConditions(start, end);
	}
	...
	*/
	public static java.util.List<com.liferay.portal.workflow.metrics.model.WorkflowMetricsSLACondition> getWorkflowMetricsSLAConditionsByUuidAndCompanyId(
		String uuid, long companyId) {
		return getService()
				   .getWorkflowMetricsSLAConditionsByUuidAndCompanyId(uuid,
			companyId);
	}
	...
	*/
	public static int getWorkflowMetricsSLAConditionsCount() {
		return getService().getWorkflowMetricsSLAConditionsCount();
	}
	...
	*/
	public static com.liferay.portal.workflow.metrics.model.WorkflowMetricsSLACondition updateWorkflowMetricsSLACondition(
		com.liferay.portal.workflow.metrics.model.WorkflowMetricsSLACondition workflowMetricsSLACondition) {
		return getService()
				   .updateWorkflowMetricsSLACondition(workflowMetricsSLACondition);
	}

	public static WorkflowMetricsSLAConditionLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<WorkflowMetricsSLAConditionLocalService, WorkflowMetricsSLAConditionLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(WorkflowMetricsSLAConditionLocalService.class);

		ServiceTracker<WorkflowMetricsSLAConditionLocalService, WorkflowMetricsSLAConditionLocalService> serviceTracker =
			new ServiceTracker<WorkflowMetricsSLAConditionLocalService, WorkflowMetricsSLAConditionLocalService>(bundle.getBundleContext(),
				WorkflowMetricsSLAConditionLocalService.class, null);

...
public class WorkflowMetricsSLAConditionLocalServiceUtil {
	...
	public static
		...
		return getService().addWorkflowMetricsSLACondition(
	...
	public static
		com.liferay.portal.workflow.metrics.model.WorkflowMetricsSLACondition
			createWorkflowMetricsSLACondition(
				long workflowMetricsSLAConditionId) {

		return getService().createWorkflowMetricsSLACondition(
	...
	public static
		...
		return getService().deleteWorkflowMetricsSLACondition(
			workflowMetricsSLAConditionId);
	}
	...
	public static
		com.liferay.portal.workflow.metrics.model.WorkflowMetricsSLACondition
			fetchWorkflowMetricsSLACondition(
				long workflowMetricsSLAConditionId) {

		return getService().fetchWorkflowMetricsSLACondition(
			workflowMetricsSLAConditionId);
	}
	...
	public static
		...
		return getService().fetchWorkflowMetricsSLAConditionByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static
		com.liferay.portal.workflow.metrics.model.WorkflowMetricsSLACondition
				getWorkflowMetricsSLACondition(
					long workflowMetricsSLAConditionId)
			throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getWorkflowMetricsSLACondition(
			workflowMetricsSLAConditionId);
	}
	...
	public static
		...
		return getService().getWorkflowMetricsSLAConditionByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static java.util.List
		...
		return getService().getWorkflowMetricsSLAConditionsByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public static
		...
		return getService().updateWorkflowMetricsSLACondition(
			workflowMetricsSLACondition);
	}
	...
	private static ServiceTracker
		<WorkflowMetricsSLAConditionLocalService,
		 WorkflowMetricsSLAConditionLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			WorkflowMetricsSLAConditionLocalService.class);

		ServiceTracker
			<WorkflowMetricsSLAConditionLocalService,
			 WorkflowMetricsSLAConditionLocalService> serviceTracker =
				new ServiceTracker
					<WorkflowMetricsSLAConditionLocalService,
					 WorkflowMetricsSLAConditionLocalService>(

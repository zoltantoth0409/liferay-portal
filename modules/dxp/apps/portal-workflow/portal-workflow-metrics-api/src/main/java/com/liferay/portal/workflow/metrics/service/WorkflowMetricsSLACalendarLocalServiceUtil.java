...
public class WorkflowMetricsSLACalendarLocalServiceUtil {
	...
	public static
		...
		return getService().addWorkflowMetricsSLACalendar(
	...
	public static
		com.liferay.portal.workflow.metrics.model.WorkflowMetricsSLACalendar
			createWorkflowMetricsSLACalendar(
				long workflowMetricsSLACalendarId) {

		return getService().createWorkflowMetricsSLACalendar(
	...
	public static
		...
		return getService().deleteWorkflowMetricsSLACalendar(
			workflowMetricsSLACalendarId);
	}
	...
	public static
		...
		return getService().fetchWorkflowMetricsSLACalendar(
			workflowMetricsSLACalendarId);
	}
	...
	public static
		...
		return getService().fetchWorkflowMetricsSLACalendarByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static
		...
		return getService().getWorkflowMetricsSLACalendar(
			workflowMetricsSLACalendarId);
	}
	...
	public static
		...
		return getService().getWorkflowMetricsSLACalendarByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static java.util.List
		...
		return getService().getWorkflowMetricsSLACalendarsByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public static
		...
		return getService().updateWorkflowMetricsSLACalendar(
			workflowMetricsSLACalendar);
	}
	...
	private static ServiceTracker
		<WorkflowMetricsSLACalendarLocalService,
		 WorkflowMetricsSLACalendarLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			WorkflowMetricsSLACalendarLocalService.class);

		ServiceTracker
			<WorkflowMetricsSLACalendarLocalService,
			 WorkflowMetricsSLACalendarLocalService> serviceTracker =
				new ServiceTracker
					<WorkflowMetricsSLACalendarLocalService,
					 WorkflowMetricsSLACalendarLocalService>(

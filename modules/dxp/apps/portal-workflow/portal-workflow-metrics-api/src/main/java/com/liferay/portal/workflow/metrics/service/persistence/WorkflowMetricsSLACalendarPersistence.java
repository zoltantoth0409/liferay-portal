 ...
 */
@ProviderType
public interface WorkflowMetricsSLACalendarPersistence extends BasePersistence<WorkflowMetricsSLACalendar> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	@Override
	public Map<Serializable, WorkflowMetricsSLACalendar> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<WorkflowMetricsSLACalendar> findByUuid(String uuid,
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<WorkflowMetricsSLACalendar> orderByComparator);
	...
	*/
	public java.util.List<WorkflowMetricsSLACalendar> findAll(int start, int end);
	...
	*/
	public java.util.List<WorkflowMetricsSLACalendar> findAll(int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<WorkflowMetricsSLACalendar> orderByComparator);

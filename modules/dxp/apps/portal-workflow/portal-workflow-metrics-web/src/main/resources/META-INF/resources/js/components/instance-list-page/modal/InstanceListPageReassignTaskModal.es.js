...
import {Table} from './ReassignTaskModalTable.es';
					...
					>
						...
						<ClayModal.Body>
							<PromisesResolver.Pending>
								<ReassignTaskModal.LoadingView />
							</PromisesResolver.Pending>

							<PromisesResolver.Rejected>
								<ReassignTaskModal.ErrorView
									onClick={() => {
										setRetry(() => true);
									}}
								/>
						...
						<ClayModal.Footer
							...
							last={
								<ClayButton onClick={() => nextButtonHandler()}>
...
ReassignTaskModal.ErrorView = ErrorView;
ReassignTaskModal.LoadingView = LoadingView;
ReassignTaskModal.Table = Table;

export {ReassignTaskModal};

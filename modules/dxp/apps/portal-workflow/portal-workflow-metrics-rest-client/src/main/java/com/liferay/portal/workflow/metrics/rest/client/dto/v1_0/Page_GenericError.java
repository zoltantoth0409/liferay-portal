 ...
 */
@Generated("")
public class Page_GenericError {

	public GenericError[] getItems() {
		return items;
	}

	public void setItems(GenericError[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<GenericError[], Exception> itemsUnsafeSupplier) {

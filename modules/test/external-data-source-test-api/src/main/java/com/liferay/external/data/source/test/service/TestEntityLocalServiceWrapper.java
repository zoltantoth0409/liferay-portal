...
public class TestEntityLocalServiceWrapper implements TestEntityLocalService,
	...
	*/
	@Override
	public com.liferay.external.data.source.test.model.TestEntity createTestEntity(
		long id) {
	...
	*/
	...
	@Override
	public com.liferay.external.data.source.test.model.TestEntity fetchTestEntity(
		long id) {
	...
	*/
	@Override
	public java.util.List<com.liferay.external.data.source.test.model.TestEntity> getTestEntities(
		int start, int end) {
	...
	*/
	@Override
	public com.liferay.external.data.source.test.model.TestEntity updateTestEntity(
		com.liferay.external.data.source.test.model.TestEntity testEntity) {

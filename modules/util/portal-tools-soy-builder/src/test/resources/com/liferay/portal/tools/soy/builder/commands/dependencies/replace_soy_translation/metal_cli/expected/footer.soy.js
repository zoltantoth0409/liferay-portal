Liferay.Loader.define(
	'hello-soy-web@1.0.4/Footer.soy',
	...
	function(exports, _Component2, _Soy) {
		...
		goog.loadModule(function(exports) {
			...
			function $render(opt_data, opt_ignored, opt_ijData) {
				/** @desc  */
				var MSG_EXTERNAL_2986127772961742460 = Liferay.Language.get(
					'this-portlet-was-written-using-soy-templates'
				);
				MSG_EXTERNAL_2986127772961742460 = MSG_EXTERNAL_2986127772961742460.replace(
					/{(\d+)}/g,
					'\x01$1\x01'
				);

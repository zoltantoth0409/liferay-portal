...
if (goog.DEBUG) {
	ddm.__deltemplate_s2_185c245a.soyTemplateName =
		'ddm.__deltemplate_s2_185c245a';
}
...
ddm.options = function(opt_data, opt_ignored) {
	return soydata.VERY_UNSAFE.ordainSanitizedHtml(
		'<div class="form-group' +
			...
			' liferay-ddm-form-field-options" data-fieldname="' +
			...
			'<input name="' +
			soy.$$escapeHtmlAttribute(opt_data.name) +
			'" type="hidden" /><div class="options"></div></div>'
	);
};
if (goog.DEBUG) {

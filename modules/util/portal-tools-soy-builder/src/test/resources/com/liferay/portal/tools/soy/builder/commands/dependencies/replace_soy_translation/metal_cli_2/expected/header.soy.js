Liferay.Loader.define(
	'hello-soy-web@1.0.4/Header.soy',
	...
	function(exports, _component, _Soy) {
		...
		goog.loadModule(function(exports) {
			...
			function $render(opt_data, opt_ignored, opt_ijData) {
				...
				ie_open('p');
				/** @desc  */
				var MSG_EXTERNAL_4961493287620807008 = Liferay.Language.get(
					'welcome-to-x'
				);
				MSG_EXTERNAL_4961493287620807008 = MSG_EXTERNAL_4961493287620807008.replace(
					/{(\d+)}/g,
					'\x01$1\x01'
				);
				var lastIndex_11 = 0,
				...
				do {
					match_11 =
						partRe_11.exec(MSG_EXTERNAL_4961493287620807008) ||
						undefined;
					itext(
						goog.string.unescapeEntities(
							MSG_EXTERNAL_4961493287620807008.substring(
								lastIndex_11,
								match_11 && match_11.index
							)
						)
					);
					...
					switch (match_11 && match_11[0]) {
						case '\x010\x01':
							...
							if (typeof dyn0 == 'function') dyn0();
							else if (dyn0 != null) itext(dyn0);
							break;
					}
				} while (match_11);
				ie_close('p');

	...
	function(exports, _Component2, _Soy) {
		...
		goog.loadModule(function(exports) {
			...
			function $render(opt_data, opt_ignored, opt_ijData) {
				/** @desc  */
				var MSG_EXTERNAL_7241381614077301826 = Liferay.Language.get(
					'here-you-will-find-how-easy-it-is-to-do-things-like'
				);
				MSG_EXTERNAL_7241381614077301826 = MSG_EXTERNAL_7241381614077301826.replace(
					/{(\d+)}/g,
					'\x01$1\x01'
				);
				var msg_s144 = MSG_EXTERNAL_7241381614077301826;
				/** @desc  */
				var MSG_EXTERNAL_52703005167531630 = Liferay.Language.get(
					'listing-pages'
				);
				MSG_EXTERNAL_52703005167531630 = MSG_EXTERNAL_52703005167531630.replace(
					/{(\d+)}/g,
					'\x01$1\x01'
				);
				var msg_s146 = MSG_EXTERNAL_52703005167531630;
				/** @desc  */
				var MSG_EXTERNAL_7891216484594141556 = Liferay.Language.get(
					'navigate-to'
				);
				MSG_EXTERNAL_7891216484594141556 = MSG_EXTERNAL_7891216484594141556.replace(
					/{(\d+)}/g,
					'\x01$1\x01'
				);
				var msg_s148 = MSG_EXTERNAL_7891216484594141556;
				/** @desc  */
				var MSG_EXTERNAL_9050153343882765023 = Liferay.Language.get(
					'navigating-between-views'
				);
				MSG_EXTERNAL_9050153343882765023 = MSG_EXTERNAL_9050153343882765023.replace(
					/{(\d+)}/g,
					'\x01$1\x01'
				);
				var msg_s150 = MSG_EXTERNAL_9050153343882765023;
				/** @desc  */
				var MSG_EXTERNAL_7202372830797071859 = Liferay.Language.get(
					'click-here-to-navigate-to-another-view'
				);
				MSG_EXTERNAL_7202372830797071859 = MSG_EXTERNAL_7202372830797071859.replace(
					/{(\d+)}/g,
					'\x01$1\x01'
				);
				...
				for (
					...
					itext(
						(goog.asserts.assert(
							layoutData60.nameCurrentValue != null
						),
						layoutData60.nameCurrentValue)
					);
					ie_close('a');
				}
				ie_close('div');

Liferay.Loader.define(
	'hello-soy-web@1.0.4/View.soy',
	['exports', 'metal-component/src/all/component', 'metal-soy/src/Soy'],
	function(exports, _component, _Soy) {
		'use strict';
		...
		goog.loadModule(function(exports) {
			...
			function $render(opt_data, opt_ignored, opt_ijData) {
				...
				ie_open('p');
				/** @desc  */
				var MSG_EXTERNAL_7241381614077301826 = goog.getMsg(
					'here-you-will-find-how-easy-it-is-to-do-things-like'
				);
				itext(
					goog.string.unescapeEntities(
						MSG_EXTERNAL_7241381614077301826
					)
				);
				ie_close('p');
				ie_open('h3');
				/** @desc  */
				var MSG_EXTERNAL_52703005167531630 = goog.getMsg(
					'listing-pages'
				);
				itext(
					goog.string.unescapeEntities(MSG_EXTERNAL_52703005167531630)
				);
				ie_close('h3');
				ie_open('div', null, null, 'class', 'list-group');
				ie_open('div', null, null, 'class', 'list-group-heading');
				/** @desc  */
				var MSG_EXTERNAL_7891216484594141556 = goog.getMsg(
					'navigate-to'
				);
				itext(
					goog.string.unescapeEntities(
						MSG_EXTERNAL_7891216484594141556
					)
				);
				ie_close('div');
				...
				for (
					...
					ie_open(
						...
						'list-group-item',
						'href',
						layoutData60.friendlyURL
					);
					var dyn1 = layoutData60.nameCurrentValue;
					if (typeof dyn1 == 'function') dyn1();
					else if (dyn1 != null) itext(dyn1);
					ie_close('a');
				}
				ie_close('div');
				ie_open('h3');
				/** @desc  */
				var MSG_EXTERNAL_9050153343882765023 = goog.getMsg(
					'navigating-between-views'
				);
				itext(
					goog.string.unescapeEntities(
						MSG_EXTERNAL_9050153343882765023
					)
				);
				ie_close('h3');
				ie_open('a', null, null, 'href', opt_data.navigationURL);
				/** @desc  */
				var MSG_EXTERNAL_7202372830797071859 = goog.getMsg(
					'click-here-to-navigate-to-another-view'
				);
				itext(
					goog.string.unescapeEntities(
						MSG_EXTERNAL_7202372830797071859
					)
				);
				ie_close('a');
		...
		var View = (function(_Component) {
			...
			function View() {
				...
				return _possibleConstructorReturn(
					this,
					(View.__proto__ || Object.getPrototypeOf(View)).apply(
						this,
						arguments
					)
				);

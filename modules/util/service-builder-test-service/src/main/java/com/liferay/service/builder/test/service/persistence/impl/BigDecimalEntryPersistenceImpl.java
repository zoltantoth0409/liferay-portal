...
import com.liferay.service.builder.test.model.impl.BigDecimalEntryImpl;
import com.liferay.service.builder.test.model.impl.BigDecimalEntryModelImpl;
 ...
 * @see com.liferay.service.builder.test.service.persistence.BigDecimalEntryUtil
 * @generated
 */
@ProviderType
public class BigDecimalEntryPersistenceImpl extends BasePersistenceImpl<BigDecimalEntry>
	...
	private static final String _FINDER_COLUMN_GTBIGDECIMALVALUE_BIGDECIMALVALUE_2 =
		"bigDecimalEntry.bigDecimalValue > ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_LTDECIMALVALUE =
		new FinderPath(BigDecimalEntryModelImpl.ENTITY_CACHE_ENABLED,
			BigDecimalEntryModelImpl.FINDER_CACHE_ENABLED,
			BigDecimalEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByLtDecimalValue",
			new String[] {
				BigDecimal.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_LTDECIMALVALUE =
		new FinderPath(BigDecimalEntryModelImpl.ENTITY_CACHE_ENABLED,
			BigDecimalEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByLtDecimalValue",
			new String[] { BigDecimal.class.getName() });
	 ...
	 */
	@Override
	public List<BigDecimalEntry> findByLtDecimalValue(
		BigDecimal bigDecimalValue) {
		return findByLtDecimalValue(bigDecimalValue, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<BigDecimalEntry> findByLtDecimalValue(
		BigDecimal bigDecimalValue, int start, int end) {
		return findByLtDecimalValue(bigDecimalValue, start, end, null);
	}
	...
	public List<BigDecimalEntry> findByLtDecimalValue(
		BigDecimal bigDecimalValue, int start, int end,
		OrderByComparator<BigDecimalEntry> orderByComparator) {
		return findByLtDecimalValue(bigDecimalValue, start, end,
			orderByComparator, true);
	}
	...
	public List<BigDecimalEntry> findByLtDecimalValue(
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_LTDECIMALVALUE;
		finderArgs = new Object[] { bigDecimalValue, start, end, orderByComparator };
		...
		if (list == null) {
			...
			if (bigDecimalValue == null) {
				query.append(_FINDER_COLUMN_LTDECIMALVALUE_BIGDECIMALVALUE_1);
			}
			else {
				bindBigDecimalValue = true;

				query.append(_FINDER_COLUMN_LTDECIMALVALUE_BIGDECIMALVALUE_2);
			}
	 ...
	 */
	@Override
	public BigDecimalEntry findByLtDecimalValue_First(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator)
		throws NoSuchBigDecimalEntryException {
		BigDecimalEntry bigDecimalEntry = fetchByLtDecimalValue_First(bigDecimalValue,
				orderByComparator);
	 ...
	 */
	@Override
	public BigDecimalEntry fetchByLtDecimalValue_First(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator) {
		List<BigDecimalEntry> list = findByLtDecimalValue(bigDecimalValue, 0,
				1, orderByComparator);
	 ...
	 */
	@Override
	public BigDecimalEntry findByLtDecimalValue_Last(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator)
		throws NoSuchBigDecimalEntryException {
		BigDecimalEntry bigDecimalEntry = fetchByLtDecimalValue_Last(bigDecimalValue,
				orderByComparator);
	 ...
	 */
	@Override
	public BigDecimalEntry fetchByLtDecimalValue_Last(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator) {
		int count = countByLtDecimalValue(bigDecimalValue);

		if (count == 0) {
			return null;
		}

		List<BigDecimalEntry> list = findByLtDecimalValue(bigDecimalValue,
				count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public BigDecimalEntry[] findByLtDecimalValue_PrevAndNext(
		long bigDecimalEntryId, BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator)
		throws NoSuchBigDecimalEntryException {
		BigDecimalEntry bigDecimalEntry = findByPrimaryKey(bigDecimalEntryId);
		...
		try {
			...
			array[0] = getByLtDecimalValue_PrevAndNext(session,
					bigDecimalEntry, bigDecimalValue, orderByComparator, true);

			array[1] = bigDecimalEntry;

			array[2] = getByLtDecimalValue_PrevAndNext(session,
					bigDecimalEntry, bigDecimalValue, orderByComparator, false);
	...
	protected BigDecimalEntry getByLtDecimalValue_PrevAndNext(Session session,
		BigDecimalEntry bigDecimalEntry, BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByLtDecimalValue(BigDecimal bigDecimalValue) {
		for (BigDecimalEntry bigDecimalEntry : findByLtDecimalValue(
				bigDecimalValue, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(bigDecimalEntry);
		}
	}
	 ...
	 */
	@Override
	public int countByLtDecimalValue(BigDecimal bigDecimalValue) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_LTDECIMALVALUE;
	...
	private static final String _FINDER_COLUMN_LTDECIMALVALUE_BIGDECIMALVALUE_1 = "bigDecimalEntry.bigDecimalValue IS NULL";
	private static final String _FINDER_COLUMN_LTDECIMALVALUE_BIGDECIMALVALUE_2 = "bigDecimalEntry.bigDecimalValue < ?";

 ...
 * @author Hugo Huijser
 */
public class EnumConstantOrderCheck extends BaseCheck {
	...
	protected void doVisitToken(DetailAST detailAST) {
		DetailAST nextEnumConstantDefAST = _getNextEnumConstantDefAST(
			detailAST);
	...
	private DetailAST _getNextEnumConstantDefAST(DetailAST enumConstantDefAST) {

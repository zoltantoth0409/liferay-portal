...
[DefaultComesLastCheck](https://checkstyle.sourceforge.io/config_coding.html#DefaultComesLast) | Styling | Check that the default is after all the cases in a switch statement. |
...
[JavadocStyleCheck](https://checkstyle.sourceforge.io/config_javadoc.html#JavadocStyle) | Styling | Validates Javadoc comments to help ensure they are well formed. |
...
[MissingDeprecatedCheck](https://checkstyle.sourceforge.io/config_annotation.html#MissingDeprecated) | Styling | Verifies that the annotation @Deprecated and the Javadoc tag @deprecated are both present when either of them is present. |

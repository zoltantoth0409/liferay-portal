...
package com.liferay.service.builder.test.service.persistence;
...
import com.liferay.service.builder.test.model.BigDecimalEntry;
 ...
 * @see com.liferay.service.builder.test.service.persistence.impl.BigDecimalEntryPersistenceImpl
 * @generated
 */
@ProviderType
public class BigDecimalEntryUtil {
	...
	*/
	public static BigDecimalEntry findByBigDecimalValue_First(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator)
		throws com.liferay.service.builder.test.exception.NoSuchBigDecimalEntryException {
		return getPersistence()
	...
	* @return the matching big decimal entries
	*/
	public static List<BigDecimalEntry> findByLtDecimalValue(
		BigDecimal bigDecimalValue) {
		return getPersistence().findByLtDecimalValue(bigDecimalValue);
	}
	...
	*/
	public static List<BigDecimalEntry> findByLtDecimalValue(
		BigDecimal bigDecimalValue, int start, int end) {
		return getPersistence().findByLtDecimalValue(bigDecimalValue, start, end);
	}
	...
	*/
	public static List<BigDecimalEntry> findByLtDecimalValue(
		...
		OrderByComparator<BigDecimalEntry> orderByComparator) {
		return getPersistence()
				   .findByLtDecimalValue(bigDecimalValue, start, end,
			orderByComparator);
	}
	...
	* @throws NoSuchBigDecimalEntryException if a matching big decimal entry could not be found
	*/
	public static BigDecimalEntry findByLtDecimalValue_First(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator)
		throws com.liferay.service.builder.test.exception.NoSuchBigDecimalEntryException {
		return getPersistence()
				   .findByLtDecimalValue_First(bigDecimalValue,
			orderByComparator);
	}
	...
	* @return the first matching big decimal entry, or <code>null</code> if a matching big decimal entry could not be found
	*/
	public static BigDecimalEntry fetchByLtDecimalValue_First(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator) {
		return getPersistence()
				   .fetchByLtDecimalValue_First(bigDecimalValue,
			orderByComparator);
	}
	...
	* @throws NoSuchBigDecimalEntryException if a matching big decimal entry could not be found
	*/
	public static BigDecimalEntry findByLtDecimalValue_Last(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator)
		throws com.liferay.service.builder.test.exception.NoSuchBigDecimalEntryException {
		return getPersistence()
				   .findByLtDecimalValue_Last(bigDecimalValue, orderByComparator);
	}
	...
	* @return the last matching big decimal entry, or <code>null</code> if a matching big decimal entry could not be found
	*/
	public static BigDecimalEntry fetchByLtDecimalValue_Last(
		BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator) {
		return getPersistence()
				   .fetchByLtDecimalValue_Last(bigDecimalValue,
			orderByComparator);
	}
	...
	* @throws NoSuchBigDecimalEntryException if a big decimal entry with the primary key could not be found
	*/
	public static BigDecimalEntry[] findByLtDecimalValue_PrevAndNext(
		long bigDecimalEntryId, BigDecimal bigDecimalValue,
		OrderByComparator<BigDecimalEntry> orderByComparator)
		throws com.liferay.service.builder.test.exception.NoSuchBigDecimalEntryException {
		return getPersistence()
				   .findByLtDecimalValue_PrevAndNext(bigDecimalEntryId,
			bigDecimalValue, orderByComparator);
	}
	...
	* @param bigDecimalValue the big decimal value
	*/
	public static void removeByLtDecimalValue(BigDecimal bigDecimalValue) {
		getPersistence().removeByLtDecimalValue(bigDecimalValue);
	}
	...
	* @return the number of matching big decimal entries
	*/
	public static int countByLtDecimalValue(BigDecimal bigDecimalValue) {
		return getPersistence().countByLtDecimalValue(bigDecimalValue);
	}

 ...
 * @see com.liferay.portal.tools.service.builder.test.service.persistence.impl.VersionedEntryVersionPersistenceImpl
 * @see VersionedEntryVersionUtil
 * @generated
 */
@ProviderType
public interface VersionedEntryVersionPersistence extends BasePersistence<VersionedEntryVersion> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<VersionedEntryVersion> findByVersionedEntryId(
		long versionedEntryId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<VersionedEntryVersion> orderByComparator);

...
public class DSLQueryEntryUtil {
	...
	private static ServiceTracker
		<DSLQueryEntryPersistence, DSLQueryEntryPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(DSLQueryEntryPersistence.class);

		ServiceTracker<DSLQueryEntryPersistence, DSLQueryEntryPersistence>
			serviceTracker =
				new ServiceTracker
					<DSLQueryEntryPersistence, DSLQueryEntryPersistence>(
						bundle.getBundleContext(),
						DSLQueryEntryPersistence.class, null);

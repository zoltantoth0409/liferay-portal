 ...
 * @see com.liferay.portal.tools.service.builder.test.service.persistence.impl.LocalizedEntryLocalizationPersistenceImpl
 * @see LocalizedEntryLocalizationUtil
 * @generated
 */
@ProviderType
public interface LocalizedEntryLocalizationPersistence extends BasePersistence<LocalizedEntryLocalization> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<LocalizedEntryLocalization> findByLocalizedEntryId(
		long localizedEntryId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<LocalizedEntryLocalization> orderByComparator);
	...
	*/
	public java.util.List<LocalizedEntryLocalization> findAll(int start, int end);
	...
	*/
	public java.util.List<LocalizedEntryLocalization> findAll(int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<LocalizedEntryLocalization> orderByComparator);

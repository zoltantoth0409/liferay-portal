...
/**
 * The persistence utility for the versioned entry version service. This utility wraps {@link com.liferay.portal.tools.service.builder.test.service.persistence.impl.VersionedEntryVersionPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class VersionedEntryVersionUtil {
	...
	*/
	public static VersionedEntryVersion findByVersionedEntryId_First(
		long versionedEntryId,
		OrderByComparator<VersionedEntryVersion> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchVersionedEntryVersionException {
		return getPersistence()
	...
	*/
	public static VersionedEntryVersion[] findByVersionedEntryId_PrevAndNext(
		...
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchVersionedEntryVersionException {
		return getPersistence()
				   .findByVersionedEntryId_PrevAndNext(versionedEntryVersionId,
	...
	* @throws NoSuchVersionedEntryVersionException if a matching versioned entry version could not be found
	*/
	public static VersionedEntryVersion findByGroupId_First(long groupId,
		OrderByComparator<VersionedEntryVersion> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchVersionedEntryVersionException {
	...
	* @return the first matching versioned entry version, or <code>null</code> if a matching versioned entry version could not be found
	*/
	public static VersionedEntryVersion fetchByGroupId_First(long groupId,
		OrderByComparator<VersionedEntryVersion> orderByComparator) {
	...
	* @throws NoSuchVersionedEntryVersionException if a matching versioned entry version could not be found
	*/
	public static VersionedEntryVersion findByGroupId_Last(long groupId,
		OrderByComparator<VersionedEntryVersion> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchVersionedEntryVersionException {
	...
	* @return the last matching versioned entry version, or <code>null</code> if a matching versioned entry version could not be found
	*/
	public static VersionedEntryVersion fetchByGroupId_Last(long groupId,
		OrderByComparator<VersionedEntryVersion> orderByComparator) {
	...
	*/
	public static VersionedEntryVersion[] findByGroupId_PrevAndNext(
		...
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchVersionedEntryVersionException {
		return getPersistence()
				   .findByGroupId_PrevAndNext(versionedEntryVersionId, groupId,
			orderByComparator);
	}
	...
	*/
	public static VersionedEntryVersion[] findByGroupId_Version_PrevAndNext(
		...
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchVersionedEntryVersionException {
		return getPersistence()
				   .findByGroupId_Version_PrevAndNext(versionedEntryVersionId,
	...
	*/
	public static void cacheResult(VersionedEntryVersion versionedEntryVersion) {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, VersionedEntryVersion> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<VersionedEntryVersionPersistence, VersionedEntryVersionPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(VersionedEntryVersionPersistence.class);

		ServiceTracker<VersionedEntryVersionPersistence, VersionedEntryVersionPersistence> serviceTracker =
			new ServiceTracker<VersionedEntryVersionPersistence, VersionedEntryVersionPersistence>(bundle.getBundleContext(),

 ...
 */
public class NoSuchFinderWhereClauseEntryException extends NoSuchModelException {
	...
	public NoSuchFinderWhereClauseEntryException(String msg, Throwable throwable) {
		super(msg, throwable);
	}

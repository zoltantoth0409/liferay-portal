...
public class LVEntryLocalizationVersionUtil {
	...
	*/
	public static LVEntryLocalizationVersion[] findByLvEntryId_PrevAndNext(
		...
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLVEntryLocalizationVersionException {
		return getPersistence()
				   .findByLvEntryId_PrevAndNext(lvEntryLocalizationVersionId,
	...
	*/
	public static List<LVEntryLocalizationVersion> findByLvEntryId_Version(
		...
		return getPersistence()
				   .findByLvEntryId_Version(lvEntryId, version, start, end);
	}
	...
	*/
	public static LVEntryLocalizationVersion findByLvEntryId_Version_First(
		...
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLVEntryLocalizationVersionException {
		return getPersistence()
				   .findByLvEntryId_Version_First(lvEntryId, version,
			orderByComparator);
	}
	...
	*/
	public static LVEntryLocalizationVersion fetchByLvEntryId_Version_First(
		...
		OrderByComparator<LVEntryLocalizationVersion> orderByComparator) {
		return getPersistence()
				   .fetchByLvEntryId_Version_First(lvEntryId, version,
			orderByComparator);
	}
	...
	*/
	public static LVEntryLocalizationVersion findByLvEntryId_Version_Last(
		...
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLVEntryLocalizationVersionException {
		return getPersistence()
				   .findByLvEntryId_Version_Last(lvEntryId, version,
			orderByComparator);
	}
	...
	*/
	public static LVEntryLocalizationVersion fetchByLvEntryId_Version_Last(
		...
		OrderByComparator<LVEntryLocalizationVersion> orderByComparator) {
		return getPersistence()
				   .fetchByLvEntryId_Version_Last(lvEntryId, version,
			orderByComparator);
	}
	...
	* @throws NoSuchLVEntryLocalizationVersionException if a lv entry localization version with the primary key could not be found
	*/
	public static LVEntryLocalizationVersion[] findByLvEntryId_Version_PrevAndNext(
		long lvEntryLocalizationVersionId, long lvEntryId, int version,
		OrderByComparator<LVEntryLocalizationVersion> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLVEntryLocalizationVersionException {
		return getPersistence()
				   .findByLvEntryId_Version_PrevAndNext(lvEntryLocalizationVersionId,
	...
	*/
	public static List<LVEntryLocalizationVersion> findByLvEntryId_LanguageId(
		...
		return getPersistence()
				   .findByLvEntryId_LanguageId(lvEntryId, languageId, start, end);
	}
	...
	*/
	public static List<LVEntryLocalizationVersion> findByLvEntryId_LanguageId(
		...
		OrderByComparator<LVEntryLocalizationVersion> orderByComparator) {
		return getPersistence()
				   .findByLvEntryId_LanguageId(lvEntryId, languageId, start,
			end, orderByComparator);
	}
	...
	*/
	public static LVEntryLocalizationVersion findByLvEntryId_LanguageId_First(
		...
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLVEntryLocalizationVersionException {
		return getPersistence()
				   .findByLvEntryId_LanguageId_First(lvEntryId, languageId,
			orderByComparator);
	}
	...
	*/
	public static LVEntryLocalizationVersion fetchByLvEntryId_LanguageId_First(
		...
		OrderByComparator<LVEntryLocalizationVersion> orderByComparator) {
		return getPersistence()
				   .fetchByLvEntryId_LanguageId_First(lvEntryId, languageId,
			orderByComparator);
	}
	...
	*/
	public static LVEntryLocalizationVersion findByLvEntryId_LanguageId_Last(
		...
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLVEntryLocalizationVersionException {
		return getPersistence()
				   .findByLvEntryId_LanguageId_Last(lvEntryId, languageId,
			orderByComparator);
	}
	...
	*/
	public static LVEntryLocalizationVersion fetchByLvEntryId_LanguageId_Last(
		...
		OrderByComparator<LVEntryLocalizationVersion> orderByComparator) {
		return getPersistence()
				   .fetchByLvEntryId_LanguageId_Last(lvEntryId, languageId,
			orderByComparator);
	}
	...
	* @throws NoSuchLVEntryLocalizationVersionException if a lv entry localization version with the primary key could not be found
	*/
	public static LVEntryLocalizationVersion[] findByLvEntryId_LanguageId_PrevAndNext(
		long lvEntryLocalizationVersionId, long lvEntryId, String languageId,
		OrderByComparator<LVEntryLocalizationVersion> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLVEntryLocalizationVersionException {
		return getPersistence()
				   .findByLvEntryId_LanguageId_PrevAndNext(lvEntryLocalizationVersionId,
	...
	* @param languageId the language ID
	*/
	public static void removeByLvEntryId_LanguageId(long lvEntryId,
		String languageId) {
	...
	*/
	public static LVEntryLocalizationVersion findByLvEntryId_LanguageId_Version(
		...
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLVEntryLocalizationVersionException {
		return getPersistence()
				   .findByLvEntryId_LanguageId_Version(lvEntryId, languageId,
			version);
	}
	...
	* @return the matching lv entry localization version, or <code>null</code> if a matching lv entry localization version could not be found
	*/
	public static LVEntryLocalizationVersion fetchByLvEntryId_LanguageId_Version(
		long lvEntryId, String languageId, int version) {
		return getPersistence()
				   .fetchByLvEntryId_LanguageId_Version(lvEntryId, languageId,
			version);
	}
	...
	* @return the lv entry localization version that was removed
	*/
	public static LVEntryLocalizationVersion removeByLvEntryId_LanguageId_Version(
		long lvEntryId, String languageId, int version)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchLVEntryLocalizationVersionException {
		return getPersistence()
				   .removeByLvEntryId_LanguageId_Version(lvEntryId, languageId,
			version);
	}
	...
	* @return the number of matching lv entry localization versions
	*/
	public static int countByLvEntryId_LanguageId_Version(long lvEntryId,
		String languageId, int version) {
		return getPersistence()
				   .countByLvEntryId_LanguageId_Version(lvEntryId, languageId,
			version);
	}

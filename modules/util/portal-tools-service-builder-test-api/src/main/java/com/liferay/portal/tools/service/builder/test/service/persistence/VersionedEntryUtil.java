...
/**
 * The persistence utility for the versioned entry service. This utility wraps {@link com.liferay.portal.tools.service.builder.test.service.persistence.impl.VersionedEntryPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.liferay.portal.tools.service.builder.test.service.persistence.impl.VersionedEntryPersistenceImpl
 * @generated
 */
@ProviderType
public class VersionedEntryUtil {
	...
	*/
	public static List<VersionedEntry> findByGroupId(long groupId, int start,
		int end) {
	...
	*/
	public static List<VersionedEntry> findByGroupId(long groupId, int start,
		int end, OrderByComparator<VersionedEntry> orderByComparator) {
		return getPersistence()
	...
	*/
	public static VersionedEntry findByGroupId_First(long groupId,
		OrderByComparator<VersionedEntry> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchVersionedEntryException {
	...
	*/
	public static VersionedEntry fetchByGroupId_First(long groupId,
		OrderByComparator<VersionedEntry> orderByComparator) {
	...
	* @throws NoSuchVersionedEntryException if a matching versioned entry could not be found
	*/
	public static VersionedEntry findByGroupId_Last(long groupId,
		OrderByComparator<VersionedEntry> orderByComparator)
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchVersionedEntryException {
	...
	*/
	public static VersionedEntry fetchByGroupId_Last(long groupId,
		OrderByComparator<VersionedEntry> orderByComparator) {
	...
	*/
	public static VersionedEntry[] findByGroupId_PrevAndNext(
		...
		throws com.liferay.portal.tools.service.builder.test.exception.NoSuchVersionedEntryException {
		return getPersistence()
				   .findByGroupId_PrevAndNext(versionedEntryId, groupId,
			orderByComparator);
	}
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, VersionedEntry> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<VersionedEntryPersistence, VersionedEntryPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(VersionedEntryPersistence.class);

		ServiceTracker<VersionedEntryPersistence, VersionedEntryPersistence> serviceTracker =
			new ServiceTracker<VersionedEntryPersistence, VersionedEntryPersistence>(bundle.getBundleContext(),

...
public class FooLocalServiceWrapper
	 ...
	 */
	@Override
	public com.example.sample.model.Foo addFoo(
	 ...
	 */
	@Override
	public java.util.List<com.example.sample.model.Foo> getFoos(
		int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<com.example.sample.model.Foo>

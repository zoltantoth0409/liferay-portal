...
public class ProjectTemplatesFreemarkerPortletNameTest
	...
	public ProjectTemplatesFreemarkerPortletNameTest(String liferayVersion) {
		_liferayVersion = liferayVersion;
	}

	@Test
	public void testBuildTemplateFreemarkerPortletName() throws Exception {
		File gradleProjectDir = testBuildTemplatePortlet(
			temporaryFolder, "freemarker-portlet", "portlet", "portlet",

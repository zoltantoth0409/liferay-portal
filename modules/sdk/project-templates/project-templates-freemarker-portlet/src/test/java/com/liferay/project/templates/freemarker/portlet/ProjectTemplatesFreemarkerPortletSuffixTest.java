...
public class ProjectTemplatesFreemarkerPortletSuffixTest
	...
	public ProjectTemplatesFreemarkerPortletSuffixTest(String liferayVersion) {
		_liferayVersion = liferayVersion;
	}

	@Test
	public void testBuildTemplateFreemarkerPortletSuffix() throws Exception {
		File gradleProjectDir = testBuildTemplatePortlet(
			temporaryFolder, "freemarker-portlet", "portlet-portlet", "portlet",
		...
		testContains(
			...
			"public class PortletPortlet extends FreeMarkerPortlet {");
	}

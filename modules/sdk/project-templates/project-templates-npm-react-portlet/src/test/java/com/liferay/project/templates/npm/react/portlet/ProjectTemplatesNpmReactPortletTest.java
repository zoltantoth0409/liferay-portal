...
public class ProjectTemplatesNpmReactPortletTest implements BaseProjectTemplatesTestCase{
	@ClassRule
	...
	@Parameterized.Parameters(
		...
		public ProjectTemplatesNpmReactPortletTest(String name, String packageName, String className, String liferayVersion) {

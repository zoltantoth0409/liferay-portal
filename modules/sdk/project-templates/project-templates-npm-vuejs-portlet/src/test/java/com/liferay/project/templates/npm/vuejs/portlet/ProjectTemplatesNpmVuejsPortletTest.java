...
public class ProjectTemplatesNpmVuejsPortletTest implements BaseProjectTemplatesTestCase{
	@ClassRule
	...
	@Parameterized.Parameters(
		...
		public ProjectTemplatesNpmVuejsPortletTest(String name, String packageName, String className, String liferayVersion) {

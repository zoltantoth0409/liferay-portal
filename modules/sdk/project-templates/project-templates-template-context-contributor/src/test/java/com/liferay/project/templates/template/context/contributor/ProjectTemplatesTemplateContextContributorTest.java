...
public class ProjectTemplatesTemplateContextContributorTest implements BaseProjectTemplatesTestCase{
	@ClassRule
	...
	public void testBuildTemplateTemplateContextContributor() throws Exception {
		...
		File mavenWorkspaceDir =
			...
			File mavenProjectDir = buildTemplateWithMaven(mavenModulesDir, mavenModulesDir, template, name, "com.test", mavenExecutor, "-DclassName=BladeTest", "-Dpackage=blade.test", "-DliferayVersion=" + _liferayVersion);

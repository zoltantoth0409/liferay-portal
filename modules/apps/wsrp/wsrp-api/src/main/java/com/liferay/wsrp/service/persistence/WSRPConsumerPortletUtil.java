...
public class WSRPConsumerPortletUtil {
	 ...
	 */
	public static Map<Serializable, WSRPConsumerPortlet> fetchByPrimaryKeys(
	 ...
	 */
	public static WSRPConsumerPortlet findByUuid_First(
			String uuid,
			OrderByComparator<WSRPConsumerPortlet> orderByComparator)
	 ...
	 */
	public static WSRPConsumerPortlet fetchByUuid_First(
	 ...
	 * @throws NoSuchConsumerPortletException if a matching wsrp consumer portlet could not be found
	 */
	public static WSRPConsumerPortlet findByUuid_Last(
			String uuid,
			OrderByComparator<WSRPConsumerPortlet> orderByComparator)
		throws com.liferay.wsrp.exception.NoSuchConsumerPortletException {
	 ...
	 */
	public static WSRPConsumerPortlet fetchByUuid_Last(
		String uuid, OrderByComparator<WSRPConsumerPortlet> orderByComparator) {
	...
	public static WSRPConsumerPortlet[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			wsrpConsumerPortletId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchConsumerPortletException if a matching wsrp consumer portlet could not be found
	 */
	public static WSRPConsumerPortlet findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<WSRPConsumerPortlet> orderByComparator)
		throws com.liferay.wsrp.exception.NoSuchConsumerPortletException {
	...
	public static WSRPConsumerPortlet[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			wsrpConsumerPortletId, uuid, companyId, orderByComparator);
	}
	...
	public static WSRPConsumerPortlet findByWsrpConsumerId_First(
		...
		return getPersistence().findByWsrpConsumerId_First(
	...
	public static WSRPConsumerPortlet fetchByWsrpConsumerId_First(
		...
		return getPersistence().fetchByWsrpConsumerId_First(
			wsrpConsumerId, orderByComparator);
	}
	...
	public static WSRPConsumerPortlet findByWsrpConsumerId_Last(
		...
		return getPersistence().findByWsrpConsumerId_Last(
			wsrpConsumerId, orderByComparator);
	}
	...
	public static WSRPConsumerPortlet fetchByWsrpConsumerId_Last(
		...
		return getPersistence().fetchByWsrpConsumerId_Last(
			wsrpConsumerId, orderByComparator);
	}
	...
	public static WSRPConsumerPortlet[] findByWsrpConsumerId_PrevAndNext(
		...
		return getPersistence().findByWsrpConsumerId_PrevAndNext(
			wsrpConsumerPortletId, wsrpConsumerId, orderByComparator);
	}
	 ...
	 * @throws NoSuchConsumerPortletException if a matching wsrp consumer portlet could not be found
	 */
	public static WSRPConsumerPortlet findByW_P(
	 ...
	 */
	public static WSRPConsumerPortlet removeByW_P(
			long wsrpConsumerId, String portletHandle)
		throws com.liferay.wsrp.exception.NoSuchConsumerPortletException {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			WSRPConsumerPortletPersistence.class);

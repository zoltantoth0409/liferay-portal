...
public class WSRPConsumerLocalServiceUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<WSRPConsumerLocalService, WSRPConsumerLocalService> serviceTracker =
			new ServiceTracker<WSRPConsumerLocalService, WSRPConsumerLocalService>(bundle.getBundleContext(),

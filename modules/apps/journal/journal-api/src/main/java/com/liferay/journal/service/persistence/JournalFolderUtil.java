...
public class JournalFolderUtil {
	 ...
	 * @return the matching journal folders
	 */
	public static List<JournalFolder> findByCTCollectionId(
		long ctCollectionId) {
	 ...
	 * @throws NoSuchFolderException if a matching journal folder could not be found
	 */
	public static JournalFolder findByCTCollectionId_First(
			long ctCollectionId,
			OrderByComparator<JournalFolder> orderByComparator)
		throws com.liferay.journal.exception.NoSuchFolderException {
	 ...
	 * @return the first matching journal folder, or <code>null</code> if a matching journal folder could not be found
	 */
	public static JournalFolder fetchByCTCollectionId_First(
		long ctCollectionId,
		OrderByComparator<JournalFolder> orderByComparator) {
	 ...
	 * @throws NoSuchFolderException if a matching journal folder could not be found
	 */
	public static JournalFolder findByCTCollectionId_Last(
			long ctCollectionId,
			OrderByComparator<JournalFolder> orderByComparator)
		throws com.liferay.journal.exception.NoSuchFolderException {
	 ...
	 * @return the last matching journal folder, or <code>null</code> if a matching journal folder could not be found
	 */
	public static JournalFolder fetchByCTCollectionId_Last(
		long ctCollectionId,
		OrderByComparator<JournalFolder> orderByComparator) {
	 ...
	 * @throws NoSuchFolderException if a journal folder with the primary key could not be found
	 */
	public static JournalFolder[] findByCTCollectionId_PrevAndNext(
			long folderId, long ctCollectionId,
			OrderByComparator<JournalFolder> orderByComparator)
		throws com.liferay.journal.exception.NoSuchFolderException {

		return getPersistence().findByCTCollectionId_PrevAndNext(
			folderId, ctCollectionId, orderByComparator);
	}

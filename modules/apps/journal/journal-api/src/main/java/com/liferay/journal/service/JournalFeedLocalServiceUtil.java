...
public class JournalFeedLocalServiceUtil {
	...
	*/
	@Deprecated
	public static void addFeedResources(
		com.liferay.journal.model.JournalFeed feed, String[] groupPermissions,
	...
	*/
	...
	public static int searchCount(long companyId, long groupId, String feedId,
	...
	*/
	...
	static {
		...
		ServiceTracker<JournalFeedLocalService, JournalFeedLocalService> serviceTracker =
			new ServiceTracker<JournalFeedLocalService, JournalFeedLocalService>(bundle.getBundleContext(),

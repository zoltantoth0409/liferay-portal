...
public class JournalFolderPersistenceImpl extends BasePersistenceImpl<JournalFolder>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	private final FinderPath _finderPathWithPaginationFindAll = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findAll", new String[0]);
	private final FinderPath _finderPathWithoutPaginationFindAll = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findAll", new String[0]);
	private final FinderPath _finderPathCountAll = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll", new String[0]);
	private final FinderPath _finderPathWithPaginationFindByUuid = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByUuid",
			new String[] {
	...
	private final FinderPath _finderPathWithoutPaginationFindByUuid = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	...
	private final FinderPath _finderPathCountByUuid = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	private final FinderPath _finderPathFetchByUUID_G = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() },
			JournalFolderModelImpl.UUID_COLUMN_BITMASK |
			JournalFolderModelImpl.GROUPID_COLUMN_BITMASK);
	private final FinderPath _finderPathCountByUUID_G = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	private final FinderPath _finderPathWithPaginationFindByUuid_C = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByUuid_C",
			new String[] {
	...
	private final FinderPath _finderPathWithoutPaginationFindByUuid_C = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByUuid_C",
			new String[] { String.class.getName(), Long.class.getName() },
			...
			JournalFolderModelImpl.PARENTFOLDERID_COLUMN_BITMASK |
			JournalFolderModelImpl.NAME_COLUMN_BITMASK);
	private final FinderPath _finderPathCountByUuid_C = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	private final FinderPath _finderPathWithPaginationFindByGroupId = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByGroupId",
			new String[] {
	...
	private final FinderPath _finderPathWithoutPaginationFindByGroupId = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			...
			JournalFolderModelImpl.PARENTFOLDERID_COLUMN_BITMASK |
			JournalFolderModelImpl.NAME_COLUMN_BITMASK);
	private final FinderPath _finderPathCountByGroupId = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	private final FinderPath _finderPathWithPaginationFindByCompanyId = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByCompanyId",
			new String[] {
	...
	private final FinderPath _finderPathWithoutPaginationFindByCompanyId = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			...
			JournalFolderModelImpl.PARENTFOLDERID_COLUMN_BITMASK |
			JournalFolderModelImpl.NAME_COLUMN_BITMASK);
	private final FinderPath _finderPathCountByCompanyId = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	private final FinderPath _finderPathWithPaginationFindByG_P = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_P",
			new String[] {
	...
	private final FinderPath _finderPathWithoutPaginationFindByG_P = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByG_P",
			...
			JournalFolderModelImpl.PARENTFOLDERID_COLUMN_BITMASK |
			JournalFolderModelImpl.NAME_COLUMN_BITMASK);
	private final FinderPath _finderPathCountByG_P = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	private final FinderPath _finderPathFetchByG_N = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByG_N",
			new String[] { Long.class.getName(), String.class.getName() },
			JournalFolderModelImpl.GROUPID_COLUMN_BITMASK |
			JournalFolderModelImpl.NAME_COLUMN_BITMASK);
	private final FinderPath _finderPathCountByG_N = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	private final FinderPath _finderPathWithPaginationFindByC_NotS = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_NotS",
			new String[] {
	...
	private final FinderPath _finderPathWithPaginationCountByC_NotS = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	private final FinderPath _finderPathFetchByG_P_N = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			...
			JournalFolderModelImpl.PARENTFOLDERID_COLUMN_BITMASK |
			JournalFolderModelImpl.NAME_COLUMN_BITMASK);
	private final FinderPath _finderPathCountByG_P_N = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	private final FinderPath _finderPathWithPaginationFindByG_P_S = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_P_S",
			new String[] {
	...
	private final FinderPath _finderPathWithoutPaginationFindByG_P_S = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByG_P_S",
			new String[] {
			...
			JournalFolderModelImpl.NAME_COLUMN_BITMASK);
	private final FinderPath _finderPathCountByG_P_S = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	private final FinderPath _finderPathWithPaginationFindByG_P_NotS = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_P_NotS",
			new String[] {
	...
	private final FinderPath _finderPathWithPaginationCountByG_P_NotS = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	private final FinderPath _finderPathWithPaginationFindByF_C_P_NotS = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED,
			JournalFolderImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByF_C_P_NotS",
			new String[] {
	...
	private final FinderPath _finderPathWithPaginationCountByF_C_P_NotS = new FinderPath(JournalFolderModelImpl.ENTITY_CACHE_ENABLED,
			JournalFolderModelImpl.FINDER_CACHE_ENABLED, Long.class,

...
<liferay-ui:error exception="<%= XLIFFFileException.MustHaveCorrectEncoding.class %>" message="the-translation-file-have-incorrect-encoding.the-supported-encoding-format-is-utf-8" />

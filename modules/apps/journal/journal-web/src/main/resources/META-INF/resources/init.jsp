...
page import="com.liferay.journal.web.internal.display.context.JournalEditStructuresDisplayContext" %><%@
...
page import="com.liferay.journal.web.internal.display.context.JournalStructuresDisplayContext" %><%@

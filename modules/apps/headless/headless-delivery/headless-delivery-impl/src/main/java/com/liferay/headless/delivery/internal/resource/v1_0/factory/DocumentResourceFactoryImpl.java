...
public class DocumentResourceFactoryImpl implements DocumentResource.Factory {
	...
	@Override
	public DocumentResource.Builder create() {
		return new DocumentResource.Builder() {
			...
			public DocumentResource build() {
				...
				return (DocumentResource)ProxyUtil.newProxyInstance(
					DocumentResource.class.getClassLoader(),
					new Class<?>[] {DocumentResource.class},
			...
			@Override
			public DocumentResource.Builder checkPermissions(
			...
			@Override
			public DocumentResource.Builder httpServletRequest(
			...
			@Override
			public DocumentResource.Builder user(User user) {
				_user = user;
	...
	private Object _invoke(
		...
		documentResource.setContextAcceptLanguage(new AcceptLanguageImpl(user));
		...
		try {
			...
			_componentServiceObjects.ungetService(documentResource);
	...
	private ComponentServiceObjects<DocumentResource> _componentServiceObjects;

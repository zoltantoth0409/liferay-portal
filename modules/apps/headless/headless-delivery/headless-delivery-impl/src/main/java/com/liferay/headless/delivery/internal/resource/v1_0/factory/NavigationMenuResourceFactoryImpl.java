...
public class NavigationMenuResourceFactoryImpl
	...
	@Override
	public NavigationMenuResource.Builder create() {
		return new NavigationMenuResource.Builder() {
			...
			public NavigationMenuResource build() {
				...
				return (NavigationMenuResource)ProxyUtil.newProxyInstance(
					NavigationMenuResource.class.getClassLoader(),
					new Class<?>[] {NavigationMenuResource.class},
			...
			@Override
			public NavigationMenuResource.Builder checkPermissions(
			...
			@Override
			public NavigationMenuResource.Builder httpServletRequest(
			...
			@Override
			public NavigationMenuResource.Builder preferredLocale(
			...
			@Override
			public NavigationMenuResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		NavigationMenuResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		NavigationMenuResource.FactoryHolder.factory = null;
	}
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(navigationMenuResource);

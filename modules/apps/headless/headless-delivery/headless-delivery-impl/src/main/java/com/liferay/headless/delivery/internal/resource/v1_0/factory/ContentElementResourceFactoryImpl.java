...
public class ContentElementResourceFactoryImpl
	...
	@Override
	public ContentElementResource.Builder create() {
		return new ContentElementResource.Builder() {
			...
			public ContentElementResource build() {
				...
				return (ContentElementResource)ProxyUtil.newProxyInstance(
					ContentElementResource.class.getClassLoader(),
					new Class<?>[] {ContentElementResource.class},
			...
			@Override
			public ContentElementResource.Builder checkPermissions(
			...
			@Override
			public ContentElementResource.Builder httpServletRequest(
			...
			@Override
			public ContentElementResource.Builder preferredLocale(
			...
			@Override
			public ContentElementResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		ContentElementResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		ContentElementResource.FactoryHolder.factory = null;
	}
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(contentElementResource);

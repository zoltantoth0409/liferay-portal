...
public class ContentStructureResourceFactoryImpl
	...
	@Override
	public ContentStructureResource.Builder create() {
		return new ContentStructureResource.Builder() {
			...
			public ContentStructureResource build() {
				...
				return (ContentStructureResource)ProxyUtil.newProxyInstance(
					ContentStructureResource.class.getClassLoader(),
					new Class<?>[] {ContentStructureResource.class},
			...
			@Override
			public ContentStructureResource.Builder checkPermissions(
			...
			@Override
			public ContentStructureResource.Builder httpServletRequest(
			...
			@Override
			public ContentStructureResource.Builder preferredLocale(
			...
			@Override
			public ContentStructureResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		ContentStructureResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		ContentStructureResource.FactoryHolder.factory = null;
	}
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(contentStructureResource);

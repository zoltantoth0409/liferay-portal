...
public class ContentTemplateResourceFactoryImpl
	...
	@Override
	public ContentTemplateResource.Builder create() {
		return new ContentTemplateResource.Builder() {
			...
			public ContentTemplateResource build() {
				...
				return (ContentTemplateResource)ProxyUtil.newProxyInstance(
					ContentTemplateResource.class.getClassLoader(),
					new Class<?>[] {ContentTemplateResource.class},
			...
			@Override
			public ContentTemplateResource.Builder checkPermissions(
			...
			@Override
			public ContentTemplateResource.Builder httpServletRequest(
			...
			@Override
			public ContentTemplateResource.Builder preferredLocale(
			...
			@Override
			public ContentTemplateResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		ContentTemplateResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		ContentTemplateResource.FactoryHolder.factory = null;
	}
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(contentTemplateResource);

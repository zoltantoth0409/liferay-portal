 ...
 */
@Generated("")
public class Page_ContentSetElement {

	public ContentSetElement[] getItems() {
		return items;
	}

	public void setItems(ContentSetElement[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<ContentSetElement[], Exception> itemsUnsafeSupplier) {
	...
	protected ContentSetElement[] items;

 ...
 */
@Generated("")
public class MessageBoardMessage_Page {

	public MessageBoardMessage[] getItems() {
		return items;
	}

	public void setItems(MessageBoardMessage[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<MessageBoardMessage[], Exception> itemsUnsafeSupplier) {
	...
	protected MessageBoardMessage[] items;

 ...
 */
@Generated("")
public class BlogPostingImage_Page {

	public BlogPostingImage[] getItems() {
		return items;
	}

	public void setItems(BlogPostingImage[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<BlogPostingImage[], Exception> itemsUnsafeSupplier) {
	...
	protected BlogPostingImage[] items;

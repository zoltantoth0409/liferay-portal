 ...
 */
@Generated("")
public class Page_ContentStructure {

	public ContentStructure[] getItems() {
		return items;
	}

	public void setItems(ContentStructure[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<ContentStructure[], Exception> itemsUnsafeSupplier) {
	...
	protected ContentStructure[] items;

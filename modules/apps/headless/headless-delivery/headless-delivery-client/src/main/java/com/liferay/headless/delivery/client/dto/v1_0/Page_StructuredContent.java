 ...
 */
@Generated("")
public class Page_StructuredContent {

	public StructuredContent[] getItems() {
		return items;
	}

	public void setItems(StructuredContent[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<StructuredContent[], Exception> itemsUnsafeSupplier) {
	...
	protected StructuredContent[] items;

 ...
 */
@Generated("")
public class Page_StructuredContentLink {

	public StructuredContentLink[] getItems() {
		return items;
	}

	public void setItems(StructuredContentLink[] items) {
		this.items = items;
	}
	...
	protected StructuredContentLink[] items;

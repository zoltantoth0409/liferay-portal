 ...
 */
@Generated("")
public class Page_KnowledgeBaseFolder {

	public KnowledgeBaseFolder[] getItems() {
		return items;
	}

	public void setItems(KnowledgeBaseFolder[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<KnowledgeBaseFolder[], Exception> itemsUnsafeSupplier) {
	...
	protected KnowledgeBaseFolder[] items;

 ...
 */
@Generated("")
public class Page_KnowledgeBaseAttachment {

	public KnowledgeBaseAttachment[] getItems() {
		return items;
	}

	public void setItems(KnowledgeBaseAttachment[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<KnowledgeBaseAttachment[], Exception>
			itemsUnsafeSupplier) {
	...
	protected KnowledgeBaseAttachment[] items;

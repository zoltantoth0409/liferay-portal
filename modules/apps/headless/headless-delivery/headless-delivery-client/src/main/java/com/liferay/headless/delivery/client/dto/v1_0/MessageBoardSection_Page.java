 ...
 */
@Generated("")
public class MessageBoardSection_Page {

	public MessageBoardSection[] getItems() {
		return items;
	}

	public void setItems(MessageBoardSection[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<MessageBoardSection[], Exception> itemsUnsafeSupplier) {
	...
	protected MessageBoardSection[] items;

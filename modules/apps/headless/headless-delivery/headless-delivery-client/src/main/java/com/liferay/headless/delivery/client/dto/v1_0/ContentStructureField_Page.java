 ...
 */
@Generated("")
public class ContentStructureField_Page {

	public ContentStructureField[] getItems() {
		return items;
	}

	public void setItems(ContentStructureField[] items) {
		this.items = items;
	}
	...
	protected ContentStructureField[] items;

 ...
 */
@Generated("")
public class RenderedContent_Page {

	public RenderedContent[] getItems() {
		return items;
	}

	public void setItems(RenderedContent[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<RenderedContent[], Exception> itemsUnsafeSupplier) {
	...
	protected RenderedContent[] items;

 ...
 */
@Generated("")
public class Creator_Page {

	public Creator[] getItems() {
		return items;
	}

	public void setItems(Creator[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<Creator[], Exception> itemsUnsafeSupplier) {

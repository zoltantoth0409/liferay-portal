 ...
 */
@Generated("")
public class Page_BlogPosting {

	public BlogPosting[] getItems() {
		return items;
	}

	public void setItems(BlogPosting[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<BlogPosting[], Exception> itemsUnsafeSupplier) {

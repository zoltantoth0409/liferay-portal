 ...
 */
@Generated("")
public class ContentField_Page {

	public ContentField[] getItems() {
		return items;
	}

	public void setItems(ContentField[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<ContentField[], Exception> itemsUnsafeSupplier) {

 ...
 */
@Generated("")
public class ContentDocument_Page {

	public ContentDocument[] getItems() {
		return items;
	}

	public void setItems(ContentDocument[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<ContentDocument[], Exception> itemsUnsafeSupplier) {
	...
	protected ContentDocument[] items;

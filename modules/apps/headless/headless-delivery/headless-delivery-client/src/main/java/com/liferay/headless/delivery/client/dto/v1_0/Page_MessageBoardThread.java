 ...
 */
@Generated("")
public class Page_MessageBoardThread {

	public MessageBoardThread[] getItems() {
		return items;
	}

	public void setItems(MessageBoardThread[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<MessageBoardThread[], Exception> itemsUnsafeSupplier) {
	...
	protected MessageBoardThread[] items;

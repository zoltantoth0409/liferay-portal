...
public interface ExperienceResource {
	...
	public HttpInvoker.HttpResponse
			getSiteContentPageFriendlyUrlPathExperiencesPageHttpResponse(
				Long siteId, String friendlyUrlPath)
		throws Exception;
	...
	public static class Builder {
		...
		public ExperienceResource build() {
			return new ExperienceResourceImpl(this);
		}
	...
	public static class ExperienceResourceImpl implements ExperienceResource {
		...
		public Page<Experience>
			...
			try {
				return Page.of(content, ExperienceSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-delivery/v1.0/sites/{siteId}/content-pages/{friendlyUrlPath}/experiences");
		...
		private ExperienceResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ExperienceResource.class.getName());

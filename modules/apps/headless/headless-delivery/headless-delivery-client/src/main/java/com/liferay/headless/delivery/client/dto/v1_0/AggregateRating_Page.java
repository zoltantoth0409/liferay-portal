 ...
 */
@Generated("")
public class AggregateRating_Page {

	public AggregateRating[] getItems() {
		return items;
	}

	public void setItems(AggregateRating[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<AggregateRating[], Exception> itemsUnsafeSupplier) {
	...
	protected AggregateRating[] items;

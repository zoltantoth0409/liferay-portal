 ...
 */
@Generated("")
public class Page_StructuredContentFolder {

	public StructuredContentFolder[] getItems() {
		return items;
	}

	public void setItems(StructuredContentFolder[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<StructuredContentFolder[], Exception>
			itemsUnsafeSupplier) {
	...
	protected StructuredContentFolder[] items;

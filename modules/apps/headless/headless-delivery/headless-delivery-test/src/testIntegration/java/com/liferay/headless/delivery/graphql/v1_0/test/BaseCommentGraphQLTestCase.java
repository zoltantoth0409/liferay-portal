 ...
 */
@Generated("")
public abstract class BaseCommentGraphQLTestCase {
	...
	public void testGetComment() throws Exception {
		Comment comment = testComment_addComment();
		...
		Assert.assertTrue(
			equals(comment, dataJSONObject.getJSONObject("comment")));
	}
	...
	protected void assertEqualsIgnoringOrder(
		...
		for (Comment comment : comments) {
			...
			for (Object object : jsonArray) {
				if (equals(comment, (JSONObject)object)) {
					contains = true;
	...
	protected boolean equals(Comment comment, JSONObject jsonObject) {
	...
	protected Comment testComment_addComment() throws Exception {

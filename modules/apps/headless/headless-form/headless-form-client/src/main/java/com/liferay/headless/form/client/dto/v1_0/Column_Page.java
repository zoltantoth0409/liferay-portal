 ...
 */
@Generated("")
public class Column_Page {

	public Column[] getItems() {
		return items;
	}

	public void setItems(Column[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<Column[], Exception> itemsUnsafeSupplier) {

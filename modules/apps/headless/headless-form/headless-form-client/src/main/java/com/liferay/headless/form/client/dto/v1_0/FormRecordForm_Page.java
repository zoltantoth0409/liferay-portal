 ...
 */
@Generated("")
public class FormRecordForm_Page {

	public FormRecordForm[] getItems() {
		return items;
	}

	public void setItems(FormRecordForm[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<FormRecordForm[], Exception> itemsUnsafeSupplier) {
	...
	protected FormRecordForm[] items;

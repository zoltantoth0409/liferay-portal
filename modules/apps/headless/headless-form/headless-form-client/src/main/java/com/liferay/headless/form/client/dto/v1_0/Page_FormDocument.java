 ...
 */
@Generated("")
public class Page_FormDocument {

	public FormDocument[] getItems() {
		return items;
	}

	public void setItems(FormDocument[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<FormDocument[], Exception> itemsUnsafeSupplier) {

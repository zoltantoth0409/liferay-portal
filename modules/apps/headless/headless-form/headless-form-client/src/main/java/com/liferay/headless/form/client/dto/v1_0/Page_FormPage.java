 ...
 */
@Generated("")
public class Page_FormPage {

	public FormPage[] getItems() {
		return items;
	}

	public void setItems(FormPage[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<FormPage[], Exception> itemsUnsafeSupplier) {

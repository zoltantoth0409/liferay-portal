 ...
 */
@Generated("")
public class FormRecord_Page {

	public FormRecord[] getItems() {
		return items;
	}

	public void setItems(FormRecord[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<FormRecord[], Exception> itemsUnsafeSupplier) {

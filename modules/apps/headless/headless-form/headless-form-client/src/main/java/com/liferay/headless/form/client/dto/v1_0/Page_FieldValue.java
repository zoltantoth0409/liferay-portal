 ...
 */
@Generated("")
public class Page_FieldValue {

	public FieldValue[] getItems() {
		return items;
	}

	public void setItems(FieldValue[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<FieldValue[], Exception> itemsUnsafeSupplier) {

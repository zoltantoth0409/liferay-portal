 ...
 */
@Generated("")
public class FormStructure_Page {

	public FormStructure[] getItems() {
		return items;
	}

	public void setItems(FormStructure[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<FormStructure[], Exception> itemsUnsafeSupplier) {

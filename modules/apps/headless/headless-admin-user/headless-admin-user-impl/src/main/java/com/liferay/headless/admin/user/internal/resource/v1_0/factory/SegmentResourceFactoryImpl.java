...
public class SegmentResourceFactoryImpl implements SegmentResource.Factory {
	...
	public SegmentResource.Builder create() {
		return new SegmentResource.Builder() {
			...
			@Override
			public SegmentResource.Builder httpServletRequest(
	...
	private Object _invoke(
		...
		segmentResource.setContextAcceptLanguage(new AcceptLanguageImpl(user));

		Company company = _companyLocalService.getCompany(user.getCompanyId());

		segmentResource.setContextCompany(company);

		segmentResource.setContextHttpServletRequest(httpServletRequest);

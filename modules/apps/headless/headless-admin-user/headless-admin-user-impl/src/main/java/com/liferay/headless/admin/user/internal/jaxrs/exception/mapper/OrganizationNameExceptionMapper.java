...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.OrganizationNameException"
	},
	service = ExceptionMapper.class
)
public class OrganizationNameExceptionMapper
	extends BaseExceptionMapper<OrganizationNameException> {

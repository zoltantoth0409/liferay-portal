 ...
 */
@Generated("")
public abstract class BasePhoneGraphQLTestCase {
	...
	public void testGetPhone() throws Exception {
		Phone phone = testPhone_addPhone();
		...
		Assert.assertTrue(equals(phone, dataJSONObject.getJSONObject("phone")));
	}
	...
	protected void assertEqualsIgnoringOrder(
		...
		for (Phone phone : phones) {
			...
			for (Object object : jsonArray) {
				if (equals(phone, (JSONObject)object)) {
					contains = true;
	...
	protected boolean equals(Phone phone, JSONObject jsonObject) {

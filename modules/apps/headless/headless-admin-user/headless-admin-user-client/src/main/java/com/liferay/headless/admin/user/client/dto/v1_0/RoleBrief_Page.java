 ...
 */
@Generated("")
public class RoleBrief_Page {

	public RoleBrief[] getItems() {
		return items;
	}

	public void setItems(RoleBrief[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<RoleBrief[], Exception> itemsUnsafeSupplier) {

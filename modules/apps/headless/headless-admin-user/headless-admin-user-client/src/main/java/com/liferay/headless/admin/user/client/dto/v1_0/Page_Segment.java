 ...
 */
@Generated("")
public class Page_Segment {

	public Segment[] getItems() {
		return items;
	}

	public void setItems(Segment[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<Segment[], Exception> itemsUnsafeSupplier) {

 ...
 */
@Generated("")
public class Page_HoursAvailable {

	public HoursAvailable[] getItems() {
		return items;
	}

	public void setItems(HoursAvailable[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<HoursAvailable[], Exception> itemsUnsafeSupplier) {
	...
	protected HoursAvailable[] items;

 ...
 */
@Generated("")
public class Page_UserAccount {

	public UserAccount[] getItems() {
		return items;
	}

	public void setItems(UserAccount[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<UserAccount[], Exception> itemsUnsafeSupplier) {

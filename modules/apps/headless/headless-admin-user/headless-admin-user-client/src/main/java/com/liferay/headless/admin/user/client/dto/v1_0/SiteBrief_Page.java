 ...
 */
@Generated("")
public class SiteBrief_Page {

	public SiteBrief[] getItems() {
		return items;
	}

	public void setItems(SiteBrief[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<SiteBrief[], Exception> itemsUnsafeSupplier) {

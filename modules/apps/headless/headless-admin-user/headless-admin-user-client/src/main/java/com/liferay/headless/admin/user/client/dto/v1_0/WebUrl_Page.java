 ...
 */
@Generated("")
public class WebUrl_Page {

	public WebUrl[] getItems() {
		return items;
	}

	public void setItems(WebUrl[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<WebUrl[], Exception> itemsUnsafeSupplier) {

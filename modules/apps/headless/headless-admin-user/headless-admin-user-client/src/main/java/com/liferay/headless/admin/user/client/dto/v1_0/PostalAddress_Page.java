 ...
 */
@Generated("")
public class PostalAddress_Page {

	public PostalAddress[] getItems() {
		return items;
	}

	public void setItems(PostalAddress[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<PostalAddress[], Exception> itemsUnsafeSupplier) {

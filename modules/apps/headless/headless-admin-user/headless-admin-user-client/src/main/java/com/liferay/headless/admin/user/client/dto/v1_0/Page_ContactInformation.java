 ...
 */
@Generated("")
public class Page_ContactInformation {

	public ContactInformation[] getItems() {
		return items;
	}

	public void setItems(ContactInformation[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<ContactInformation[], Exception> itemsUnsafeSupplier) {
	...
	protected ContactInformation[] items;

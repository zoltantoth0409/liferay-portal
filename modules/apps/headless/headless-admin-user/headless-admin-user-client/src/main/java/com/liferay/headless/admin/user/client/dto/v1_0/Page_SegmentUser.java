 ...
 */
@Generated("")
public class Page_SegmentUser {

	public SegmentUser[] getItems() {
		return items;
	}

	public void setItems(SegmentUser[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<SegmentUser[], Exception> itemsUnsafeSupplier) {

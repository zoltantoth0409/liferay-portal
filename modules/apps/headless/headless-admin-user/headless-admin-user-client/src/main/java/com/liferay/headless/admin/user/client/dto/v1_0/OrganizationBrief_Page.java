 ...
 */
@Generated("")
public class OrganizationBrief_Page {

	public OrganizationBrief[] getItems() {
		return items;
	}

	public void setItems(OrganizationBrief[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<OrganizationBrief[], Exception> itemsUnsafeSupplier) {
	...
	protected OrganizationBrief[] items;

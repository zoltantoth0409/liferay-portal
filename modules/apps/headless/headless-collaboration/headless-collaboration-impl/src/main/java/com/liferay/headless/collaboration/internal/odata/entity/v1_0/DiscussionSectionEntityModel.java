 ...
 */
public class DiscussionSectionEntityModel implements EntityModel {

	public DiscussionSectionEntityModel() {
	...
	public String getName() {
		String name = DiscussionSectionEntityModel.class.getName();

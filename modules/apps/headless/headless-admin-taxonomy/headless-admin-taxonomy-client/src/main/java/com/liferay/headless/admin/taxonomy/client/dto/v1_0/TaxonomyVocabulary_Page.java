 ...
 */
@Generated("")
public class TaxonomyVocabulary_Page {

	public TaxonomyVocabulary[] getItems() {
		return items;
	}

	public void setItems(TaxonomyVocabulary[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<TaxonomyVocabulary[], Exception> itemsUnsafeSupplier) {
	...
	protected TaxonomyVocabulary[] items;

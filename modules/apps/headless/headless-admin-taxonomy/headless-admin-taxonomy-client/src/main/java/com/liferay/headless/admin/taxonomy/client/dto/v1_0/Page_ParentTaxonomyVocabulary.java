 ...
 */
@Generated("")
public class Page_ParentTaxonomyVocabulary {

	public ParentTaxonomyVocabulary[] getItems() {
		return items;
	}

	public void setItems(ParentTaxonomyVocabulary[] items) {
		this.items = items;
	}
	...
	protected ParentTaxonomyVocabulary[] items;

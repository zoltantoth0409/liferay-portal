 ...
 */
@Generated("")
public class AssetType_Page {

	public AssetType[] getItems() {
		return items;
	}

	public void setItems(AssetType[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<AssetType[], Exception> itemsUnsafeSupplier) {

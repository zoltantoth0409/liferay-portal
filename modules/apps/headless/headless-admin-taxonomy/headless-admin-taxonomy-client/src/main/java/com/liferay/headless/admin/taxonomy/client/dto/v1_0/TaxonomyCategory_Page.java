 ...
 */
@Generated("")
public class TaxonomyCategory_Page {

	public TaxonomyCategory[] getItems() {
		return items;
	}

	public void setItems(TaxonomyCategory[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<TaxonomyCategory[], Exception> itemsUnsafeSupplier) {
	...
	protected TaxonomyCategory[] items;

 ...
 */
@Generated("")
public class ParentTaxonomyCategory_Page {

	public ParentTaxonomyCategory[] getItems() {
		return items;
	}

	public void setItems(ParentTaxonomyCategory[] items) {
		this.items = items;
	}
	...
	protected ParentTaxonomyCategory[] items;

...
package com.liferay.headless.foundation.internal.query.v1_0;
...
public class Query {
	...
	@GraphQLField
	@GraphQLInvokeDetached
	public Collection<Vocabulary> getContentSpaceVocabulariesPage( @GraphQLName("content-space-id") Long contentSpaceId , @GraphQLName("per_page") int perPage , @GraphQLName("page") int page ) throws Exception {

		return _getVocabularyResource().getContentSpaceVocabulariesPage( contentSpaceId , Pagination.of(perPage, page) ).getItems();

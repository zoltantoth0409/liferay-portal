...
public interface PhoneResource {
	...
	public Page<Phone> getPhonesPage( @PathParam("generic-parent-id") Object genericParentId , @Context Company company , @Context Pagination pagination ) throws Exception;

	@GET
	@Path("/phones/{phones-id}")
	@Produces("application/json")
	@RequiresScope("headless-foundation-application.read")
	public Phone getPhone( @PathParam("phones-id") Long phonesId , @Context Company company ) throws Exception;

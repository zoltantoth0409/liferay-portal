 ...
 */
@Generated("")
public class WorkflowTaskAssignToUser_Page {

	public WorkflowTaskAssignToUser[] getItems() {
		return items;
	}

	public void setItems(WorkflowTaskAssignToUser[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<WorkflowTaskAssignToUser[], Exception>
			itemsUnsafeSupplier) {
	...
	protected WorkflowTaskAssignToUser[] items;

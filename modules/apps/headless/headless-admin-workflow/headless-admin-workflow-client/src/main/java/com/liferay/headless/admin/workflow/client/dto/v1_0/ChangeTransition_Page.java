 ...
 */
@Generated("")
public class ChangeTransition_Page {

	public ChangeTransition[] getItems() {
		return items;
	}

	public void setItems(ChangeTransition[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<ChangeTransition[], Exception> itemsUnsafeSupplier) {
	...
	protected ChangeTransition[] items;

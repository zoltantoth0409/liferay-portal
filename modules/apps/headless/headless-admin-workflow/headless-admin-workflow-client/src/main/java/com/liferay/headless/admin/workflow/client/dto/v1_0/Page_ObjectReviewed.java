 ...
 */
@Generated("")
public class Page_ObjectReviewed {

	public ObjectReviewed[] getItems() {
		return items;
	}

	public void setItems(ObjectReviewed[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<ObjectReviewed[], Exception> itemsUnsafeSupplier) {
	...
	protected ObjectReviewed[] items;

 ...
 */
@Generated("")
public class Page_WorkflowTaskAssignToMe {

	public WorkflowTaskAssignToMe[] getItems() {
		return items;
	}

	public void setItems(WorkflowTaskAssignToMe[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<WorkflowTaskAssignToMe[], Exception>
			itemsUnsafeSupplier) {
	...
	protected WorkflowTaskAssignToMe[] items;

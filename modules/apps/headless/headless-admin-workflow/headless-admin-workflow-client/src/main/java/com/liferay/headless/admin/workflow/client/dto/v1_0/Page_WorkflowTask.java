 ...
 */
@Generated("")
public class Page_WorkflowTask {

	public WorkflowTask[] getItems() {
		return items;
	}

	public void setItems(WorkflowTask[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<WorkflowTask[], Exception> itemsUnsafeSupplier) {

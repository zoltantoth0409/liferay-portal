 ...
 */
@Generated("")
public class Page_WorkflowLog {

	public WorkflowLog[] getItems() {
		return items;
	}

	public void setItems(WorkflowLog[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<WorkflowLog[], Exception> itemsUnsafeSupplier) {

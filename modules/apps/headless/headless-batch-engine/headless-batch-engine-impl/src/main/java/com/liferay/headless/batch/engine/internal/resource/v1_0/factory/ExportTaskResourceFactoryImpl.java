...
public class ExportTaskResourceFactoryImpl
	...
	@Override
	public ExportTaskResource.Builder create() {
		return new ExportTaskResource.Builder() {
			...
			@Override
			public ExportTaskResource.Builder checkPermissions(
			...
			@Override
			public ExportTaskResource.Builder httpServletRequest(
			...
			@Override
			public ExportTaskResource.Builder preferredLocale(
			...
			@Override
			public ExportTaskResource.Builder user(User user) {
				_user = user;
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(exportTaskResource);
	...
	private ComponentServiceObjects<ExportTaskResource>

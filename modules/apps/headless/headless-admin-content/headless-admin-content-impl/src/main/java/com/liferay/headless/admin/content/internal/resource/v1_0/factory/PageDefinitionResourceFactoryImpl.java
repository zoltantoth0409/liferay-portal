...
public class PageDefinitionResourceFactoryImpl
	...
	@Override
	public PageDefinitionResource.Builder create() {
		return new PageDefinitionResource.Builder() {
			...
			public PageDefinitionResource build() {
				...
				return (PageDefinitionResource)ProxyUtil.newProxyInstance(
					PageDefinitionResource.class.getClassLoader(),
					new Class<?>[] {PageDefinitionResource.class},
			...
			@Override
			public PageDefinitionResource.Builder checkPermissions(
			...
			@Override
			public PageDefinitionResource.Builder httpServletRequest(
			...
			@Override
			public PageDefinitionResource.Builder preferredLocale(
			...
			@Override
			public PageDefinitionResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		PageDefinitionResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		PageDefinitionResource.FactoryHolder.factory = null;
	}
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(pageDefinitionResource);

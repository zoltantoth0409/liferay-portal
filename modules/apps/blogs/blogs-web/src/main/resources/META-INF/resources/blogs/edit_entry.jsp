				...
				<aui:fieldset>
					...
					<div class="col-md-8 col-md-offset-2">
						<div class="entry-title form-group">
							...
							<aui:input autoSize="<%= true %>" cssClass="form-control-edit form-control-edit-title form-control-unstyled" label="" name="title" onChange="<%= onChangeTitle %>" placeholder="<%= LanguageUtil.get(request, "title") + StringPool.BLANK + \" *\" %>" required="<%= true %>" showRequiredLabel="<%= true %>" type="textarea" value="<%= HtmlUtil.escape(title) %>" />
						</div>

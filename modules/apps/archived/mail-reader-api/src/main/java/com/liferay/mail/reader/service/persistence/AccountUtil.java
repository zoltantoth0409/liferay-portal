...
public class AccountUtil {
	 ...
	 */
	public static Account findByUserId_First(
	 ...
	 */
	public static Account fetchByUserId_First(
		long userId, OrderByComparator<Account> orderByComparator) {
	 ...
	 * @throws NoSuchAccountException if a matching account could not be found
	 */
	public static Account findByUserId_Last(
			long userId, OrderByComparator<Account> orderByComparator)
		throws com.liferay.mail.reader.exception.NoSuchAccountException {
	 ...
	 */
	public static Account fetchByUserId_Last(
		long userId, OrderByComparator<Account> orderByComparator) {
	 ...
	 */
	public static Account[] findByUserId_PrevAndNext(
			long accountId, long userId,
			OrderByComparator<Account> orderByComparator)
		throws com.liferay.mail.reader.exception.NoSuchAccountException {

		return getPersistence().findByUserId_PrevAndNext(
			accountId, userId, orderByComparator);
	}

...
public class MDRRuleUtil {
	...
	private static ServiceTracker<MDRRulePersistence, MDRRulePersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(MDRRulePersistence.class);

		ServiceTracker<MDRRulePersistence, MDRRulePersistence> serviceTracker =
			new ServiceTracker<MDRRulePersistence, MDRRulePersistence>(
				bundle.getBundleContext(), MDRRulePersistence.class, null);

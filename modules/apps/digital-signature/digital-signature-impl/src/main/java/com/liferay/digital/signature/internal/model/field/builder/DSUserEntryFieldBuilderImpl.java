...
import com.liferay.digital.signature.internal.model.field.DSUserEntryFieldImpl;
import com.liferay.digital.signature.model.field.DSField;
import com.liferay.digital.signature.model.field.builder.DSUserEntryFieldBuilder;

/**
 * @author Michael C. Han
 */
public abstract class DSUserEntryFieldBuilderImpl<T extends DSField>
	extends DSStyledFieldBuilderImpl<T> implements DSUserEntryFieldBuilder<T> {

	public DSUserEntryFieldBuilderImpl(
	...
	protected void populateFields(
		DSUserEntryFieldImpl<T> dsUserEntryFieldImpl) {

		dsUserEntryFieldImpl.setConcealValue(_concealValue);
		dsUserEntryFieldImpl.setDisableAutoSize(_disableAutoSize);
		dsUserEntryFieldImpl.setMaxLength(_maxLength);
		dsUserEntryFieldImpl.setOriginalValue(_originalValue);
		dsUserEntryFieldImpl.setRequireInitialOnSharedChange(
			_requireInitialOnSharedChange);
		dsUserEntryFieldImpl.setValidationMessage(_validationMessage);
		dsUserEntryFieldImpl.setValidationRegex(_validationRegex);
		dsUserEntryFieldImpl.setValue(_value);

		super.populateFields(dsUserEntryFieldImpl);
	}

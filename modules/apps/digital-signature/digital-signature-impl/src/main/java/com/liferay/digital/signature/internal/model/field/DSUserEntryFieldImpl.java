...
import com.liferay.digital.signature.model.field.DSUserEntryField;

/**
 * @author Michael C. Han
 */
public abstract class DSUserEntryFieldImpl<T extends DSField>
	extends DSStyledFieldImpl<T> implements DSUserEntryField<T> {

	public DSUserEntryFieldImpl(

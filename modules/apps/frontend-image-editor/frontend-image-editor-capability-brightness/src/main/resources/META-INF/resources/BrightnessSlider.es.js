...
class BrightnessSlider extends Component {
	...
	/**
	 * Handles mouse down actions on the BrightnessSlider rail and updates the BrightnessSlider value accordingly.
	 * @param {!Event} event
	 * @protected
	 */
	...
	/**
	 * Synchronizes the BrightnessSlider UI with the `max` state key.
	...
	/**
	 * Synchronizes the BrightnessSlider UI with the `min` state key.
	 * @param {number} newVal The new value of the state key.
	 */
	...
	/**
	 * Updates the BrightnessSlider value based on the UI state of the handle element.
	...
	/**
	 * Handles Drag events from the rail handle and updates the BrightnessSlider value accordingly.
	 * @param {!Object} data
	 * @protected
	 */
...
Soy.register(BrightnessSlider, templates);

/**
 * `BrightnessSlider`'s state definition.
 */
...
BrightnessSlider.STATE = {
	...
	/**
	 * Defines the maximum value handled by the BrightnessSlider.
	 * @type {number}
	 * @default 100
	 */
	...
	/**
	 * Defines the minimum value handled by the BrightnessSlider.
	 * @type {number}
	 * @default 0
	 */
	...
	/**
	 * Defines the currently selected value on the BrightnessSlider.
	 * @type {number}
	 * @default 0
	 */

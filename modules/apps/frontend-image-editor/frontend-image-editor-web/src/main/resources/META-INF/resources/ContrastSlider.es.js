...
class ContrastSlider extends Component {
	...
	/**
	 * Handles mouse down actions on the ContrastSlider rail and updates the ContrastSlider value accordingly.
	 * @param {!Event} event
	 * @protected
	 */
	...
	/**
	 * Synchronizes the ContrastSlider UI with the `max` state key.
	...
	/**
	 * Synchronizes the ContrastSlider UI with the `min` state key.
	 * @param {number} newVal The new value of the state key.
	 */
	...
	/**
	 * Updates the ContrastSlider value based on the UI state of the handle element.
	...
	/**
	 * Handles Drag events from the rail handle and updates the ContrastSlider value accordingly.
	 * @param {!Object} data
	 * @protected
	 */
...
Soy.register(ContrastSlider, templates);

/**
 * `ContrastSlider`'s state definition.
 */
...
ContrastSlider.STATE = {
	...
	/**
	 * Defines the maximum value handled by the ContrastSlider.
	 * @type {number}
	 * @default 100
	 */
	...
	/**
	 * Defines the minimum value handled by the ContrastSlider.
	 * @type {number}
	 * @default 0
	 */
	...
	/**
	 * Defines the currently selected value on the ContrastSlider.
	 * @type {number}
	 * @default 0
	 */

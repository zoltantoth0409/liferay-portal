...
<clay:link buttonStyle="secondary" data="<%= data %>" elementClasses="btn-outline-borderless lfr-portal-tooltip" href="<%= socialBookmark.getPostURL(title, url) %>" icon="social-linkedin" label="" title="<%= socialBookmark.getName(locale) %>" />
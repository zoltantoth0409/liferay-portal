...
@Component(immediate = true, property =  {
	"model.class.name=" + MBUADConstants.CLASS_NAME_MB_CATEGORY}, service = UADEntityAggregator.class)
public class MBCategoryUADEntityAggregator
	extends DynamicQueryUADEntityAggregator<MBCategory> {
	@Override
	...
	@Override
	public MBCategory getEntity(Serializable entityId)
	...
	@Override
	protected List<MBCategory> doGetEntities(DynamicQuery dynamicQuery,
		int start, int end) {

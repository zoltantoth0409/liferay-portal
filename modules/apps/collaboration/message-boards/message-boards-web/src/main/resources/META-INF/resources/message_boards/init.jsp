...
page import="com.liferay.message.boards.model.MBCategoryDisplay" %><%@
...
page import="com.liferay.message.boards.model.impl.MBCategoryDisplayImpl" %><%@
page import="com.liferay.message.boards.model.impl.MBMessageImpl" %><%@

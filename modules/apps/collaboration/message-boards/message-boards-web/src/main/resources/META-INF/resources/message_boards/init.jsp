...
page import="com.liferay.message.boards.util.comparator.MBEntryModifiedDateComparator" %><%@
page import="com.liferay.message.boards.util.comparator.MBEntryTitleComparator" %><%@

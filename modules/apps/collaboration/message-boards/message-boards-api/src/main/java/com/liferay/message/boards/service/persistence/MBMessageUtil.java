...
/**
 * The persistence utility for the message-boards message service. This utility wraps {@link com.liferay.message.boards.service.persistence.impl.MBMessagePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class MBMessageUtil {
	...
	*/
	...
	private static ServiceTracker<MBMessagePersistence, MBMessagePersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(MBMessagePersistence.class);

		ServiceTracker<MBMessagePersistence, MBMessagePersistence> serviceTracker =
			new ServiceTracker<MBMessagePersistence, MBMessagePersistence>(bundle.getBundleContext(),
				MBMessagePersistence.class, null);

 ...
 * @see com.liferay.message.boards.service.persistence.impl.MBCategoryPersistenceImpl
 * @see MBCategoryUtil
 * @generated
 */
@ProviderType
public interface MBCategoryPersistence extends BasePersistence<MBCategory> {
	...
	* @return the matching message boards categories
	*/
	public java.util.List<MBCategory> findByG_P_NotS(long groupId,
		long parentCategoryId, int status);
	...
	* @return the matching message boards categories that the user has permission to view
	*/
	public java.util.List<MBCategory> filterFindByG_P_NotS(long groupId,
		long parentCategoryId, int status);

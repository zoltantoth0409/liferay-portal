...
public class MicroblogsEntryPersistenceImpl
	...
	public Map<Serializable, MicroblogsEntry> fetchByPrimaryKeys(
		...
		Map<Serializable, MicroblogsEntry> map =
			new HashMap<Serializable, MicroblogsEntry>();
	...
	private static final String _SQL_SELECT_MICROBLOGSENTRY_WHERE_PKS_IN =
		"SELECT microblogsEntry FROM MicroblogsEntry microblogsEntry WHERE microblogsEntryId IN (";

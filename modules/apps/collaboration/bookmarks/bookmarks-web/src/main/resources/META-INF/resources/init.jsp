...
page import="com.liferay.bookmarks.web.internal.security.permission.BookmarksEntryPermissionChecker" %><%@
page import="com.liferay.bookmarks.web.internal.security.permission.BookmarksFolderPermissionChecker" %><%@

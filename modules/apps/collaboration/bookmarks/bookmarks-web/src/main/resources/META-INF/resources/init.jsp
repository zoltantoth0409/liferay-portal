...
page import="com.liferay.bookmarks.web.internal.permission.BookmarksEntryPermissionChecker" %><%@
page import="com.liferay.bookmarks.web.internal.permission.BookmarksFolderPermissionChecker" %><%@

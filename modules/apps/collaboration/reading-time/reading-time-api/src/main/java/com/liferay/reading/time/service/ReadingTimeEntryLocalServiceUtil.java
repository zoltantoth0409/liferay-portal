 ...
 * {@link com.liferay.reading.time.service.impl.ReadingTimeEntryLocalServiceImpl} and is the
 ...
 * @see com.liferay.reading.time.service.base.ReadingTimeEntryLocalServiceBaseImpl
...
public class ReadingTimeEntryLocalServiceUtil {
	...
	*/
	public static com.liferay.reading.time.model.ReadingTimeEntry createReadingTimeEntry(
	...
	*/
	...
	public static com.liferay.reading.time.model.ReadingTimeEntry fetchReadingTimeEntry(
		long groupId, long classNameId, long classPK) {
		return getService().fetchReadingTimeEntry(groupId, classNameId, classPK);
	}
	...
	*/
	public static java.util.List<com.liferay.reading.time.model.ReadingTimeEntry> getReadingTimeEntries(
		int start, int end) {
	...
	* @throws PortalException if a reading time entry with the primary key could not be found
	*/
	public static com.liferay.reading.time.model.ReadingTimeEntry getReadingTimeEntry(
		long readingTimeEntryId)
		throws com.liferay.portal.kernel.exception.PortalException {

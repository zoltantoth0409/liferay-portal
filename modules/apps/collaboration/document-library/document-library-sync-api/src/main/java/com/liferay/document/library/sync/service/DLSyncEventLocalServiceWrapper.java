...
public class DLSyncEventLocalServiceWrapper implements DLSyncEventLocalService,
	...
	*/
	@Override
	public com.liferay.document.library.sync.model.DLSyncEvent createDLSyncEvent(
		long syncEventId) {
	...
	*/
	@Override
	public com.liferay.document.library.sync.model.DLSyncEvent deleteDLSyncEvent(
		com.liferay.document.library.sync.model.DLSyncEvent dlSyncEvent) {
	...
	*/
	@Override
	public java.util.List<com.liferay.document.library.sync.model.DLSyncEvent> getDLSyncEvents(
		int start, int end) {
	...
	*/
	...
	@Override
	public java.util.List<com.liferay.document.library.sync.model.DLSyncEvent> getLatestDLSyncEvents() {
	...
	*/
	@Override
	public com.liferay.document.library.sync.model.DLSyncEvent updateDLSyncEvent(
		com.liferay.document.library.sync.model.DLSyncEvent dlSyncEvent) {

...
page import="com.liferay.blogs.web.internal.security.permission.BlogsEntryPermission" %><%@
page import="com.liferay.blogs.web.internal.security.permission.BlogsPermission" %><%@

...
public class AssetListWebKeys {
	...
	public static final String ASSET_LIST_ITEMS_ACTION_DROPDOWN_ITEMS =
		"ASSET_LIST_ITEMS_ACTION_DROPDOWN_ITEMS";

	public static final String ASSET_LIST_ITEMS_DISPLAY_CONTEXT =
		"ASSET_LIST_ITEMS_DISPLAY_CONTEXT";

	public static final String ASSET_LIST_ITEMS_DROPDOWN_DEFAULT_EVENT_HANDLER =
		"ASSET_LIST_ITEMS_DROPDOWN_DEFAULT_EVENT_HANDLER";

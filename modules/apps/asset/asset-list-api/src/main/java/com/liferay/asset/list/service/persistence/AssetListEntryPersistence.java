...
public interface AssetListEntryPersistence extends BasePersistence<AssetListEntry> {
	...
	*/
	public java.util.List<AssetListEntry> findByUuid(String uuid, int start,
		int end);
	...
	* @return the matching asset list entries
	*/
	public java.util.List<AssetListEntry> findByUuid_C(String uuid,
		long companyId);
	...
	* @return the matching asset list entries
	*/
	public java.util.List<AssetListEntry> findByG_LikeT(long groupId,
		String title);
	...
	* @return the matching asset list entries that the user has permission to view
	*/
	public java.util.List<AssetListEntry> filterFindByG_LikeT(long groupId,
		String title);
	...
	* @return the matching asset list entries that the user has permission to view
	*/
	public java.util.List<AssetListEntry> filterFindByG_TY(long groupId,
		int type);

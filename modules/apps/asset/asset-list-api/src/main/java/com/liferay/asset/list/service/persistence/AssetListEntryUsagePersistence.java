 ...
 */
@ProviderType
public interface AssetListEntryUsagePersistence extends BasePersistence<AssetListEntryUsage> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	* @return the matching asset list entry usages
	*/
	public java.util.List<AssetListEntryUsage> findByUuid_C(String uuid,
		long companyId);

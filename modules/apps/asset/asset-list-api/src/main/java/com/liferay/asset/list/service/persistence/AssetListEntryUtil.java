...
public class AssetListEntryUtil {
	...
	*/
	public static AssetListEntry[] filterFindByGroupId_PrevAndNext(
		...
		throws com.liferay.asset.list.exception.NoSuchEntryException {
		return getPersistence()
				   .filterFindByGroupId_PrevAndNext(assetListEntryId, groupId,
			orderByComparator);
	}
	...
	* @return the range of matching asset list entries
	*/
	public static List<AssetListEntry> findByG_LikeT(long groupId,
	...
	* @throws NoSuchEntryException if a matching asset list entry could not be found
	*/
	public static AssetListEntry findByG_LikeT_First(long groupId,
	...
	* @return the first matching asset list entry, or <code>null</code> if a matching asset list entry could not be found
	*/
	public static AssetListEntry fetchByG_LikeT_First(long groupId,
		String title, OrderByComparator<AssetListEntry> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchEntryException if a matching asset list entry could not be found
	*/
	public static AssetListEntry findByG_LikeT_Last(long groupId, String title,
		OrderByComparator<AssetListEntry> orderByComparator)
		throws com.liferay.asset.list.exception.NoSuchEntryException {
		return getPersistence()
	...
	* @return the last matching asset list entry, or <code>null</code> if a matching asset list entry could not be found
	*/
	public static AssetListEntry fetchByG_LikeT_Last(long groupId,
		String title, OrderByComparator<AssetListEntry> orderByComparator) {
		return getPersistence()
	...
	*/
	public static AssetListEntry[] findByG_LikeT_PrevAndNext(
		...
		throws com.liferay.asset.list.exception.NoSuchEntryException {
		return getPersistence()
				   .findByG_LikeT_PrevAndNext(assetListEntryId, groupId, title,
			orderByComparator);
	}
	...
	* @return the matching asset list entries that the user has permission to view
	*/
	public static List<AssetListEntry> filterFindByG_LikeT(long groupId,
		String title) {
	...
	*/
	public static List<AssetListEntry> filterFindByG_LikeT(long groupId,
		...
		OrderByComparator<AssetListEntry> orderByComparator) {
		return getPersistence()
				   .filterFindByG_LikeT(groupId, title, start, end,
			orderByComparator);
	}
	...
	*/
	public static AssetListEntry[] filterFindByG_LikeT_PrevAndNext(
		...
		throws com.liferay.asset.list.exception.NoSuchEntryException {
		return getPersistence()
				   .filterFindByG_LikeT_PrevAndNext(assetListEntryId, groupId,
	...
	*/
	public static List<AssetListEntry> filterFindByG_TY(long groupId, int type,
		int start, int end, OrderByComparator<AssetListEntry> orderByComparator) {
		return getPersistence()
				   .filterFindByG_TY(groupId, type, start, end,
			orderByComparator);
	}
	...
	*/
	public static AssetListEntry[] filterFindByG_TY_PrevAndNext(
		...
		throws com.liferay.asset.list.exception.NoSuchEntryException {
		return getPersistence()
				   .filterFindByG_TY_PrevAndNext(assetListEntryId, groupId,

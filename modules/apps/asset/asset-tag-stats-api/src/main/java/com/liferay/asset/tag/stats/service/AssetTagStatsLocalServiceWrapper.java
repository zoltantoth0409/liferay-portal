...
public class AssetTagStatsLocalServiceWrapper
	...
	*/
	@Override
	public java.util.List<com.liferay.asset.tag.stats.model.AssetTagStats> getAssetTagStatses(
		int start, int end) {
	...
	*/
	@Override
	public java.util.List<com.liferay.asset.tag.stats.model.AssetTagStats> getTagStats(

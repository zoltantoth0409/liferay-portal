...
/**
 * Provides the information necessary to expose a WorkflowTask resources through a web API.
 * The resources are mapped from the internal model {@link WorkflowTask}.
 *
 * @author Sarai Díaz
 */
@Component

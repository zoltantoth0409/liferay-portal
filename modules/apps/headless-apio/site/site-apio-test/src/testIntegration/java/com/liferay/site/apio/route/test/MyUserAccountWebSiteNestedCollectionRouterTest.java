...
public class MyUserAccountWebSiteNestedCollectionRouterTest
	...
	@Inject(
		filter = "component.name=com.liferay.site.apio.internal.architect.router.MyUserAccountWebSiteNestedCollectionRouter"
	)

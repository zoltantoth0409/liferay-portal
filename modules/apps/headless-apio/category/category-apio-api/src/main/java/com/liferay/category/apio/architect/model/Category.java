...
package com.liferay.category.apio.architect.model;
 ...
 * com.liferay.asset.kernel.model.AssetCategory} exposed through the API.
 *
 * @author Rubén Pulido
 * @review
 */
public interface Category {
	...
	/**
	 * Returns the asset category's names map.
	 *

...
public class CalendarBookingPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(
			existingCalendarBooking.getResourceBlockId(),
	...
	protected OrderByComparator<CalendarBooking> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			true, "calendarId", true, "calendarResourceId", true,
			"parentCalendarBookingId", true, "vEventUid", true, "title", true,
			"location", true, "startTime", true, "endTime", true, "allDay",
			true, "recurrence", true, "firstReminder", true,

...
page import="com.liferay.calendar.web.internal.security.permission.CalendarPermission" %><%@
page import="com.liferay.calendar.web.internal.security.permission.CalendarPortletPermission" %><%@
page import="com.liferay.calendar.web.internal.security.permission.CalendarResourcePermission" %><%@

...
public class CalendarResourceLocalServiceUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(CalendarResourceLocalService.class);

		ServiceTracker<CalendarResourceLocalService, CalendarResourceLocalService> serviceTracker =
			new ServiceTracker<CalendarResourceLocalService, CalendarResourceLocalService>(bundle.getBundleContext(),

...
public class CalendarUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<CalendarPersistence, CalendarPersistence> serviceTracker = new ServiceTracker<CalendarPersistence, CalendarPersistence>(bundle.getBundleContext(),

...
public class CalendarUtil {
	 ...
	 */
	public static Calendar findByResourceBlockId_First(
	 ...
	 */
	public static Calendar fetchByResourceBlockId_First(
		long resourceBlockId, OrderByComparator<Calendar> orderByComparator) {
	 ...
	 * @throws NoSuchCalendarException if a matching calendar could not be found
	 */
	public static Calendar findByResourceBlockId_Last(
			long resourceBlockId, OrderByComparator<Calendar> orderByComparator)
		throws com.liferay.calendar.exception.NoSuchCalendarException {
	 ...
	 */
	public static Calendar fetchByResourceBlockId_Last(
		long resourceBlockId, OrderByComparator<Calendar> orderByComparator) {
	...
	public static Calendar[] findByResourceBlockId_PrevAndNext(
		...
		return getPersistence().findByResourceBlockId_PrevAndNext(
			calendarId, resourceBlockId, orderByComparator);
	}

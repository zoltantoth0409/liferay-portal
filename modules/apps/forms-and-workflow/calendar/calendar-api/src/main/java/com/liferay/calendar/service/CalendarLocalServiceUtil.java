...
public class CalendarLocalServiceUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<CalendarLocalService, CalendarLocalService> serviceTracker =
			new ServiceTracker<CalendarLocalService, CalendarLocalService>(bundle.getBundleContext(),

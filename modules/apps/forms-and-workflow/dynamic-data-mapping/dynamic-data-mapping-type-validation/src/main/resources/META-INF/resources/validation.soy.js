...
ddm.__deltemplate_s2_49e0bcef = function(opt_data, opt_ignored) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(ddm.validation(opt_data));
};
if (goog.DEBUG) {

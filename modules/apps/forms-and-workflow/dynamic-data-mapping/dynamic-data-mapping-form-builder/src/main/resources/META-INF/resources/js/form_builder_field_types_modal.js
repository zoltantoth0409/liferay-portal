AUI.add(
	...
	function(A) {
		...
		var FormBuilderFieldTypesModal = A.Component.create(
			{
				CSS_PREFIX: 'lfr-ddm-form-builder-field-types-modal',

				AUGMENTS: [Liferay.DDM.FormBuilderModalSupport],
		...
		Liferay.namespace('DDM').FormBuilderFieldTypesModal = FormBuilderFieldTypesModal;
	},
	'',
	{
		requires: ['aui-form-builder-field-types-modal', 'liferay-ddm-form-builder-modal-support']
	}
);
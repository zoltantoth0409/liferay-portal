...
public class DDMFormInstanceVersionPersistenceImpl extends BasePersistenceImpl<DDMFormInstanceVersion>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(DDMFormInstanceVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceVersionModelImpl.FINDER_CACHE_ENABLED,
			DDMFormInstanceVersionImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(DDMFormInstanceVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceVersionModelImpl.FINDER_CACHE_ENABLED,
			DDMFormInstanceVersionImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			DDMFormInstanceVersionModelImpl.UUID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(DDMFormInstanceVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DDMFormInstanceVersion> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<DDMFormInstanceVersion> findByUuid(String uuid, int start,
		int end) {
	...
	@Override
	public List<DDMFormInstanceVersion> findByUuid(String uuid, int start,
		int end, OrderByComparator<DDMFormInstanceVersion> orderByComparator) {
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (DDMFormInstanceVersion ddmFormInstanceVersion : list) {
					if (!Objects.equals(uuid, ddmFormInstanceVersion.getUuid())) {
						list = null;
	 ...
	 */
	@Override
	public DDMFormInstanceVersion findByUuid_First(String uuid,
		OrderByComparator<DDMFormInstanceVersion> orderByComparator)
		throws NoSuchFormInstanceVersionException {
		DDMFormInstanceVersion ddmFormInstanceVersion = fetchByUuid_First(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public DDMFormInstanceVersion fetchByUuid_First(String uuid,
		OrderByComparator<DDMFormInstanceVersion> orderByComparator) {
		List<DDMFormInstanceVersion> list = findByUuid(uuid, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public DDMFormInstanceVersion findByUuid_Last(String uuid,
		OrderByComparator<DDMFormInstanceVersion> orderByComparator)
		throws NoSuchFormInstanceVersionException {
		DDMFormInstanceVersion ddmFormInstanceVersion = fetchByUuid_Last(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public DDMFormInstanceVersion fetchByUuid_Last(String uuid,
		OrderByComparator<DDMFormInstanceVersion> orderByComparator) {
		...
		List<DDMFormInstanceVersion> list = findByUuid(uuid, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public DDMFormInstanceVersion[] findByUuid_PrevAndNext(
		long formInstanceVersionId, String uuid,
		OrderByComparator<DDMFormInstanceVersion> orderByComparator)
		throws NoSuchFormInstanceVersionException {
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session, ddmFormInstanceVersion,
					uuid, orderByComparator, true);

			array[1] = ddmFormInstanceVersion;

			array[2] = getByUuid_PrevAndNext(session, ddmFormInstanceVersion,
	...
	protected DDMFormInstanceVersion getByUuid_PrevAndNext(Session session,
		DDMFormInstanceVersion ddmFormInstanceVersion, String uuid,
		OrderByComparator<DDMFormInstanceVersion> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByUuid(String uuid) {
		for (DDMFormInstanceVersion ddmFormInstanceVersion : findByUuid(uuid,
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "ddmFormInstanceVersion.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "ddmFormInstanceVersion.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(ddmFormInstanceVersion.uuid IS NULL OR ddmFormInstanceVersion.uuid = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(DDMFormInstanceVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceVersionModelImpl.FINDER_CACHE_ENABLED,
			DDMFormInstanceVersionImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() },
			DDMFormInstanceVersionModelImpl.UUID_COLUMN_BITMASK |
			DDMFormInstanceVersionModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_G = new FinderPath(DDMFormInstanceVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public DDMFormInstanceVersion findByUUID_G(String uuid, long groupId)
		throws NoSuchFormInstanceVersionException {
		DDMFormInstanceVersion ddmFormInstanceVersion = fetchByUUID_G(uuid,
				groupId);
	 ...
	 */
	@Override
	public DDMFormInstanceVersion fetchByUUID_G(String uuid, long groupId) {
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((ddmFormInstanceVersion.getUuid() == null) ||
							!ddmFormInstanceVersion.getUuid().equals(uuid) ||
							(ddmFormInstanceVersion.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
	 ...
	 */
	@Override
	public DDMFormInstanceVersion removeByUUID_G(String uuid, long groupId)
		throws NoSuchFormInstanceVersionException {
		DDMFormInstanceVersion ddmFormInstanceVersion = findByUUID_G(uuid,
				groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1 = "ddmFormInstanceVersion.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 = "ddmFormInstanceVersion.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(ddmFormInstanceVersion.uuid IS NULL OR ddmFormInstanceVersion.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 = "ddmFormInstanceVersion.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(DDMFormInstanceVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceVersionModelImpl.FINDER_CACHE_ENABLED,
			DDMFormInstanceVersionImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(DDMFormInstanceVersionModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { String.class.getName(), Long.class.getName() },
			DDMFormInstanceVersionModelImpl.UUID_COLUMN_BITMASK |
			DDMFormInstanceVersionModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(DDMFormInstanceVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DDMFormInstanceVersion> findByUuid_C(String uuid, long companyId) {
	 ...
	 */
	@Override
	public List<DDMFormInstanceVersion> findByUuid_C(String uuid,
	 ...
	 */
	@Override
	public DDMFormInstanceVersion findByUuid_C_First(String uuid,
		long companyId,
		OrderByComparator<DDMFormInstanceVersion> orderByComparator)
		throws NoSuchFormInstanceVersionException {
		DDMFormInstanceVersion ddmFormInstanceVersion = fetchByUuid_C_First(uuid,
	 ...
	 */
	@Override
	public DDMFormInstanceVersion fetchByUuid_C_First(String uuid,
		long companyId,
		OrderByComparator<DDMFormInstanceVersion> orderByComparator) {
		List<DDMFormInstanceVersion> list = findByUuid_C(uuid, companyId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public DDMFormInstanceVersion findByUuid_C_Last(String uuid,
		long companyId,
		OrderByComparator<DDMFormInstanceVersion> orderByComparator)
		throws NoSuchFormInstanceVersionException {
		DDMFormInstanceVersion ddmFormInstanceVersion = fetchByUuid_C_Last(uuid,
				companyId, orderByComparator);
	 ...
	 */
	@Override
	public DDMFormInstanceVersion fetchByUuid_C_Last(String uuid,
		long companyId,
		OrderByComparator<DDMFormInstanceVersion> orderByComparator) {
		...
		List<DDMFormInstanceVersion> list = findByUuid_C(uuid, companyId,
	 ...
	 */
	@Override
	public DDMFormInstanceVersion[] findByUuid_C_PrevAndNext(
		long formInstanceVersionId, String uuid, long companyId,
		OrderByComparator<DDMFormInstanceVersion> orderByComparator)
		throws NoSuchFormInstanceVersionException {
		DDMFormInstanceVersion ddmFormInstanceVersion = findByPrimaryKey(formInstanceVersionId);
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session, ddmFormInstanceVersion,
					uuid, companyId, orderByComparator, true);

			array[1] = ddmFormInstanceVersion;

			array[2] = getByUuid_C_PrevAndNext(session, ddmFormInstanceVersion,
	...
	protected DDMFormInstanceVersion getByUuid_C_PrevAndNext(Session session,
		DDMFormInstanceVersion ddmFormInstanceVersion, String uuid,
		long companyId,
		OrderByComparator<DDMFormInstanceVersion> orderByComparator,
		boolean previous) {
	...
	public void removeByUuid_C(String uuid, long companyId) {
		for (DDMFormInstanceVersion ddmFormInstanceVersion : findByUuid_C(
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "ddmFormInstanceVersion.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "ddmFormInstanceVersion.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(ddmFormInstanceVersion.uuid IS NULL OR ddmFormInstanceVersion.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "ddmFormInstanceVersion.companyId = ?";
	...
	public void cacheResult(DDMFormInstanceVersion ddmFormInstanceVersion) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
			new Object[] {
				ddmFormInstanceVersion.getUuid(),
				ddmFormInstanceVersion.getGroupId()
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
				ddmFormInstanceVersionModelImpl.getUuid(),
				ddmFormInstanceVersionModelImpl.getGroupId()
			};
	...
	protected void clearUniqueFindersCache(
		...
		if ((ddmFormInstanceVersionModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
					ddmFormInstanceVersionModelImpl.getOriginalUuid(),
					ddmFormInstanceVersionModelImpl.getOriginalGroupId()
				};
	...
	public DDMFormInstanceVersion create(long formInstanceVersionId) {
		...
		ddmFormInstanceVersion.setUuid(uuid);
	...
	public DDMFormInstanceVersion updateImpl(
		...
		if (Validator.isNull(ddmFormInstanceVersion.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (ddmFormInstanceVersion.getCreateDate() == null)) {
			if (serviceContext == null) {
				...
				ddmFormInstanceVersion.setCreateDate(serviceContext.getCreateDate(
						now));
			}
		}

		if (!ddmFormInstanceVersionModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				ddmFormInstanceVersion.setModifiedDate(now);
			}
			else {
				ddmFormInstanceVersion.setModifiedDate(serviceContext.getModifiedDate(
						now));
			}
		}
		...
		if (!DDMFormInstanceVersionModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] {
					ddmFormInstanceVersionModelImpl.getUuid(),
					ddmFormInstanceVersionModelImpl.getCompanyId()
				};
			...
			if ((ddmFormInstanceVersionModelImpl.getColumnBitmask() &
				...
				args = new Object[] { ddmFormInstanceVersionModelImpl.getUuid() };
			...
			if ((ddmFormInstanceVersionModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						ddmFormInstanceVersionModelImpl.getOriginalUuid(),
						ddmFormInstanceVersionModelImpl.getOriginalCompanyId()
					};
	...
	protected DDMFormInstanceVersion toUnwrappedModel(
		...
		ddmFormInstanceVersionImpl.setUuid(ddmFormInstanceVersion.getUuid());
		...
		ddmFormInstanceVersionImpl.setModifiedDate(ddmFormInstanceVersion.getModifiedDate());
		...
		ddmFormInstanceVersionImpl.setLastPublishDate(ddmFormInstanceVersion.getLastPublishDate());

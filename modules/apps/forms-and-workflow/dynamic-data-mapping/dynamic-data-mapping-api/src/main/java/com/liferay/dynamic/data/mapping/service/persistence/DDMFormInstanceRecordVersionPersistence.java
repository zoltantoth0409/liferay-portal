 ...
 */
@ProviderType
public interface DDMFormInstanceRecordVersionPersistence extends BasePersistence<DDMFormInstanceRecordVersion> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<DDMFormInstanceRecordVersion> findByFormInstanceRecordId(
	...
	*/
	public void cacheResult(
		java.util.List<DDMFormInstanceRecordVersion> ddmFormInstanceRecordVersions);
	...
	*/
	public java.util.List<DDMFormInstanceRecordVersion> findAll(int start,
		int end);

...
public class DDMFormInstanceRecordLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.portal.kernel.search.BaseModelSearchResult<com.liferay.dynamic.data.mapping.model.DDMFormInstanceRecord> searchFormInstanceRecords(
	...
	*/
	...
	public static com.liferay.dynamic.data.mapping.model.DDMFormInstanceRecord updateStatus(
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(DDMFormInstanceRecordLocalService.class);

		ServiceTracker<DDMFormInstanceRecordLocalService, DDMFormInstanceRecordLocalService> serviceTracker =
			new ServiceTracker<DDMFormInstanceRecordLocalService, DDMFormInstanceRecordLocalService>(bundle.getBundleContext(),

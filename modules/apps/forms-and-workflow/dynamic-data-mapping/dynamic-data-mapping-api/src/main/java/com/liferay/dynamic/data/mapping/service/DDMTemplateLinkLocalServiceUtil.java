...
public class DDMTemplateLinkLocalServiceUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(DDMTemplateLinkLocalService.class);

		ServiceTracker<DDMTemplateLinkLocalService, DDMTemplateLinkLocalService> serviceTracker =
			new ServiceTracker<DDMTemplateLinkLocalService, DDMTemplateLinkLocalService>(bundle.getBundleContext(),

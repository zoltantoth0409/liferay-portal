...
public class DDMFormInstanceRecordVersionUtil {
	...
	*/
	public static DDMFormInstanceRecordVersion findByF_V(
		long formInstanceRecordId, java.lang.String version)
		throws com.liferay.dynamic.data.mapping.exception.NoSuchFormInstanceRecordVersionException {
	...
	* @return the number of matching ddm form instance record versions
	*/
	public static int countByF_V(long formInstanceRecordId,
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, DDMFormInstanceRecordVersion> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<DDMFormInstanceRecordVersionPersistence, DDMFormInstanceRecordVersionPersistence> _serviceTracker =
		ServiceTrackerFactory.open(DDMFormInstanceRecordVersionPersistence.class);
}
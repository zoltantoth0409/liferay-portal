...
public class KaleoActionPersistenceImpl extends BasePersistenceImpl<KaleoAction>
	...
	private final FinderPath _finderPathWithPaginationFindByKaleoDefinitionId = new FinderPath(KaleoActionModelImpl.ENTITY_CACHE_ENABLED,
			KaleoActionModelImpl.FINDER_CACHE_ENABLED, KaleoActionImpl.class,
	...
	private final FinderPath _finderPathWithoutPaginationFindByKaleoDefinitionId =
		new FinderPath(KaleoActionModelImpl.ENTITY_CACHE_ENABLED,
			...
			KaleoActionModelImpl.PRIORITY_COLUMN_BITMASK);
	private final FinderPath _finderPathCountByKaleoDefinitionId = new FinderPath(KaleoActionModelImpl.ENTITY_CACHE_ENABLED,
			KaleoActionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,

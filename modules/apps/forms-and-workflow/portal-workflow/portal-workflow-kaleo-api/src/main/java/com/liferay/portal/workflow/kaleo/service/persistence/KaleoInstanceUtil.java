...
public class KaleoInstanceUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<KaleoInstancePersistence, KaleoInstancePersistence> serviceTracker =
			new ServiceTracker<KaleoInstancePersistence, KaleoInstancePersistence>(bundle.getBundleContext(),

...
public class KaleoDefinitionUtil {
	 ...
	 * @return the range of matching kaleo definitions
	 */
	public static List<KaleoDefinition> findByC_N(
	 ...
	 * @throws NoSuchDefinitionException if a matching kaleo definition could not be found
	 */
	public static KaleoDefinition findByC_N_First(
	 ...
	 * @return the first matching kaleo definition, or <code>null</code> if a matching kaleo definition could not be found
	 */
	public static KaleoDefinition fetchByC_N_First(
		long companyId, String name,
		OrderByComparator<KaleoDefinition> orderByComparator) {
	 ...
	 * @throws NoSuchDefinitionException if a matching kaleo definition could not be found
	 */
	public static KaleoDefinition findByC_N_Last(
			long companyId, String name,
			OrderByComparator<KaleoDefinition> orderByComparator)
		throws com.liferay.portal.workflow.kaleo.exception.
			NoSuchDefinitionException {
	 ...
	 * @return the last matching kaleo definition, or <code>null</code> if a matching kaleo definition could not be found
	 */
	public static KaleoDefinition fetchByC_N_Last(
		long companyId, String name,
		OrderByComparator<KaleoDefinition> orderByComparator) {
	...
	public static KaleoDefinition[] findByC_N_PrevAndNext(
		...
		return getPersistence().findByC_N_PrevAndNext(
			kaleoDefinitionId, companyId, name, orderByComparator);
	}
	 ...
	 *
	 * @deprecated As of Mueller (7.2.x), replaced by {@link #fetchByC_N_V(long,String,int)}
	 * @param companyId the company ID
	 * @param name the name
	 * @param version the version
	 * @param useFinderCache whether to use the finder cache
	 ...
	 * @return the matching kaleo definitions
	 */
	public static List<KaleoDefinition> findByC_N_A(
	...
	public static List<KaleoDefinition> findByC_N_A(
		...
		return getPersistence().findByC_N_A(
			companyId, name, active, start, end);
	}
	 ...
	 * </p>
	 *
	 * @deprecated As of Mueller (7.2.x), replaced by {@link #findByC_N_A(long,String,boolean, int, int, OrderByComparator)}
	 * @param companyId the company ID
	 * @param name the name
	 * @param active the active
	 * @param start the lower bound of the range of kaleo definitions
	 ...
	 * @throws NoSuchDefinitionException if a matching kaleo definition could not be found
	 */
	public static KaleoDefinition findByC_N_A_First(
			long companyId, String name, boolean active,
			OrderByComparator<KaleoDefinition> orderByComparator)
		throws com.liferay.portal.workflow.kaleo.exception.
			NoSuchDefinitionException {

		return getPersistence().findByC_N_A_First(
	 ...
	 * @return the first matching kaleo definition, or <code>null</code> if a matching kaleo definition could not be found
	 */
	public static KaleoDefinition fetchByC_N_A_First(
		long companyId, String name, boolean active,
		OrderByComparator<KaleoDefinition> orderByComparator) {

		return getPersistence().fetchByC_N_A_First(
			companyId, name, active, orderByComparator);
	}
	 ...
	 * @throws NoSuchDefinitionException if a matching kaleo definition could not be found
	 */
	public static KaleoDefinition findByC_N_A_Last(
			long companyId, String name, boolean active,
			OrderByComparator<KaleoDefinition> orderByComparator)
		throws com.liferay.portal.workflow.kaleo.exception.
			NoSuchDefinitionException {

		return getPersistence().findByC_N_A_Last(
			companyId, name, active, orderByComparator);
	}
	 ...
	 * @return the last matching kaleo definition, or <code>null</code> if a matching kaleo definition could not be found
	 */
	public static KaleoDefinition fetchByC_N_A_Last(
		long companyId, String name, boolean active,
		OrderByComparator<KaleoDefinition> orderByComparator) {

		return getPersistence().fetchByC_N_A_Last(
			companyId, name, active, orderByComparator);
	}
	...
	public static KaleoDefinition[] findByC_N_A_PrevAndNext(
		...
		return getPersistence().findByC_N_A_PrevAndNext(
			kaleoDefinitionId, companyId, name, active, orderByComparator);
	}
	 ...
	 * @param active the active
	 */
	public static void removeByC_N_A(
		long companyId, String name, boolean active) {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			KaleoDefinitionPersistence.class);

		ServiceTracker<KaleoDefinitionPersistence, KaleoDefinitionPersistence>
			serviceTracker =
				new ServiceTracker
					<KaleoDefinitionPersistence, KaleoDefinitionPersistence>(

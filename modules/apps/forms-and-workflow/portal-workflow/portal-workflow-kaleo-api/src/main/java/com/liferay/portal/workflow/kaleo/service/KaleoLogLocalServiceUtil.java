...
public class KaleoLogLocalServiceUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<KaleoLogLocalService, KaleoLogLocalService> serviceTracker =
			new ServiceTracker<KaleoLogLocalService, KaleoLogLocalService>(bundle.getBundleContext(),

...
public class KaleoNodeUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<KaleoNodePersistence, KaleoNodePersistence> serviceTracker =
			new ServiceTracker<KaleoNodePersistence, KaleoNodePersistence>(bundle.getBundleContext(),

...
public class PollsQuestionPersistenceImpl
	...
	public Map<Serializable, PollsQuestion> fetchByPrimaryKeys(
		...
		Map<Serializable, PollsQuestion> map =
			new HashMap<Serializable, PollsQuestion>();
	...
	private static final String _SQL_SELECT_POLLSQUESTION_WHERE_PKS_IN =
		"SELECT pollsQuestion FROM PollsQuestion pollsQuestion WHERE questionId IN (";

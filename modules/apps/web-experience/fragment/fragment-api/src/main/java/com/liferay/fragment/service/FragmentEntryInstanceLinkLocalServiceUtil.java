...
/**
 * Provides the local service utility for FragmentEntryInstanceLink. This utility wraps
 * {@link com.liferay.fragment.service.impl.FragmentEntryInstanceLinkLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class FragmentEntryInstanceLinkLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.fragment.service.impl.FragmentEntryInstanceLinkLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.fragment.model.FragmentEntryInstanceLink addFragmentEntryInstanceLink(
		...
		return getService()
				   .addFragmentEntryInstanceLink(fragmentEntryInstanceLink);
	}
	...
	*/
	public static com.liferay.fragment.model.FragmentEntryInstanceLink createFragmentEntryInstanceLink(
		long fragmentEntryInstanceLinkId) {
		return getService()
				   .createFragmentEntryInstanceLink(fragmentEntryInstanceLinkId);
	}
	...
	*/
	public static com.liferay.fragment.model.FragmentEntryInstanceLink deleteFragmentEntryInstanceLink(
		com.liferay.fragment.model.FragmentEntryInstanceLink fragmentEntryInstanceLink) {
		return getService()
				   .deleteFragmentEntryInstanceLink(fragmentEntryInstanceLink);
	}
	...
	*/
	public static com.liferay.fragment.model.FragmentEntryInstanceLink deleteFragmentEntryInstanceLink(
		...
		return getService()
				   .deleteFragmentEntryInstanceLink(fragmentEntryInstanceLinkId);
	}

	public static java.util.List<com.liferay.fragment.model.FragmentEntryInstanceLink> deleteLayoutPageTemplateEntryFragmentEntryInstanceLinks(
		long groupId, long layoutPageTemplateEntryId) {
		return getService()
				   .deleteLayoutPageTemplateEntryFragmentEntryInstanceLinks(groupId,
	...
	*/
	...
	public static com.liferay.fragment.model.FragmentEntryInstanceLink fetchFragmentEntryInstanceLink(
		long fragmentEntryInstanceLinkId) {
		return getService()
				   .fetchFragmentEntryInstanceLink(fragmentEntryInstanceLinkId);
	}
	...
	* @throws PortalException if a fragment entry instance link with the primary key could not be found
	*/
	public static com.liferay.fragment.model.FragmentEntryInstanceLink getFragmentEntryInstanceLink(
		long fragmentEntryInstanceLinkId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getFragmentEntryInstanceLink(fragmentEntryInstanceLinkId);
	}
	...
	*/
	public static java.util.List<com.liferay.fragment.model.FragmentEntryInstanceLink> getFragmentEntryInstanceLinks(
		int start, int end) {
		return getService().getFragmentEntryInstanceLinks(start, end);
	}

	public static java.util.List<com.liferay.fragment.model.FragmentEntryInstanceLink> getFragmentEntryInstanceLinks(
		long groupId, long layoutPageTemplateEntryId) {
		return getService()
				   .getFragmentEntryInstanceLinks(groupId,
			layoutPageTemplateEntryId);
	}
	...
	*/
	public static int getFragmentEntryInstanceLinksCount() {
		return getService().getFragmentEntryInstanceLinksCount();
	}
	...
	*/
	public static com.liferay.fragment.model.FragmentEntryInstanceLink updateFragmentEntryInstanceLink(
		com.liferay.fragment.model.FragmentEntryInstanceLink fragmentEntryInstanceLink) {
		return getService()
				   .updateFragmentEntryInstanceLink(fragmentEntryInstanceLink);
	}

	public static FragmentEntryInstanceLinkLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<FragmentEntryInstanceLinkLocalService, FragmentEntryInstanceLinkLocalService> _serviceTracker =
		ServiceTrackerFactory.open(FragmentEntryInstanceLinkLocalService.class);
}
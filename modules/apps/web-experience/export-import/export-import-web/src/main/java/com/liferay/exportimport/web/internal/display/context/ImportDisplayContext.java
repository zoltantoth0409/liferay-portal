...
public class ImportDisplayContext {
	...
	public static JSPNavigationItemList importJSPNavigationItemList(
		...
		_navigationItem.setActive(true);
		_navigationItem.setHref(renderResponse.createRenderURL());
		_navigationItem.setLabel(LanguageUtil.get(request, "processes"));
	...
	private static NavigationItem _navigationItem;

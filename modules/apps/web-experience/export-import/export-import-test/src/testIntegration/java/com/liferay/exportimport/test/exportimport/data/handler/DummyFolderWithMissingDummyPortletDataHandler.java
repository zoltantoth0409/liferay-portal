...
package com.liferay.exportimport.test.exportimport.data.handler;
...
import com.liferay.exportimport.test.internal.exportimport.staged.model.repository.DummyFolderStagedModelRepository;
import com.liferay.exportimport.test.internal.exportimport.staged.model.repository.DummyStagedModelRepository;
...
public class DummyFolderWithMissingDummyPortletDataHandler
	...
	protected String doExportData(
		...
		List<DummyFolder> dummyFolders =
			((DummyFolderStagedModelRepository)
				_dummyFolderStagedModelRepository).getDummyFolders(
	...
	@Reference(
		target = "(model.class.name=com.liferay.exportimport.test.model.DummyFolder)",
		unbind = "-"
	)
	...
	@Reference(
		target = "(model.class.name=com.liferay.exportimport.test.model.Dummy)",
		unbind = "-"
	)

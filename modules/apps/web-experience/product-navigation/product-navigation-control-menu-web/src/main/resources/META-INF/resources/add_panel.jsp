							...
							<div class="add-application-panel panel">
								<div class="panel-heading" id="<portlet:namespace />addApplicationHeading" role="tab">
									<div class="panel-title">
										<a aria-controls="#<portlet:namespace />addApplicationCollapse" aria-expanded="<%= selectedTab.equals("applications") %>" class="collapsed" data-qa-id="addMenuAddApplicationCategory" data-toggle="collapse" href="#<portlet:namespace />addApplicationCollapse" role="button">
						...
						<c:if test="<%= hasAddContentPermission %>">
							<div class="add-content-panel panel">
								<div class="panel-heading" id="<portlet:namespace />addContentHeading" role="tab">
									<div class="panel-title">
										<a aria-controls="#<portlet:namespace />addContentCollapse" aria-expanded="<%= selectedTab.equals("content") %>" class="collapsed" data-qa-id="addMenuAddContentCategory" data-toggle="collapse" href="#<portlet:namespace />addContentCollapse" role="button">

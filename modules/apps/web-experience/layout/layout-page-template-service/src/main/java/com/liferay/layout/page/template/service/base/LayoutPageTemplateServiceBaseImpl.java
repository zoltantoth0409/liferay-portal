...
import com.liferay.layout.page.template.service.LayoutPageTemplateService;
...
/**
 * Provides the base implementation for the layout page template remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.layout.page.template.service.impl.LayoutPageTemplateServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.layout.page.template.service.impl.LayoutPageTemplateServiceImpl
 * @see com.liferay.layout.page.template.service.LayoutPageTemplateServiceUtil
 * @generated
 */
public abstract class LayoutPageTemplateServiceBaseImpl extends BaseServiceImpl
	implements LayoutPageTemplateService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.layout.page.template.service.LayoutPageTemplateServiceUtil} to access the layout page template remote service.
	 */
	 ...
	 */
	public LayoutPageTemplateService getLayoutPageTemplateService() {
	...
	/**
	 * Returns the layout page template folder remote service.
	 *
	 * @return the layout page template folder remote service
	 */
	public com.liferay.layout.page.template.service.LayoutPageTemplateFolderService getLayoutPageTemplateFolderService() {
		return layoutPageTemplateFolderService;
	}

	/**
	 * Sets the layout page template folder remote service.
	 *
	 * @param layoutPageTemplateFolderService the layout page template folder remote service
	 */
	public void setLayoutPageTemplateFolderService(
		com.liferay.layout.page.template.service.LayoutPageTemplateFolderService layoutPageTemplateFolderService) {
		this.layoutPageTemplateFolderService = layoutPageTemplateFolderService;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LayoutPageTemplateService.class.getName();
	}
	...
	@BeanReference(type = LayoutPageTemplateService.class)
	protected LayoutPageTemplateService layoutPageTemplateService;
	...
	@BeanReference(type = com.liferay.layout.page.template.service.LayoutPageTemplateFolderService.class)
	protected com.liferay.layout.page.template.service.LayoutPageTemplateFolderService layoutPageTemplateFolderService;

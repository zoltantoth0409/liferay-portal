...
/**
 * Provides the local service interface for LayoutPageTemplateFolder. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LayoutPageTemplateFolderLocalServiceUtil
...
public interface LayoutPageTemplateFolderLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LayoutPageTemplateFolderLocalServiceUtil} to access the layout page template folder local service. Add custom service methods to {@link com.liferay.layout.page.template.service.impl.LayoutPageTemplateFolderLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public LayoutPageTemplateFolder createLayoutPageTemplateFolder(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LayoutPageTemplateFolder getLayoutPageTemplateFolder(
		long layoutPageTemplateFolderId) throws PortalException;

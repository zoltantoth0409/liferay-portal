...
<portlet:actionURL name="/layout/get_fragment_entry" var="getFragmentEntryURL">
</portlet:actionURL>
...
layoutPageTemplateEditorContext.put("getFragmentEntryURL", String.valueOf(getFragmentEntryURL));

 ...
 * @see com.liferay.modern.site.building.fragment.service.persistence.impl.FragmentCollectionPersistenceImpl
 * @generated
 */
@ProviderType
public class FragmentCollectionUtil {
	...
	*/
	public static FragmentCollection findByGroupId_First(long groupId,
		OrderByComparator<FragmentCollection> orderByComparator)
		throws com.liferay.modern.site.building.fragment.exception.NoSuchCollectionException {
	...
	*/
	...
	private static ServiceTracker<FragmentCollectionPersistence, FragmentCollectionPersistence> _serviceTracker =
		ServiceTrackerFactory.open(FragmentCollectionPersistence.class);
}
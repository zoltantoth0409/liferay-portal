...
<aui:fieldset>
	...
	<aui:input label="public-pages" name="publicVirtualHost" placeholder="public-pages" type="text" maxlength="75" value="<%= publicVirtualHost %>" />

	<aui:input label="private-pages" name="privateVirtualHost" placeholder="private-pages" type="text" maxlength="75" value="<%= privateVirtualHost %>">
	...
	<c:if test="<%= liveGroup.hasStagingGroup() %>">
		...
		<aui:input label="staging-public-pages" name="stagingPublicVirtualHost" type="text" maxlength="75" value="<%= stagingPublicVirtualHost %>" />
		...
		<aui:input label="staging-private-pages" name="stagingPrivateVirtualHost" type="text" maxlength="75" value="<%= stagingPrivateVirtualHost %>">
			<aui:validator errorMessage="please-enter-a-unique-virtual-host" name="custom">
				function(val, fieldNode, ruleValue) {

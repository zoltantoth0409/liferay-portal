...
public class JournalArticleResourceLocalServiceUtil {
	...
	*/
	...
	public static long getArticleResourcePrimKey(long groupId, String articleId) {
		return getService().getArticleResourcePrimKey(groupId, articleId);
	}

	public static long getArticleResourcePrimKey(String uuid, long groupId,
		String articleId) {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(JournalArticleResourceLocalService.class);

		ServiceTracker<JournalArticleResourceLocalService, JournalArticleResourceLocalService> serviceTracker =
			new ServiceTracker<JournalArticleResourceLocalService, JournalArticleResourceLocalService>(bundle.getBundleContext(),

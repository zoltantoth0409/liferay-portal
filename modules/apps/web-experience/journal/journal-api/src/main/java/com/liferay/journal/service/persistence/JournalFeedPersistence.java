...
public interface JournalFeedPersistence extends BasePersistence<JournalFeed> {
	...
	*/
	public java.util.List<JournalFeed> findByUuid(String uuid, int start,
		int end);
	...
	* @return the matching journal feeds
	*/
	public java.util.List<JournalFeed> findByUuid_C(String uuid, long companyId);
	...
	* @return the range of matching journal feeds
	*/
	public java.util.List<JournalFeed> findByUuid_C(String uuid,

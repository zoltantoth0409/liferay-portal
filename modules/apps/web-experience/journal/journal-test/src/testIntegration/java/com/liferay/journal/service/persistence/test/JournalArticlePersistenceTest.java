...
public class JournalArticlePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(
			existingJournalArticle.getTitle(), newJournalArticle.getTitle());
		Assert.assertEquals(
			existingJournalArticle.getUrlTitle(),
			newJournalArticle.getUrlTitle());
		Assert.assertEquals(
			existingJournalArticle.getDescription(),
	...
	protected OrderByComparator<JournalArticle> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			true, "version", true, "title", true, "urlTitle", true,
			"DDMStructureKey", true, "DDMTemplateKey", true, "layoutUuid", true,

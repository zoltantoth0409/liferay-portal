...
public class RedirectEntryPersistenceImpl
	...
	protected void clearUniqueFindersCache(
		...
		if ((redirectEntryModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				redirectEntryModelImpl.getColumnOriginalValue("uuid_"),
				redirectEntryModelImpl.getColumnOriginalValue("groupId")
			};
		...
		if ((redirectEntryModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				redirectEntryModelImpl.getColumnOriginalValue("groupId"),
				redirectEntryModelImpl.getColumnOriginalValue("sourceURL")
			};
	...
	public RedirectEntry updateImpl(RedirectEntry redirectEntry) {
		...
		if (isNew) {
			...
			if ((redirectEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					redirectEntryModelImpl.getColumnOriginalValue("uuid_"),
					redirectEntryModelImpl.getColumnOriginalValue("companyId")
				};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			RedirectEntryModelImpl.getColumnBitmask("uuid_"));

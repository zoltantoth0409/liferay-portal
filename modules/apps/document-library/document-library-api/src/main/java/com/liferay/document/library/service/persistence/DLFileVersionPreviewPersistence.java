 ...
 */
@ProviderType
public interface DLFileVersionPreviewPersistence extends BasePersistence<DLFileVersionPreview> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<DLFileVersionPreview> findByFileEntryId(
		long fileEntryId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<DLFileVersionPreview> orderByComparator);

...
public class DLFileVersionPreviewLocalServiceUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(DLFileVersionPreviewLocalService.class);

		ServiceTracker<DLFileVersionPreviewLocalService, DLFileVersionPreviewLocalService> serviceTracker =
			new ServiceTracker<DLFileVersionPreviewLocalService, DLFileVersionPreviewLocalService>(bundle.getBundleContext(),

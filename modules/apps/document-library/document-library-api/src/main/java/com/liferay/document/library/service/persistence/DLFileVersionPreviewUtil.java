...
public class DLFileVersionPreviewUtil {
	 ...
	 */
	public static DLFileVersionPreview update(
		DLFileVersionPreview dlFileVersionPreview, ServiceContext serviceContext) {
	...
	*/
	public static DLFileVersionPreview[] findByFileEntryId_PrevAndNext(
		...
		throws com.liferay.document.library.exception.NoSuchFileVersionPreviewException {
		return getPersistence()
				   .findByFileEntryId_PrevAndNext(dlFileVersionPreviewId,
	...
	*/
	public static DLFileVersionPreview[] findByFileVersionId_PrevAndNext(
		...
		throws com.liferay.document.library.exception.NoSuchFileVersionPreviewException {
		return getPersistence()
				   .findByFileVersionId_PrevAndNext(dlFileVersionPreviewId,
	...
	* @throws NoSuchFileVersionPreviewException if a matching dl file version preview could not be found
	*/
	public static DLFileVersionPreview findByF_F(long fileEntryId,
		long fileVersionId)
		throws com.liferay.document.library.exception.NoSuchFileVersionPreviewException {
	...
	*/
	public static DLFileVersionPreview fetchByF_F(long fileEntryId,
		long fileVersionId) {
	...
	*/
	public static DLFileVersionPreview removeByF_F(long fileEntryId,
		long fileVersionId)
		throws com.liferay.document.library.exception.NoSuchFileVersionPreviewException {
	...
	* @throws NoSuchFileVersionPreviewException if a matching dl file version preview could not be found
	*/
	public static DLFileVersionPreview findByF_F_P(long fileEntryId,
	...
	* @return the matching dl file version preview, or <code>null</code> if a matching dl file version preview could not be found
	*/
	public static DLFileVersionPreview fetchByF_F_P(long fileEntryId,
		long fileVersionId, int previewStatus) {
		return getPersistence()
	...
	* @return the dl file version preview that was removed
	*/
	public static DLFileVersionPreview removeByF_F_P(long fileEntryId,
		long fileVersionId, int previewStatus)
		throws com.liferay.document.library.exception.NoSuchFileVersionPreviewException {
		return getPersistence()
	...
	*/
	...
	private static ServiceTracker<DLFileVersionPreviewPersistence, DLFileVersionPreviewPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(DLFileVersionPreviewPersistence.class);

		ServiceTracker<DLFileVersionPreviewPersistence, DLFileVersionPreviewPersistence> serviceTracker =
			new ServiceTracker<DLFileVersionPreviewPersistence, DLFileVersionPreviewPersistence>(bundle.getBundleContext(),

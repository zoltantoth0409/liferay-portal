 ...
 * {@link com.liferay.document.library.sync.service.impl.DLSyncEventLocalServiceImpl} and is the
...
public class DLSyncEventLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.document.library.sync.service.impl.DLSyncEventLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.document.library.sync.model.DLSyncEvent createDLSyncEvent(
		long syncEventId) {
	...
	*/
	public static com.liferay.document.library.sync.model.DLSyncEvent deleteDLSyncEvent(
		com.liferay.document.library.sync.model.DLSyncEvent dlSyncEvent) {
	...
	*/
	...
	public static com.liferay.document.library.sync.model.DLSyncEvent fetchDLSyncEvent(
		long syncEventId) {
	...
	* @throws PortalException if a dl sync event with the primary key could not be found
	*/
	public static com.liferay.document.library.sync.model.DLSyncEvent getDLSyncEvent(
		long syncEventId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<com.liferay.document.library.sync.model.DLSyncEvent> getDLSyncEvents(
		int start, int end) {
	...
	*/
	...
	public static java.util.List<com.liferay.document.library.sync.model.DLSyncEvent> getLatestDLSyncEvents() {
	...
	*/
	public static com.liferay.document.library.sync.model.DLSyncEvent updateDLSyncEvent(
		com.liferay.document.library.sync.model.DLSyncEvent dlSyncEvent) {
	...
	private static ServiceTracker<DLSyncEventLocalService, DLSyncEventLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(DLSyncEventLocalService.class);

		ServiceTracker<DLSyncEventLocalService, DLSyncEventLocalService> serviceTracker =
			new ServiceTracker<DLSyncEventLocalService, DLSyncEventLocalService>(bundle.getBundleContext(),

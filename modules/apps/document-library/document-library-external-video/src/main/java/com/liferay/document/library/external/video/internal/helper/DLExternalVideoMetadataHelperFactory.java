 ...
 */
@Component(service = DLExternalVideoMetadataHelperFactory.class)
public class DLExternalVideoMetadataHelperFactory {

	public DLExternalVideoMetadataHelper getDLExternalVideoMetadataHelper(
		FileEntry fileEntry) {
		...
		if (fileEntry.getModel() instanceof DLFileEntry) {
			...
			if (dlExternalVideoMetadataHelper.isExternalVideo()) {
				return dlExternalVideoMetadataHelper;
			}
		}

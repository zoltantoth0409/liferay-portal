 ...
 */
public class ModuleApplicationContextHolder implements ApplicationContextAware {

	public ModuleApplicationContext getModuleApplicationContext() {
	...
	private ModuleApplicationContext _moduleApplicationContext;

...
/**
 * The persistence utility for the scheduler process log service. This utility wraps <code>com.liferay.scheduler.service.persistence.impl.SchedulerProcessLogPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see SchedulerProcessLogPersistence
 * @generated
 */
public class SchedulerProcessLogUtil {
	 ...
	 */
	public static void clearCache(SchedulerProcessLog schedulerProcessLog) {
		getPersistence().clearCache(schedulerProcessLog);
	}
	 ...
	 */
	public static Map<Serializable, SchedulerProcessLog> fetchByPrimaryKeys(
	 ...
	 */
	public static List<SchedulerProcessLog> findWithDynamicQuery(
	 ...
	 */
	public static SchedulerProcessLog update(
		SchedulerProcessLog schedulerProcessLog) {

		return getPersistence().update(schedulerProcessLog);
	}
	...
	public static SchedulerProcessLog update(
		...
		return getPersistence().update(schedulerProcessLog, serviceContext);
	}
	 ...
	 */
	public static List<SchedulerProcessLog> findBySchedulerProcessId(
		long schedulerProcessId) {

		return getPersistence().findBySchedulerProcessId(schedulerProcessId);
	}
	...
	public static List<SchedulerProcessLog> findBySchedulerProcessId(
		...
		return getPersistence().findBySchedulerProcessId(
			schedulerProcessId, start, end);
	}
	...
	public static List<SchedulerProcessLog> findBySchedulerProcessId(
		...
		return getPersistence().findBySchedulerProcessId(
			schedulerProcessId, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 */
	public static SchedulerProcessLog findBySchedulerProcessId_First(
			long schedulerProcessId,
			OrderByComparator<SchedulerProcessLog> orderByComparator)
		throws com.liferay.scheduler.exception.NoSuchProcessLogException {

		return getPersistence().findBySchedulerProcessId_First(
	 ...
	 */
	public static SchedulerProcessLog fetchBySchedulerProcessId_First(
		long schedulerProcessId,
		OrderByComparator<SchedulerProcessLog> orderByComparator) {

		return getPersistence().fetchBySchedulerProcessId_First(
			schedulerProcessId, orderByComparator);
	}
	 ...
	 * @throws NoSuchProcessLogException if a matching scheduler process log could not be found
	 */
	public static SchedulerProcessLog findBySchedulerProcessId_Last(
			long schedulerProcessId,
			OrderByComparator<SchedulerProcessLog> orderByComparator)
		throws com.liferay.scheduler.exception.NoSuchProcessLogException {

		return getPersistence().findBySchedulerProcessId_Last(
			schedulerProcessId, orderByComparator);
	}
	 ...
	 */
	public static SchedulerProcessLog fetchBySchedulerProcessId_Last(
		long schedulerProcessId,
		OrderByComparator<SchedulerProcessLog> orderByComparator) {

		return getPersistence().fetchBySchedulerProcessId_Last(
			schedulerProcessId, orderByComparator);
	}
	 ...
	 */
	public static SchedulerProcessLog[] findBySchedulerProcessId_PrevAndNext(
			long schedulerProcessLogId, long schedulerProcessId,
			OrderByComparator<SchedulerProcessLog> orderByComparator)
		throws com.liferay.scheduler.exception.NoSuchProcessLogException {

		return getPersistence().findBySchedulerProcessId_PrevAndNext(
			schedulerProcessLogId, schedulerProcessId, orderByComparator);
	}
	 ...
	 * @param schedulerProcessId the scheduler process ID
	 */
	public static void removeBySchedulerProcessId(long schedulerProcessId) {
		getPersistence().removeBySchedulerProcessId(schedulerProcessId);
	}
	 ...
	 */
	public static int countBySchedulerProcessId(long schedulerProcessId) {
		return getPersistence().countBySchedulerProcessId(schedulerProcessId);
	}
	 ...
	 * @return the matching scheduler process logs
	 */
	public static List<SchedulerProcessLog> findByS_S(
		long schedulerProcessId, int status) {

		return getPersistence().findByS_S(schedulerProcessId, status);
	}
	...
	public static List<SchedulerProcessLog> findByS_S(
		...
		return getPersistence().findByS_S(
			schedulerProcessId, status, start, end);
	}
	 ...
	 * @throws NoSuchProcessLogException if a matching scheduler process log could not be found
	 */
	public static SchedulerProcessLog findByS_S_First(
			long schedulerProcessId, int status,
			OrderByComparator<SchedulerProcessLog> orderByComparator)
		throws com.liferay.scheduler.exception.NoSuchProcessLogException {
	 ...
	 * @return the first matching scheduler process log, or <code>null</code> if a matching scheduler process log could not be found
	 */
	public static SchedulerProcessLog fetchByS_S_First(
		long schedulerProcessId, int status,
		OrderByComparator<SchedulerProcessLog> orderByComparator) {
	 ...
	 * @throws NoSuchProcessLogException if a matching scheduler process log could not be found
	 */
	public static SchedulerProcessLog findByS_S_Last(
			long schedulerProcessId, int status,
			OrderByComparator<SchedulerProcessLog> orderByComparator)
		throws com.liferay.scheduler.exception.NoSuchProcessLogException {
	 ...
	 * @return the last matching scheduler process log, or <code>null</code> if a matching scheduler process log could not be found
	 */
	public static SchedulerProcessLog fetchByS_S_Last(
		long schedulerProcessId, int status,
		OrderByComparator<SchedulerProcessLog> orderByComparator) {
	 ...
	 * @param status the status
	 */
	public static void removeByS_S(long schedulerProcessId, int status) {
		getPersistence().removeByS_S(schedulerProcessId, status);
	}
	 ...
	 * @return the number of matching scheduler process logs
	 */
	public static int countByS_S(long schedulerProcessId, int status) {
		return getPersistence().countByS_S(schedulerProcessId, status);
	}
	 ...
	 */
	public static void cacheResult(SchedulerProcessLog schedulerProcessLog) {
		getPersistence().cacheResult(schedulerProcessLog);
	}
	...
	public static void cacheResult(
		List<SchedulerProcessLog> schedulerProcessLogs) {

		getPersistence().cacheResult(schedulerProcessLogs);
	}
	 ...
	 */
	public static SchedulerProcessLog create(long schedulerProcessLogId) {
		return getPersistence().create(schedulerProcessLogId);
	}
	 ...
	 * @throws NoSuchProcessLogException if a scheduler process log with the primary key could not be found
	 */
	public static SchedulerProcessLog remove(long schedulerProcessLogId)
		throws com.liferay.scheduler.exception.NoSuchProcessLogException {

		return getPersistence().remove(schedulerProcessLogId);
	}

	public static SchedulerProcessLog updateImpl(
		SchedulerProcessLog schedulerProcessLog) {

		return getPersistence().updateImpl(schedulerProcessLog);
	}
	 ...
	 * @throws NoSuchProcessLogException if a scheduler process log with the primary key could not be found
	 */
	public static SchedulerProcessLog findByPrimaryKey(
			long schedulerProcessLogId)
		throws com.liferay.scheduler.exception.NoSuchProcessLogException {

		return getPersistence().findByPrimaryKey(schedulerProcessLogId);
	}
	 ...
	 */
	public static SchedulerProcessLog fetchByPrimaryKey(
		long schedulerProcessLogId) {

		return getPersistence().fetchByPrimaryKey(schedulerProcessLogId);
	}
	 ...
	 */
	public static List<SchedulerProcessLog> findAll() {
	 ...
	 */
	public static List<SchedulerProcessLog> findAll(int start, int end) {
	...
	public static SchedulerProcessLogPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<SchedulerProcessLogPersistence, SchedulerProcessLogPersistence>
			_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			SchedulerProcessLogPersistence.class);

		ServiceTracker
			<SchedulerProcessLogPersistence, SchedulerProcessLogPersistence>
				serviceTracker =
					new ServiceTracker
						<SchedulerProcessLogPersistence,
						 SchedulerProcessLogPersistence>(
							 bundle.getBundleContext(),
							 SchedulerProcessLogPersistence.class, null);

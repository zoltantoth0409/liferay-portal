 ...
 */
@Component(service = InfoItemUsageFinder.class)
public class InfoItemUsageFinderImpl
	extends InfoItemUsageFinderBaseImpl implements InfoItemUsageFinder {

	public static final String COUNT_BY_C_C =
		InfoItemUsageFinder.class.getName() + ".countByC_C";

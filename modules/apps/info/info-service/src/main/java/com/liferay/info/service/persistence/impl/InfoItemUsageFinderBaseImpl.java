 ...
 * @generated
 */
public abstract class InfoItemUsageFinderBaseImpl
	extends BasePersistenceImpl<InfoItemUsage> {

	public InfoItemUsageFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return infoItemUsagePersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		InfoItemUsageFinderBaseImpl.class);

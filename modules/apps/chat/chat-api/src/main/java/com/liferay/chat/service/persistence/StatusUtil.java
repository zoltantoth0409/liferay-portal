...
public class StatusUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<StatusPersistence, StatusPersistence> serviceTracker = new ServiceTracker<StatusPersistence, StatusPersistence>(bundle.getBundleContext(),
				StatusPersistence.class, null);

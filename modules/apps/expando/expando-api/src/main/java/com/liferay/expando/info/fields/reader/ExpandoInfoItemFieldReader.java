...
public class ExpandoInfoItemFieldReader
	...
	public InfoItemField getInfoItemField() {
		InfoItemFieldType itemFieldType = null; // TODO
		return new InfoItemField(getKey(), getLabels(), itemFieldType);
	}

	public Map<Locale, String> getLabels() {
		// TODO: Fix. It might be better to not return a Map but create an InfoLocalizedValue
		Map labels = new HashMap();

		labels.put(LocaleUtil.getDefault(), _attributeName);

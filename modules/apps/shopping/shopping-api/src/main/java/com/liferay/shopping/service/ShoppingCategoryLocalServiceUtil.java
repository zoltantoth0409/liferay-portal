...
public class ShoppingCategoryLocalServiceUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(ShoppingCategoryLocalService.class);

		ServiceTracker<ShoppingCategoryLocalService, ShoppingCategoryLocalService> serviceTracker =
			new ServiceTracker<ShoppingCategoryLocalService, ShoppingCategoryLocalService>(bundle.getBundleContext(),

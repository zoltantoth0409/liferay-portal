...
public class ShoppingCouponServiceUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<ShoppingCouponService, ShoppingCouponService> serviceTracker =
			new ServiceTracker<ShoppingCouponService, ShoppingCouponService>(bundle.getBundleContext(),

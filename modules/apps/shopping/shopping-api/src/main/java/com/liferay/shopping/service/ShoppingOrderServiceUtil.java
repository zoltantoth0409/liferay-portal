...
public class ShoppingOrderServiceUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<ShoppingOrderService, ShoppingOrderService> serviceTracker =
			new ServiceTracker<ShoppingOrderService, ShoppingOrderService>(bundle.getBundleContext(),

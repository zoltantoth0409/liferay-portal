...
public class ShoppingOrderLocalServiceWrapper
	implements ServiceWrapper<ShoppingOrderLocalService>,
	...
	public long dynamicQueryCount(
		...
		return _shoppingOrderLocalService.dynamicQueryCount(
	...
	public java.util.List<com.liferay.shopping.model.ShoppingOrder> search(
		...
		return _shoppingOrderLocalService.search(
	...
	public int searchCount(
		...
		return _shoppingOrderLocalService.searchCount(
			groupId, companyId, userId, number, billingFirstName,
			billingLastName, billingEmailAddress, shippingFirstName,
			shippingLastName, shippingEmailAddress, ppPaymentStatus,
			andOperator);
	...
	public com.liferay.shopping.model.ShoppingOrder updateLatestOrder(
		...
		return _shoppingOrderLocalService.updateLatestOrder(
	...
	public com.liferay.shopping.model.ShoppingOrder updateOrder(
		...
		return _shoppingOrderLocalService.updateOrder(

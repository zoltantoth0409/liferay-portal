...
public class ShoppingItemUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<ShoppingItemPersistence, ShoppingItemPersistence> serviceTracker =
			new ServiceTracker<ShoppingItemPersistence, ShoppingItemPersistence>(bundle.getBundleContext(),

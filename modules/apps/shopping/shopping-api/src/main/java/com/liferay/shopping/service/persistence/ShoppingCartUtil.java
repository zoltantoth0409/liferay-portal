...
public class ShoppingCartUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<ShoppingCartPersistence, ShoppingCartPersistence> serviceTracker =
			new ServiceTracker<ShoppingCartPersistence, ShoppingCartPersistence>(bundle.getBundleContext(),

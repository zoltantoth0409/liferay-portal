...
/**
 * The persistence utility for the shopping cart service. This utility wraps <code>com.liferay.shopping.service.persistence.impl.ShoppingCartPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ShoppingCartUtil {
	 ...
	 */
	public static Map<Serializable, ShoppingCart> fetchByPrimaryKeys(
	 ...
	 */
	public static ShoppingCart update(
		ShoppingCart shoppingCart, ServiceContext serviceContext) {
	 ...
	 */
	public static ShoppingCart findByGroupId_First(
	 ...
	 */
	public static ShoppingCart fetchByGroupId_First(
		long groupId, OrderByComparator<ShoppingCart> orderByComparator) {
	 ...
	 * @throws NoSuchCartException if a matching shopping cart could not be found
	 */
	public static ShoppingCart findByGroupId_Last(
			long groupId, OrderByComparator<ShoppingCart> orderByComparator)
		throws com.liferay.shopping.exception.NoSuchCartException {
	 ...
	 */
	public static ShoppingCart fetchByGroupId_Last(
		long groupId, OrderByComparator<ShoppingCart> orderByComparator) {
	 ...
	 */
	public static ShoppingCart[] findByGroupId_PrevAndNext(
			long cartId, long groupId,
			OrderByComparator<ShoppingCart> orderByComparator)
		throws com.liferay.shopping.exception.NoSuchCartException {

		return getPersistence().findByGroupId_PrevAndNext(
			cartId, groupId, orderByComparator);
	}
	 ...
	 * @throws NoSuchCartException if a matching shopping cart could not be found
	 */
	public static ShoppingCart findByUserId_First(
	 ...
	 * @return the first matching shopping cart, or <code>null</code> if a matching shopping cart could not be found
	 */
	public static ShoppingCart fetchByUserId_First(
		long userId, OrderByComparator<ShoppingCart> orderByComparator) {
	 ...
	 * @throws NoSuchCartException if a matching shopping cart could not be found
	 */
	public static ShoppingCart findByUserId_Last(
			long userId, OrderByComparator<ShoppingCart> orderByComparator)
		throws com.liferay.shopping.exception.NoSuchCartException {
	 ...
	 * @return the last matching shopping cart, or <code>null</code> if a matching shopping cart could not be found
	 */
	public static ShoppingCart fetchByUserId_Last(
		long userId, OrderByComparator<ShoppingCart> orderByComparator) {
	 ...
	 * @throws NoSuchCartException if a shopping cart with the primary key could not be found
	 */
	public static ShoppingCart[] findByUserId_PrevAndNext(
	...
	private static ServiceTracker
		<ShoppingCartPersistence, ShoppingCartPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ShoppingCartPersistence.class);

		ServiceTracker<ShoppingCartPersistence, ShoppingCartPersistence>
			serviceTracker =
				new ServiceTracker

...
/**
 * The persistence utility for the shopping category service. This utility wraps <code>com.liferay.shopping.service.persistence.impl.ShoppingCategoryPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ShoppingCategoryUtil {
	 ...
	 */
	public static Map<Serializable, ShoppingCategory> fetchByPrimaryKeys(
	 ...
	 */
	public static ShoppingCategory update(
		ShoppingCategory shoppingCategory, ServiceContext serviceContext) {
	 ...
	 */
	public static List<ShoppingCategory> findByGroupId(
	 ...
	 */
	public static ShoppingCategory findByGroupId_First(
	 ...
	 */
	public static ShoppingCategory fetchByGroupId_First(
		long groupId, OrderByComparator<ShoppingCategory> orderByComparator) {
	 ...
	 * @throws NoSuchCategoryException if a matching shopping category could not be found
	 */
	public static ShoppingCategory findByGroupId_Last(
			long groupId, OrderByComparator<ShoppingCategory> orderByComparator)
		throws com.liferay.shopping.exception.NoSuchCategoryException {
	 ...
	 */
	public static ShoppingCategory fetchByGroupId_Last(
		long groupId, OrderByComparator<ShoppingCategory> orderByComparator) {
	 ...
	 */
	public static List<ShoppingCategory> filterFindByGroupId(
		long groupId, int start, int end) {
	 ...
	 * @return the matching shopping categories
	 */
	public static List<ShoppingCategory> findByG_P(
	 ...
	 * @throws NoSuchCategoryException if a matching shopping category could not be found
	 */
	public static ShoppingCategory findByG_P_First(
			long groupId, long parentCategoryId,
			OrderByComparator<ShoppingCategory> orderByComparator)
		throws com.liferay.shopping.exception.NoSuchCategoryException {
	 ...
	 * @return the first matching shopping category, or <code>null</code> if a matching shopping category could not be found
	 */
	public static ShoppingCategory fetchByG_P_First(
		long groupId, long parentCategoryId,
		OrderByComparator<ShoppingCategory> orderByComparator) {
	 ...
	 * @throws NoSuchCategoryException if a matching shopping category could not be found
	 */
	public static ShoppingCategory findByG_P_Last(
			long groupId, long parentCategoryId,
			OrderByComparator<ShoppingCategory> orderByComparator)
		throws com.liferay.shopping.exception.NoSuchCategoryException {
	 ...
	 * @return the last matching shopping category, or <code>null</code> if a matching shopping category could not be found
	 */
	public static ShoppingCategory fetchByG_P_Last(
		long groupId, long parentCategoryId,
		OrderByComparator<ShoppingCategory> orderByComparator) {
	 ...
	 * @throws NoSuchCategoryException if a shopping category with the primary key could not be found
	 */
	public static ShoppingCategory[] findByG_P_PrevAndNext(
	 ...
	 * @return the matching shopping categories that the user has permission to view
	 */
	public static List<ShoppingCategory> filterFindByG_P(
		long groupId, long parentCategoryId) {
	 ...
	 * @return the matching shopping category, or <code>null</code> if a matching shopping category could not be found
	 */
	public static ShoppingCategory fetchByG_N(
	...
	public static ShoppingCategory updateImpl(
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			ShoppingCategoryPersistence.class);

		ServiceTracker<ShoppingCategoryPersistence, ShoppingCategoryPersistence>
			serviceTracker =
				new ServiceTracker
					<ShoppingCategoryPersistence, ShoppingCategoryPersistence>(

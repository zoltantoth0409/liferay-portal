...
public class ShoppingOrderItemLocalServiceUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(ShoppingOrderItemLocalService.class);

		ServiceTracker<ShoppingOrderItemLocalService, ShoppingOrderItemLocalService> serviceTracker =
			new ServiceTracker<ShoppingOrderItemLocalService, ShoppingOrderItemLocalService>(bundle.getBundleContext(),

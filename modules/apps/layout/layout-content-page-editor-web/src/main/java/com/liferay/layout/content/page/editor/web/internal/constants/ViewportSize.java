...
public enum ViewportSize {
	...
	DESKTOP("desktop", "desktop", "desktop", 992, 960),
	MOBILE_LANDSCAPE(
		"landscapeMobile", "mobile-landscape", "mobile-landscape", 576, 540),
	PORTRAIT_MOBILE(
		"portraitMobile", "mobile-portrait", "mobile-portrait", 540, 0),
	TABLET("tablet", "tablet", "tablet-portrait", 768, 720);

...
@Component(
	immediate = true,
	property = "javax.portlet.name=" + LayoutTemplateAdminPortletKeys.GROUP_PAGE_TEMPLATES,
	service = ControlPanelEntry.class
)
public class GroupPageTemplatesControlPanelEntry extends BaseControlPanelEntry {

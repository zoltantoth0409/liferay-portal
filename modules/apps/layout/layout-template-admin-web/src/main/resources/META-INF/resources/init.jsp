...
page import="com.liferay.layout.template.admin.web.internal.display.context.LayoutPrototypeManagementToolbarDisplayContext" %><%@
...
<%
LayoutTemplatesAdminDisplayContext layoutTemplatesAdminDisplayContext = new LayoutTemplatesAdminDisplayContext(liferayPortletRequest, liferayPortletResponse);
%>

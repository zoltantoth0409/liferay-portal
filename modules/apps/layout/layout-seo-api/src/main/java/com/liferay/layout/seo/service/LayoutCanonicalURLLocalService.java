...
/**
 * Provides the local service interface for LayoutCanonicalURL. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LayoutCanonicalURLLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LayoutCanonicalURLLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LayoutCanonicalURLLocalServiceUtil} to access the layout canonical url local service. Add custom service methods to <code>com.liferay.layout.seo.service.impl.LayoutCanonicalURLLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

 ...
 */
@ProviderType
public interface LayoutPageTemplateStructurePersistence extends BasePersistence<LayoutPageTemplateStructure> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<LayoutPageTemplateStructure> findByUuid(String uuid,
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<LayoutPageTemplateStructure> orderByComparator);
	...
	*/
	public void cacheResult(
		java.util.List<LayoutPageTemplateStructure> layoutPageTemplateStructures);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, LayoutPageTemplateStructure> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<LayoutPageTemplateStructure> findAll(int start,
		int end);

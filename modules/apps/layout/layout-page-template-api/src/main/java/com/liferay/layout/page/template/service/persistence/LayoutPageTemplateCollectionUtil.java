...
public class LayoutPageTemplateCollectionUtil {
	 ...
	 */
	public static Map<Serializable, LayoutPageTemplateCollection> fetchByPrimaryKeys(
	...
	*/
	public static LayoutPageTemplateCollection findByUuid_First(String uuid,
		OrderByComparator<LayoutPageTemplateCollection> orderByComparator)
	...
	*/
	public static LayoutPageTemplateCollection fetchByUuid_First(String uuid,
		OrderByComparator<LayoutPageTemplateCollection> orderByComparator) {
	...
	* @throws NoSuchPageTemplateCollectionException if a matching layout page template collection could not be found
	*/
	public static LayoutPageTemplateCollection findByUuid_Last(String uuid,
		OrderByComparator<LayoutPageTemplateCollection> orderByComparator)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateCollectionException {
	...
	*/
	public static LayoutPageTemplateCollection fetchByUuid_Last(String uuid,
		OrderByComparator<LayoutPageTemplateCollection> orderByComparator) {
	...
	*/
	public static LayoutPageTemplateCollection[] findByUuid_PrevAndNext(
		...
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateCollectionException {
		return getPersistence()
				   .findByUuid_PrevAndNext(layoutPageTemplateCollectionId,
	...
	* @throws NoSuchPageTemplateCollectionException if a matching layout page template collection could not be found
	*/
	public static LayoutPageTemplateCollection findByUUID_G(String uuid,
		long groupId)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateCollectionException {
	...
	*/
	public static LayoutPageTemplateCollection fetchByUUID_G(String uuid,
		long groupId) {
	...
	*/
	public static LayoutPageTemplateCollection removeByUUID_G(String uuid,
		long groupId)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateCollectionException {
	...
	* @return the matching layout page template collections
	*/
	public static List<LayoutPageTemplateCollection> findByUuid_C(String uuid,
		long companyId) {
	...
	* @throws NoSuchPageTemplateCollectionException if a matching layout page template collection could not be found
	*/
	public static LayoutPageTemplateCollection findByUuid_C_First(String uuid,
		long companyId,
		OrderByComparator<LayoutPageTemplateCollection> orderByComparator)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateCollectionException {
		return getPersistence()
	...
	* @throws NoSuchPageTemplateCollectionException if a matching layout page template collection could not be found
	*/
	public static LayoutPageTemplateCollection findByUuid_C_Last(String uuid,
		long companyId,
		OrderByComparator<LayoutPageTemplateCollection> orderByComparator)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateCollectionException {
		return getPersistence()
	...
	* @return the last matching layout page template collection, or <code>null</code> if a matching layout page template collection could not be found
	*/
	public static LayoutPageTemplateCollection fetchByUuid_C_Last(String uuid,
		long companyId,
		OrderByComparator<LayoutPageTemplateCollection> orderByComparator) {
		return getPersistence()
	...
	*/
	public static LayoutPageTemplateCollection[] findByUuid_C_PrevAndNext(
		...
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateCollectionException {
		return getPersistence()
				   .findByUuid_C_PrevAndNext(layoutPageTemplateCollectionId,

...
public class LayoutPageTemplateEntryUtil {
	...
	* @return the matching layout page template entries
	*/
	public static List<LayoutPageTemplateEntry> findByG_LP(long groupId,
	...
	*/
	public static List<LayoutPageTemplateEntry> findByG_LP(long groupId,
		...
		return getPersistence()
				   .findByG_LP(groupId, layoutPrototypeId, start, end);
	}
	...
	* @throws NoSuchPageTemplateEntryException if a matching layout page template entry could not be found
	*/
	public static LayoutPageTemplateEntry findByG_LP_First(long groupId,
		long layoutPrototypeId,
		OrderByComparator<LayoutPageTemplateEntry> orderByComparator)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateEntryException {
		return getPersistence()
				   .findByG_LP_First(groupId, layoutPrototypeId,
			orderByComparator);
	}
	...
	* @return the first matching layout page template entry, or <code>null</code> if a matching layout page template entry could not be found
	*/
	public static LayoutPageTemplateEntry fetchByG_LP_First(long groupId,
		long layoutPrototypeId,
		OrderByComparator<LayoutPageTemplateEntry> orderByComparator) {
		return getPersistence()
				   .fetchByG_LP_First(groupId, layoutPrototypeId,
			orderByComparator);
	}
	...
	* @throws NoSuchPageTemplateEntryException if a matching layout page template entry could not be found
	*/
	public static LayoutPageTemplateEntry findByG_LP_Last(long groupId,
		long layoutPrototypeId,
		OrderByComparator<LayoutPageTemplateEntry> orderByComparator)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateEntryException {
		return getPersistence()
				   .findByG_LP_Last(groupId, layoutPrototypeId,
			orderByComparator);
	}
	...
	* @return the last matching layout page template entry, or <code>null</code> if a matching layout page template entry could not be found
	*/
	public static LayoutPageTemplateEntry fetchByG_LP_Last(long groupId,
		long layoutPrototypeId,
		OrderByComparator<LayoutPageTemplateEntry> orderByComparator) {
		return getPersistence()
				   .fetchByG_LP_Last(groupId, layoutPrototypeId,
			orderByComparator);
	}
	...
	* @throws NoSuchPageTemplateEntryException if a layout page template entry with the primary key could not be found
	*/
	public static LayoutPageTemplateEntry[] findByG_LP_PrevAndNext(
		long layoutPageTemplateEntryId, long groupId, long layoutPrototypeId,
		OrderByComparator<LayoutPageTemplateEntry> orderByComparator)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateEntryException {
		return getPersistence()
				   .findByG_LP_PrevAndNext(layoutPageTemplateEntryId, groupId,
	...
	* @return the matching layout page template entries that the user has permission to view
	*/
	public static List<LayoutPageTemplateEntry> filterFindByG_LP(long groupId,
		long layoutPrototypeId) {
		return getPersistence().filterFindByG_LP(groupId, layoutPrototypeId);
	}
	...
	*/
	public static List<LayoutPageTemplateEntry> filterFindByG_LP(long groupId,
		long layoutPrototypeId, int start, int end) {
		return getPersistence()
				   .filterFindByG_LP(groupId, layoutPrototypeId, start, end);
	}
	...
	* @throws NoSuchPageTemplateEntryException if a layout page template entry with the primary key could not be found
	*/
	public static LayoutPageTemplateEntry[] filterFindByG_LP_PrevAndNext(
		long layoutPageTemplateEntryId, long groupId, long layoutPrototypeId,
		OrderByComparator<LayoutPageTemplateEntry> orderByComparator)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateEntryException {
		return getPersistence()
				   .filterFindByG_LP_PrevAndNext(layoutPageTemplateEntryId,
			groupId, layoutPrototypeId, orderByComparator);
	}
	...
	* @param layoutPrototypeId the layout prototype ID
	*/
	public static void removeByG_LP(long groupId, long layoutPrototypeId) {
		getPersistence().removeByG_LP(groupId, layoutPrototypeId);
	}
	...
	* @return the number of matching layout page template entries that the user has permission to view
	*/
	public static int filterCountByG_LP(long groupId, long layoutPrototypeId) {
		return getPersistence().filterCountByG_LP(groupId, layoutPrototypeId);
	}

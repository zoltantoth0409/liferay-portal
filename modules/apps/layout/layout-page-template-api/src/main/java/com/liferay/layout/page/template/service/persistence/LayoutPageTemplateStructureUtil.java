 ...
 * @see com.liferay.layout.page.template.service.persistence.impl.LayoutPageTemplateStructurePersistenceImpl
 * @generated
 */
@ProviderType
public class LayoutPageTemplateStructureUtil {
	...
	public static LayoutPageTemplateStructure update(
		...
		return getPersistence()
				   .update(layoutPageTemplateStructure, serviceContext);
	}
	...
	*/
	public static LayoutPageTemplateStructure findByUuid_First(String uuid,
		OrderByComparator<LayoutPageTemplateStructure> orderByComparator)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateStructureException {
	...
	*/
	public static LayoutPageTemplateStructure fetchByUuid_First(String uuid,
		OrderByComparator<LayoutPageTemplateStructure> orderByComparator) {
	...
	* @throws NoSuchPageTemplateStructureException if a matching layout page template structure could not be found
	*/
	public static LayoutPageTemplateStructure findByUuid_Last(String uuid,
		OrderByComparator<LayoutPageTemplateStructure> orderByComparator)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateStructureException {
	...
	*/
	public static LayoutPageTemplateStructure fetchByUuid_Last(String uuid,
		OrderByComparator<LayoutPageTemplateStructure> orderByComparator) {
	...
	*/
	public static LayoutPageTemplateStructure[] findByUuid_PrevAndNext(
		...
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateStructureException {
		return getPersistence()
				   .findByUuid_PrevAndNext(layoutPageTemplateStructureId, uuid,
			orderByComparator);
	}
	...
	* @throws NoSuchPageTemplateStructureException if a matching layout page template structure could not be found
	*/
	public static LayoutPageTemplateStructure findByUUID_G(String uuid,
		long groupId)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateStructureException {
	...
	*/
	public static LayoutPageTemplateStructure fetchByUUID_G(String uuid,
		long groupId) {
	...
	*/
	public static LayoutPageTemplateStructure removeByUUID_G(String uuid,
		long groupId)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateStructureException {
	...
	* @return the matching layout page template structures
	*/
	public static List<LayoutPageTemplateStructure> findByUuid_C(String uuid,
		long companyId) {
	...
	* @throws NoSuchPageTemplateStructureException if a matching layout page template structure could not be found
	*/
	public static LayoutPageTemplateStructure findByUuid_C_First(String uuid,
		long companyId,
		OrderByComparator<LayoutPageTemplateStructure> orderByComparator)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateStructureException {
		return getPersistence()
	...
	* @return the first matching layout page template structure, or <code>null</code> if a matching layout page template structure could not be found
	*/
	public static LayoutPageTemplateStructure fetchByUuid_C_First(String uuid,
		long companyId,
		OrderByComparator<LayoutPageTemplateStructure> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchPageTemplateStructureException if a matching layout page template structure could not be found
	*/
	public static LayoutPageTemplateStructure findByUuid_C_Last(String uuid,
		long companyId,
		OrderByComparator<LayoutPageTemplateStructure> orderByComparator)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateStructureException {
		return getPersistence()
	...
	* @return the last matching layout page template structure, or <code>null</code> if a matching layout page template structure could not be found
	*/
	public static LayoutPageTemplateStructure fetchByUuid_C_Last(String uuid,
		long companyId,
		OrderByComparator<LayoutPageTemplateStructure> orderByComparator) {
		return getPersistence()
	...
	*/
	public static LayoutPageTemplateStructure[] findByUuid_C_PrevAndNext(
		...
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateStructureException {
		return getPersistence()
				   .findByUuid_C_PrevAndNext(layoutPageTemplateStructureId,
	...
	* @throws NoSuchPageTemplateStructureException if a matching layout page template structure could not be found
	*/
	public static LayoutPageTemplateStructure findByGroupId_Last(long groupId,
		OrderByComparator<LayoutPageTemplateStructure> orderByComparator)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateStructureException {
	...
	*/
	public static LayoutPageTemplateStructure[] findByGroupId_PrevAndNext(
		...
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateStructureException {
		return getPersistence()
				   .findByGroupId_PrevAndNext(layoutPageTemplateStructureId,
	...
	* @throws NoSuchPageTemplateStructureException if a matching layout page template structure could not be found
	*/
	public static LayoutPageTemplateStructure findByG_C_C(long groupId,
	...
	* @return the matching layout page template structure, or <code>null</code> if a matching layout page template structure could not be found
	*/
	public static LayoutPageTemplateStructure fetchByG_C_C(long groupId,
		long classNameId, long classPK) {
	...
	* @return the layout page template structure that was removed
	*/
	public static LayoutPageTemplateStructure removeByG_C_C(long groupId,
		long classNameId, long classPK)
		throws com.liferay.layout.page.template.exception.NoSuchPageTemplateStructureException {
	...
	*/
	public static LayoutPageTemplateStructure fetchByPrimaryKey(
		long layoutPageTemplateStructureId) {
		return getPersistence().fetchByPrimaryKey(layoutPageTemplateStructureId);
	}

	public static java.util.Map<java.io.Serializable, LayoutPageTemplateStructure> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<LayoutPageTemplateStructurePersistence, LayoutPageTemplateStructurePersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(LayoutPageTemplateStructurePersistence.class);

		ServiceTracker<LayoutPageTemplateStructurePersistence, LayoutPageTemplateStructurePersistence> serviceTracker =
			new ServiceTracker<LayoutPageTemplateStructurePersistence, LayoutPageTemplateStructurePersistence>(bundle.getBundleContext(),

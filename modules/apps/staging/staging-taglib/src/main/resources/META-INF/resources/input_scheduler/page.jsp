	...
	<li>
		...
		<table class="staging-publish-schedule">
			...
			<tr>
				...
				<td class="staging-scheduler-content bottom-gap">
					<aui:input checked="<%= true %>" inlineField="<%= true %>" id="schedulerNoEndDate" label="no-end-date" name="endDateType" type="radio" value="0" />
					<aui:input first="<%= true %>" inlineField="<%= true %>" id="schedulerEndBy" label="end-by" name="endDateType" type="radio" value="1" />
			...
			<tr>
				...
				<td class="staging-scheduler-content">
					<aui:select name="recurrenceType" label="">
			...
			<tr>
				...
				<td class="staging-scheduler-content">
					<aui:input checked="<%= dailyType == 0 %>" cssClass="input-container" name="dailyType" label="days" type="radio" value="0" />
				</td>
			</tr>
			<tr>
				<th class="staging-scheduler-title">
				...
				<td class="staging-scheduler-content">
					<aui:input suffix="day-s" maxlength="3" label="" cssClass="number-input" name="dailyInterval" type="number" value="<%= dailyInterval %>" >
			...
			<tr>
				...
				<td class="staging-scheduler-content">
					<aui:input inlineField="<%= false %>" inlineLabel="right" cssClass="number-input" maxlength="2" name="weeklyInterval" label="" type="number" value="<%= weeklyInterval %>" >
						<aui:validator name="digit" />
					</aui:input>
				</td>
			</tr>
			...
			<tr class="hide" id="<portlet:namespace />schedulerMonthlyDayOfMonthTypeDay">
				...
				<td class="staging-scheduler-content">
					<aui:input label="" maxlength="2" name="monthlyDay0" cssClass="number-input" type="number" value="<%= monthlyDay0 %>" >
						<aui:validator name="digit" />
					</aui:input>
				</td>
			</tr>
			<tr class="hide" id="<portlet:namespace />schedulerMonthlyDayOfMonthTypeMonth">
				...
				<td class="staging-scheduler-content">
					<aui:input label="" maxlength="2" name="monthlyInterval0" cssClass="number-input"  type="number" suffix="month" value="<%= monthlyInterval0 %>" >
						<aui:validator name="digit" />
					</aui:input>
				</td>
			</tr>
			...
			<tr class="hide" id="<portlet:namespace />schedulerMonthlyDayOfWeekTypeMonth">
				...
				<td class="staging-scheduler-content">
					<aui:input inlineField="<%= false %>" inlineLabel="left" label="" cssClass="number-input" maxlength="2" name="monthlyInterval1" suffix="month" type="number" value="<%= monthlyInterval1 %>" >
						<aui:validator name="digit" />
					</aui:input>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="staging-scheduler-content">
					<aui:input checked="<%= yearlyType == 0 %>" id="yearlyTypeDayOfMonth" cssClass="input-container" inlineField="<%= true %>" label="day-of-month" name="yearlyType" type="radio" value="0" />
					<aui:input checked="<%= yearlyType == 1 %>" id="yearlyTypeDayOfWeek" cssClass="input-container" inlineField="<%= true %>" label="day-of-week" name="yearlyType" type="radio" value="1" />
				</td>
			</tr>
			<tr class="hide" id="<portlet:namespace />schedulerYearlyDayOfMonthTypeDay">
				...
				<td class="staging-scheduler-content">
					<aui:input inlineField="<%= false %>" inlineLabel="right" label="" maxlength="2" cssClass="number-input" name="yearlyDay0" type="number" value="<%= yearlyDay0 %>" >
						<aui:validator name="digit" />
					</aui:input>
				</td>
			</tr>
			...
			<tr class="hide" id="<portlet:namespace />schedulerYearlyDayOfMonthTypeYear">
				...
				<td class="staging-scheduler-content">
					<aui:input inlineField="<%= false %>" inlineLabel="right" label="" maxlength="2" cssClass="number-input" name="yearlyInterval0" type="number" value="<%= yearlyInterval0 %>" >
						<aui:validator name="digit" />
					</aui:input>
				</td>
			</tr>
			...
			<tr class="hide" id="<portlet:namespace />schedulerYearlyDayOfWeekTypeYear">
				...
				<td class="staging-scheduler-content">
					<aui:input label="" maxlength="2" name="yearlyInterval1" cssClass="number-input" type="number" value="<%= yearlyInterval1 %>" >
						<aui:validator name="digit" />
					</aui:input>
				</td>
			</tr>
...
<aui:script>
	...
	['<portlet:namespace />schedulerMonthlyDayOfMonthTypeDay','<portlet:namespace />schedulerMonthlyDayOfMonthTypeMonth'],
	['<portlet:namespace />schedulerMonthlyDayOfWeekTypeDay','<portlet:namespace />schedulerMonthlyDayOfWeekTypeMonth']);
	...
	['<portlet:namespace />schedulerYearlyDayOfMonthTypeDay','<portlet:namespace />schedulerYearlyDayOfMonthTypeMonth','<portlet:namespace />schedulerYearlyDayOfMonthTypeYear'],
	['<portlet:namespace />schedulerYearlyDayOfWeekTypeDay', '<portlet:namespace />schedulerYearlyDayOfWeekTypeMonth','<portlet:namespace />schedulerYearlyDayOfWeekTypeYear']);

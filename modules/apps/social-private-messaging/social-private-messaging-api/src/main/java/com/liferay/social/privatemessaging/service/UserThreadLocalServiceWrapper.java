 ...
 * @generated
 */
public class UserThreadLocalServiceWrapper
	implements ServiceWrapper<UserThreadLocalService>, UserThreadLocalService {
	...
	public com.liferay.message.boards.kernel.model.MBMessage addPrivateMessage(
		...
		return _userThreadLocalService.addPrivateMessage(
	...
	public com.liferay.message.boards.kernel.model.MBMessage
		...
		return _userThreadLocalService.addPrivateMessageBranch(
	...
	public void addUserThread(
		...
		_userThreadLocalService.addUserThread(
	 ...
	 */
	@Override
	public com.liferay.social.privatemessaging.model.UserThread
	...
	public long dynamicQueryCount(
		...
		return _userThreadLocalService.dynamicQueryCount(
	...
	@Override
	public java.util.List<com.liferay.social.privatemessaging.model.UserThread>
		getUserThreads(int start, int end) {
	...
	public int getUserUserThreadCount(
		...
		return _userThreadLocalService.getUserUserThreadCount(
			userId, read, deleted);
	}
	...
	public java.util.List<com.liferay.social.privatemessaging.model.UserThread>
		...
		return _userThreadLocalService.getUserUserThreads(
			userId, read, deleted);
	}

	@Override
	public java.util.List<com.liferay.social.privatemessaging.model.UserThread>
		getUserUserThreads(long userId, boolean deleted, int start, int end) {

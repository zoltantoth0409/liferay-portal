...
/**
 * The persistence utility for the user thread service. This utility wraps <code>com.liferay.social.privatemessaging.service.persistence.impl.UserThreadPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class UserThreadUtil {
	 ...
	 */
	public static Map<Serializable, UserThread> fetchByPrimaryKeys(
	 ...
	 */
	public static UserThread update(
		UserThread userThread, ServiceContext serviceContext) {
	 ...
	 */
	public static UserThread findByUserId_First(
			long userId, OrderByComparator<UserThread> orderByComparator)
		throws com.liferay.social.privatemessaging.exception.
	 ...
	 */
	public static UserThread fetchByUserId_First(
		long userId, OrderByComparator<UserThread> orderByComparator) {
	 ...
	 * @throws NoSuchUserThreadException if a matching user thread could not be found
	 */
	public static UserThread findByUserId_Last(
			long userId, OrderByComparator<UserThread> orderByComparator)
		throws com.liferay.social.privatemessaging.exception.
			NoSuchUserThreadException {
	 ...
	 */
	public static UserThread fetchByUserId_Last(
		long userId, OrderByComparator<UserThread> orderByComparator) {
	 ...
	 */
	public static UserThread[] findByUserId_PrevAndNext(
		...
		return getPersistence().findByUserId_PrevAndNext(
			userThreadId, userId, orderByComparator);
	}
	...
	public static List<UserThread> findByMBThreadId(
		...
		return getPersistence().findByMBThreadId(
			mbThreadId, start, end, orderByComparator, retrieveFromCache);
	}
	 ...
	 * @throws NoSuchUserThreadException if a matching user thread could not be found
	 */
	public static UserThread findByMBThreadId_First(
			long mbThreadId, OrderByComparator<UserThread> orderByComparator)
		throws com.liferay.social.privatemessaging.exception.
			NoSuchUserThreadException {

		return getPersistence().findByMBThreadId_First(
	 ...
	 * @return the first matching user thread, or <code>null</code> if a matching user thread could not be found
	 */
	public static UserThread fetchByMBThreadId_First(
		long mbThreadId, OrderByComparator<UserThread> orderByComparator) {

		return getPersistence().fetchByMBThreadId_First(
			mbThreadId, orderByComparator);
	}
	 ...
	 * @throws NoSuchUserThreadException if a matching user thread could not be found
	 */
	public static UserThread findByMBThreadId_Last(
			long mbThreadId, OrderByComparator<UserThread> orderByComparator)
		throws com.liferay.social.privatemessaging.exception.
			NoSuchUserThreadException {

		return getPersistence().findByMBThreadId_Last(
			mbThreadId, orderByComparator);
	}
	 ...
	 * @return the last matching user thread, or <code>null</code> if a matching user thread could not be found
	 */
	public static UserThread fetchByMBThreadId_Last(
		long mbThreadId, OrderByComparator<UserThread> orderByComparator) {

		return getPersistence().fetchByMBThreadId_Last(
			mbThreadId, orderByComparator);
	}
	 ...
	 * @throws NoSuchUserThreadException if a user thread with the primary key could not be found
	 */
	public static UserThread[] findByMBThreadId_PrevAndNext(
			long userThreadId, long mbThreadId,
			OrderByComparator<UserThread> orderByComparator)
		throws com.liferay.social.privatemessaging.exception.
			NoSuchUserThreadException {

		return getPersistence().findByMBThreadId_PrevAndNext(
			userThreadId, mbThreadId, orderByComparator);
	}
	...
	public static UserThread fetchByU_M(
		...
		return getPersistence().fetchByU_M(
			userId, mbThreadId, retrieveFromCache);
	}
	...
	public static List<UserThread> findByU_D(
		...
		return getPersistence().findByU_D(
			userId, deleted, start, end, orderByComparator, retrieveFromCache);
	}
	 ...
	 * @throws NoSuchUserThreadException if a matching user thread could not be found
	 */
	public static UserThread findByU_D_First(
	 ...
	 * @return the first matching user thread, or <code>null</code> if a matching user thread could not be found
	 */
	public static UserThread fetchByU_D_First(
		long userId, boolean deleted,
		OrderByComparator<UserThread> orderByComparator) {
	 ...
	 * @throws NoSuchUserThreadException if a matching user thread could not be found
	 */
	public static UserThread findByU_D_Last(
			long userId, boolean deleted,
			OrderByComparator<UserThread> orderByComparator)
		throws com.liferay.social.privatemessaging.exception.
			NoSuchUserThreadException {
	 ...
	 * @return the last matching user thread, or <code>null</code> if a matching user thread could not be found
	 */
	public static UserThread fetchByU_D_Last(
		long userId, boolean deleted,
		OrderByComparator<UserThread> orderByComparator) {
	 ...
	 * @throws NoSuchUserThreadException if a user thread with the primary key could not be found
	 */
	public static UserThread[] findByU_D_PrevAndNext(
		...
		return getPersistence().findByU_D_PrevAndNext(
			userThreadId, userId, deleted, orderByComparator);
	}
	 ...
	 * @throws NoSuchUserThreadException if a matching user thread could not be found
	 */
	public static UserThread findByU_R_D_First(
			long userId, boolean read, boolean deleted,
			OrderByComparator<UserThread> orderByComparator)
		throws com.liferay.social.privatemessaging.exception.
			NoSuchUserThreadException {

		return getPersistence().findByU_R_D_First(
	 ...
	 * @return the first matching user thread, or <code>null</code> if a matching user thread could not be found
	 */
	public static UserThread fetchByU_R_D_First(
		long userId, boolean read, boolean deleted,
		OrderByComparator<UserThread> orderByComparator) {

		return getPersistence().fetchByU_R_D_First(
			userId, read, deleted, orderByComparator);
	}
	 ...
	 * @throws NoSuchUserThreadException if a matching user thread could not be found
	 */
	public static UserThread findByU_R_D_Last(
			long userId, boolean read, boolean deleted,
			OrderByComparator<UserThread> orderByComparator)
		throws com.liferay.social.privatemessaging.exception.
			NoSuchUserThreadException {

		return getPersistence().findByU_R_D_Last(
			userId, read, deleted, orderByComparator);
	}
	 ...
	 * @return the last matching user thread, or <code>null</code> if a matching user thread could not be found
	 */
	public static UserThread fetchByU_R_D_Last(
		long userId, boolean read, boolean deleted,
		OrderByComparator<UserThread> orderByComparator) {

		return getPersistence().fetchByU_R_D_Last(
			userId, read, deleted, orderByComparator);
	}
	 ...
	 * @throws NoSuchUserThreadException if a user thread with the primary key could not be found
	 */
	public static UserThread[] findByU_R_D_PrevAndNext(
			long userThreadId, long userId, boolean read, boolean deleted,
			OrderByComparator<UserThread> orderByComparator)
		throws com.liferay.social.privatemessaging.exception.
			NoSuchUserThreadException {

		return getPersistence().findByU_R_D_PrevAndNext(
			userThreadId, userId, read, deleted, orderByComparator);
	}
	 ...
	 * @param deleted the deleted
	 */
	public static void removeByU_R_D(
		long userId, boolean read, boolean deleted) {
	...
	private static ServiceTracker<UserThreadPersistence, UserThreadPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(UserThreadPersistence.class);

		ServiceTracker<UserThreadPersistence, UserThreadPersistence>
			serviceTracker =
				new ServiceTracker
					<UserThreadPersistence, UserThreadPersistence>(
						bundle.getBundleContext(), UserThreadPersistence.class,
						null);

						...
						<div class="autofit-col autofit-col-expand">
							<div class="text-truncate">
								...
								<c:if test="<%= discussionComment.getParentCommentId() != rootDiscussionComment.getCommentId() %>">
									...
									<a aria-label="<liferay-ui:message key="in-reply-to-x" />" class="lfr-discussion-parent-link" data-inreply-content="<%= HtmlUtil.escape(parentDiscussionComment.getBody()) %>" data-inreply-title="<%= HtmlUtil.escape(parentCommentUserBuffer) %>" href="javascript:void(0);">

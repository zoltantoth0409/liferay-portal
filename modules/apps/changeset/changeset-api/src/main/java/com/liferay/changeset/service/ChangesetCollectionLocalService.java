 ...
 * @see com.liferay.changeset.service.base.ChangesetCollectionLocalServiceBaseImpl
...
public interface ChangesetCollectionLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ChangesetCollectionLocalServiceUtil} to access the changeset collection local service. Add custom service methods to {@link com.liferay.changeset.service.impl.ChangesetCollectionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ChangesetCollection addChangesetCollection(long userId,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ChangesetCollection fetchChangesetCollection(long groupId,
		String name);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ChangesetCollection fetchOrAddChangesetCollection(long groupId,

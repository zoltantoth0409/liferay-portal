<style>
	...
	.closed-claim-card.product-card:before {
		background-color: var(--success);
	}
</style>

<a class="card-link" href="${friendlyURLs[themeDisplay.getLanguageId()]!""}">
	<div class="claim-card closed-claim-card product-card">
		...
		<div class="product-card-status"><#if CurrentStatusImage.getData()?? && CurrentStatusImage.getData() != "">

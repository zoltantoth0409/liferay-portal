...
package com.liferay.segments.vocabulary.field.customizer.options.provider.test;
...
public class FieldOptionsProviderTest {
	...
	@Inject(
		filter = "(&(configuration.pid=com.liferay.segments.vocabulary.field.customizer.internal.configuration.SegmentsVocabularyFieldCustomizerConfiguration)(configuration.field.name=fieldName))"
	)

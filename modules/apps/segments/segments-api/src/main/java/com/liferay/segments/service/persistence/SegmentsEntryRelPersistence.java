 ...
 */
@ProviderType
public interface SegmentsEntryRelPersistence extends BasePersistence<SegmentsEntryRel> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	* @return the matching segments entry rels
	*/
	public java.util.List<SegmentsEntryRel> findByCN_CPK(long classNameId,
		long classPK);

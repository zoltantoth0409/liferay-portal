...
public interface SegmentsExperiencePersistence extends BasePersistence<SegmentsExperience> {
	...
	* @return the matching segments experiences
	*/
	public java.util.List<SegmentsExperience> findByG_C_C(long groupId,
	...
	* @return the matching segments experiences that the user has permission to view
	*/
	public java.util.List<SegmentsExperience> filterFindByG_C_C(long groupId,
		long classNameId, long classPK);
	...
	* @return the matching segments experiences
	*/
	public java.util.List<SegmentsExperience> findByG_S_C_C_A(long groupId,

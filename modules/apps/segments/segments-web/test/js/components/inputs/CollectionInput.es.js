...
describe(
	...
	() => {
		...
		it(
			'should render a key input with the right-side value of the equal character',
			() => {
				const mockOnChange = jest.fn();
				...
				const keyInputElement = getByTestId(
					COLLECTION_KEY_INPUT_TESTID
				);
		...
		it(
			'should render a value input with the left-side value of the equal character',
			() => {
				const mockOnChange = jest.fn();
				...
				const valueInputElement = getByTestId(
					COLLECTION_VALUE_INPUT_TESTID
				);
		...
		it(
			'should have a changeable key input',
			() => {
				const mockOnChange = jest.fn();
		...
		it(
			'should have a changeable value input',
			() => {
				const mockOnChange = jest.fn();

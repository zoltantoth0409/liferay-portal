...
public class BookmarksFolderUADAnonymizerTest extends BaseUADAnonymizerTestCase<BookmarksFolder>
	...
	protected boolean isBaseModelAutoAnonymized(long baseModelPK, User user)
		throws Exception {
		BookmarksFolder bookmarksFolder = _bookmarksFolderLocalService.getBookmarksFolder(baseModelPK);
	...
	protected boolean isBaseModelDeleted(long baseModelPK) {
		if (_bookmarksFolderLocalService.fetchBookmarksFolder(baseModelPK) == null) {
			return true;
		}

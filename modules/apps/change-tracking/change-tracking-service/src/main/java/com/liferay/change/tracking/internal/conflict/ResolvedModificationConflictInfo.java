 ...
 */
public class ResolvedModificationConflictInfo implements ConflictInfo {

	public ResolvedModificationConflictInfo(
	...
	public String getResolutionDescription(ResourceBundle resourceBundle) {
		return LanguageUtil.get(
			resourceBundle, "system-automatically-resolved-the-conflict");
	}

	@Override
	public ResourceBundle getResourceBundle(Locale locale) {
		return ResourceBundleUtil.getBundle(
			locale, ResolvedModificationConflictInfo.class);
	}

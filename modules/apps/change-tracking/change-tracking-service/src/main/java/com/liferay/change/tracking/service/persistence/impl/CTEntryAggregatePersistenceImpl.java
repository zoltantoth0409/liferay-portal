...
public class CTEntryAggregatePersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByCTCID_OCEID;
	private FinderPath _finderPathWithoutPaginationFindByCTCID_OCEID;
	private FinderPath _finderPathCountByCTCID_OCEID;
	...
	public List<CTEntryAggregate> findByCTCID_OCEID(
		...
		return findByCTCID_OCEID(
			ctCollectionId, ownerCTEntryId, start, end, null);
	}
	...
	public List<CTEntryAggregate> findByCTCID_OCEID(
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_CTCID_OCEID_CTCOLLECTIONID_2);

			query.append(_FINDER_COLUMN_CTCID_OCEID_OWNERCTENTRYID_2);
	...
	public CTEntryAggregate findByCTCID_OCEID_First(
		...
		CTEntryAggregate ctEntryAggregate = fetchByCTCID_OCEID_First(
	...
	public CTEntryAggregate fetchByCTCID_OCEID_First(
		...
		List<CTEntryAggregate> list = findByCTCID_OCEID(
			ctCollectionId, ownerCTEntryId, 0, 1, orderByComparator);
	...
	public CTEntryAggregate findByCTCID_OCEID_Last(
		...
		CTEntryAggregate ctEntryAggregate = fetchByCTCID_OCEID_Last(
			ctCollectionId, ownerCTEntryId, orderByComparator);
	...
	public CTEntryAggregate fetchByCTCID_OCEID_Last(
		...
		int count = countByCTCID_OCEID(ctCollectionId, ownerCTEntryId);
		...
		List<CTEntryAggregate> list = findByCTCID_OCEID(
			ctCollectionId, ownerCTEntryId, count - 1, count,
			orderByComparator);
	...
	public CTEntryAggregate[] findByCTCID_OCEID_PrevAndNext(
		...
		try {
			...
			array[0] = getByCTCID_OCEID_PrevAndNext(
				session, ctEntryAggregate, ctCollectionId, ownerCTEntryId,
				orderByComparator, true);

			array[1] = ctEntryAggregate;

			array[2] = getByCTCID_OCEID_PrevAndNext(
				session, ctEntryAggregate, ctCollectionId, ownerCTEntryId,
	...
	protected CTEntryAggregate getByCTCID_OCEID_PrevAndNext(
		Session session, CTEntryAggregate ctEntryAggregate, long ctCollectionId,
		long ownerCTEntryId,
		OrderByComparator<CTEntryAggregate> orderByComparator,
		boolean previous) {
	...
	public int countByCTCID_OCEID(long ctCollectionId, long ownerCTEntryId) {
		FinderPath finderPath = _finderPathCountByCTCID_OCEID;
	...
	private static final String _FINDER_COLUMN_CTCID_OCEID_CTCOLLECTIONID_2 =
		"ctEntryAggregate.ctCollectionId = ? AND ";

	private static final String _FINDER_COLUMN_CTCID_OCEID_OWNERCTENTRYID_2 =
		"ctEntryAggregate.ownerCTEntryId = ?";
	...
	public CTEntryAggregate updateImpl(CTEntryAggregate ctEntryAggregate) {
		...
		if (!_columnBitmaskEnabled) {
			...
			finderCache.removeResult(_finderPathCountByCTCID_OCEID, args);
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByCTCID_OCEID, args);
			...
			if ((ctEntryAggregateModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByCTCID_OCEID.
					 getColumnBitmask()) != 0) {
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByCTCID_OCEID = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, CTEntryAggregateImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByCTCID_OCEID",
			new String[] {
		...
		_finderPathWithoutPaginationFindByCTCID_OCEID = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, CTEntryAggregateImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByCTCID_OCEID",
			new String[] {Long.class.getName(), Long.class.getName()},
			CTEntryAggregateModelImpl.CTCOLLECTIONID_COLUMN_BITMASK |
			CTEntryAggregateModelImpl.OWNERCTENTRYID_COLUMN_BITMASK);

		_finderPathCountByCTCID_OCEID = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCTCID_OCEID",
			new String[] {Long.class.getName(), Long.class.getName()});
	}

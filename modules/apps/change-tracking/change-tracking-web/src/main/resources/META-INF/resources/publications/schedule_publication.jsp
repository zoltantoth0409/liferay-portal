...
>
	<liferay-portlet:actionURL name='<%= scheduled ? "/publications/reschedule_publication" : "/publications/schedule_publication" %>' var="submitURL">
				...
				<tr>
					<td>
						...
						<aui:field-wrapper>
							...
							<div class="autofit-row">
								<div class="autofit-col" id="publicationsInputDate">
								...
								<div class="autofit-col" id="publicationInputTime">
								...
								<div class="autofit-col">
									...
									<span class="publications-time-zone"><h5 class="text-secondary"><%= timeZoneDisplay %></h5></span>
								</div>
							</div>
						</aui:field-wrapper>
					</td>

									...
									<div>
										<div class="alert alert-success" role="alert">
											<clay:content-row>
												...
												<liferay-portlet:actionURL name="/publications/delete_ct_auto_resolution_info" var="dismissURL">
												...
												<clay:content-col>
													<clay:content-section>
														<liferay-portlet:renderURL var="discardURL">
															<portlet:param name="mvcRenderCommandName" value="/publications/view_discard" />

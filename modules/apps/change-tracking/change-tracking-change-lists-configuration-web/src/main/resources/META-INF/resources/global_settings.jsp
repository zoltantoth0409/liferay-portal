...
<script>
	function <portlet:namespace />doSubmitRedirectToOverview() {
		...
		const redirectToOverviewInput = form.<portlet:namespace />redirectToOverview;
	...
	function <portlet:namespace />updateSubmitRedirectToOverview() {
		...
		Liferay.Util.toggleDisabled('#<portlet:namespace />submitRedirectToOverview' ,!enableChangeListsInput.checked);
	}
</script>
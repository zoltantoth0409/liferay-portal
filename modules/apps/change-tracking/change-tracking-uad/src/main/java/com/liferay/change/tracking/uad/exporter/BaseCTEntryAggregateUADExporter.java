...
/**
 * Provides the base implementation for the ct entry aggregate UAD exporter.
 *
 * <p>
 * This implementation exists only as a container for the default methods
 * generated by ServiceBuilder. All custom service methods should be put in
 * {@link CTEntryAggregateUADExporter}.
 * </p>
 *
...
public abstract class BaseCTEntryAggregateUADExporter
	...
	@Override
	protected String toXmlString(CTEntryAggregate ctEntryAggregate) {
		StringBundler sb = new StringBundler(13);

		sb.append("<model><model-name>");
		sb.append("com.liferay.change.tracking.model.CTEntryAggregate");
		sb.append("</model-name>");

		sb.append(
			"<column><column-name>ctEntryAggregateId</column-name><column-value><![CDATA[");
		sb.append(ctEntryAggregate.getCtEntryAggregateId());
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>userId</column-name><column-value><![CDATA[");
		sb.append(ctEntryAggregate.getUserId());
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>userName</column-name><column-value><![CDATA[");
		sb.append(ctEntryAggregate.getUserName());
		sb.append("]]></column-value></column>");

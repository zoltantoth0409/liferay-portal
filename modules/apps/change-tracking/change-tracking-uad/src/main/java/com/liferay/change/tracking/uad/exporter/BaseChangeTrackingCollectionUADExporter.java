...
/**
 * Provides the base implementation for the change tracking collection UAD exporter.
 *
 * <p>
 * This implementation exists only as a container for the default methods
 * generated by ServiceBuilder. All custom service methods should be put in
 * {@link ChangeTrackingCollectionUADExporter}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @generated
 */
public abstract class BaseChangeTrackingCollectionUADExporter
	extends DynamicQueryUADExporter<ChangeTrackingCollection> {
	@Override
	...
	protected String toXmlString(
		...
		sb.append(changeTrackingCollection.getChangeTrackingCollectionId());
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>statusByUserId</column-name><column-value><![CDATA[");
		sb.append(changeTrackingCollection.getStatusByUserId());
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>statusByUserName</column-name><column-value><![CDATA[");
		sb.append(changeTrackingCollection.getStatusByUserName());
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>userId</column-name><column-value><![CDATA[");
		sb.append(changeTrackingCollection.getUserId());
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>userName</column-name><column-value><![CDATA[");
		sb.append(changeTrackingCollection.getUserName());
		sb.append("]]></column-value></column>");

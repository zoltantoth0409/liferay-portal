...
package com.liferay.change.tracking.rest.internal.writer;
...
@Component(
	property = {
		...
		"osgi.jaxrs.extension=true", "osgi.jaxrs.name=CTWriter.JSON"
	},
	scope = ServiceScope.PROTOTYPE, service = MessageBodyWriter.class
)
@Produces(MediaType.APPLICATION_JSON)
@Provider
public class CTJSONMessageBodyWriter implements MessageBodyWriter {

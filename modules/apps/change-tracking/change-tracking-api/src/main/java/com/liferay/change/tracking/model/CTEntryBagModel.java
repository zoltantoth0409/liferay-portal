...
/**
 * The base model interface for the CTEntryBag service. Represents a row in the &quot;CTEntryBag&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.change.tracking.model.impl.CTEntryBagModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.change.tracking.model.impl.CTEntryBagImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface CTEntryBagModel extends AuditedModel, BaseModel<CTEntryBag>,
	ShardedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a ct entry bag model instance should use the {@link CTEntryBag} interface instead.
	 */

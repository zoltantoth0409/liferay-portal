...
public interface CTEntryLocalService extends BaseLocalService,
	PersistedModelLocalService, PersistedResourcedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CTEntryLocalServiceUtil} to access the ct entry local service. Add custom service methods to {@link com.liferay.change.tracking.service.impl.CTEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public CTEntry addCTEntry(long userId, long classNameId, long classPK,
		long resourcePrimKey, long ctCollectionId, ServiceContext serviceContext)
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CTEntry> fetchCTEntries(long ctCollectionId,
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CTEntry fetchCTEntry(long ctCollectionId, long classNameId,
		long classPK);

...
public class CTEntryAggregateLocalServiceUtil {
	...
	*/
	...
	public static void addCTEntryCTEntryAggregates(long ctEntryId,
	...
	public static void addCTEntryCTEntryAggregates(long ctEntryId,
		...
		getService().addCTEntryCTEntryAggregates(ctEntryId, ctEntryAggregateIds);
	}
	...
	*/
	public static com.liferay.change.tracking.model.CTEntryAggregate deleteCTEntryAggregate(
		com.liferay.change.tracking.model.CTEntryAggregate ctEntryAggregate) {
	...
	*/
	...
	public static void deleteCTEntryCTEntryAggregate(long ctEntryId,
		com.liferay.change.tracking.model.CTEntryAggregate ctEntryAggregate) {
	...
	public static void deleteCTEntryCTEntryAggregate(long ctEntryId,
		long ctEntryAggregateId) {
		getService().deleteCTEntryCTEntryAggregate(ctEntryId, ctEntryAggregateId);
	}

	public static void deleteCTEntryCTEntryAggregates(long ctEntryId,
		java.util.List<com.liferay.change.tracking.model.CTEntryAggregate> ctEntryAggregates) {
		getService().deleteCTEntryCTEntryAggregates(ctEntryId, ctEntryAggregates);
	}

	public static void deleteCTEntryCTEntryAggregates(long ctEntryId,
		long[] ctEntryAggregateIds) {
		getService()
			.deleteCTEntryCTEntryAggregates(ctEntryId, ctEntryAggregateIds);
	}
	...
	*/
	...
	public static com.liferay.change.tracking.model.CTEntryAggregate fetchCTEntryAggregate(
		long ctEntryAggregateId) {
	...
	* @throws PortalException if a ct entry aggregate with the primary key could not be found
	*/
	public static com.liferay.change.tracking.model.CTEntryAggregate getCTEntryAggregate(
		long ctEntryAggregateId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<com.liferay.change.tracking.model.CTEntryAggregate> getCTEntryAggregates(
		int start, int end) {
	...
	*/
	...
	public static java.util.List<com.liferay.change.tracking.model.CTEntryAggregate> getCTEntryCTEntryAggregates(
		long ctEntryId) {
	...
	public static java.util.List<com.liferay.change.tracking.model.CTEntryAggregate> getCTEntryCTEntryAggregates(
		...
		return getService()
				   .getCTEntryCTEntryAggregates(ctEntryId, start, end,
			orderByComparator);
	}
	...
	*/
	...
	public static boolean hasCTEntryCTEntryAggregate(long ctEntryId,
		long ctEntryAggregateId) {
		return getService()
				   .hasCTEntryCTEntryAggregate(ctEntryId, ctEntryAggregateId);
	}
	...
	public static void setCTEntryCTEntryAggregates(long ctEntryId,
		long[] ctEntryAggregateIds) {
		getService().setCTEntryCTEntryAggregates(ctEntryId, ctEntryAggregateIds);
	}
	...
	*/
	public static com.liferay.change.tracking.model.CTEntryAggregate updateCTEntryAggregate(
		com.liferay.change.tracking.model.CTEntryAggregate ctEntryAggregate) {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(CTEntryAggregateLocalService.class);

		ServiceTracker<CTEntryAggregateLocalService, CTEntryAggregateLocalService> serviceTracker =
			new ServiceTracker<CTEntryAggregateLocalService, CTEntryAggregateLocalService>(bundle.getBundleContext(),

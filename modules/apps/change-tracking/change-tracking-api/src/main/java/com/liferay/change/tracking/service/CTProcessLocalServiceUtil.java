 ...
 * {@link com.liferay.change.tracking.service.impl.CTProcessLocalServiceImpl} and is the
...
public class CTProcessLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.change.tracking.service.impl.CTProcessLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	public static com.liferay.change.tracking.model.CTProcess addCTProcess(
		...
		return getService().addCTProcess(userId, ctCollectionId, serviceContext);
	}
	...
	*/
	public static java.util.List<com.liferay.change.tracking.model.CTProcess> getCTProcesses(
		int start, int end) {
	...
	*/
	...
	private static ServiceTracker<CTProcessLocalService, CTProcessLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CTProcessLocalService.class);

		ServiceTracker<CTProcessLocalService, CTProcessLocalService> serviceTracker =
			new ServiceTracker<CTProcessLocalService, CTProcessLocalService>(bundle.getBundleContext(),
				CTProcessLocalService.class, null);

 ...
 */
@ProviderType
public class CTProcessLocalServiceWrapper implements CTProcessLocalService,
	ServiceWrapper<CTProcessLocalService> {
	...
	*/
	...
	public long dynamicQueryCount(
		...
		return _ctProcessLocalService.dynamicQueryCount(dynamicQuery, projection);
	}
	...
	*/
	@Override
	public java.util.List<com.liferay.change.tracking.model.CTProcess> getCTProcesses(
		int start, int end) {

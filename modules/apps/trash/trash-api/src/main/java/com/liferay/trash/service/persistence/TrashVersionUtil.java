...
public class TrashVersionUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<TrashVersionPersistence, TrashVersionPersistence> serviceTracker =
			new ServiceTracker<TrashVersionPersistence, TrashVersionPersistence>(bundle.getBundleContext(),

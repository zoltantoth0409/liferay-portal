...
public interface KaleoInstanceTokenLocalService extends BaseLocalService,
	...
	*/
	...
	@Indexable(type = IndexableType.REINDEX)
	public KaleoInstanceToken addKaleoInstanceToken(long currentKaleoNodeId,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Hits search(String assetClassName, String assetTitle,
		String assetDescription, String currentKaleoNodeName,
		String kaleoDefinitionName, Boolean completed, int start, int end,
		Sort[] sorts, ServiceContext serviceContext);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public int searchCount(String assetClassName, String assetTitle,
		String assetDescription, String currentKaleoNodeName,

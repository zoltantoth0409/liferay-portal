...
public class KaleoConditionUtil {
	...
	*/
	public static KaleoCondition[] findByKaleoDefinitionVersionId_PrevAndNext(
		...
		throws com.liferay.portal.workflow.kaleo.exception.NoSuchConditionException {
		return getPersistence()
				   .findByKaleoDefinitionVersionId_PrevAndNext(kaleoConditionId,
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(KaleoConditionPersistence.class);

		ServiceTracker<KaleoConditionPersistence, KaleoConditionPersistence> serviceTracker =
			new ServiceTracker<KaleoConditionPersistence, KaleoConditionPersistence>(bundle.getBundleContext(),

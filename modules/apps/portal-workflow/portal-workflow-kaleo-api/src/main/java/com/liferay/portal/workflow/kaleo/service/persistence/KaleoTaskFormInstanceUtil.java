...
public class KaleoTaskFormInstanceUtil {
	...
	* @throws NoSuchTaskFormInstanceException if a kaleo task form instance with the primary key could not be found
	*/
	public static KaleoTaskFormInstance[] findByKaleoDefinitionVersionId_PrevAndNext(
		long kaleoTaskFormInstanceId, long kaleoDefinitionVersionId,
		OrderByComparator<KaleoTaskFormInstance> orderByComparator)
		throws com.liferay.portal.workflow.kaleo.exception.NoSuchTaskFormInstanceException {
		return getPersistence()
				   .findByKaleoDefinitionVersionId_PrevAndNext(kaleoTaskFormInstanceId,
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(KaleoTaskFormInstancePersistence.class);

		ServiceTracker<KaleoTaskFormInstancePersistence, KaleoTaskFormInstancePersistence> serviceTracker =
			new ServiceTracker<KaleoTaskFormInstancePersistence, KaleoTaskFormInstancePersistence>(bundle.getBundleContext(),

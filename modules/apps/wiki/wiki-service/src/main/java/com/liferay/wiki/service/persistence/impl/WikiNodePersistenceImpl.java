...
public class WikiNodePersistenceImpl
	...
	public void cacheResult(WikiNode wikiNode) {
		entityCache.putResult(
			WikiNodeModelImpl.ENTITY_CACHE_ENABLED, WikiNodeImpl.class,
			wikiNode.getPrimaryKey(), wikiNode);
	...
	public WikiNode updateImpl(WikiNode wikiNode) {
		...
		entityCache.putResult(
			WikiNodeModelImpl.ENTITY_CACHE_ENABLED, WikiNodeImpl.class,
			wikiNode.getPrimaryKey(), wikiNode, false);
	...
	private static final String _SQL_SELECT_WIKINODE_WHERE_PKS_IN =
		"SELECT wikiNode FROM WikiNode wikiNode WHERE nodeId IN (";

...
public class MBThreadFlagUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<MBThreadFlagPersistence, MBThreadFlagPersistence> serviceTracker =
			new ServiceTracker<MBThreadFlagPersistence, MBThreadFlagPersistence>(bundle.getBundleContext(),

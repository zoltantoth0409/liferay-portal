...
public class MBDiscussionLocalServiceUtil {
	...
	*/
	public static com.liferay.message.boards.model.MBDiscussion createMBDiscussion(
		long discussionId) {
	...
	*/
	public static com.liferay.message.boards.model.MBDiscussion deleteMBDiscussion(
		long discussionId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static com.liferay.message.boards.model.MBDiscussion fetchMBDiscussionByUuidAndGroupId(
	...
	*/
	public static com.liferay.message.boards.model.MBDiscussion getMBDiscussionByUuidAndGroupId(
		String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<com.liferay.message.boards.model.MBDiscussion> getMBDiscussions(
		int start, int end) {
	...
	*/
	public static java.util.List<com.liferay.message.boards.model.MBDiscussion> getMBDiscussionsByUuidAndCompanyId(
	...
	*/
	public static com.liferay.message.boards.model.MBDiscussion updateMBDiscussion(
		com.liferay.message.boards.model.MBDiscussion mbDiscussion) {
	...
	private static ServiceTracker<MBDiscussionLocalService, MBDiscussionLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(MBDiscussionLocalService.class);

		ServiceTracker<MBDiscussionLocalService, MBDiscussionLocalService> serviceTracker =
			new ServiceTracker<MBDiscussionLocalService, MBDiscussionLocalService>(bundle.getBundleContext(),

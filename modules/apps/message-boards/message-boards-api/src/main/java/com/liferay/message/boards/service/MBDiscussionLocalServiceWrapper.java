...
public class MBDiscussionLocalServiceWrapper implements MBDiscussionLocalService,
	...
	*/
	@Override
	public java.util.List<com.liferay.message.boards.model.MBDiscussion> getMBDiscussions(
		int start, int end) {

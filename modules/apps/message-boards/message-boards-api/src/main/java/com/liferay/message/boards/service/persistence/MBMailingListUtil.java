...
public class MBMailingListUtil {
	...
	*/
	public static List<MBMailingList> findByUuid(String uuid, int start, int end) {
	...
	*/
	public static List<MBMailingList> findByUuid(String uuid, int start,
	...
	*/
	public static MBMailingList fetchByUuid_First(String uuid,
		OrderByComparator<MBMailingList> orderByComparator) {
	...
	*/
	public static MBMailingList fetchByUuid_Last(String uuid,
		OrderByComparator<MBMailingList> orderByComparator) {
	...
	* @return the matching message boards mailing lists
	*/
	public static List<MBMailingList> findByUuid_C(String uuid, long companyId) {
	...
	* @throws NoSuchMailingListException if a matching message boards mailing list could not be found
	*/
	public static MBMailingList findByUuid_C_First(String uuid, long companyId,
		OrderByComparator<MBMailingList> orderByComparator)
		throws com.liferay.message.boards.exception.NoSuchMailingListException {
		return getPersistence()
	...
	* @return the first matching message boards mailing list, or <code>null</code> if a matching message boards mailing list could not be found
	*/
	public static MBMailingList fetchByUuid_C_First(String uuid,
	...
	* @throws NoSuchMailingListException if a matching message boards mailing list could not be found
	*/
	public static MBMailingList findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<MBMailingList> orderByComparator)
		throws com.liferay.message.boards.exception.NoSuchMailingListException {
		return getPersistence()
	...
	* @return the last matching message boards mailing list, or <code>null</code> if a matching message boards mailing list could not be found
	*/
	public static MBMailingList fetchByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<MBMailingList> orderByComparator) {
		return getPersistence()

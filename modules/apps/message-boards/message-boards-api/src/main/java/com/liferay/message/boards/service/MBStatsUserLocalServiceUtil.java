 ...
 * {@link com.liferay.message.boards.service.impl.MBStatsUserLocalServiceImpl} and is the
...
public class MBStatsUserLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.message.boards.service.impl.MBStatsUserLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	private static ServiceTracker<MBStatsUserLocalService, MBStatsUserLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(MBStatsUserLocalService.class);

		ServiceTracker<MBStatsUserLocalService, MBStatsUserLocalService> serviceTracker =
			new ServiceTracker<MBStatsUserLocalService, MBStatsUserLocalService>(bundle.getBundleContext(),

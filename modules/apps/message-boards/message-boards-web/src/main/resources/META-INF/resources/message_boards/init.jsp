...
page import="com.liferay.message.boards.util.comparator.MBObjectsModifiedDateComparator" %><%@
page import="com.liferay.message.boards.util.comparator.MBObjectsTitleComparator" %><%@

...
public interface AcceptLanguage {
	 ...
	 *
	 * <p>
	 * The list values start with the first locale added on the {@code
	 ...
	 * </p>
	 *
	 * @return a {@code List} of the request's preferred {@code Locale}, if
	 *         the {@code Accept-Language} header is present; otherwise returns
	 *         a {@code List} containing the server's default locale
	 * @review
	 */
	public default List<Locale> getLocales() {

...
public class SiteNavigationMenuUtil {
	...
	*/
	public static List<SiteNavigationMenu> findByUuid(String uuid, int start,
		int end) {
	...
	*/
	public static SiteNavigationMenu findByUuid_First(String uuid,
		OrderByComparator<SiteNavigationMenu> orderByComparator)
	...
	*/
	public static SiteNavigationMenu fetchByUuid_First(String uuid,
		OrderByComparator<SiteNavigationMenu> orderByComparator) {
	...
	* @throws NoSuchMenuException if a matching site navigation menu could not be found
	*/
	public static SiteNavigationMenu findByUuid_Last(String uuid,
		OrderByComparator<SiteNavigationMenu> orderByComparator)
		throws com.liferay.site.navigation.exception.NoSuchMenuException {
	...
	*/
	public static SiteNavigationMenu fetchByUuid_Last(String uuid,
		OrderByComparator<SiteNavigationMenu> orderByComparator) {
	...
	*/
	public static SiteNavigationMenu[] findByUuid_PrevAndNext(
		...
		throws com.liferay.site.navigation.exception.NoSuchMenuException {
		return getPersistence()
				   .findByUuid_PrevAndNext(siteNavigationMenuId, uuid,
			orderByComparator);
	}
	...
	*/
	...
	/**
	* Returns the site navigation menu where uuid = &#63; and groupId = &#63; or throws a {@link NoSuchMenuException} if it could not be found.
	*
	* @param uuid the uuid
	...
	* @return the matching site navigation menus
	*/
	public static List<SiteNavigationMenu> findByUuid_C(String uuid,
		long companyId) {
	...
	* @throws NoSuchMenuException if a matching site navigation menu could not be found
	*/
	public static SiteNavigationMenu findByUuid_C_First(String uuid,
	...
	* @return the first matching site navigation menu, or <code>null</code> if a matching site navigation menu could not be found
	*/
	public static SiteNavigationMenu fetchByUuid_C_First(String uuid,
		long companyId, OrderByComparator<SiteNavigationMenu> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchMenuException if a matching site navigation menu could not be found
	*/
	public static SiteNavigationMenu findByUuid_C_Last(String uuid,
		long companyId, OrderByComparator<SiteNavigationMenu> orderByComparator)
		throws com.liferay.site.navigation.exception.NoSuchMenuException {
		return getPersistence()
	...
	* @return the last matching site navigation menu, or <code>null</code> if a matching site navigation menu could not be found
	*/
	public static SiteNavigationMenu fetchByUuid_C_Last(String uuid,
		long companyId, OrderByComparator<SiteNavigationMenu> orderByComparator) {
		return getPersistence()
	...
	*/
	public static SiteNavigationMenu[] findByUuid_C_PrevAndNext(
		...
		throws com.liferay.site.navigation.exception.NoSuchMenuException {
		return getPersistence()
				   .findByUuid_C_PrevAndNext(siteNavigationMenuId, uuid,

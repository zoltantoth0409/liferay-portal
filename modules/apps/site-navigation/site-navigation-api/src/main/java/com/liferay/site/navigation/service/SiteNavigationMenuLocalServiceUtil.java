...
public class SiteNavigationMenuLocalServiceUtil {
	...
	public static com.liferay.site.navigation.model.SiteNavigationMenu
		...
		return getService().addDefaultSiteNavigationMenu(

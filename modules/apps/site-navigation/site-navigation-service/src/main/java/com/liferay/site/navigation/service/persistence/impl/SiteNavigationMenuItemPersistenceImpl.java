...
public class SiteNavigationMenuItemPersistenceImpl
	...
	public List<SiteNavigationMenuItem> findByUuid(
		...
		List<SiteNavigationMenuItem> list =
			(List<SiteNavigationMenuItem>)finderCache.getResult(
	...
	private static final String _FINDER_COLUMN_S_LIKEN_NAME_2 =
		"lower(siteNavigationMenuItem.name) LIKE ?";
	...
	public Map<Serializable, SiteNavigationMenuItem> fetchByPrimaryKeys(
		...
		try {
			...
			for (SiteNavigationMenuItem siteNavigationMenuItem :
					(List<SiteNavigationMenuItem>)q.list()) {
	...
	private static final String
		_SQL_SELECT_SITENAVIGATIONMENUITEM_WHERE_PKS_IN =
			"SELECT siteNavigationMenuItem FROM SiteNavigationMenuItem siteNavigationMenuItem WHERE siteNavigationMenuItemId IN (";

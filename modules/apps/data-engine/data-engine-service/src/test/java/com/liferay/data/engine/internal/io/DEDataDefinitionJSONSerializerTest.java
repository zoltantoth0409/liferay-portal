...
public class DEDataDefinitionJSONSerializerTest extends BaseTestCase {
	...
	public void testApply() throws Exception {
		...
		DEDataDefinitionRule deDataDefinitionRule1 =
			DEDataDefinitionRuleFactory.emailAddress(Arrays.asList("email"));

		DEDataDefinitionRule deDataDefinitionRule2 =
			DEDataDefinitionRuleFactory.required(Arrays.asList("name"));

		DEDataDefinitionRule deDataDefinitionRule3 =
			DEDataDefinitionRuleFactory.matchExpression(
		...
		deDataDefinition.setDEDataDefinitionRules(
			Arrays.asList(
				deDataDefinitionRule1, deDataDefinitionRule2,
				deDataDefinitionRule3));

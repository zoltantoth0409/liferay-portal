...
/**
 * Provides the local service interface for DEDataRecordQuery. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DEDataRecordQueryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DEDataRecordQueryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DEDataRecordQueryLocalServiceUtil} to access the de data record query local service. Add custom service methods to <code>com.liferay.data.engine.service.impl.DEDataRecordQueryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

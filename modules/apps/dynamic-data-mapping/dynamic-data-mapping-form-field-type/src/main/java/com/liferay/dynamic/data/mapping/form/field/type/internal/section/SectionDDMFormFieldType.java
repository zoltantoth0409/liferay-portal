...
@Component(
	immediate = true,
	property = {
		"ddm.form.field.type.data.domain=section",
		"ddm.form.field.type.description=section-field-type-description",
		...
		"ddm.form.field.type.name=section", "ddm.form.field.type.scope=forms",
		"ddm.form.field.type.system=true"
	},
	service = DDMFormFieldType.class
)
public class SectionDDMFormFieldType extends BaseDDMFormFieldType {

	@Override
	public Class<? extends DDMFormFieldTypeSettings>
		getDDMFormFieldTypeSettings() {

		return SectionDDMFormFieldTypeSettings.class;
	}

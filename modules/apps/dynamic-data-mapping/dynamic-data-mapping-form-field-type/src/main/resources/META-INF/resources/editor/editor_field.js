		...
		var EditorField = A.Component.create({
			...
			prototype: {
				...
				getTemplateContext: function() {
					...
					return A.merge(
						EditorField.superclass.getTemplateContext.apply(
							instance,
							arguments
						),
						{
				...
				getValue: function() {
					...
					var value = EditorField.superclass.getValue.apply(
						instance,
						arguments
					);
				...
				hasFocus: function() {
					...
					return (
						EditorField.superclass.hasFocus.apply(
							instance,
							arguments
						) || instance._hasAlloyEditorFocus()
					);
				},
				...
				render: function() {
					...
					if (editorNode.inDoc() && !instance.get('readOnly')) {
						...
						instance._alloyEditor = new A.LiferayAlloyEditor({
							...
							onChangeMethod: A.bind(
								instance._onChangeEditor,
								instance
							),
							onFocusMethod: A.bind(
						...
						instance._alloyEditor
							.getNativeEditor()
							.on(
								'actionPerformed',
								A.bind(instance._onActionPerformed, instance)
							);
					}

		...
		var GridField = A.Component.create({
			...
			prototype: {
				initializer: function() {
					...
					instance._eventHandlers.push(
						instance.bindContainerEvent(
							'blur',
							instance._onBlurItem,
							'.form-builder-grid-field'
						),
						instance.bindContainerEvent(
							'change',
							instance._onCheckItem,
							'.form-builder-grid-field'
						),
						instance.bindContainerEvent(
							'focus',
							instance._onFocusItem,
							'.form-builder-grid-field'
						)
					);
				},
				...
				focusOnTarget: function() {
					...
					var row = container.one(
						'tr[name="' + focusTarget.row + '"]'
					);

					var column = row.one(
						'[data-row-index="' + focusTarget.index + '"]'
					);
				...
				getTemplateContext: function() {
					...
					return A.merge(
						GridField.superclass.getTemplateContext.apply(
							instance,
							arguments
						),
						{
				...
				showErrorMessage: function() {
					...
					GridField.superclass.showErrorMessage.apply(
						instance,
						arguments
					);

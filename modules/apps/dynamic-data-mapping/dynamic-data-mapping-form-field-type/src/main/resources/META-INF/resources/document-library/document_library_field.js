		...
		var DocumentLibraryField = A.Component.create({
			...
			prototype: {
				...
				getDocumentLibrarySelectorURL: function() {
					...
					portletURL.setParameter(
						'p_p_auth',
						instance.get('itemSelectorAuthToken')
					);
					portletURL.setParameter(
						'refererGroupId',
						instance.get('groupId')
				...
				getTemplateContext: function() {
					...
					return A.merge(
						DocumentLibraryField.superclass.getTemplateContext.apply(
							instance,
							arguments
						),
						{
				...
				showErrorMessage: function() {
					...
					DocumentLibraryField.superclass.showErrorMessage.apply(
						instance,
						arguments
					);

					container
						.all('.form-feedback-indicator')
						.appendTo(container.one('.form-group'));
				},

...
describe('Validation', () => {
	...
	it('should enable validation after click on toogle', () => {
		jest.useFakeTimers();
	...
	it('should render parameter field with TextField element', () => {
		jest.useFakeTimers();
	...
	it('should render parameter field with Numeric element', () => {
		jest.useFakeTimers();
	...
	it('should render parameter field with Text element and then with Numeric after update dataType', () => {
		jest.useFakeTimers();
	...
	it('should not render parameter field if validation is isUrl', () => {
		jest.useFakeTimers();
	...
	it('should not render parameter field if validation is isEmailAddress', () => {
		jest.useFakeTimers();
	...
	it('should render filled fields when value is filled', () => {
		jest.useFakeTimers();
	...
	it('should update parameter message and emit a field edited event', () => {
		jest.useFakeTimers();
	...
	it('should update error message and emit a field edited event', () => {
		jest.useFakeTimers();

...
describe(
	...
	() => {
		it(
			'should tokenize single digit expressions',
			() => {
		...
		it(
			'should tokenize multiple digit expressions',
			() => {
		...
		it(
			'should tokenize floating point expressions',
			() => {
		...
		it(
			'should tokenize multiple letter variables',
			() => {
		...
		it(
			'should tokenize expressions with functions',
			() => {

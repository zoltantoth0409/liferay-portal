...
public class SumFunctionFactory implements DDMExpressionFunctionFactory {

	@Override
	public DDMExpressionFunction create() {
		return _SUM_FUNCTION;
	}

	private static final SumFunction _SUM_FUNCTION = new SumFunction();

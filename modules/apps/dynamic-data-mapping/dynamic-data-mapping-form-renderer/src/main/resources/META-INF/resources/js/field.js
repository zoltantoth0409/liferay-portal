AUI.add(
	...
	function(A) {
		...
		var TPL_FORM_FIELD_CONTAINER =
			'<div class="clearfix {hide} lfr-ddm-form-field-container"></div>';
			...
			prototype: {
				...
				fetchContainer: function() {
					...
					if (!container) {
						...
						container = instance._getContainerByNameAndIndex(
							name,
							repeatedIndex
						);
					}
				...
				getInputNode: function() {
					...
					return instance
						.get('container')
						.one(instance.getInputSelector());
				},

				getInputSelector: function() {
					var instance = this;

					var qualifiedName = instance
						.getQualifiedName()
						.replace(/\$/gi, '\\$');
				...
				getTemplate: function() {
					...
					const metalComponent = new renderer(
				...
				getTemplateContext: function() {
					...
					return A.merge(instance.get('context'), {
				...
				toJSON: function() {
					...
					context.localizedValue = instance.get(
				...
				_createContainer: function() {
					...
					return A.Node.create(
						Lang.sub(TPL_FORM_FIELD_CONTAINER, {
							hide: visible ? '' : 'hide'
						})
					);
				},
					...
					if (root) {
						container = root
							.filterNodes(function(qualifiedName) {
								var nodeInstanceId = Util.getInstanceIdFromQualifiedName(
									qualifiedName
								);

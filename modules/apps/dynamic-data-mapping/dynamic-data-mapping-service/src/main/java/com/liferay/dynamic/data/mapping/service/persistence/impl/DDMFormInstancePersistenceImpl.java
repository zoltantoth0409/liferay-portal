...
public class DDMFormInstancePersistenceImpl extends BasePersistenceImpl<DDMFormInstance>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	private final FinderPath _finderPathWithPaginationFindAll = new FinderPath(DDMFormInstanceModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceModelImpl.FINDER_CACHE_ENABLED,
			DDMFormInstanceImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findAll", new String[0]);
	private final FinderPath _finderPathWithoutPaginationFindAll = new FinderPath(DDMFormInstanceModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceModelImpl.FINDER_CACHE_ENABLED,
			DDMFormInstanceImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	private final FinderPath _finderPathCountAll = new FinderPath(DDMFormInstanceModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll", new String[0]);
	private final FinderPath _finderPathWithPaginationFindByUuid = new FinderPath(DDMFormInstanceModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceModelImpl.FINDER_CACHE_ENABLED,
			DDMFormInstanceImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByUuid",
			new String[] {
	...
	private final FinderPath _finderPathWithoutPaginationFindByUuid = new FinderPath(DDMFormInstanceModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceModelImpl.FINDER_CACHE_ENABLED,
			DDMFormInstanceImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			DDMFormInstanceModelImpl.UUID_COLUMN_BITMASK);
	private final FinderPath _finderPathCountByUuid = new FinderPath(DDMFormInstanceModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	private final FinderPath _finderPathFetchByUUID_G = new FinderPath(DDMFormInstanceModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceModelImpl.FINDER_CACHE_ENABLED,
	...
	private final FinderPath _finderPathCountByUUID_G = new FinderPath(DDMFormInstanceModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	private final FinderPath _finderPathWithPaginationFindByUuid_C = new FinderPath(DDMFormInstanceModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceModelImpl.FINDER_CACHE_ENABLED,
			DDMFormInstanceImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByUuid_C",
			new String[] {
	...
	private final FinderPath _finderPathWithoutPaginationFindByUuid_C = new FinderPath(DDMFormInstanceModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceModelImpl.FINDER_CACHE_ENABLED,
			DDMFormInstanceImpl.class,
	...
	private final FinderPath _finderPathCountByUuid_C = new FinderPath(DDMFormInstanceModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	private final FinderPath _finderPathWithPaginationFindByGroupId = new FinderPath(DDMFormInstanceModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceModelImpl.FINDER_CACHE_ENABLED,
			DDMFormInstanceImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByGroupId",
			new String[] {
	...
	private final FinderPath _finderPathWithoutPaginationFindByGroupId = new FinderPath(DDMFormInstanceModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceModelImpl.FINDER_CACHE_ENABLED,
			DDMFormInstanceImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByGroupId",
			new String[] { Long.class.getName() },
			DDMFormInstanceModelImpl.GROUPID_COLUMN_BITMASK);
	private final FinderPath _finderPathCountByGroupId = new FinderPath(DDMFormInstanceModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByGroupId",
			new String[] { Long.class.getName() });
	private final FinderPath _finderPathWithPaginationCountByGroupId = new FinderPath(DDMFormInstanceModelImpl.ENTITY_CACHE_ENABLED,
			DDMFormInstanceModelImpl.FINDER_CACHE_ENABLED, Long.class,

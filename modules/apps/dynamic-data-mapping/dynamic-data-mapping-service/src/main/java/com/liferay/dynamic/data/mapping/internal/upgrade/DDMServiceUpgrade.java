...
import com.liferay.dynamic.data.mapping.internal.upgrade.v3_1_3.UpgradeDataProviderOutputParameters;
...
public class DDMServiceUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		...
		registry.register(
			"3.2.0", "3.2.1",
			new UpgradeDataProviderOutputParameters(_jsonFactory));
	}

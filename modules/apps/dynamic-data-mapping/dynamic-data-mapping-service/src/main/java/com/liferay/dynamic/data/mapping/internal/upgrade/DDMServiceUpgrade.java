...
import com.liferay.dynamic.data.mapping.internal.upgrade.v3_7_1.UpgradeEmptyValidation;
...
public class DDMServiceUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		...
		registry.register(
			"3.7.0", "3.7.1",
			new UpgradeEmptyValidation(ddmFormJSONDeserializer, ddmFormSerializer));
	}

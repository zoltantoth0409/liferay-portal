...
public class DDMStructureLinkUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(DDMStructureLinkPersistence.class);

		ServiceTracker<DDMStructureLinkPersistence, DDMStructureLinkPersistence> serviceTracker =
			new ServiceTracker<DDMStructureLinkPersistence, DDMStructureLinkPersistence>(bundle.getBundleContext(),

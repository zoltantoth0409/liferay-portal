...
public class DDMTemplateVersionUtil {
	 ...
	 */
	public static List<DDMTemplateVersion> findByCTCollectionId(
		long ctCollectionId) {
	 ...
	 */
	public static DDMTemplateVersion findByCTCollectionId_First(
			long ctCollectionId,
			OrderByComparator<DDMTemplateVersion> orderByComparator)
	 ...
	 */
	public static DDMTemplateVersion fetchByCTCollectionId_First(
		long ctCollectionId,
		OrderByComparator<DDMTemplateVersion> orderByComparator) {
	 ...
	 * @throws NoSuchTemplateVersionException if a matching ddm template version could not be found
	 */
	public static DDMTemplateVersion findByCTCollectionId_Last(
			long ctCollectionId,
			OrderByComparator<DDMTemplateVersion> orderByComparator)
		throws com.liferay.dynamic.data.mapping.exception.
			NoSuchTemplateVersionException {
	 ...
	 */
	public static DDMTemplateVersion fetchByCTCollectionId_Last(
		long ctCollectionId,
		OrderByComparator<DDMTemplateVersion> orderByComparator) {
	 ...
	 */
	public static DDMTemplateVersion[] findByCTCollectionId_PrevAndNext(
		...
		return getPersistence().findByCTCollectionId_PrevAndNext(
			templateVersionId, ctCollectionId, orderByComparator);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			DDMTemplateVersionPersistence.class);

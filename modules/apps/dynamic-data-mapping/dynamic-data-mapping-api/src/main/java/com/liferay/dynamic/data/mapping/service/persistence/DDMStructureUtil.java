...
public class DDMStructureUtil {
	 ...
	 * @return the matching ddm structures
	 */
	public static List<DDMStructure> findByCTCollectionId(long ctCollectionId) {
	 ...
	 * @return the range of matching ddm structures
	 */
	public static List<DDMStructure> findByCTCollectionId(
	 ...
	 * @throws NoSuchStructureException if a matching ddm structure could not be found
	 */
	public static DDMStructure findByCTCollectionId_First(
			long ctCollectionId,
			OrderByComparator<DDMStructure> orderByComparator)
		throws com.liferay.dynamic.data.mapping.exception.
			NoSuchStructureException {
	 ...
	 * @return the first matching ddm structure, or <code>null</code> if a matching ddm structure could not be found
	 */
	public static DDMStructure fetchByCTCollectionId_First(
		long ctCollectionId,
		OrderByComparator<DDMStructure> orderByComparator) {
	 ...
	 * @throws NoSuchStructureException if a matching ddm structure could not be found
	 */
	public static DDMStructure findByCTCollectionId_Last(
			long ctCollectionId,
			OrderByComparator<DDMStructure> orderByComparator)
		throws com.liferay.dynamic.data.mapping.exception.
			NoSuchStructureException {
	 ...
	 * @return the last matching ddm structure, or <code>null</code> if a matching ddm structure could not be found
	 */
	public static DDMStructure fetchByCTCollectionId_Last(
		long ctCollectionId,
		OrderByComparator<DDMStructure> orderByComparator) {
	 ...
	 * @throws NoSuchStructureException if a ddm structure with the primary key could not be found
	 */
	public static DDMStructure[] findByCTCollectionId_PrevAndNext(
		...
		return getPersistence().findByCTCollectionId_PrevAndNext(
			structureId, ctCollectionId, orderByComparator);
	}
	...
	private static ServiceTracker
		<DDMStructurePersistence, DDMStructurePersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(DDMStructurePersistence.class);

		ServiceTracker<DDMStructurePersistence, DDMStructurePersistence>
			serviceTracker =
				new ServiceTracker

...
public interface DDMFormInstanceRecordPersistence extends BasePersistence<DDMFormInstanceRecord> {
	...
	* @return the matching ddm form instance records
	*/
	public java.util.List<DDMFormInstanceRecord> findByUuid_C(String uuid,
		long companyId);
	...
	* @return the matching ddm form instance records
	*/
	public java.util.List<DDMFormInstanceRecord> findByCompanyId(long companyId);
	...
	* @return the matching ddm form instance records
	*/
	public java.util.List<DDMFormInstanceRecord> findByU_F(long userId,
		long formInstanceId);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, DDMFormInstanceRecord> fetchByPrimaryKeys(

 ...
 * @see com.liferay.dynamic.data.mapping.service.persistence.impl.DDMFormInstanceRecordVersionPersistenceImpl
 * @generated
 */
@ProviderType
public class DDMFormInstanceRecordVersionUtil {
	 ...
	 */
	public static Map<Serializable, DDMFormInstanceRecordVersion> fetchByPrimaryKeys(
	...
	public static DDMFormInstanceRecordVersion update(
		...
		return getPersistence()
				   .update(ddmFormInstanceRecordVersion, serviceContext);
	}
	...
	*/
	public static List<DDMFormInstanceRecordVersion> findByFormInstanceRecordId(
		...
		return getPersistence().findByFormInstanceRecordId(formInstanceRecordId);
	}
	...
	*/
	public static List<DDMFormInstanceRecordVersion> findByFormInstanceRecordId(
		...
		return getPersistence()
				   .findByFormInstanceRecordId(formInstanceRecordId, start, end);
	}
	...
	*/
	public static List<DDMFormInstanceRecordVersion> findByFormInstanceRecordId(
		...
		OrderByComparator<DDMFormInstanceRecordVersion> orderByComparator) {
		return getPersistence()
				   .findByFormInstanceRecordId(formInstanceRecordId, start,
	...
	*/
	public static DDMFormInstanceRecordVersion findByFormInstanceRecordId_First(
		long formInstanceRecordId,
		OrderByComparator<DDMFormInstanceRecordVersion> orderByComparator)
		throws com.liferay.dynamic.data.mapping.exception.NoSuchFormInstanceRecordVersionException {
		return getPersistence()
				   .findByFormInstanceRecordId_First(formInstanceRecordId,
			orderByComparator);
	}
	...
	*/
	public static DDMFormInstanceRecordVersion fetchByFormInstanceRecordId_First(
		long formInstanceRecordId,
		OrderByComparator<DDMFormInstanceRecordVersion> orderByComparator) {
		return getPersistence()
				   .fetchByFormInstanceRecordId_First(formInstanceRecordId,
			orderByComparator);
	}
	...
	*/
	public static DDMFormInstanceRecordVersion findByFormInstanceRecordId_Last(
		...
		throws com.liferay.dynamic.data.mapping.exception.NoSuchFormInstanceRecordVersionException {
		return getPersistence()
				   .findByFormInstanceRecordId_Last(formInstanceRecordId,
			orderByComparator);
	}
	...
	*/
	public static DDMFormInstanceRecordVersion fetchByFormInstanceRecordId_Last(
		...
		OrderByComparator<DDMFormInstanceRecordVersion> orderByComparator) {
		return getPersistence()
				   .fetchByFormInstanceRecordId_Last(formInstanceRecordId,
			orderByComparator);
	}
	...
	*/
	public static DDMFormInstanceRecordVersion[] findByFormInstanceRecordId_PrevAndNext(
		...
		throws com.liferay.dynamic.data.mapping.exception.NoSuchFormInstanceRecordVersionException {
		return getPersistence()
				   .findByFormInstanceRecordId_PrevAndNext(formInstanceRecordVersionId,
	...
	*/
	public static int countByFormInstanceRecordId(long formInstanceRecordId) {
		return getPersistence().countByFormInstanceRecordId(formInstanceRecordId);
	}
	...
	*/
	public static DDMFormInstanceRecordVersion findByF_F_First(
		...
		throws com.liferay.dynamic.data.mapping.exception.NoSuchFormInstanceRecordVersionException {
		return getPersistence()
				   .findByF_F_First(formInstanceId, formInstanceVersion,
			orderByComparator);
	}
	...
	*/
	public static DDMFormInstanceRecordVersion findByF_F_Last(
		...
		throws com.liferay.dynamic.data.mapping.exception.NoSuchFormInstanceRecordVersionException {
		return getPersistence()
				   .findByF_F_Last(formInstanceId, formInstanceVersion,
			orderByComparator);
	}
	...
	*/
	public static DDMFormInstanceRecordVersion[] findByF_F_PrevAndNext(
		...
		throws com.liferay.dynamic.data.mapping.exception.NoSuchFormInstanceRecordVersionException {
		return getPersistence()
				   .findByF_F_PrevAndNext(formInstanceRecordVersionId,
	...
	*/
	public static DDMFormInstanceRecordVersion fetchByF_V(
		...
		return getPersistence()
				   .fetchByF_V(formInstanceRecordId, version, retrieveFromCache);
	}
	...
	*/
	public static List<DDMFormInstanceRecordVersion> findByF_S(
		...
		return getPersistence()
				   .findByF_S(formInstanceRecordId, status, start, end);
	}
	...
	*/
	public static DDMFormInstanceRecordVersion findByF_S_First(
		...
		throws com.liferay.dynamic.data.mapping.exception.NoSuchFormInstanceRecordVersionException {
		return getPersistence()
				   .findByF_S_First(formInstanceRecordId, status,
			orderByComparator);
	}
	...
	*/
	public static DDMFormInstanceRecordVersion fetchByF_S_First(
		...
		OrderByComparator<DDMFormInstanceRecordVersion> orderByComparator) {
		return getPersistence()
				   .fetchByF_S_First(formInstanceRecordId, status,
			orderByComparator);
	}
	...
	*/
	public static DDMFormInstanceRecordVersion findByF_S_Last(
		...
		throws com.liferay.dynamic.data.mapping.exception.NoSuchFormInstanceRecordVersionException {
		return getPersistence()
				   .findByF_S_Last(formInstanceRecordId, status,
			orderByComparator);
	}
	...
	*/
	public static DDMFormInstanceRecordVersion fetchByF_S_Last(
		...
		OrderByComparator<DDMFormInstanceRecordVersion> orderByComparator) {
		return getPersistence()
				   .fetchByF_S_Last(formInstanceRecordId, status,
			orderByComparator);
	}
	...
	*/
	public static DDMFormInstanceRecordVersion[] findByF_S_PrevAndNext(
		...
		throws com.liferay.dynamic.data.mapping.exception.NoSuchFormInstanceRecordVersionException {
		return getPersistence()
				   .findByF_S_PrevAndNext(formInstanceRecordVersionId,
	...
	*/
	public static List<DDMFormInstanceRecordVersion> findByU_F_F_S(
		...
		return getPersistence()
				   .findByU_F_F_S(userId, formInstanceId, formInstanceVersion,
			status);
	}
	...
	*/
	public static DDMFormInstanceRecordVersion findByU_F_F_S_First(
		...
		throws com.liferay.dynamic.data.mapping.exception.NoSuchFormInstanceRecordVersionException {
		return getPersistence()
				   .findByU_F_F_S_First(userId, formInstanceId,
	...
	*/
	public static DDMFormInstanceRecordVersion fetchByU_F_F_S_First(
		...
		OrderByComparator<DDMFormInstanceRecordVersion> orderByComparator) {
		return getPersistence()
				   .fetchByU_F_F_S_First(userId, formInstanceId,
			formInstanceVersion, status, orderByComparator);
	}
	...
	* @throws NoSuchFormInstanceRecordVersionException if a matching ddm form instance record version could not be found
	*/
	public static DDMFormInstanceRecordVersion findByU_F_F_S_Last(long userId,
		long formInstanceId, String formInstanceVersion, int status,
		OrderByComparator<DDMFormInstanceRecordVersion> orderByComparator)
		throws com.liferay.dynamic.data.mapping.exception.NoSuchFormInstanceRecordVersionException {
		return getPersistence()
				   .findByU_F_F_S_Last(userId, formInstanceId,
			formInstanceVersion, status, orderByComparator);
	}
	...
	*/
	public static DDMFormInstanceRecordVersion fetchByU_F_F_S_Last(
		...
		OrderByComparator<DDMFormInstanceRecordVersion> orderByComparator) {
		return getPersistence()
				   .fetchByU_F_F_S_Last(userId, formInstanceId,
			formInstanceVersion, status, orderByComparator);
	}
	...
	*/
	public static DDMFormInstanceRecordVersion[] findByU_F_F_S_PrevAndNext(
		...
		throws com.liferay.dynamic.data.mapping.exception.NoSuchFormInstanceRecordVersionException {
		return getPersistence()
				   .findByU_F_F_S_PrevAndNext(formInstanceRecordVersionId,
	...
	* @param status the status
	*/
	public static void removeByU_F_F_S(long userId, long formInstanceId,
		String formInstanceVersion, int status) {
		getPersistence()
			.removeByU_F_F_S(userId, formInstanceId, formInstanceVersion, status);
	}
	...
	* @return the number of matching ddm form instance record versions
	*/
	public static int countByU_F_F_S(long userId, long formInstanceId,
		String formInstanceVersion, int status) {
		return getPersistence()
				   .countByU_F_F_S(userId, formInstanceId, formInstanceVersion,
			status);
	}
	...
	*/
	public static List<DDMFormInstanceRecordVersion> findAll(int start,
		int end,
		OrderByComparator<DDMFormInstanceRecordVersion> orderByComparator) {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(DDMFormInstanceRecordVersionPersistence.class);

		ServiceTracker<DDMFormInstanceRecordVersionPersistence, DDMFormInstanceRecordVersionPersistence> serviceTracker =
			new ServiceTracker<DDMFormInstanceRecordVersionPersistence, DDMFormInstanceRecordVersionPersistence>(bundle.getBundleContext(),

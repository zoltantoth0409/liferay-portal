 ...
 *
 * <p>
 * Note that adding a {@link JSModule} to a {@link ModifiableJSPackage} by
 * itself doesn't update the {@link NPMRegistry} by itself, thus the new module
 * won't be visible until the registry updates its caches.
 * </p>
 *
 * <p>

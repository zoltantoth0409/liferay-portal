...
describe(
	...
	() => {
		it(
			'should return null if the form parameter is not a form node',
			() => {
		...
		it(
			'should return null if the elementName parameter is not a string',
			() => {
		...
		it(
			'should return null if the element does not exist withing the form',
			() => {
		...
		it(
			'should return element value if the element does exist withing the form',
			() => {
				let fragment = dom.buildFragment(`
					<form data-fm-namespace="_com_liferay_test_portlet_" id="fm">
						<input name="_com_liferay_test_portlet_foo" type="text" value="abc">

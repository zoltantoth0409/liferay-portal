...
function main {
	...
	./build_bundle.sh files.liferay.com/private/ee/commerce/2.1.0/Liferay%20Commerce%20Enterprise%202.1.0%20-%207.1.x.lpkg files.liferay.com/private/ee/portal/7.1.10.4/liferay-dxp-tomcat-7.1.10.4-sp4-20200331093526761.7z
	./build_bundle.sh files.liferay.com/private/ee/commerce/2.1.0/Liferay%20Commerce%20Enterprise%202.1.0%20-%207.2.x.lpkg files.liferay.com/private/ee/portal/7.2.10.2/liferay-dxp-tomcat-7.2.10.2-sp2-20200511121558464.7z
}

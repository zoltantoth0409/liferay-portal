...
public class CommerceInventoryManagementPanelCategory
	extends BasePanelCategory {

	@Override
	public String getKey() {
		return CommercePanelCategoryKeys.COMMERCE_INVENTORY_MANAGEMENT;
	}

	@Override
	public String getLabel(Locale locale) {
		return LanguageUtil.get(locale, "inventory-management");
	}

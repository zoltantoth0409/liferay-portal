				...
				onClick={() => add()
						.then((orderId) => {
							...
							Liferay.fire(CURRENT_ORDER_UPDATED, {
								orderId: orderDidChange ? orderId : currentCartId
							});

...
@Component(
	immediate = true,
	property = "commerce.data.set.display.name=" + CommercePriceListDataSetConstants.COMMERCE_DATA_SET_KEY_INSTANCE_TIER_PRICE_ENTRIES,
...
public class CPInstanceTierPriceEntryClayTableDataSetDisplayView
	...
	public ClayTableSchema getClayTableSchema() {
		...
		clayTableSchemaBuilder.addField("minQuantity", "min-quantity");

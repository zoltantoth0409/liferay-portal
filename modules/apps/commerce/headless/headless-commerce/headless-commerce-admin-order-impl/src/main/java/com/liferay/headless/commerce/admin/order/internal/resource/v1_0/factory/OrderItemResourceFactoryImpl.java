 ...
 * @generated
 */
@Component(immediate = true, service = OrderItemResource.Factory.class)
@Generated("")
public class OrderItemResourceFactoryImpl implements OrderItemResource.Factory {

	@Override
	public OrderItemResource.Builder create() {
		return new OrderItemResource.Builder() {
			...
			@Override
			public OrderItemResource.Builder checkPermissions(
			...
			@Override
			public OrderItemResource.Builder httpServletRequest(
			...
			@Override
			public OrderItemResource.Builder preferredLocale(
			...
			@Override
			public OrderItemResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		OrderItemResource.FactoryHolder.factory = this;
	}
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(orderItemResource);
	...
	private ComponentServiceObjects<OrderItemResource> _componentServiceObjects;

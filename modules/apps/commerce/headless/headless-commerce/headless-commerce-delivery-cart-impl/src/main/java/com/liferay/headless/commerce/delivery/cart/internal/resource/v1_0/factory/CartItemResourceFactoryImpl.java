...
public class CartItemResourceFactoryImpl implements CartItemResource.Factory {
	...
	public CartItemResource.Builder create() {
		return new CartItemResource.Builder() {
			...
			public CartItemResource build() {
				...
				return (CartItemResource)ProxyUtil.newProxyInstance(
					CartItemResource.class.getClassLoader(),
					new Class<?>[] {CartItemResource.class},
			...
			@Override
			public CartItemResource.Builder checkPermissions(
			...
			@Override
			public CartItemResource.Builder httpServletRequest(
			...
			@Override
			public CartItemResource.Builder preferredLocale(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(cartItemResource);

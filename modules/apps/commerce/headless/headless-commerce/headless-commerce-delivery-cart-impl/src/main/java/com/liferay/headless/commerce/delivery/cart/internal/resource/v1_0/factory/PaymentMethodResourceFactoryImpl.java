...
public class PaymentMethodResourceFactoryImpl
	...
	@Override
	public PaymentMethodResource.Builder create() {
		return new PaymentMethodResource.Builder() {
			...
			@Override
			public PaymentMethodResource.Builder checkPermissions(
			...
			@Override
			public PaymentMethodResource.Builder httpServletRequest(
			...
			@Override
			public PaymentMethodResource.Builder preferredLocale(
			...
			@Override
			public PaymentMethodResource.Builder user(User user) {
				_user = user;
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(paymentMethodResource);

...
public class DiscountProductResourceFactoryImpl
	...
	@Override
	public DiscountProductResource.Builder create() {
		return new DiscountProductResource.Builder() {
			...
			public DiscountProductResource build() {
				...
				return (DiscountProductResource)ProxyUtil.newProxyInstance(
					DiscountProductResource.class.getClassLoader(),
					new Class<?>[] {DiscountProductResource.class},
			...
			@Override
			public DiscountProductResource.Builder checkPermissions(
			...
			@Override
			public DiscountProductResource.Builder httpServletRequest(
			...
			@Override
			public DiscountProductResource.Builder preferredLocale(
			...
			@Override
			public DiscountProductResource.Builder user(User user) {
				_user = user;
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(discountProductResource);

...
public class PriceListAccountGroupResourceFactoryImpl
	implements PriceListAccountGroupResource.Factory {

	@Override
	public PriceListAccountGroupResource.Builder create() {
		return new PriceListAccountGroupResource.Builder() {
			...
			@Override
			public PriceListAccountGroupResource.Builder checkPermissions(
			...
			@Override
			public PriceListAccountGroupResource.Builder httpServletRequest(
			...
			@Override
			public PriceListAccountGroupResource.Builder preferredLocale(
			...
			@Override
			public PriceListAccountGroupResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		PriceListAccountGroupResource.FactoryHolder.factory = this;
	}

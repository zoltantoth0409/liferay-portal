...
>
	<c:if test="<%= commerceCountriesDisplayContext.hasPermission(CommerceActionKeys.MANAGE_COMMERCE_COUNTRIES) %>">
		<portlet:renderURL var="editURL">
			<portlet:param name="mvcRenderCommandName" value="/commerce_address/edit_commerce_country" />
		...
		<portlet:actionURL name="/commerce_address/edit_commerce_country" var="setActiveURL">
		...
		<portlet:actionURL name="/commerce_address/edit_commerce_country" var="deleteURL">

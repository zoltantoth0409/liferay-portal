...
@Component(
	immediate = true,
	property = {
		"commerce.pricing.navigation.item.key=" + CommercePricingPorletKeys.COMMERCE_PRICING_CLASSES,
...
public class PricingClassNavigationItem implements PricingNavigationItem {
	...
	public NavigationItem getNavigationItem(PortletRequest portletRequest)
		...
		PortletURL portletURL = _portal.getControlPanelPortletURL(
			portletRequest, CommercePricingPorletKeys.COMMERCE_PRICING_CLASSES,

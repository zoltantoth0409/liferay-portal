...
<div class="row">
	<div class="col-12">
		<commerce-ui:dataset-display
			...
			dataProviderKey="<%= CommercePricingClassDataSetConstants.COMMERCE_DATA_SET_KEY_PRICING_CLASSES %>"
			id="<%= CommercePricingClassDataSetConstants.COMMERCE_DATA_SET_KEY_PRICING_CLASSES %>"
			itemsPerPage="<%= 10 %>"

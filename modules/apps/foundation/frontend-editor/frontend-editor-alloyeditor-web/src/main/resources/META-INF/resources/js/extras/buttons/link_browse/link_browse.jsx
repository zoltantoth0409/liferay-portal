...
/**
 * The LinkBrowse class provides functionality for creating and editing a link in a document,
 * and also allows to link to an existing file in DM.
 * LinkBrowse renders in two different modes:
 *
 ...
 * @class LinkBrowse
 */
const LinkBrowse = React.createClass({

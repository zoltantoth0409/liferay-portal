	...
	<c:choose>
		<c:when test="<%= showSource %>">
			...
			<div class="alloy-editor-switch hide">
				...
				<button class="btn btn-default btn-xs lfr-portal-tooltip editor-view" data-title='<%= LanguageUtil.get(resourceBundle, "code-view") %>' id="<%= HtmlUtil.escapeAttribute(name) %>Switch" type="button">

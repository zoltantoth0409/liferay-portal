...
public class MDRRuleServiceUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<MDRRuleService, MDRRuleService> serviceTracker = new ServiceTracker<MDRRuleService, MDRRuleService>(bundle.getBundleContext(),
				MDRRuleService.class, null);

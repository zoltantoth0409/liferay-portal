...
public class MDRRuleLocalServiceUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<MDRRuleLocalService, MDRRuleLocalService> serviceTracker = new ServiceTracker<MDRRuleLocalService, MDRRuleLocalService>(bundle.getBundleContext(),

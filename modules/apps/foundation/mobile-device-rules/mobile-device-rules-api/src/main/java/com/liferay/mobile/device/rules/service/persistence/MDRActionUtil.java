...
public class MDRActionUtil {
	...
	* @throws NoSuchActionException if a matching mdr action could not be found
	*/
	public static MDRAction findByUuid_C_First(String uuid, long companyId,
		OrderByComparator<MDRAction> orderByComparator)
		throws com.liferay.mobile.device.rules.exception.NoSuchActionException {
		return getPersistence()
	...
	* @return the first matching mdr action, or <code>null</code> if a matching mdr action could not be found
	*/
	public static MDRAction fetchByUuid_C_First(String uuid, long companyId,
		OrderByComparator<MDRAction> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchActionException if a matching mdr action could not be found
	*/
	public static MDRAction findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<MDRAction> orderByComparator)
		throws com.liferay.mobile.device.rules.exception.NoSuchActionException {
		return getPersistence()
	...
	* @return the last matching mdr action, or <code>null</code> if a matching mdr action could not be found
	*/
	public static MDRAction fetchByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<MDRAction> orderByComparator) {
		return getPersistence()
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(MDRActionPersistence.class);

		ServiceTracker<MDRActionPersistence, MDRActionPersistence> serviceTracker =
			new ServiceTracker<MDRActionPersistence, MDRActionPersistence>(bundle.getBundleContext(),

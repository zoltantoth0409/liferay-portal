...
page import="com.liferay.mobile.device.rules.web.internal.security.permission.MDRPermission" %><%@
page import="com.liferay.mobile.device.rules.web.internal.security.permission.MDRRuleGroupInstancePermission" %><%@
page import="com.liferay.mobile.device.rules.web.internal.security.permission.MDRRuleGroupPermission" %><%@

...
<div class="server-admin-tabs">
	<aui:fieldset>
		<liferay-ui:panel-container
			extended="<%= true %>"
			id="uploadPanelContainer"
			persistState="<%= true %>"
		>
			<liferay-ui:panel
				collapsible="<%= true %>"
				extended="<%= true %>"
				id="adminGeneralUploadPanel"
				markupView="lexicon"
				persistState="<%= true %>"
				title="general"
			>
			...
			<liferay-ui:panel
				collapsible="<%= true %>"
				extended="<%= true %>"
				id="adminWebContentImagesPanel"
				markupView="lexicon"
				persistState="<%= true %>"
				title="web-content-images"
			>
			...
			<liferay-ui:panel
				collapsible="<%= true %>"
				extended="<%= true %>"
				id="adminShoppingCartImagesPanel"
				markupView="lexicon"
				persistState="<%= true %>"
				title="shopping-cart-images"
			>

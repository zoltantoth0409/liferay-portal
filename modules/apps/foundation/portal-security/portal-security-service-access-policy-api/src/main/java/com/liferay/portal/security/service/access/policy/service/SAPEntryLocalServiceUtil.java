...
public class SAPEntryLocalServiceUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<SAPEntryLocalService, SAPEntryLocalService> serviceTracker =
			new ServiceTracker<SAPEntryLocalService, SAPEntryLocalService>(bundle.getBundleContext(),

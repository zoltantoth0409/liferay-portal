...
public class UADWebKeys {
	...
	public static final String MANAGE_UAD_ENTITIES_DISPLAY =
		"MANAGE_UAD_ENTITIES_DISPLAY";

	public static final String MANAGE_UAD_SUMMARY_STEP =
		"MANAGE_UAD_SUMMARY_STEP";

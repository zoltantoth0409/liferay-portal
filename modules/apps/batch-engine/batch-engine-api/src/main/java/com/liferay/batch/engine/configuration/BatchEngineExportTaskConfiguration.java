...
@Meta.OCD(
	id = "com.liferay.batch.engine.configuration.BatchEngineExportTaskConfiguration",
	localization = "content/Language",
	name = "batch-engine-export-configuration-name"
)
public interface BatchEngineExportTaskConfiguration {

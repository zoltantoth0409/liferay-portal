...
/**
 * Provides the local service interface for BatchTask. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Shuyang Zhou
 * @see BatchTaskLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BatchTaskLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BatchTaskLocalServiceUtil} to access the batch task local service. Add custom service methods to <code>com.liferay.batch.engine.service.impl.BatchTaskLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

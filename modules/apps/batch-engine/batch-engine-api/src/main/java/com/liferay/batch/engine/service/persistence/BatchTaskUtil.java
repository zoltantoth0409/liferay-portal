...
/**
 * The persistence utility for the batch task service. This utility wraps <code>com.liferay.batch.engine.service.persistence.impl.BatchTaskPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class BatchTaskUtil {
	 ...
	 */
	public static void clearCache(BatchTask batchTask) {
		getPersistence().clearCache(batchTask);
	}
	 ...
	 */
	public static Map<Serializable, BatchTask> fetchByPrimaryKeys(
	 ...
	 */
	public static List<BatchTask> findWithDynamicQuery(
	 ...
	 */
	public static BatchTask update(BatchTask batchTask) {
		return getPersistence().update(batchTask);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static BatchTask update(
		BatchTask batchTask, ServiceContext serviceContext) {

		return getPersistence().update(batchTask, serviceContext);
	}
	 ...
	 */
	public static List<BatchTask> findByUuid(String uuid) {
	 ...
	 */
	public static List<BatchTask> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	public static List<BatchTask> findByUuid(
	 ...
	 */
	public static BatchTask findByUuid_First(
	 ...
	 */
	public static BatchTask fetchByUuid_First(
		String uuid, OrderByComparator<BatchTask> orderByComparator) {
	 ...
	 * @throws NoSuchTaskException if a matching batch task could not be found
	 */
	public static BatchTask findByUuid_Last(
			String uuid, OrderByComparator<BatchTask> orderByComparator)
		throws com.liferay.batch.engine.exception.NoSuchTaskException {
	 ...
	 */
	public static BatchTask fetchByUuid_Last(
		String uuid, OrderByComparator<BatchTask> orderByComparator) {
	 ...
	 */
	public static BatchTask[] findByUuid_PrevAndNext(
			long batchTaskId, String uuid,
			OrderByComparator<BatchTask> orderByComparator)
		throws com.liferay.batch.engine.exception.NoSuchTaskException {

		return getPersistence().findByUuid_PrevAndNext(
			batchTaskId, uuid, orderByComparator);
	}
	 ...
	 * @return the matching batch tasks
	 */
	public static List<BatchTask> findByUuid_C(String uuid, long companyId) {
	 ...
	 * @return the range of matching batch tasks
	 */
	public static List<BatchTask> findByUuid_C(
	 ...
	 * @throws NoSuchTaskException if a matching batch task could not be found
	 */
	public static BatchTask findByUuid_C_First(
	 ...
	 * @return the first matching batch task, or <code>null</code> if a matching batch task could not be found
	 */
	public static BatchTask fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<BatchTask> orderByComparator) {
	 ...
	 * @throws NoSuchTaskException if a matching batch task could not be found
	 */
	public static BatchTask findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<BatchTask> orderByComparator)
		throws com.liferay.batch.engine.exception.NoSuchTaskException {
	 ...
	 * @return the last matching batch task, or <code>null</code> if a matching batch task could not be found
	 */
	public static BatchTask fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<BatchTask> orderByComparator) {
	 ...
	 * @throws NoSuchTaskException if a batch task with the primary key could not be found
	 */
	public static BatchTask[] findByUuid_C_PrevAndNext(
			long batchTaskId, String uuid, long companyId,
			OrderByComparator<BatchTask> orderByComparator)
		throws com.liferay.batch.engine.exception.NoSuchTaskException {

		return getPersistence().findByUuid_C_PrevAndNext(
			batchTaskId, uuid, companyId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(BatchTask batchTask) {
		getPersistence().cacheResult(batchTask);
	}
	 ...
	 */
	public static void cacheResult(List<BatchTask> batchTasks) {
		getPersistence().cacheResult(batchTasks);
	}
	 ...
	 */
	public static BatchTask create(long batchTaskId) {
		return getPersistence().create(batchTaskId);
	}
	 ...
	 * @throws NoSuchTaskException if a batch task with the primary key could not be found
	 */
	public static BatchTask remove(long batchTaskId)
		throws com.liferay.batch.engine.exception.NoSuchTaskException {

		return getPersistence().remove(batchTaskId);
	}

	public static BatchTask updateImpl(BatchTask batchTask) {
		return getPersistence().updateImpl(batchTask);
	}
	 ...
	 * @throws NoSuchTaskException if a batch task with the primary key could not be found
	 */
	public static BatchTask findByPrimaryKey(long batchTaskId)
		throws com.liferay.batch.engine.exception.NoSuchTaskException {

		return getPersistence().findByPrimaryKey(batchTaskId);
	}
	 ...
	 */
	public static BatchTask fetchByPrimaryKey(long batchTaskId) {
		return getPersistence().fetchByPrimaryKey(batchTaskId);
	}
	 ...
	 */
	public static List<BatchTask> findAll() {
	 ...
	 */
	public static List<BatchTask> findAll(int start, int end) {
	...
	public static BatchTaskPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<BatchTaskPersistence, BatchTaskPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(BatchTaskPersistence.class);

		ServiceTracker<BatchTaskPersistence, BatchTaskPersistence>
			serviceTracker =
				new ServiceTracker<BatchTaskPersistence, BatchTaskPersistence>(
					bundle.getBundleContext(), BatchTaskPersistence.class,
					null);

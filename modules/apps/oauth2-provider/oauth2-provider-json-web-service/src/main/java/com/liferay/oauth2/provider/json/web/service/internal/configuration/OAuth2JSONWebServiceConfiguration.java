...
package com.liferay.oauth2.provider.json.web.service.internal.configuration;
...
@Meta.OCD(
	id = "com.liferay.oauth2.provider.json.web.service.internal.configuration.OAuth2JSONWebServiceConfiguration",
	localization = "content/Language",
	name = "oauth2-json-web-service-configuration-name"
)
public interface OAuth2JSONWebServiceConfiguration {

	@Meta.AD(
		deflt = "oauth2.application.description.JSONWS",
		description = "oauth2-json-web-service-application-description-description",
		id = "oauth2.application.description",
		name = "oauth2-json-web-service-application-description",
		required = false
	)

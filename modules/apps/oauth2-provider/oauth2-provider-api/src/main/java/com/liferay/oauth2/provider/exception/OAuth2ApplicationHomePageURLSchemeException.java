 ...
 */
@ProviderType
public class OAuth2ApplicationHomePageURLSchemeException extends PortalException {
	...
	public OAuth2ApplicationHomePageURLSchemeException(String msg, Throwable cause) {
		super(msg, cause);
	}

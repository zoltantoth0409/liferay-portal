 ...
 */
@ProviderType
public class OAuth2ApplicationRedirectURIFragmentException extends PortalException {
	...
	public OAuth2ApplicationRedirectURIFragmentException(String msg, Throwable cause) {
		super(msg, cause);
	}

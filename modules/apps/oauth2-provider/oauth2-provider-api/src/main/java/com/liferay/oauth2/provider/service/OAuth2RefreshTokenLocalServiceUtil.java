...
/**
 * Provides the local service utility for OAuth2RefreshToken. This utility wraps
 * {@link com.liferay.oauth2.provider.service.impl.OAuth2RefreshTokenLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class OAuth2RefreshTokenLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.oauth2.provider.service.impl.OAuth2RefreshTokenLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.oauth2.provider.model.OAuth2RefreshToken addOAuth2RefreshToken(
		com.liferay.oauth2.provider.model.OAuth2RefreshToken oAuth2RefreshToken) {
		return getService().addOAuth2RefreshToken(oAuth2RefreshToken);
	}
	...
	*/
	public static java.util.List<com.liferay.oauth2.provider.model.OAuth2RefreshToken> getOAuth2RefreshTokens(
		int start, int end) {
		return getService().getOAuth2RefreshTokens(start, end);
	}
	...
	*/
	public static int getOAuth2RefreshTokensCount() {
		return getService().getOAuth2RefreshTokensCount();
	}
	...
	*/
	public static com.liferay.oauth2.provider.model.OAuth2RefreshToken updateOAuth2RefreshToken(
		com.liferay.oauth2.provider.model.OAuth2RefreshToken oAuth2RefreshToken) {
		return getService().updateOAuth2RefreshToken(oAuth2RefreshToken);
	}

	public static OAuth2RefreshTokenLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<OAuth2RefreshTokenLocalService, OAuth2RefreshTokenLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(OAuth2RefreshTokenLocalService.class);

		ServiceTracker<OAuth2RefreshTokenLocalService, OAuth2RefreshTokenLocalService> serviceTracker =
			new ServiceTracker<OAuth2RefreshTokenLocalService, OAuth2RefreshTokenLocalService>(bundle.getBundleContext(),
				OAuth2RefreshTokenLocalService.class, null);

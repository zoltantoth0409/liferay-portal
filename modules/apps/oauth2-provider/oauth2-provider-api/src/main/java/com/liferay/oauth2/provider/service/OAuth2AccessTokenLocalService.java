...
/**
 * Provides the local service interface for OAuth2AccessToken. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OAuth2AccessTokenLocalServiceUtil
...
public interface OAuth2AccessTokenLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OAuth2AccessTokenLocalServiceUtil} to access the o auth2 access token local service. Add custom service methods to {@link com.liferay.oauth2.provider.service.impl.OAuth2AccessTokenLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public OAuth2AccessToken addOAuth2AccessToken(
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public OAuth2AccessToken deleteOAuth2AccessToken(
		OAuth2AccessToken oAuth2AccessToken);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public OAuth2AccessToken updateOAuth2AccessToken(
		OAuth2AccessToken oAuth2AccessToken);
}
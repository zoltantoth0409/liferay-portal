 ...
 */
@ProviderType
public class OAuth2ApplicationRedirectURIMissingException extends PortalException {
	...
	public OAuth2ApplicationRedirectURIMissingException(String msg, Throwable cause) {
		super(msg, cause);
	}

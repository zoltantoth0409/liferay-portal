...
/**
 * Provides the base implementation for the o auth2 access token local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.oauth2.provider.service.impl.OAuth2AccessTokenLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class OAuth2AccessTokenLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements OAuth2AccessTokenLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.oauth2.provider.service.OAuth2AccessTokenLocalServiceUtil} to access the o auth2 access token local service.
	 */
	...
	public OAuth2AccessToken addOAuth2AccessToken(
		...
		return oAuth2AccessTokenPersistence.update(oAuth2AccessToken);
	}
	...
	public OAuth2AccessToken deleteOAuth2AccessToken(
		OAuth2AccessToken oAuth2AccessToken) {
		return oAuth2AccessTokenPersistence.remove(oAuth2AccessToken);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(OAuth2AccessToken.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return oAuth2AccessTokenPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return oAuth2AccessTokenPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(oAuth2AccessTokenLocalService);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(oAuth2AccessTokenLocalService);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return oAuth2AccessTokenLocalService.deleteOAuth2AccessToken((OAuth2AccessToken)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return oAuth2AccessTokenPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<OAuth2AccessToken> getOAuth2AccessTokens(int start, int end) {
		return oAuth2AccessTokenPersistence.findAll(start, end);
	}
	...
	public int getOAuth2AccessTokensCount() {
		return oAuth2AccessTokenPersistence.countAll();
	}
	 ...
	 */
	public OAuth2AccessTokenLocalService getOAuth2AccessTokenLocalService() {
	...
	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.oauth2.provider.model.OAuth2AccessToken");
	}
	...
	public String getOSGiServiceIdentifier() {
		return OAuth2AccessTokenLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = oAuth2AccessTokenPersistence.getDataSource();
	...
	@BeanReference(type = OAuth2AccessTokenLocalService.class)
	protected OAuth2AccessTokenLocalService oAuth2AccessTokenLocalService;

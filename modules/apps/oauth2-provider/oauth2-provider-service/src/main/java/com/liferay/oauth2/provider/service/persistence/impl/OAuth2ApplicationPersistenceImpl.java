...
public class OAuth2ApplicationPersistenceImpl
	 ...
	 */
	@Override
	public List<OAuth2Application> findByC_N(long companyId, String name) {
		return findByC_N(
	 ...
	 */
	@Override
	public List<OAuth2Application> findByC_N(
	...
	public List<OAuth2Application> findByC_N(
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (OAuth2Application oAuth2Application : list) {
					if ((companyId != oAuth2Application.getCompanyId()) ||
						!name.equals(oAuth2Application.getName())) {
	...
	public OAuth2Application findByC_N_First(
		...
		OAuth2Application oAuth2Application = fetchByC_N_First(
	...
	public OAuth2Application fetchByC_N_First(
		...
		List<OAuth2Application> list = findByC_N(
	...
	public OAuth2Application findByC_N_Last(
		...
		OAuth2Application oAuth2Application = fetchByC_N_Last(
			companyId, name, orderByComparator);
	...
	public OAuth2Application[] findByC_N_PrevAndNext(
		...
		try {
			...
			array[0] = getByC_N_PrevAndNext(
				session, oAuth2Application, companyId, name, orderByComparator,
				true);
	...
	protected OAuth2Application getByC_N_PrevAndNext(
		Session session, OAuth2Application oAuth2Application, long companyId,
		String name, OrderByComparator<OAuth2Application> orderByComparator,
		boolean previous) {
	 ...
	 */
	@Override
	public List<OAuth2Application> filterFindByC_N(
		long companyId, String name) {
	...
	public OAuth2Application[] filterFindByC_N_PrevAndNext(
		...
		if (!InlineSQLHelperUtil.isEnabled(companyId, 0)) {
			return findByC_N_PrevAndNext(
				oAuth2ApplicationId, companyId, name, orderByComparator);
		}
	...
	protected OAuth2Application filterGetByC_N_PrevAndNext(
		Session session, OAuth2Application oAuth2Application, long companyId,
		String name, OrderByComparator<OAuth2Application> orderByComparator,
		boolean previous) {
	...
	private static final String _FINDER_COLUMN_C_N_NAME_3 =
		"(oAuth2Application.name IS NULL OR oAuth2Application.name = '')";
	...
	public OAuth2Application updateImpl(OAuth2Application oAuth2Application) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {
				oAuth2ApplicationModelImpl.getCompanyId(),
				oAuth2ApplicationModelImpl.getName()
			};
			...
			if ((oAuth2ApplicationModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					oAuth2ApplicationModelImpl.getOriginalCompanyId(),
					oAuth2ApplicationModelImpl.getOriginalName()
				};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByC_N = new FinderPath(
			...
			new String[] {Long.class.getName(), String.class.getName()},
			OAuth2ApplicationModelImpl.COMPANYID_COLUMN_BITMASK |
			OAuth2ApplicationModelImpl.NAME_COLUMN_BITMASK);

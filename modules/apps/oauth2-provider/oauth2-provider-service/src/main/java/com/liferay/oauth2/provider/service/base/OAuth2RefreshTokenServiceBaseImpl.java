...
/**
 * Provides the base implementation for the o auth2 refresh token remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.oauth2.provider.service.impl.OAuth2RefreshTokenServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class OAuth2RefreshTokenServiceBaseImpl extends BaseServiceImpl
	implements OAuth2RefreshTokenService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.oauth2.provider.service.OAuth2RefreshTokenServiceUtil} to access the o auth2 refresh token remote service.
	 */
	 ...
	 */
	public OAuth2RefreshTokenService getOAuth2RefreshTokenService() {
	...
	public String getOSGiServiceIdentifier() {
		return OAuth2RefreshTokenService.class.getName();
	}
	...
	@BeanReference(type = OAuth2RefreshTokenService.class)
	protected OAuth2RefreshTokenService oAuth2RefreshTokenService;

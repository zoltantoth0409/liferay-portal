...
import com.liferay.oauth2.provider.service.model.ApplicationModel;
...
/**
 * The base model implementation for the Application service. Represents a row in the &quot;OAuthTwo_Application&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link ApplicationModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ApplicationImpl}.
 * </p>
 *
...
public class ApplicationModelImpl extends BaseModelImpl<Application>
	 ...
	 */
	public static final String TABLE_NAME = "OAuthTwo_Application";
	...
	public static final String TABLE_SQL_CREATE = "create table OAuthTwo_Application (id_ LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,description VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table OAuthTwo_Application";
	public static final String ORDER_BY_JPQL = " ORDER BY application.id ASC";
	public static final String ORDER_BY_SQL = " ORDER BY OAuthTwo_Application.id_ ASC";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.oauth2.provider.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.oauth2.provider.service.model.Application"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.oauth2.provider.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.oauth2.provider.service.model.Application"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.oauth2.provider.service.util.ServiceProps.get(
				"lock.expiration.time.com.liferay.oauth2.provider.service.model.Application"));
	...
	public void resetOriginalValues() {
		...
		applicationModelImpl._setModifiedDate = false;
	}
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.oauth2.provider.service.model.Application");
	...
	private static final ClassLoader _classLoader = Application.class.getClassLoader();

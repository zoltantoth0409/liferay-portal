...
public interface FragmentEntryPersistence extends BasePersistence<FragmentEntry> {
	...
	* @return the matching fragment entries that the user has permission to view
	*/
	public java.util.List<FragmentEntry> filterFindByG_FCI_T(long groupId,
		long fragmentCollectionId, int type);
	...
	* @return the matching fragment entries
	*/
	public java.util.List<FragmentEntry> findByG_FCI_T_S(long groupId,
	...
	* @return the matching fragment entries that the user has permission to view
	*/
	public java.util.List<FragmentEntry> filterFindByG_FCI_T_S(long groupId,
		long fragmentCollectionId, int type, int status);

...
public class FragmentEntryUtil {
	...
	* @return the matching fragment entries that the user has permission to view
	*/
	public static List<FragmentEntry> filterFindByG_FCI_T(long groupId,
		long fragmentCollectionId, int type) {
		return getPersistence()
				   .filterFindByG_FCI_T(groupId, fragmentCollectionId, type);
	}
	...
	* @throws NoSuchEntryException if a fragment entry with the primary key could not be found
	*/
	public static FragmentEntry[] filterFindByG_FCI_T_PrevAndNext(
		long fragmentEntryId, long groupId, long fragmentCollectionId,
		int type, OrderByComparator<FragmentEntry> orderByComparator)
		throws com.liferay.fragment.exception.NoSuchEntryException {
		return getPersistence()
				   .filterFindByG_FCI_T_PrevAndNext(fragmentEntryId, groupId,
			fragmentCollectionId, type, orderByComparator);
	}
	...
	* @return the number of matching fragment entries that the user has permission to view
	*/
	public static int filterCountByG_FCI_T(long groupId,
		long fragmentCollectionId, int type) {
		return getPersistence()
				   .filterCountByG_FCI_T(groupId, fragmentCollectionId, type);
	}
	...
	* @return the matching fragment entries that the user has permission to view
	*/
	public static List<FragmentEntry> filterFindByG_FCI_S(long groupId,
		long fragmentCollectionId, int status) {
		return getPersistence()
				   .filterFindByG_FCI_S(groupId, fragmentCollectionId, status);
	}
	...
	* @throws NoSuchEntryException if a fragment entry with the primary key could not be found
	*/
	public static FragmentEntry[] filterFindByG_FCI_S_PrevAndNext(
		long fragmentEntryId, long groupId, long fragmentCollectionId,
		int status, OrderByComparator<FragmentEntry> orderByComparator)
		throws com.liferay.fragment.exception.NoSuchEntryException {
		return getPersistence()
				   .filterFindByG_FCI_S_PrevAndNext(fragmentEntryId, groupId,
			fragmentCollectionId, status, orderByComparator);
	}
	...
	* @return the number of matching fragment entries that the user has permission to view
	*/
	public static int filterCountByG_FCI_S(long groupId,
		long fragmentCollectionId, int status) {
		return getPersistence()
				   .filterCountByG_FCI_S(groupId, fragmentCollectionId, status);
	}
	...
	* @return the matching fragment entries that the user has permission to view
	*/
	public static List<FragmentEntry> filterFindByG_FCI_LikeN_S(long groupId,
		long fragmentCollectionId, String name, int status) {
		return getPersistence()
				   .filterFindByG_FCI_LikeN_S(groupId, fragmentCollectionId,
			name, status);
	}
	...
	* @throws NoSuchEntryException if a fragment entry with the primary key could not be found
	*/
	public static FragmentEntry[] filterFindByG_FCI_LikeN_S_PrevAndNext(
		long fragmentEntryId, long groupId, long fragmentCollectionId,
		String name, int status,
		OrderByComparator<FragmentEntry> orderByComparator)
		throws com.liferay.fragment.exception.NoSuchEntryException {
		return getPersistence()
				   .filterFindByG_FCI_LikeN_S_PrevAndNext(fragmentEntryId,
	...
	* @return the number of matching fragment entries that the user has permission to view
	*/
	public static int filterCountByG_FCI_LikeN_S(long groupId,
		long fragmentCollectionId, String name, int status) {
		return getPersistence()
				   .filterCountByG_FCI_LikeN_S(groupId, fragmentCollectionId,
			name, status);
	}
	...
	* @return the matching fragment entries
	*/
	public static List<FragmentEntry> findByG_FCI_T_S(long groupId,
	...
	*/
	public static List<FragmentEntry> findByG_FCI_T_S(long groupId,
		...
		return getPersistence()
				   .findByG_FCI_T_S(groupId, fragmentCollectionId, type,
			status, start, end);
	}
	...
	* @throws NoSuchEntryException if a matching fragment entry could not be found
	*/
	public static FragmentEntry findByG_FCI_T_S_First(long groupId,
		long fragmentCollectionId, int type, int status,
		OrderByComparator<FragmentEntry> orderByComparator)
		throws com.liferay.fragment.exception.NoSuchEntryException {
		return getPersistence()
				   .findByG_FCI_T_S_First(groupId, fragmentCollectionId, type,
	...
	* @return the first matching fragment entry, or <code>null</code> if a matching fragment entry could not be found
	*/
	public static FragmentEntry fetchByG_FCI_T_S_First(long groupId,
		long fragmentCollectionId, int type, int status,
		OrderByComparator<FragmentEntry> orderByComparator) {
		return getPersistence()
				   .fetchByG_FCI_T_S_First(groupId, fragmentCollectionId, type,
			status, orderByComparator);
	}
	...
	* @throws NoSuchEntryException if a matching fragment entry could not be found
	*/
	public static FragmentEntry findByG_FCI_T_S_Last(long groupId,
		long fragmentCollectionId, int type, int status,
		OrderByComparator<FragmentEntry> orderByComparator)
		throws com.liferay.fragment.exception.NoSuchEntryException {
		return getPersistence()
				   .findByG_FCI_T_S_Last(groupId, fragmentCollectionId, type,
			status, orderByComparator);
	}
	...
	* @return the last matching fragment entry, or <code>null</code> if a matching fragment entry could not be found
	*/
	public static FragmentEntry fetchByG_FCI_T_S_Last(long groupId,
		long fragmentCollectionId, int type, int status,
		OrderByComparator<FragmentEntry> orderByComparator) {
		return getPersistence()
				   .fetchByG_FCI_T_S_Last(groupId, fragmentCollectionId, type,
			status, orderByComparator);
	}
	...
	*/
	public static FragmentEntry[] findByG_FCI_T_S_PrevAndNext(
		...
		throws com.liferay.fragment.exception.NoSuchEntryException {
		return getPersistence()
				   .findByG_FCI_T_S_PrevAndNext(fragmentEntryId, groupId,
	...
	* @return the matching fragment entries that the user has permission to view
	*/
	public static List<FragmentEntry> filterFindByG_FCI_T_S(long groupId,
		long fragmentCollectionId, int type, int status) {
		return getPersistence()
				   .filterFindByG_FCI_T_S(groupId, fragmentCollectionId, type,
			status);
	}
	...
	* @throws NoSuchEntryException if a fragment entry with the primary key could not be found
	*/
	public static FragmentEntry[] filterFindByG_FCI_T_S_PrevAndNext(
		long fragmentEntryId, long groupId, long fragmentCollectionId,
		int type, int status, OrderByComparator<FragmentEntry> orderByComparator)
		throws com.liferay.fragment.exception.NoSuchEntryException {
		return getPersistence()
				   .filterFindByG_FCI_T_S_PrevAndNext(fragmentEntryId, groupId,
			fragmentCollectionId, type, status, orderByComparator);
	}
	...
	* @param status the status
	*/
	public static void removeByG_FCI_T_S(long groupId,
		long fragmentCollectionId, int type, int status) {
		getPersistence()
			.removeByG_FCI_T_S(groupId, fragmentCollectionId, type, status);
	}
	...
	* @return the number of matching fragment entries that the user has permission to view
	*/
	public static int filterCountByG_FCI_T_S(long groupId,
		long fragmentCollectionId, int type, int status) {
		return getPersistence()
				   .filterCountByG_FCI_T_S(groupId, fragmentCollectionId, type,
			status);
	}

...
public class FragmentEntryLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.fragment.model.FragmentEntry addFragmentEntry(
		...
		return getService()
				   .addFragmentEntry(userId, groupId, fragmentCollectionId,
			fragmentEntryKey, name, previewFileEntryId, type, status,
			serviceContext);
	}
	...
	public static com.liferay.fragment.model.FragmentEntry addFragmentEntry(
		...
		return getService()
				   .addFragmentEntry(userId, groupId, fragmentCollectionId,
			fragmentEntryKey, name, previewFileEntryId, status, serviceContext);
	}
	...
	public static com.liferay.fragment.model.FragmentEntry addFragmentEntry(
		...
		return getService()
				   .addFragmentEntry(userId, groupId, fragmentCollectionId,
			fragmentEntryKey, name, css, html, js, previewFileEntryId, type,
	...
	public static com.liferay.fragment.model.FragmentEntry addFragmentEntry(
		...
		return getService()
				   .addFragmentEntry(userId, groupId, fragmentCollectionId,
			fragmentEntryKey, name, css, html, js, previewFileEntryId, status,
			serviceContext);
	}

...
public class AnalyticsSyncedSitesConfigurationScreen
	...
	public String getName(Locale locale) {
		return LanguageUtil.get(
			ResourceBundleUtil.getBundle(locale, getClass()), "synced-sites");
	}
	...
	public void render(
		...
		try {
			RequestDispatcher requestDispatcher =
				_servletContext.getRequestDispatcher("/edit_synced_sites.jsp");

			requestDispatcher.include(httpServletRequest, httpServletResponse);
		}
		catch (ServletException se) {
			throw new IOException(
				"Unable to render /edit_synced_sites.jsp", se);
		}
	}

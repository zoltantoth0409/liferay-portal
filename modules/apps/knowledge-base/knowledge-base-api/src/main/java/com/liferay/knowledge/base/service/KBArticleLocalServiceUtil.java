...
public class KBArticleLocalServiceUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<KBArticleLocalService, KBArticleLocalService> serviceTracker =
			new ServiceTracker<KBArticleLocalService, KBArticleLocalService>(bundle.getBundleContext(),
				KBArticleLocalService.class, null);

...
package com.liferay.connected.apps.web.internal;
 ...
 */
@Component(service = ConnectedAppsManager.class)
public class ConnectedAppManagerImpl implements ConnectedAppsManager {

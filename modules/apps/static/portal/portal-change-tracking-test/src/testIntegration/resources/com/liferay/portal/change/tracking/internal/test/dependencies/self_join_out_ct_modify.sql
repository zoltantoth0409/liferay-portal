...
ON
 ...
 ((tempMainTable.mainTableId NOT IN ([$MAIN_TABLE_CT_ENTRY_MODEL_CLASS_PKS$]) AND tempMainTable.ctCollectionId = 0 OR tempMainTable.ctCollectionId = [$CT_COLLECTION_ID$]) OR tempMainTable.ctCollectionId IS NULL)
WHERE

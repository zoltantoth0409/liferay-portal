 ...
 */
public class NoSuchAppDataRecordLinkException extends NoSuchModelException {

	public NoSuchAppDataRecordLinkException() {
	}

	public NoSuchAppDataRecordLinkException(String msg) {
		super(msg);
	}

...
public class AppBuilderAppVersionPersistenceImpl
	...
	public void clearCache(AppBuilderAppVersion appBuilderAppVersion) {
		entityCache.removeResult(
			AppBuilderAppVersionImpl.class,
			appBuilderAppVersion.getPrimaryKey());

		finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITH_PAGINATION);
		finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);

		clearUniqueFindersCache(
			(AppBuilderAppVersionModelImpl)appBuilderAppVersion, true);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathCountByA_V, args, Long.valueOf(1), false);
		finderCache.putResult(
			_finderPathFetchByA_V, args, appBuilderAppVersionModelImpl, false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if ((appBuilderAppVersionModelImpl.getColumnBitmask() &
			 _finderPathFetchByUUID_G.getColumnBitmask()) != 0) {

			Object[] args = new Object[] {
				appBuilderAppVersionModelImpl.getColumnOriginalValue("uuid_"),
				appBuilderAppVersionModelImpl.getColumnOriginalValue("groupId")
			};
		...
		if (clearCurrent) {
			...
			finderCache.removeResult(_finderPathFetchByA_V, args);
		}
		...
		if ((appBuilderAppVersionModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				appBuilderAppVersionModelImpl.getColumnOriginalValue(
					"appBuilderAppId"),
				appBuilderAppVersionModelImpl.getColumnOriginalValue("version")
			};
	...
	public AppBuilderAppVersion updateImpl(
		...
		if (isNew) {
			...
			args = new Object[] {
				appBuilderAppVersionModelImpl.getUuid(),
				appBuilderAppVersionModelImpl.getCompanyId()
			};
			...
			args = new Object[] {appBuilderAppVersionModelImpl.getGroupId()};

			finderCache.removeResult(_finderPathCountByGroupId, args);
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByGroupId, args);

			args = new Object[] {appBuilderAppVersionModelImpl.getCompanyId()};
			...
			if ((appBuilderAppVersionModelImpl.getColumnBitmask() &
				...
				args = new Object[] {appBuilderAppVersionModelImpl.getUuid()};
		...
		entityCache.putResult(
			AppBuilderAppVersionImpl.class,
			appBuilderAppVersion.getPrimaryKey(), appBuilderAppVersion, false);

		clearUniqueFindersCache(appBuilderAppVersionModelImpl, false);
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			AppBuilderAppVersionModelImpl.getColumnBitmask("uuid_") |

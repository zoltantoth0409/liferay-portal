...
public class AppBuilderAppPersistenceImpl
	...
	public List<AppBuilderApp> filterFindByGroupId(
		...
		if (getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_APPBUILDERAPP_WHERE);
		}
		else {
			query.append(
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(AppBuilderAppModelImpl.ORDER_BY_SQL);
			}
		}

		String sql = InlineSQLHelperUtil.replacePermissionCheck(
			query.toString(), AppBuilderApp.class.getName(),
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				q.addEntity(_FILTER_ENTITY_ALIAS, AppBuilderAppImpl.class);
			}
			else {
				q.addEntity(_FILTER_ENTITY_TABLE, AppBuilderAppImpl.class);
			}
	...
	public int filterCountByGroupId(long groupId) {
		...
		query.append(_FILTER_SQL_COUNT_APPBUILDERAPP_WHERE);

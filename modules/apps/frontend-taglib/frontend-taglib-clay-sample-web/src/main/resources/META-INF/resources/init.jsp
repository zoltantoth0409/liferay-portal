...
page import="com.liferay.frontend.taglib.clay.sample.web.internal.display.context.ClaySampleTableDisplayContext" %><%@
...
ClaySampleTableDisplayContext claySampleTableDisplayContext = (ClaySampleTableDisplayContext)request.getAttribute(ClaySamplePortletKeys.CLAY_SAMPLE_TABLE_DISPLAY_CONTEXT);
%>
...
/**
 * Provides the base implementation of {@link UADExporter} for entities generated with
 * Service Builder. The count and batch actions are based on the
...
public abstract class DynamicQueryUADExporter<T extends BaseModel>
	...
	/**
	 * Returns a {@code ZipWriter} to write the data to. Each individual
	 * type {@code T} entity is written as a file in the resulting ZIP file.
	 *
	...
	/**
	 * Converts the type {@code T} base model to an XML string to be written
	 * to a file.
	 *

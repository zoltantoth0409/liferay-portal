...
page import="com.liferay.recent.documents.web.internal.constants.RecentDocumentsWebKeys" %>
...
<%
DLURLHelper dlurlHelper = (DLURLHelper)request.getAttribute(RecentDocumentsWebKeys.DL_URL_HELPER);
%>
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.powwow.model.PowwowParticipantModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link PowwowParticipantImpl}.
 * </p>
 *
 * @author Shinn Lok
 * @see PowwowParticipantImpl
 * @see com.liferay.powwow.model.PowwowParticipant
 * @see com.liferay.powwow.model.PowwowParticipantModel
 * @generated
 */
@JSON(strict = true)
public class PowwowParticipantModelImpl extends BaseModelImpl<PowwowParticipant>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a powwow participant model instance should use the {@link com.liferay.powwow.model.PowwowParticipant} interface instead.
	 */
	...
	public static long PARTICIPANTUSERID_COLUMN_BITMASK = 2L;
	public static long POWWOWMEETINGID_COLUMN_BITMASK = 4L;
	public static long TYPE_COLUMN_BITMASK = 8L;
	public static long POWWOWPARTICIPANTID_COLUMN_BITMASK = 16L;
	...
	private static ClassLoader _classLoader = PowwowParticipant.class.getClassLoader();

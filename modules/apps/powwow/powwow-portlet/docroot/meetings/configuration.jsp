...
String defaultEmailSubject = ContentUtil.get(PortletPropsValues.POWWOW_INVITATION_EMAIL_SUBJECT);
String defaultEmailBody = ContentUtil.get(PortletPropsValues.POWWOW_INVITATION_EMAIL_BODY);

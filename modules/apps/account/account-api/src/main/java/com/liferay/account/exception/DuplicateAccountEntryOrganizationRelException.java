 ...
 */
public class DuplicateAccountEntryOrganizationRelException extends PortalException {
	...
	public DuplicateAccountEntryOrganizationRelException(String msg, Throwable cause) {
		super(msg, cause);
	}

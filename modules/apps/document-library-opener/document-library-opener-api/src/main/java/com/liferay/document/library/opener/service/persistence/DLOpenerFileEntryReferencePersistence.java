...
public interface DLOpenerFileEntryReferencePersistence extends BasePersistence<DLOpenerFileEntryReference> {
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, DLOpenerFileEntryReference> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<DLOpenerFileEntryReference> findAll(int start, int end);
	...
	*/
	public java.util.List<DLOpenerFileEntryReference> findAll(int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<DLOpenerFileEntryReference> orderByComparator);

...
public class UpgradeDocumentLibrary extends UpgradeProcess {
	...
	protected void doUpgrade() throws Exception {
		...
		// DLFileEntry
		populateEmptyTitles("DLFileEntry");
		...
		populateEmptyTitles("DLFileVersion");
	...
	private void populateEmptyTitles(String tableName) throws Exception {
		try (PreparedStatement ps1 = connection.prepareStatement(
			"select fileEntryId from " + tableName + " where title = '' or " +
				"title is null");
	...
	private void _updateLongFileNames(String tableName) throws Exception {
		try (PreparedStatement ps1 = connection.prepareStatement(
			...
			PreparedStatement ps2 = AutoBatchPreparedStatementUtil.autoBatch(
				connection.prepareStatement(
					"update " + tableName + " set fileName = ? where " +
					"fileEntryId = ?"));
			ResultSet rs = ps1.executeQuery()) {

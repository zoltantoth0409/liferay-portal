...
public class GroupServiceHttp {
	...
	public static java.util.List<com.liferay.portal.kernel.model.Group> getGtGroups(
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class,
					"getGtGroups", _getGtGroupsParameterTypes14);
	...
	public static int getUserSitesGroupsCount(HttpPrincipal httpPrincipal)
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class,
					...
					_getUserSitesGroupsCountParameterTypes23);
	...
	public static boolean hasUserGroup(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class,
					"hasUserGroup", _hasUserGroupParameterTypes24);
	...
	public static void setRoleGroups(HttpPrincipal httpPrincipal, long roleId,
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class,
					"setRoleGroups", _setRoleGroupsParameterTypes29);
	...
	public static void unsetRoleGroups(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class,
					"unsetRoleGroups", _unsetRoleGroupsParameterTypes30);
	...
	public static void updateStagedPortlets(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class,
					...
					_updateStagedPortletsParameterTypes35);
	...
	private static final Class<?>[] _getGtGroupsParameterTypes14 = new Class[] {
	...
	private static final Class<?>[] _getUserSitesGroupsCountParameterTypes23 = new Class[] {
			
		};
	private static final Class<?>[] _hasUserGroupParameterTypes24 = new Class[] {
			long.class, long.class
		};
	...
	private static final Class<?>[] _setRoleGroupsParameterTypes29 = new Class[] {
			long.class, long[].class
		};
	private static final Class<?>[] _unsetRoleGroupsParameterTypes30 = new Class[] {
			long.class, long[].class
		};
	...
	private static final Class<?>[] _updateStagedPortletsParameterTypes35 = new Class[] {

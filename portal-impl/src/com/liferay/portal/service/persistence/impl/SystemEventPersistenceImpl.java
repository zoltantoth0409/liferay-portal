...
public class SystemEventPersistenceImpl
	...
	public Map<Serializable, SystemEvent> fetchByPrimaryKeys(
		...
		sb.append(_SQL_SELECT_SYSTEMEVENT_WHERE_PKS_IN);
	...
	private static final String _SQL_SELECT_SYSTEMEVENT_WHERE_PKS_IN =
		"SELECT systemEvent FROM SystemEvent systemEvent WHERE systemEventId IN (";

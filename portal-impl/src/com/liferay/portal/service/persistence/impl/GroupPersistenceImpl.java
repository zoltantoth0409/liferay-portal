...
public class GroupPersistenceImpl
	...
	public Group fetchByPrimaryKey(Serializable primaryKey) {
		Serializable serializable = EntityCacheUtil.getResult(
			GroupModelImpl.ENTITY_CACHE_ENABLED, GroupImpl.class, primaryKey);
	...
	public Map<Serializable, Group> fetchByPrimaryKeys(
		...
		sb.append(_SQL_SELECT_GROUP__WHERE_PKS_IN);
	...
	private static final String _SQL_SELECT_GROUP__WHERE_PKS_IN =
		"SELECT group_ FROM Group group_ WHERE groupId IN (";

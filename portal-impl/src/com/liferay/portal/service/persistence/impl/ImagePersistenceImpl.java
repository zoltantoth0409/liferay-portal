...
public class ImagePersistenceImpl
	 ...
	 * </p>
	 *
	 * @deprecated As of Mueller (7.2.x), replaced by {@link #findByLtSize(int, int, int, OrderByComparator)}
	 * @param size the size
	 * @param start the lower bound of the range of images
	 * @param end the upper bound of the range of images (not inclusive)
	...
	public List<Image> findByLtSize(
		...
		return findByLtSize(size, start, end, orderByComparator);
	}
	...
	public List<Image> findByLtSize(
		...
		List<Image> list = (List<Image>)FinderCacheUtil.getResult(

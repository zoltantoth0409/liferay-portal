...
public class LayoutBranchPersistenceImpl
	...
	public List<LayoutBranch> findByLayoutSetBranchId(
		...
		List<LayoutBranch> list = (List<LayoutBranch>)FinderCacheUtil.getResult(
	...
	public LayoutBranch fetchByL_P_N(
		...
		return fetchByL_P_N(layoutSetBranchId, plid, name);
	}
	...
	public Map<Serializable, LayoutBranch> fetchByPrimaryKeys(
		...
		Map<Serializable, LayoutBranch> map =
			new HashMap<Serializable, LayoutBranch>();
	...
	private static final String _SQL_SELECT_LAYOUTBRANCH_WHERE_PKS_IN =
		"SELECT layoutBranch FROM LayoutBranch layoutBranch WHERE layoutBranchId IN (";

...
public class ClusterGroupPersistenceImpl
	...
	public Map<Serializable, ClusterGroup> fetchByPrimaryKeys(
		...
		Map<Serializable, ClusterGroup> map =
			new HashMap<Serializable, ClusterGroup>();
		...
		sb.append(_SQL_SELECT_CLUSTERGROUP_WHERE_PKS_IN);
		...
		try {
			...
			for (ClusterGroup clusterGroup : (List<ClusterGroup>)query.list()) {
	...
	private static final String _SQL_SELECT_CLUSTERGROUP_WHERE_PKS_IN =
		"SELECT clusterGroup FROM ClusterGroup clusterGroup WHERE clusterGroupId IN (";

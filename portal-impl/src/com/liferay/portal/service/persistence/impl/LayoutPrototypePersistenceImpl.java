...
public class LayoutPrototypePersistenceImpl
	...
	public Map<Serializable, LayoutPrototype> fetchByPrimaryKeys(
		...
		sb.append(_SQL_SELECT_LAYOUTPROTOTYPE_WHERE_PKS_IN);
	...
	private static final String _SQL_SELECT_LAYOUTPROTOTYPE_WHERE_PKS_IN =
		"SELECT layoutPrototype FROM LayoutPrototype layoutPrototype WHERE layoutPrototypeId IN (";

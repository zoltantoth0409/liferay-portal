...
public class ResourcePermissionPersistenceImpl
	...
	public ResourcePermission updateImpl(
		...
		if (!ResourcePermissionModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			FinderCacheUtil.removeResult(
				_finderPathWithoutPaginationFindByC_N_S, args);
			...
			if ((resourcePermissionModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByC_N_S.getColumnBitmask()) !=
					 0) {
	...
	public Map<Serializable, ResourcePermission> fetchByPrimaryKeys(
		...
		sb.append(_SQL_SELECT_RESOURCEPERMISSION_WHERE_PKS_IN);
	...
	private static final String _SQL_SELECT_RESOURCEPERMISSION_WHERE_PKS_IN =
		"SELECT resourcePermission FROM ResourcePermission resourcePermission WHERE resourcePermissionId IN (";

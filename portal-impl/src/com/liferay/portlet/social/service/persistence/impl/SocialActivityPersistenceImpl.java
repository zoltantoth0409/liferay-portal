...
public class SocialActivityPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByCompanyId_C;
	private FinderPath _finderPathWithoutPaginationFindByCompanyId_C;
	private FinderPath _finderPathCountByCompanyId_C;
	 ...
	 */
	@Override
	public List<SocialActivity> findByCompanyId_C(
		long companyId, long classNameId) {

		return findByCompanyId_C(
	...
	public List<SocialActivity> findByCompanyId_C(
		...
		return findByCompanyId_C(companyId, classNameId, start, end, null);
	}
	...
	public List<SocialActivity> findByCompanyId_C(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache && productionMode) {
				finderPath = _finderPathWithoutPaginationFindByCompanyId_C;
				finderArgs = new Object[] {companyId, classNameId};
			}
		}
		else if (useFinderCache && productionMode) {
			finderPath = _finderPathWithPaginationFindByCompanyId_C;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_COMPANYID_C_COMPANYID_2);

			sb.append(_FINDER_COLUMN_COMPANYID_C_CLASSNAMEID_2);
	...
	public SocialActivity findByCompanyId_C_First(
		...
		SocialActivity socialActivity = fetchByCompanyId_C_First(
	...
	public SocialActivity fetchByCompanyId_C_First(
		...
		List<SocialActivity> list = findByCompanyId_C(
	...
	public SocialActivity findByCompanyId_C_Last(
		...
		SocialActivity socialActivity = fetchByCompanyId_C_Last(
			companyId, classNameId, orderByComparator);
	...
	public SocialActivity fetchByCompanyId_C_Last(
		...
		int count = countByCompanyId_C(companyId, classNameId);
	...
	public SocialActivity[] findByCompanyId_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByCompanyId_C_PrevAndNext(
				session, socialActivity, companyId, classNameId,
				orderByComparator, true);

			array[1] = socialActivity;

			array[2] = getByCompanyId_C_PrevAndNext(
				session, socialActivity, companyId, classNameId,
	...
	protected SocialActivity getByCompanyId_C_PrevAndNext(
		Session session, SocialActivity socialActivity, long companyId,
	...
	public int countByCompanyId_C(long companyId, long classNameId) {
		...
		if (productionMode) {
			finderPath = _finderPathCountByCompanyId_C;
	...
	private static final String _FINDER_COLUMN_COMPANYID_C_COMPANYID_2 =
		"socialActivity.companyId = ? AND ";

	private static final String _FINDER_COLUMN_COMPANYID_C_CLASSNAMEID_2 =
	...
	public SocialActivity updateImpl(SocialActivity socialActivity) {
		...
		if (isNew) {
			...
			FinderCacheUtil.removeResult(_finderPathCountByCompanyId_C, args);
			FinderCacheUtil.removeResult(
				_finderPathWithoutPaginationFindByCompanyId_C, args);
			...
			if ((socialActivityModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByCompanyId_C.
					 getColumnBitmask()) != 0) {
				...
				FinderCacheUtil.removeResult(
					_finderPathCountByCompanyId_C, args);
				FinderCacheUtil.removeResult(
					_finderPathWithoutPaginationFindByCompanyId_C, args);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByCompanyId_C = new FinderPath(
			SocialActivityImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByCompanyId_C",
			new String[] {
		...
		_finderPathWithoutPaginationFindByCompanyId_C = new FinderPath(
			SocialActivityImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByCompanyId_C",
		...
		_finderPathCountByCompanyId_C = new FinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByCompanyId_C",
			new String[] {Long.class.getName(), Long.class.getName()});

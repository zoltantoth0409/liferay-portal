...
public class SocialActivitySetPersistenceImpl
	...
	public List<SocialActivitySet> findByGroupId(
		...
		List<SocialActivitySet> list =
			(List<SocialActivitySet>)FinderCacheUtil.getResult(
	...
	private static final String _SQL_SELECT_SOCIALACTIVITYSET_WHERE_PKS_IN =
		"SELECT socialActivitySet FROM SocialActivitySet socialActivitySet WHERE activitySetId IN (";

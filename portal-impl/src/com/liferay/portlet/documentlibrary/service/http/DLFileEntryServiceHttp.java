...
public class DLFileEntryServiceHttp {
	...
	public static int getFileEntriesCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getFileEntriesCountParameterTypes17);
	...
	public static com.liferay.portal.kernel.lock.Lock getFileEntryLock(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getFileEntryLockParameterTypes24);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getGroupFileEntriesParameterTypes26);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				DLFileEntryServiceUtil.class, "getGroupFileEntries",
				_getGroupFileEntriesParameterTypes27);
	...
	public static boolean hasFileEntryLock(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_hasFileEntryLockParameterTypes32);
	...
	private static final Class<?>[] _getFileEntriesCountParameterTypes17 =
	...
	private static final Class<?>[] _getFileEntriesCountParameterTypes20 =
		new Class[] {long.class, long.class, String[].class};
	private static final Class<?>[] _getFileEntryParameterTypes21 =
		new Class[] {long.class};
	private static final Class<?>[] _getFileEntryParameterTypes22 =
		new Class[] {long.class, long.class, String.class};
	private static final Class<?>[]
		_getFileEntryByUuidAndGroupIdParameterTypes23 = new Class[] {
			String.class, long.class
		};
	private static final Class<?>[] _getFileEntryLockParameterTypes24 =
		new Class[] {long.class};
	private static final Class<?>[]
		_getFoldersFileEntriesCountParameterTypes25 = new Class[] {
			long.class, java.util.List.class, int.class
		};
	private static final Class<?>[] _getGroupFileEntriesParameterTypes26 =
		new Class[] {
			long.class, long.class, long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[] _getGroupFileEntriesParameterTypes27 =
		new Class[] {
	...
	private static final Class<?>[] _getGroupFileEntriesCountParameterTypes29 =
		new Class[] {long.class, long.class, long.class};
	private static final Class<?>[] _getGroupFileEntriesCountParameterTypes30 =
		new Class[] {
			long.class, long.class, long.class, long.class, String[].class,
			int.class
		};
	...
	private static final Class<?>[] _hasFileEntryLockParameterTypes32 =
		new Class[] {long.class};
	private static final Class<?>[] _isFileEntryCheckedOutParameterTypes33 =
		new Class[] {long.class};
	private static final Class<?>[] _isKeepFileVersionLabelParameterTypes34 =
		new Class[] {
			long.class, boolean.class,
			com.liferay.portal.kernel.service.ServiceContext.class
		};
	private static final Class<?>[] _isKeepFileVersionLabelParameterTypes35 =
		new Class[] {
			long.class, com.liferay.portal.kernel.service.ServiceContext.class
		};

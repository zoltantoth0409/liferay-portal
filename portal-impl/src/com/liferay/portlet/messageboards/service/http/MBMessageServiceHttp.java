...
public class MBMessageServiceHttp {
	...
	public static void deleteDiscussionMessage(
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, groupId, className, classPK, permissionClassName,
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCategoryMessagesParameterTypes12);
	...
	public static String getGroupMessagesRSS(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getGroupMessagesRSSParameterTypes17);
	...
	public static com.liferay.message.boards.kernel.model.MBMessageDisplay
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getMessageDisplayParameterTypes20);
			...
			return (com.liferay.message.boards.kernel.model.MBMessageDisplay)
				returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	public static com.liferay.message.boards.kernel.model.MBMessageDisplay
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, messageId, status, threadView, includePrevAndNext);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getThreadMessagesParameterTypes23);
	...
	public static void subscribeMessage(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_subscribeMessageParameterTypes27);
	...
	public static void unsubscribeMessage(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_unsubscribeMessageParameterTypes28);
	...
	public static com.liferay.message.boards.kernel.model.MBMessage
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_updateMessageParameterTypes31);
	...
	private static final Class<?>[] _deleteDiscussionMessageParameterTypes6 =
	...
	private static final Class<?>[] _deleteMessageAttachmentsParameterTypes10 =
		new Class[] {long.class};
	private static final Class<?>[] _emptyMessageAttachmentsParameterTypes11 =
		new Class[] {long.class};
	private static final Class<?>[] _getCategoryMessagesParameterTypes12 =
		new Class[] {long.class, long.class, int.class, int.class, int.class};
	private static final Class<?>[] _getCategoryMessagesCountParameterTypes13 =
		new Class[] {long.class, long.class, int.class};
	private static final Class<?>[] _getCategoryMessagesRSSParameterTypes14 =
		new Class[] {
	...
	private static final Class<?>[] _getCompanyMessagesRSSParameterTypes15 =
		new Class[] {
			long.class, int.class, int.class, String.class, double.class,
			String.class, String.class, String.class,
			com.liferay.portal.kernel.theme.ThemeDisplay.class
		};
	private static final Class<?>[] _getGroupMessagesCountParameterTypes16 =
		new Class[] {long.class, int.class};
	private static final Class<?>[] _getGroupMessagesRSSParameterTypes17 =
		new Class[] {
			long.class, int.class, int.class, String.class, double.class,
			String.class, String.class, String.class,
			com.liferay.portal.kernel.theme.ThemeDisplay.class
	...
	private static final Class<?>[] _getMessageDisplayParameterTypes20 =
		new Class[] {long.class, int.class};
	private static final Class<?>[] _getMessageDisplayParameterTypes21 =
		new Class[] {long.class, int.class, String.class, boolean.class};
	private static final Class<?>[] _getThreadAnswersCountParameterTypes22 =
		new Class[] {long.class, long.class, long.class};
	private static final Class<?>[] _getThreadMessagesParameterTypes23 =
		new Class[] {
			long.class, long.class, long.class, int.class, int.class, int.class
		};
	private static final Class<?>[] _getThreadMessagesCountParameterTypes24 =
		new Class[] {long.class, long.class, long.class, int.class};
	private static final Class<?>[] _getThreadMessagesRSSParameterTypes25 =
		new Class[] {
			long.class, int.class, int.class, String.class, double.class,
			String.class, String.class, String.class,
			com.liferay.portal.kernel.theme.ThemeDisplay.class
	...
	private static final Class<?>[]
		_restoreMessageAttachmentFromTrashParameterTypes26 = new Class[] {
			long.class, String.class
		};
	private static final Class<?>[] _subscribeMessageParameterTypes27 =
		new Class[] {long.class};
	private static final Class<?>[] _unsubscribeMessageParameterTypes28 =
		new Class[] {long.class};
	private static final Class<?>[] _updateAnswerParameterTypes29 =
		new Class[] {long.class, boolean.class, boolean.class};
	private static final Class<?>[] _updateDiscussionMessageParameterTypes30 =
		new Class[] {
			String.class, long.class, long.class, String.class, String.class,
			com.liferay.portal.kernel.service.ServiceContext.class
		};
	private static final Class<?>[] _updateMessageParameterTypes31 =
		new Class[] {

...
public class MBCategoryServiceHttp {
	...
	public static com.liferay.message.boards.kernel.model.MBCategory
			addCategory(
		...
		try {
			...
			return (com.liferay.message.boards.kernel.model.MBCategory)
				returnObj;
		}
	...
	public static java.util.List
		<com.liferay.message.boards.kernel.model.MBCategory> getCategories(
		...
		try {
			...
			return (java.util.List
				<com.liferay.message.boards.kernel.model.MBCategory>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	public static int getCategoriesCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCategoriesCountParameterTypes20);
	...
	public static com.liferay.message.boards.kernel.model.MBCategory
			getCategory(HttpPrincipal httpPrincipal, long categoryId)
		throws com.liferay.portal.kernel.exception.PortalException {

		try {
			MethodKey methodKey = new MethodKey(
				MBCategoryServiceUtil.class, "getCategory",
				_getCategoryParameterTypes26);
	...
	public static long[] getCategoryIds(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCategoryIdsParameterTypes27);
	...
	public static java.util.List<Long> getSubcategoryIds(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getSubcategoryIdsParameterTypes28);
	...
	public static com.liferay.message.boards.kernel.model.MBCategory
			moveCategory(
				HttpPrincipal httpPrincipal, long categoryId,
				long parentCategoryId, boolean mergeWithParentCategory)
		throws com.liferay.portal.kernel.exception.PortalException {

		try {
			MethodKey methodKey = new MethodKey(
				MBCategoryServiceUtil.class, "moveCategory",
				_moveCategoryParameterTypes31);
	...
	public static com.liferay.message.boards.kernel.model.MBCategory
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_moveCategoryToTrashParameterTypes33);
	...
	public static void subscribeCategory(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_subscribeCategoryParameterTypes35);
	...
	public static void unsubscribeCategory(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_unsubscribeCategoryParameterTypes36);
	...
	private static final Class<?>[] _getCategoriesAndThreadsParameterTypes12 =
		new Class[] {long.class, long.class};
	...
	private static final Class<?>[]
		_getCategoriesAndThreadsCountParameterTypes17 = new Class[] {
			long.class, long.class
		};
	private static final Class<?>[]
	...
	private static final Class<?>[] _getCategoriesCountParameterTypes20 =
		new Class[] {long.class, long.class};
	...
	private static final Class<?>[] _getCategoryIdsParameterTypes27 =
		new Class[] {long.class, long.class};
	private static final Class<?>[] _getSubcategoryIdsParameterTypes28 =
		new Class[] {java.util.List.class, long.class, long.class};
	private static final Class<?>[] _getSubscribedCategoriesParameterTypes29 =
		new Class[] {long.class, long.class, int.class, int.class};
	private static final Class<?>[]
		_getSubscribedCategoriesCountParameterTypes30 = new Class[] {
			long.class, long.class
		};
	private static final Class<?>[] _moveCategoryParameterTypes31 =
		new Class[] {long.class, long.class, boolean.class};
	private static final Class<?>[] _moveCategoryFromTrashParameterTypes32 =
		new Class[] {long.class, long.class};
	private static final Class<?>[] _moveCategoryToTrashParameterTypes33 =
		new Class[] {long.class};
	private static final Class<?>[] _restoreCategoryFromTrashParameterTypes34 =
		new Class[] {long.class};
	private static final Class<?>[] _subscribeCategoryParameterTypes35 =
		new Class[] {long.class, long.class};
	private static final Class<?>[] _unsubscribeCategoryParameterTypes36 =
		new Class[] {long.class, long.class};

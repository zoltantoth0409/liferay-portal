...
public class AssetCategoryServiceHttp {
	...
	public static String getCategoryPath(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCategoryPathParameterTypes8);
	...
	public static java.util.List<com.liferay.asset.kernel.model.AssetCategory>
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getChildCategoriesParameterTypes9);
	...
	public static com.liferay.asset.kernel.model.AssetCategory updateCategory(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_updateCategoryParameterTypes32);
	...
	private static final Class<?>[] _getCategoryPathParameterTypes8 =
		new Class[] {long.class};
	private static final Class<?>[] _getChildCategoriesParameterTypes9 =
		new Class[] {long.class};
	...
	private static final Class<?>[] _getVocabularyCategoriesParameterTypes11 =
		new Class[] {
			long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[] _getVocabularyCategoriesParameterTypes12 =
		new Class[] {
	...
	private static final Class<?>[]
		_getVocabularyCategoriesCountParameterTypes15 = new Class[] {
			long.class, long.class
		};
	private static final Class<?>[]
		_getVocabularyCategoriesCountParameterTypes16 = new Class[] {
	...
	private static final Class<?>[]
		_getVocabularyCategoriesDisplayParameterTypes18 = new Class[] {
			long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[]
		_getVocabularyCategoriesDisplayParameterTypes19 = new Class[] {
			long.class, String.class, long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[]
		_getVocabularyRootCategoriesParameterTypes20 = new Class[] {
			long.class, long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[]
		_getVocabularyRootCategoriesCountParameterTypes21 = new Class[] {
			long.class, long.class
		};
	private static final Class<?>[] _moveCategoryParameterTypes22 =
		new Class[] {
			long.class, long.class, long.class,
			com.liferay.portal.kernel.service.ServiceContext.class
		};
	...
	private static final Class<?>[] _searchCategoriesDisplayParameterTypes26 =
		new Class[] {
			long.class, String.class, long.class, int.class, int.class
		};
	private static final Class<?>[] _searchCategoriesDisplayParameterTypes27 =
		new Class[] {
	...
	private static final Class<?>[] _updateCategoryParameterTypes32 =
		new Class[] {
			long.class, long.class, java.util.Map.class, java.util.Map.class,
			long.class, String[].class,
			com.liferay.portal.kernel.service.ServiceContext.class

...
public class AssetTagPersistenceImpl
	...
	public List<AssetTag> filterFindByGroupId(
		...
		if (getDB().isSupportsInlineDistinct()) {
			sb.append(_FILTER_SQL_SELECT_ASSETTAG_WHERE);
		}
		else {
			sb.append(_FILTER_SQL_SELECT_ASSETTAG_NO_INLINE_DISTINCT_WHERE_1);
		}

		sb.append(_FINDER_COLUMN_GROUPID_GROUPID_2);

		if (!getDB().isSupportsInlineDistinct()) {
			sb.append(_FILTER_SQL_SELECT_ASSETTAG_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		String sql = InlineSQLHelperUtil.replacePermissionCheck(
			sb.toString(), AssetTag.class.getName(),
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				sqlQuery.addEntity(_FILTER_ENTITY_ALIAS, AssetTagImpl.class);
			}
			else {
				sqlQuery.addEntity(_FILTER_ENTITY_TABLE, AssetTagImpl.class);
			}
	...
	protected AssetTag filterGetByGroupId_PrevAndNext(
		...
		List<AssetTag> list = sqlQuery.list();
	...
	public int filterCountByGroupId(long groupId) {
		...
		sb.append(_FILTER_SQL_COUNT_ASSETTAG_WHERE);
	...
	public Map<Serializable, AssetTag> fetchByPrimaryKeys(
		...
		sb.append(_SQL_SELECT_ASSETTAG_WHERE_PKS_IN);

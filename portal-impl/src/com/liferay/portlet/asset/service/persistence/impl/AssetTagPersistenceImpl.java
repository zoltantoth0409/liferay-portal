...
public class AssetTagPersistenceImpl extends BasePersistenceImpl<AssetTag>
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByName = new FinderPath(AssetTagModelImpl.ENTITY_CACHE_ENABLED,
				AssetTagModelImpl.FINDER_CACHE_ENABLED, AssetTagImpl.class,
		...
		_finderPathWithoutPaginationFindByName = new FinderPath(AssetTagModelImpl.ENTITY_CACHE_ENABLED,
				AssetTagModelImpl.FINDER_CACHE_ENABLED, AssetTagImpl.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByName",
				new String[] { String.class.getName() },
				AssetTagModelImpl.NAME_COLUMN_BITMASK);

		_finderPathCountByName = new FinderPath(AssetTagModelImpl.ENTITY_CACHE_ENABLED,
				AssetTagModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByName",
				new String[] { String.class.getName() });

		_finderPathWithPaginationCountByName = new FinderPath(AssetTagModelImpl.ENTITY_CACHE_ENABLED,
				AssetTagModelImpl.FINDER_CACHE_ENABLED, Long.class,

...
@Processor(name = "tLiferayOutput")
@Documentation("TODO fill the documentation for this processor")
public class TLiferayOutput implements Serializable {
    private final TLiferayOutputConfiguration configuration;
    private final TalendService service;

    public TLiferayOutput(@Option("configuration") final TLiferayOutputConfiguration configuration,

...
public class SocialActivityUtil {
	 ...
	 * @return the matching social activities
	 */
	public static List<SocialActivity> findByCompanyId_C(
		long companyId, long classNameId) {

		return getPersistence().findByCompanyId_C(companyId, classNameId);
	}
	...
	public static List<SocialActivity> findByCompanyId_C(
		...
		return getPersistence().findByCompanyId_C(
	 ...
	 * @throws NoSuchActivityException if a matching social activity could not be found
	 */
	public static SocialActivity findByCompanyId_C_First(
			long companyId, long classNameId,
			OrderByComparator<SocialActivity> orderByComparator)
		throws com.liferay.social.kernel.exception.NoSuchActivityException {

		return getPersistence().findByCompanyId_C_First(
	 ...
	 * @return the first matching social activity, or <code>null</code> if a matching social activity could not be found
	 */
	public static SocialActivity fetchByCompanyId_C_First(
		long companyId, long classNameId,
		OrderByComparator<SocialActivity> orderByComparator) {

		return getPersistence().fetchByCompanyId_C_First(
			companyId, classNameId, orderByComparator);
	}
	 ...
	 * @throws NoSuchActivityException if a matching social activity could not be found
	 */
	public static SocialActivity findByCompanyId_C_Last(
			long companyId, long classNameId,
			OrderByComparator<SocialActivity> orderByComparator)
		throws com.liferay.social.kernel.exception.NoSuchActivityException {

		return getPersistence().findByCompanyId_C_Last(
			companyId, classNameId, orderByComparator);
	}
	 ...
	 * @return the last matching social activity, or <code>null</code> if a matching social activity could not be found
	 */
	public static SocialActivity fetchByCompanyId_C_Last(
		long companyId, long classNameId,
		OrderByComparator<SocialActivity> orderByComparator) {

		return getPersistence().fetchByCompanyId_C_Last(
			companyId, classNameId, orderByComparator);
	}
	 ...
	 * @throws NoSuchActivityException if a social activity with the primary key could not be found
	 */
	public static SocialActivity[] findByCompanyId_C_PrevAndNext(
			long activityId, long companyId, long classNameId,
			OrderByComparator<SocialActivity> orderByComparator)
		throws com.liferay.social.kernel.exception.NoSuchActivityException {

		return getPersistence().findByCompanyId_C_PrevAndNext(
	 ...
	 * @param classNameId the class name ID
	 */
	public static void removeByCompanyId_C(long companyId, long classNameId) {
		getPersistence().removeByCompanyId_C(companyId, classNameId);
	}
	 ...
	 * @return the number of matching social activities
	 */
	public static int countByCompanyId_C(long companyId, long classNameId) {
		return getPersistence().countByCompanyId_C(companyId, classNameId);
	}

...
public class SocialActivitySetUtil {
	 ...
	 * @throws NoSuchActivitySetException if a matching social activity set could not be found
	 */
	public static SocialActivitySet findByGroupId_Last(
			long groupId,
			OrderByComparator<SocialActivitySet> orderByComparator)
		throws com.liferay.social.kernel.exception.NoSuchActivitySetException {
	 ...
	 */
	public static SocialActivitySet fetchByGroupId_Last(
		long groupId, OrderByComparator<SocialActivitySet> orderByComparator) {
	...
	public static SocialActivitySet[] findByGroupId_PrevAndNext(
		...
		return getPersistence().findByGroupId_PrevAndNext(
			activitySetId, groupId, orderByComparator);
	}
	 ...
	 * @throws NoSuchActivitySetException if a matching social activity set could not be found
	 */
	public static SocialActivitySet findByUserId_Last(
			long userId, OrderByComparator<SocialActivitySet> orderByComparator)
		throws com.liferay.social.kernel.exception.NoSuchActivitySetException {
	 ...
	 * @return the last matching social activity set, or <code>null</code> if a matching social activity set could not be found
	 */
	public static SocialActivitySet fetchByUserId_Last(
		long userId, OrderByComparator<SocialActivitySet> orderByComparator) {
	...
	public static SocialActivitySet[] findByUserId_PrevAndNext(
		...
		return getPersistence().findByUserId_PrevAndNext(
			activitySetId, userId, orderByComparator);
	}
	 ...
	 * </p>
	 *
	 * @deprecated As of Mueller (7.2.x), replaced by {@link #findByG_U_T(long,long,int, int, int, OrderByComparator)}
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param type the type
	 * @param start the lower bound of the range of social activity sets
	 ...
	 * @throws NoSuchActivitySetException if a matching social activity set could not be found
	 */
	public static SocialActivitySet findByG_U_T_Last(
			long groupId, long userId, int type,
			OrderByComparator<SocialActivitySet> orderByComparator)
		throws com.liferay.social.kernel.exception.NoSuchActivitySetException {
	 ...
	 * @return the last matching social activity set, or <code>null</code> if a matching social activity set could not be found
	 */
	public static SocialActivitySet fetchByG_U_T_Last(
		long groupId, long userId, int type,
		OrderByComparator<SocialActivitySet> orderByComparator) {
	...
	public static SocialActivitySet[] findByG_U_T_PrevAndNext(
		...
		return getPersistence().findByG_U_T_PrevAndNext(
			activitySetId, groupId, userId, type, orderByComparator);
	}
	 ...
	 * @throws NoSuchActivitySetException if a matching social activity set could not be found
	 */
	public static SocialActivitySet findByC_C_T_Last(
			long classNameId, long classPK, int type,
			OrderByComparator<SocialActivitySet> orderByComparator)
		throws com.liferay.social.kernel.exception.NoSuchActivitySetException {
	 ...
	 * @return the last matching social activity set, or <code>null</code> if a matching social activity set could not be found
	 */
	public static SocialActivitySet fetchByC_C_T_Last(
		long classNameId, long classPK, int type,
		OrderByComparator<SocialActivitySet> orderByComparator) {
	...
	public static SocialActivitySet[] findByC_C_T_PrevAndNext(
		...
		return getPersistence().findByC_C_T_PrevAndNext(
			activitySetId, classNameId, classPK, type, orderByComparator);
	}
	 ...
	 * </p>
	 *
	 * @deprecated As of Mueller (7.2.x), replaced by {@link #findByG_U_C_T(long,long,long,int, int, int, OrderByComparator)}
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 * @param type the type
	 ...
	 * @throws NoSuchActivitySetException if a matching social activity set could not be found
	 */
	public static SocialActivitySet findByG_U_C_T_Last(
			long groupId, long userId, long classNameId, int type,
			OrderByComparator<SocialActivitySet> orderByComparator)
		throws com.liferay.social.kernel.exception.NoSuchActivitySetException {

		return getPersistence().findByG_U_C_T_Last(
			groupId, userId, classNameId, type, orderByComparator);
	}
	 ...
	 * @return the last matching social activity set, or <code>null</code> if a matching social activity set could not be found
	 */
	public static SocialActivitySet fetchByG_U_C_T_Last(
		long groupId, long userId, long classNameId, int type,
		OrderByComparator<SocialActivitySet> orderByComparator) {

		return getPersistence().fetchByG_U_C_T_Last(
			groupId, userId, classNameId, type, orderByComparator);
	}
	...
	public static SocialActivitySet[] findByG_U_C_T_PrevAndNext(
		...
		return getPersistence().findByG_U_C_T_PrevAndNext(
			activitySetId, groupId, userId, classNameId, type,
			orderByComparator);
	}
	 ...
	 * </p>
	 *
	 * @deprecated As of Mueller (7.2.x), replaced by {@link #findByU_C_C_T(long,long,long,int, int, int, OrderByComparator)}
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 * @param type the type
	 ...
	 * @throws NoSuchActivitySetException if a matching social activity set could not be found
	 */
	public static SocialActivitySet findByU_C_C_T_Last(
			long userId, long classNameId, long classPK, int type,
			OrderByComparator<SocialActivitySet> orderByComparator)
		throws com.liferay.social.kernel.exception.NoSuchActivitySetException {

		return getPersistence().findByU_C_C_T_Last(
			userId, classNameId, classPK, type, orderByComparator);
	}
	 ...
	 * @return the last matching social activity set, or <code>null</code> if a matching social activity set could not be found
	 */
	public static SocialActivitySet fetchByU_C_C_T_Last(
		long userId, long classNameId, long classPK, int type,
		OrderByComparator<SocialActivitySet> orderByComparator) {

		return getPersistence().fetchByU_C_C_T_Last(
			userId, classNameId, classPK, type, orderByComparator);
	}
	...
	public static SocialActivitySet[] findByU_C_C_T_PrevAndNext(
		...
		return getPersistence().findByU_C_C_T_PrevAndNext(
			activitySetId, userId, classNameId, classPK, type,
			orderByComparator);
	}
	...
	public static SocialActivitySetPersistence getPersistence() {
		if (_persistence == null) {
			_persistence =
				(SocialActivitySetPersistence)PortalBeanLocatorUtil.locate(

...
public interface DLSyncEventPersistence extends BasePersistence<DLSyncEvent> {
	 ...
	 * </p>
	 *
	 * @deprecated As of Mueller (7.2.x), replaced by {@link #findByModifiedTime(long, int, int, OrderByComparator)}
	 * @param modifiedTime the modified time
	 * @param start the lower bound of the range of dl sync events
	 * @param end the upper bound of the range of dl sync events (not inclusive)
	...
	/**
	 * Returns the dl sync event where typePK = &#63; or throws a <code>NoSuchSyncEventException</code> if it could not be found.
	 *
	 ...
	 *
	 * @deprecated As of Mueller (7.2.x), replaced by {@link #fetchByTypePK(long)}
	 * @param typePK the type pk
	 * @param useFinderCache whether to use the finder cache
	...
	/**
	 * Returns the dl sync event with the primary key or throws a <code>NoSuchSyncEventException</code> if it could not be found.
	 *
	 * @param syncEventId the primary key of the dl sync event

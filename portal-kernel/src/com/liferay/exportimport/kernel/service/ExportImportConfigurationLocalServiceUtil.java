...
public class ExportImportConfigurationLocalServiceUtil {
	...
	*/
	...
	public static int getExportImportConfigurationsCount(long companyId,
		long groupId, String keywords, int type) {
		return getService()

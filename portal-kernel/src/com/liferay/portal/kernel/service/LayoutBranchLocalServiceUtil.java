...
public class LayoutBranchLocalServiceUtil {
	...
	public static java.util.List<com.liferay.portal.kernel.model.LayoutBranch>
		getLayoutBranches(int start, int end) {

		return getService().getLayoutBranches(start, end);
	}
	 ...
	 */
	public static int getLayoutBranchesCount() {
		return getService().getLayoutBranchesCount();
	}

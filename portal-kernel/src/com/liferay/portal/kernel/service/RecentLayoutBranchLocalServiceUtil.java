	...
	public static RecentLayoutBranchLocalService getService() {
		if (_service == null) {
			...
			ReferenceRegistry.registerReference(
				RecentLayoutBranchLocalServiceUtil.class, "_service");
		}

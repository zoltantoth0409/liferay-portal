...
public class AssetCategoryUtil {
	 ...
	 * @return the matching asset categories
	 */
	public static List<AssetCategory> findByCTCollectionId(
		long ctCollectionId) {
	 ...
	 * @throws NoSuchCategoryException if a matching asset category could not be found
	 */
	public static AssetCategory findByCTCollectionId_First(
			long ctCollectionId,
			OrderByComparator<AssetCategory> orderByComparator)
		throws com.liferay.asset.kernel.exception.NoSuchCategoryException {
	 ...
	 * @return the first matching asset category, or <code>null</code> if a matching asset category could not be found
	 */
	public static AssetCategory fetchByCTCollectionId_First(
		long ctCollectionId,
		OrderByComparator<AssetCategory> orderByComparator) {
	 ...
	 * @throws NoSuchCategoryException if a matching asset category could not be found
	 */
	public static AssetCategory findByCTCollectionId_Last(
			long ctCollectionId,
			OrderByComparator<AssetCategory> orderByComparator)
		throws com.liferay.asset.kernel.exception.NoSuchCategoryException {
	 ...
	 * @return the last matching asset category, or <code>null</code> if a matching asset category could not be found
	 */
	public static AssetCategory fetchByCTCollectionId_Last(
		long ctCollectionId,
		OrderByComparator<AssetCategory> orderByComparator) {
	 ...
	 * @throws NoSuchCategoryException if a asset category with the primary key could not be found
	 */
	public static AssetCategory[] findByCTCollectionId_PrevAndNext(
			long categoryId, long ctCollectionId,
			OrderByComparator<AssetCategory> orderByComparator)
		throws com.liferay.asset.kernel.exception.NoSuchCategoryException {

		return getPersistence().findByCTCollectionId_PrevAndNext(
			categoryId, ctCollectionId, orderByComparator);
	}

...
public class AssetVocabularyWrapper
	...
	@Override
	public Object clone() {
		return new AssetVocabularyWrapper(
			(AssetVocabulary)_assetVocabulary.clone());
	}
	...
	public String getUnambiguousTitle(
		...
		return _assetVocabulary.getUnambiguousTitle(
			vocabularies, groupId, locale);
	}
	...
	public boolean isAssociatedToClassNameIdAndClassTypePK(
		...
		return _assetVocabulary.isAssociatedToClassNameIdAndClassTypePK(
	...
	public boolean isMissingRequiredCategory(
		...
		return _assetVocabulary.isMissingRequiredCategory(
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<AssetVocabulary>
		toCacheModel() {

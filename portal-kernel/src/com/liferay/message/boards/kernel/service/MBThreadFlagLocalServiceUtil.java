 ...
 * <code>com.liferay.portlet.messageboards.service.impl.MBThreadFlagLocalServiceImpl</code> and
...
public class MBThreadFlagLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.portlet.messageboards.service.impl.MBThreadFlagLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.liferay.message.boards.kernel.model.MBThreadFlag
		addMBThreadFlag(
	...
	public static java.util.List
		<com.liferay.message.boards.kernel.model.MBThreadFlag> getMBThreadFlags(
			int start, int end) {
	...
	public static MBThreadFlagLocalService getService() {
		if (_service == null) {
			_service = (MBThreadFlagLocalService)PortalBeanLocatorUtil.locate(
				MBThreadFlagLocalService.class.getName());

			ReferenceRegistry.registerReference(
				MBThreadFlagLocalServiceUtil.class, "_service");
		}

 ...
 * <code>com.liferay.portlet.messageboards.service.impl.MBThreadLocalServiceImpl</code> and
...
public class MBThreadLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.portlet.messageboards.service.impl.MBThreadLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static java.util.List
		<com.liferay.message.boards.kernel.model.MBThread> getMBThreads(
			int start, int end) {
	...
	public static java.util.List
		<com.liferay.message.boards.kernel.model.MBThread> getNoAssetThreads() {
	...
	public static java.util.List
		<com.liferay.message.boards.kernel.model.MBThread> getPriorityThreads(
	...
	public static com.liferay.message.boards.kernel.model.MBThread
			moveThreadFromTrash(long userId, long categoryId, long threadId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static com.liferay.message.boards.kernel.model.MBThread
			moveThreadToTrash(long userId, long threadId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static MBThreadLocalService getService() {
		if (_service == null) {
			_service = (MBThreadLocalService)PortalBeanLocatorUtil.locate(
				MBThreadLocalService.class.getName());

			ReferenceRegistry.registerReference(
				MBThreadLocalServiceUtil.class, "_service");
		}
